...
Generated 2026-09-17T03:45:49Z. Pin `82f20568` (82f20568997a, raw/ frozen at 2026-09-07T12:42:23Z).
...
| ASM_ pins | 2135 | 1,465,048 | 57.3% | 1278 | 1,096,564 | 42.9% |
| goto | 1545 | 1,318,412 | 51.5% | 1605 | 1,367,896 | 53.5% |
...
| do{}while(0) scheduling barrier (scaffolding, pure C) | 227 | 156,176 | 6.1% | 403 | 292,604 | 11.4% |
| fake dependency x=(e)+a;x-=a / arg+v-v (scaffolding, pure C) | 1 | 408 | 0.0% | 2 | 820 | 0.0% |
| local address-named struct | 633 | 346,988 | 13.6% | 3176 | 1,619,588 | 63.3% |
| clean shape (none of boiler/M2C_FIELD/pins/goto/m2c names) | 632 | 156,440 | 6.1% | 2898 | 499,784 | 19.5% |

Pin sites now: 6,050 in 1,276 rows; REG 2,725, KEEP 1,576, KEEP_NV 756, SCHED_BARRIER 322, USE_NV 126, KEEP_DEP_NV 112, USE 82, MEM_BARRIER 58.  At the pin: 25,759; REG 12,778, KEEP 6,854, KEEP_NV 2,500, SCHED_BARRIER 1,349, TAILSLOT_PIN 499, USE 294, USE_NV 260, KEEP_DEP_NV 184.
...
Per-row optimization flags (weak evidence about the real build; each switch is undone from the `t30_cellpins` journal's `cell_from`): 301 rows carry one flag, 38 carry two or more.
