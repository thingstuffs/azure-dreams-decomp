...
void func_800A58CC(S_800A58CC_2 *arg0, void *arg1) {
    register S_800A58CC_2 *saved_arg0 ASM_REG("$18") = arg0; /* MATCH: Keep the object in retail s2 across the merged control-flow arms. */
    s16 temp_v0;
    s16 temp_v0_2;
    s32 shared_s0;
    s32 var_v0;
    ...
    ASM_KEEP_NV(saved_arg0); /* MATCH: Order the s2 parameter copy before the s0 copy. */
    shared_s0 = (s32) arg1;
    town = D_80083160;
    ...
    func_80095094((void *) shared_s0);
    shared_s0 = (saved_arg0->unk_10 - 0x800) & 0xFFF;
    ...
    temp_v0_3 = saved_arg0->unk_0A.s - 1;
    saved_arg0->unk_0A.s = temp_v0_3;
    ...
    if ((saved_arg0->unk_0A.u == 0) && (((S_800A58CC_3 *)town)->unk_C8 == shared_s0)) {
        saved_arg0->unk_0A.u = 0;
        saved_arg0->unk_00 = &D_800A5A98;
    }
}
