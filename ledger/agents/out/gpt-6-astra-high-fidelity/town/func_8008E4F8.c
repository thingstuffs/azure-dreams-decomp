...
void func_8008BC58(u8 *object, void *arg1, void *arg2) {
    ...
    s16 state;
    register void *arg2_copy ASM_REG("$4"); /* MATCH: retain retail's unused a2-to-a0 move in the entry branch delay slot. */
    register void *incoming ASM_REG("$6") = arg2; /* MATCH: keep the incoming argument in a2 until its delay-slot copy. */

    arg2_copy = incoming;
    if (D_800FC418 != 0) {
        ASM_USE2_NV(arg2_copy, incoming);
