...
/* MECHANISM: Preserve the exact 0x20 frame and s0/s1/s2 holds.
   The two guard arms share the func_800A0F10 check and action tail;
   GCC places arg0 in the conditional-branch delay slot and emits the join jump. */
