...
void func_80165FA4(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    if (!(D_80083462 & 0x2000)) {
...

        {
            ...
            void *current;
            void *table;
            register void *state_table ASM_REG("$5"); /* MATCH: merge the selected table address in a1. */
            ...
            func_80047784(arg2,
                *(u8 *)((((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7) + (u32)state_table),
                0);
