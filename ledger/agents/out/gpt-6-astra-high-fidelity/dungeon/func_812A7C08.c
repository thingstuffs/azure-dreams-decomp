...
void func_80173408(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    state = ((S_80173408_0 *)arg0)->unk_9B.n;
    if ((u32)state >= 5) {
        return;
    }
    (void)jt_keep;
...
L1:
    ...
    func_80047784(arg2,
        D_80175C48[((D_80083228 + ((S_80173408_4 *)arg3)->unk_2A.s + 0x100) >> 9) & 7],
        0);
    func_801753DC((u8 *)arg0 - 0x20, (u8 *)arg3 + 0x2A);
    state = ((S_80173408_0 *)arg0)->unk_9B.v;
...
L2:
    ...
    func_80047784(arg2,
        D_80175C50[((D_80083228 + ((S_80173408_4 *)arg3)->unk_2A.s + 0x100) >> 9) & 7],
        0);
    func_800A56E0(0x808);
    state = ((S_80173408_0 *)arg0)->unk_9B.n;
increment_state:
    ((S_80173408_0 *)arg0)->unk_9B.n = state + 1;
    return;
...
L3:
    {
        ...
        if (((S_80173408_0 *)arg0)->unk_96.s == 10) {
            func_8009C12C(arg3, arg2, ((S_80173408_4 *)arg3)->unk_2A.s, 1);
        }
        base_x = (s16 *)&D_8006CCD8;
        base_y = (s16 *)&D_8006CCE8;
        index = ((u16)((S_80173408_4 *)arg3)->unk_2A.u >> 8) & 0xE;
        ...
        func_80047784(arg2,
            D_80175C58[((D_80083228 + ((S_80173408_4 *)arg3)->unk_2A.s + 0x100) >> 9) & 7],
            0);
