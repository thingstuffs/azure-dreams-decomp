...
{
    u8 *table;
    register u8 *state ASM_REG("$5"); /* MATCH: merge both table choices in a1 for the shared tail. */
    s32 result;
    s32 scratch;
    ...
    if (initial_flags & 0x1000) {
        ...
        func_80171438(arg0, arg1, arg2, arg3);
        return;
    }
...
set_table:
    ...
    func_80047784(arg2,
        *(u8 *)((((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7) + (u32)state),
        0);
}
