...
void func_8001D4AC(Rec_func_8001CE44_arg0 *arg0, s32 arg1, s32 arg2, s32 arg3) {
    static void *const jt_keep[] = { &&jt_c0, &&jt_c1, &&jt_c2, &&jt_c3, &&jt_c4, &&jt_c5, &&jt_c6, &&jt_c7, &&jt_c8, &&jt_c9, &&jt_c10, &&jt_c11, &&jt_c12 };
    u32 temp_v1;
    s16 saved_arg1 = arg1;

    arg0->unk_0A = 1;
    temp_v1 = func_800A6D30(arg0, arg1, arg2, arg3) & 0xFF;
    if (temp_v1 >= 0xDU) {
        goto block_14;
    }
