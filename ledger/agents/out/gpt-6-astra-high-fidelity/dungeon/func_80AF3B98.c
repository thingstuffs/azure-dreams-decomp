...
jt_c1:
    ...
    ((S_80175398_1 *)arg3)->unk_8A = ((S_80175398_1 *)arg3)->unk_2A.u;
...
jt_c2:
    {
        ...
        direction = ((D_80083228 + ((S_80175398_1 *)arg3)->unk_2A.s + 0x100) >> 9) & 7;
        angle = ((S_80175398_1 *)arg3)->unk_2A.u;
        if (D_80175A80[0] == 0) {
...
direction_not_ready:
        ...
        ((S_80175398_1 *)arg3)->unk_2A.u = angle + 0x200;
        return;
...
direction_ready:
        ...
        ((S_80175398_0 *)arg0)->unk_96.u = 0x10;
        ((S_80175398_0 *)arg0)->unk_9B++;
    }

jt_c3:
    {
        u16 old_timer = ((S_80175398_0 *)arg0)->unk_96.u;
        u16 timer = old_timer - 1;
        u8 *target;

        ((S_80175398_0 *)arg0)->unk_96.u = timer;
        if ((s32)(timer << 16) <= 0) {
            u8 finished = D_80175A81;
            ((S_80175398_0 *)arg0)->unk_96.u = old_timer;
            if (finished == 0) {
                goto done;
            }
            ((S_80175398_0 *)arg0)->unk_9B++;
...
jt_c4:
    ...
    }
    {
        ...
        ((S_80175398_0 *)arg0)->unk_A8.p = effect;
    ...
    next_state = ((S_80175398_0 *)arg0)->unk_9B + 1;
store_next_state:
    ((S_80175398_0 *)arg0)->unk_9B = next_state;
    return;

jt_c5:
    {
        u16 old_timer = ((S_80175398_0 *)arg0)->unk_96.u;
        ((S_80175398_0 *)arg0)->unk_96.u = old_timer + 1;
        if ((s16)old_timer < 30) {
            s16 i = 0;
            do {
    ...
    var_s0 = ((S_80175398_0 *)arg0)->unk_A8.p2;
...
jt_c7:
    {
        ...
        ((S_80175398_0 *)arg0)->unk_96.u = 0x10;
        ((S_80175398_0 *)arg0)->unk_9B++;
        ((S_80175398_7 *)(((S_80175398_1 *)arg3)->unk_60))->unk_2A = ((S_80175398_1 *)arg3)->unk_2A.u;
        {
...
jt_c8:
    {
        u16 timer = ((S_80175398_0 *)arg0)->unk_96.u - 1;
        ((S_80175398_0 *)arg0)->unk_96.u = timer;
        if ((s32)(timer << 16) > 0) {
            goto done;
        }
