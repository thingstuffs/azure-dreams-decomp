...
typedef struct S_801711D0_0 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    void * unk_10;
} S_801711D0_0;   /* obj in func_801711D0 */

typedef struct S_801711D0_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_801711D0_1;   /* work in func_801711D0 */

typedef struct S_801711D0_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_801711D0_2;   /* part_a in func_801711D0 */

typedef struct S_801711D0_3 {
    u8 pad_00[0x24];
    s8 unk_24;
    s8 unk_25;
    u8 pad_26[0x6];
    void * unk_2C;
} S_801711D0_3;   /* part_b in func_801711D0 */

typedef struct S_801711D0_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0xA];
    u8 unk_9A;
    u8 pad_9B[0x1];
    s8 unk_9C;
} S_801711D0_4;   /* actor in func_801711D0 */
...
void *func_801711D0(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    s32 kind;
    void *obj;
    S_801711D0_2 *part_a;
...
/* MECHANISM: Preserve the seed's exact 0x38 frame, s0-s7 holds, CFG, and true-base name.
   The sole residue was part_b's saved_arg1 byte field at 0xF versus retail offset 0x24.
