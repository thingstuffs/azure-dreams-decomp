...
void func_801593A8(void *arg0, S_801593A8_0 *arg1, void *arg2)
{
    ...
    u16 mode;
    s32 tail_sum;
    register u16 tail_mode ASM_REG("$4"); /* MATCH: both height paths merge the mode in a0. */
    ...
    if (!(initial_mode & 0x8000)) {
        ...
        }
        {
            ...
            if (D_8006CCF8[index] != 0) {
                ...
                tail_value = ((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0xFFFE;
            }
        ...
        if (flags & 0x40000) {
            ...
            if (amount == 0) {
                ...
                if (amount < motion_value) {
                    amount = motion_raw - 8;
                    ASM_SCHED_BARRIER(); /* MATCH: keep the first motion store on its own jump path. */
