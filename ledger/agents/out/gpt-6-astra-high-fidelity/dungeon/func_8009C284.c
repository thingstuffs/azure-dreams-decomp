...
s32 func_800A19E4(void *a, void *b, s32 lo, s32 hi, s8 *out) {
    ...
    if (flags & 0x20000) {
        if (flags & 0x10) { F(b,u32,0x1C) = flags & ~0x20000; F(b,s8,0x73)=0; F(b,s8,0x72)=0; *out=-1; goto done; }
        v = F(a,s8,0x26);
        if (v >= 0) {
        ...
        if ((func_8009FD40(D_80082E80,a) << 16) >= (hi << 16)) { F(b,s8,0x73)=0; F(b,s8,0x72)=0; F(b,u32,0x1C) &= ~0x20000; *out=-1; goto done; }
        goto done;
    }
    if (!(flags & 0x10)) {
        v=F(a,s8,0x26);
