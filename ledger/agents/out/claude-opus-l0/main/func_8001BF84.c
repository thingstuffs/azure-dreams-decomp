...
u8 *func_80402F84(s32 message_param_1, s32 message_param_2, s32 message_param_3, s32 message_param_4)
{
    s32 result;
    u8 *store_base;
    u8 *root = D_80409508;
    ...
    if (func_80047FD8(root) == 0) {
        root = (u8 *)func_8003C714(0, root, 0x1E1);
        if (root == 0) {
            func_8007C040(D_80400548, D_80400570, 0x299);
            func_8007BEF0(1);
        }
        func_80040560((s32)root, D_8040861C);
    } else {
