...
typedef struct S_819ACB28_0_pre {
    u16 unk_00;
} S_819ACB28_0_pre;   /* the 0x2 bytes before arg0 in func_80024328, addressed as arg0[-1] */
...
typedef struct S_819ACB28_0 {
    ...
    s16 unk_2E;
} S_819ACB28_0;   /* arg0 in func_80024328 */
...
typedef struct S_819ACB28_1 {
    ...
    u8 pad_0C[0x8];
    u16 unk_14;
} S_819ACB28_1;   /* temp_s0 in func_80024328 */
...
typedef struct S_819ACB28_3 {
    ...
    u8 pad_08[0x2];
    u16 unk_0A;
} S_819ACB28_3;   /* temp_a0_2 in func_80024328 */

typedef struct S_819ACB28_4 {
    u8 pad_00[0xC];
    union { u8 u8; u32 u32; } unk_0C;   /* accessed as both */
} S_819ACB28_4;   /* arg2 in func_80024328 */
