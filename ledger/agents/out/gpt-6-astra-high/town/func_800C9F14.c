...
void func_800C7674(S_800C7674_0 *entity, S_800C7674_1 *motion_state, s32 context)
{
    s32 quadrant;
    s32 angle;
    s32 speed;
...
case_zero:
    if (entity->unk_84.s + entity->unk_8C.s < motion_state->unk_02) {
        motion_state->unk_02 = entity->unk_84.u + entity->unk_8C.u;
        goto position_clamped;
    }
    goto apply_velocity;
case_one:
    if (entity->unk_86.s + entity->unk_8E.s < motion_state->unk_06) {
        motion_state->unk_06 = entity->unk_86.u + entity->unk_8E.u;
        goto position_clamped;
    }
    goto apply_velocity;
case_two:
    if (motion_state->unk_02 < entity->unk_84.s - entity->unk_8C.s) {
        motion_state->unk_02 = entity->unk_84.u - entity->unk_8C.u;
        goto position_clamped;
    }
    goto apply_velocity;
case_three:
    if (motion_state->unk_06 < entity->unk_86.s - entity->unk_8E.s) {
        motion_state->unk_06 = entity->unk_86.u - entity->unk_8E.u;
        goto position_clamped;
    }
    goto apply_velocity;
