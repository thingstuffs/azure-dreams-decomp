...
{
    s32 y_distance;
    register s32 axis_distance ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    register s32 axis_offset ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
