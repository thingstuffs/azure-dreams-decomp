...
L0:
    ...
    ASM_KEEP(texture_rect_base);   /* MATCH pin: keeps a statement from moving across a call/branch */
...
Lthird_0:
    ...
    ASM_KEEP(palette_rect_base);   /* MATCH pin: keeps a statement from moving across a call/branch */
