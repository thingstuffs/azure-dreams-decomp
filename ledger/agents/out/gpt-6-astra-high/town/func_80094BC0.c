...
void func_80092320(S_80092320_3 *action, S_80092320_0 *actor, M2C_UNK context) {
    u8 *state = D_80083160;
    s16 reference_value;
    s32 action_result;
    u16 ticks_left;
    ...
    if ((reference_value - actor->unk_0A) >= 4) {
...
check_state:
    ...
    ticks_left = action->unk_0A - 1;
    action->unk_0A = ticks_left;
    if ((s16) ticks_left < 0) {
