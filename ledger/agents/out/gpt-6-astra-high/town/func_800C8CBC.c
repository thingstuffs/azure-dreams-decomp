...
/* Sets the object's referenced data pointers to the static data blocks. */
void func_800C641C(S_800C641C_0 *object) {
    *object->unk_7C = &D_800D5820;
    ((S_800C641C_2 *)(((S_800C641C_1 *)object)->unk_80))->unk_04 = &D_800D5844;
}
