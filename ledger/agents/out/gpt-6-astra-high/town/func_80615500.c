...
void func_80016D00(s32 firstValue, s32 unusedValue, s32 secondValue) {
    register s32 entryIndex ASM_REG("$2") = D_80018FB4 % 3;   /* MATCH pin: load-bearing for the whole function shape */
    register s32 twiceEntryIndex ASM_REG("$3") = entryIndex << 1;   /* MATCH pin: load-bearing for the whole function shape */
    register s32 thriceEntryIndex ASM_REG("$4") = entryIndex + twiceEntryIndex;   /* MATCH pin: load-bearing for the whole function shape */
