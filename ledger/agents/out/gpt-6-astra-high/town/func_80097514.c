...
void func_80094C74(Func97514Object *object) {
    ...
    if (angle != -1) {
        ...
        s32 component;
        register s32 x_quotient ASM_REG("$5");   /* MATCH pin: load-bearing for the whole function shape */
        register s32 y_quotient ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
