...
void func_800B8B00(s32 code) {
    ...
    s32 *scan_id;
    s32 *free_id;
    register s32 scan_count ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
    register s32 free_count ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
    s32 duplicate_code;
