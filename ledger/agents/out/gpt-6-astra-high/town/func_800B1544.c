    ...
    *((S_800AECA4_5 *)(((S_800AECA4_2 *)list)->unk_D8))->unk_00 = func_80049E6C(((S_800AECA4_0 *)list)->unk_28);
    ...
    if (((S_800AECA4_0 *)list)->unk_28 > 0) {
        ...
        do {
            ...
            {
                register u8 *row_slots ASM_REG("$2") = ((S_800AECA4_0 *)list)->unk_D8;   /* MATCH pin: load-bearing for the whole function shape */
            ...
            row_y += 0x10;
            {
                ...
                register u8 *row_slots ASM_REG("$3") = ((S_800AECA4_0 *)list)->unk_D8;   /* MATCH pin: load-bearing for the whole function shape */
                row_slots = (u8 *)(row_slot + (s32)row_slots);
