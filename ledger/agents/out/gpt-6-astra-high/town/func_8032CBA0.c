...
// Returns event-specific data, running the fallback action when the object check fails.
void *func_800173A0(void *object, s32 unused, s32 eventCode) {
    if (eventCode == 0x25) {
        if (func_8001ADE0(*(s16 *)((u8 *)object + 0x18)) != 0) {
            return D_8001F4E2;
        }
        func_80019BC0();
