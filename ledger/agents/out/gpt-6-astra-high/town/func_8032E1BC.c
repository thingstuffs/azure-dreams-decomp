...
/* Decrements the object's counter and invokes the callback when its status check succeeds. */
void func_800189BC(void) {
    S_800189BC_0 *counterObject;

    counterObject = ((S_800189BC_2 *)(((S_800189BC_1 *)(&D_80016000))->unk_00))->unk_38;
    counterObject->unk_2D5C = (u32) (counterObject->unk_2D5C - D_8001C368[0]);
    if (func_8001890C(counterObject) != 0) {
