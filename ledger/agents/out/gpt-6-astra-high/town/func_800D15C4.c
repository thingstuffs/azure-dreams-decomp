...
typedef struct S_800CED24_0 {
    ...
    u8 pad_64[0x2C];
    s16 unk_90;
} S_800CED24_0;   /* arg0 in func_800CED24 */
...
void func_800CED24(S_800CED24_0 *object, S_800CED24_1 *state, M2C_UNK init_data) {
    s8 entry_value;
