...
/* Initialize the object's referenced data pointers. */
void func_800CB028(S_800CB028_0 *object) {
    *object->unk_7C = &D_800D685C;
    ((S_800CB028_2 *)(((S_800CB028_1 *)object)->unk_80))->unk_04 = &D_800D6870;
}
