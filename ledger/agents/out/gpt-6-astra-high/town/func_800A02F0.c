...
{
    register s32 test_x ASM_REG("$8");
    register s32 test_y ASM_REG("$3");
    s32 entry_x;
    register s32 entry_y ASM_REG("$19");
    u8 *entry_data;
    register u8 *entry ASM_REG("$17");
    register void *quad ASM_REG("$20");
    s32 base_y;
    s32 base_x;
    register s32 flags ASM_REG("$5");
