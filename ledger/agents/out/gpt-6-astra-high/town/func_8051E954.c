...
void func_8051E954(s32 command_value) {
    register s32 *command_words ASM_REG("$16");   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    void *context;
    s32 first_command;
    s32 second_command;
    ...
    context = ((S_8051E954_1 *)(&D_80016000))->unk_00;
    ((S_8051E954_0 *)command_words)->unk_08 = command_value;
    ((S_8051E954_3 *)((*(void **)((u8 *)context + 0x20))))->unk_208(0);
    ((S_8051E954_5 *)(((S_8051E954_4 *)(((S_8051E954_2 *)(&D_80016000))->unk_00))->unk_20))->unk_224(command_words);
}
