...
void func_8050E100(void)
{
    ...
    ASM_KEEP(callback_storage_base);   /* MATCH pin: load-bearing for the whole function shape */
    callback_code_base = (u8 *)0x80010000;
    ASM_KEEP(callback_code_base);   /* MATCH pin: retail delay-slot fill depends on it */
#endif
