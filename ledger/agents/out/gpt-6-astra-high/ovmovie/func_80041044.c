...
{
    register s32 command_word ASM_REG("$2");   /* MATCH pin: keeps a statement from moving across a call/branch */
    register s32 bit_mask ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
