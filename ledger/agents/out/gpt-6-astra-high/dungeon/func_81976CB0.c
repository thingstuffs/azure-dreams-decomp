...
typedef struct State81976CB0 {
    u8 pad0[0x8D0];
    Packet81976CB0 *next;
} State81976CB0;

typedef struct Scratch81976CB0 {
    u32 *ordering_table;
    s32 ordering_index;
    u8 pad8[8];
    s16 x0;
...
s32 func_81976CB0(s32 vertex_color0, s32 vertex_color1, s32 vertex_color2)
{
    ...
    ASM_KEEP(transform_flags);   /* MATCH pin: retail schedule: same instructions, different order without it */
    packet->clut = 0x7DCF;
    do {
        tex_u_left = 0xC0;
        tex_v_bottom = 0x7F;
