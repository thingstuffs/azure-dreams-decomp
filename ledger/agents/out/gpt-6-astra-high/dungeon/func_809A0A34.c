...
void func_809A0A34(void *controller, M2C_UNK action_context, void *sprite, void *actor) {
    ((S_809A0A34_0 *)actor)->unk_71 = (u8) (((S_809A0A34_0 *)actor)->unk_71 & 0x7F);
    if (!(D_80083462 & 0x2000) && ((func_800A2B5C(actor) << 0x10) == 0)) {
        ...
        if ((func_800A2B5C(actor) << 0x10) == 0) {
            ...
            func_80047784(sprite, *((((s32) (D_80083228 + ((S_809A0A34_0 *)actor)->unk_2A + 0x100) >> 9) & 7) + &D_80175E70), 0);
            ((S_809A0A34_0 *)actor)->unk_6D = (u8) (((S_809A0A34_0 *)actor)->unk_6D - 1);
            ((S_809A0A34_1 *)controller)->unk_98 = (u16) (((S_809A0A34_1 *)controller)->unk_98 | 8);
            func_8009C93C(actor, sprite, ((S_809A0A34_0 *)actor)->unk_2A, 1, 0);
            ((S_809A0A34_0 *)actor)->unk_84 = 0x7C;
            ((S_809A0A34_0 *)actor)->unk_85 = 0;
        }
    }
}
