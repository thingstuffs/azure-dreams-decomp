...
typedef struct S_81994800_0 {
    ...
    u8 pad_34[0x2C];
    s32 unk_60;
} S_81994800_0;   /* arg0 in BODY_NAME */
...
typedef struct S_81994800_2 {
    u8 pad_00[0x46];
    s16 unk_46;
} S_81994800_2;   /* ((((S_81994800_0 *)arg0)->unk_32 * 2) + ((S_81994800_0 *)arg0)->unk_60) in BODY_NAME */
...
void BODY_NAME(void *effect, void *unused_context, void *effect_params) {
    ...
    ticks_left = ((S_81994800_0 *)effect)->unk_2A - 1;
    scale = (s32)((s32)(ticks_left << 0x10) >> 9) / (s16)((S_81994800_0 *)effect)->unk_2C;
    D_80025384 = 1;
    ((S_81994800_0 *)effect)->unk_2A = ticks_left;
    ...
    if ((s16)((S_81994800_0 *)effect)->unk_2A <= 0) {
        ((S_81994800_2 *)(((((S_81994800_0 *)effect)->unk_32 * 2) + ((S_81994800_0 *)effect)->unk_60)))->unk_46 = 0;
