...
void BODY_NAME(void *effect_in, void *motion_in, void *sprite_in)
{
    ...
    register void *motion ASM_REG("$17") = motion_in;
    void *sprite = sprite_in;
    register void *owner ASM_REG("$18");
    void *owner_base;
    void *owner_motion;
#else
    void *effect = effect_in;
...
#ifdef __mips__
                s32 owner_tile;
                register s32 target_tile ASM_REG("$3");
#else
                s32 owner_tile;
                s32 target_tile;
#endif
...
#ifdef __mips__
        s32 x_step;
        register s32 x_velocity ASM_REG("$4");
#else
        s32 x_step;
        s32 x_velocity;
#endif
...
#ifdef __mips__
        s32 y_step;
        register s32 y_velocity ASM_REG("$4");
#else
        s32 y_step;
        s32 y_velocity;
#endif
...
case_2:
    ...
    {
#ifdef __mips__
        register void *target_object ASM_REG("$7");
#else
        void *target_object;
#endif
...
case_3:
    {
#ifdef __mips__
        register void *moving_motion ASM_REG("$4");
#else
        void *moving_motion;
#endif
