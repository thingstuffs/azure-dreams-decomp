...
void func_800AACA4(S_800AACA4_0 *state, S_800AACA4_6 *motion, S_800AACA4_7 *tile, S_800AACA4_1 *entity) {
    LocalResult height_adjustment;
    S_800AACA4_3 *source_object;
    void *entity_data;
    S_800AACA4_4 *resource_table;
    S_800AACA4_5 *resource_entry;
    register u32 step_offset ASM_REG("$2");   /* MATCH pin: keeps a constant in a register as retail does */
    u32 target_offset;
    s16 travel_steps;
    s32 target_height;
    s16 travel_duration;
    ...
    entity_data = entity->unk_60;
    motion->unk_0A = ((S_800AACA4_11 *)(((S_800AACA4_2_pre *)entity_data)[-1].unk_00))->unk_0A + height_adjustment.value;
    ...
    if (travel_steps != 0) {
        ...
        if (target_height < 0x200) {
            motion->unk_14 = -((motion->unk_0A - target_height) << 15) / travel_duration;
        } else {
            motion->unk_14 = -((motion->unk_0A - ((S_800AACA4_8 *)(entity->unk_60))->unk_88) << 15) / travel_duration;
        }
