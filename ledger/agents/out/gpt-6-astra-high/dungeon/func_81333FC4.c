...
void func_8016AFC4(void *actor, s32 unused, void *sprite, void *movement)
{
    ...
    behavior = ((S_8016AFC4_1 *)actor)->unk_AC;
    switch (behavior) {
    case 0:
        if (((S_8016AFC4_2 *)sprite)->unk_2C != D_801739C0) {
        ...
        break;
    case 1:
        if (((S_8016AFC4_2 *)sprite)->unk_2C != D_801739C8) {
        ...
        break;
    case 2:
        if (((S_8016AFC4_2 *)sprite)->unk_2C != D_801739D0) {
        ...
        break;
    case 3:
        if (((S_8016AFC4_2 *)sprite)->unk_2C != D_801739D8) {
    ...
    move_mode = 0x3000;
    old_x = ((S_8016AFC4_2 *)sprite)->unk_24;
    old_y = ((S_8016AFC4_2 *)sprite)->unk_25;
    ...
    ((S_8016AFC4_2 *)sprite)->unk_24 =
        ((S_8016AFC4_4 *)((u8 *)movement + ((S_8016AFC4_0 *)movement)->unk_8A.s))->unk_74;
    ((S_8016AFC4_2 *)sprite)->unk_25 =
        ((S_8016AFC4_4 *)((u8 *)movement + ((S_8016AFC4_0 *)movement)->unk_8A.s))->unk_7C;
    ((S_8016AFC4_0 *)movement)->unk_8A.u++;

    func_8009A21C(((S_8016AFC4_2 *)sprite)->unk_24, ((S_8016AFC4_2 *)sprite)->unk_25,
                  (((S_8016AFC4_0 *)movement)->unk_1C & 0x2000) ? 0x300 : 0x3000);

    ((S_8016AFC4_0 *)movement)->unk_2A = direction;
    ((S_8016AFC4_1 *)actor)->unk_9A = 0xF;
    ((S_8016AFC4_1 *)actor)->unk_8C = 0;
    (*(s32 *)((u8 *)movement + 0x1C)) |= 0x40000000;

    if (D_80083462 & 0x80) {
        ((S_8016AFC4_1 *)actor)->unk_96 = 0;
        return;
    }

    if (((S_8016AFC4_1 *)actor)->unk_B0 != 0) {
        ((S_8016AFC4_1 *)actor)->unk_96 = 0x10;
    } else {
        ((S_8016AFC4_1 *)actor)->unk_96 = 8;
    }
    step_count = ((S_8016AFC4_0 *)movement)->unk_71.u;
    if (step_count > 0) {
        ((S_8016AFC4_1 *)actor)->unk_96 = ((S_8016AFC4_1 *)actor)->unk_96 / step_count;
    }
}
