...
void func_80172DEC(void *action_state, void *transform, void *sprite, void *actor)
{
    ...
    register s32 use_global_target ASM_REG("$21");   /* MATCH pin: keeps a constant in a register as retail does */
    void *target;
    ...
    case 0:
        ...
        if (*motion != 0) {
            ...
            ASM_KEEP(motion);   /* MATCH pin: retail delay-slot fill depends on it */
            {
                ...
                ASM_KEEP(global_target_flag);   /* MATCH pin: retail delay-slot fill depends on it */
