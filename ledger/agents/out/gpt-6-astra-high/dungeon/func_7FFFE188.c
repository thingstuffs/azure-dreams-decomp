...
void func_7FFFE188(S_7FFFE188_1 *entity, M2C_UNK context, S_7FFFE188_0 *motion, M2C_UNK completion_data) {
    s32 *target_pos;
    u16 remaining_ticks;

    target_pos = D_80080000 + 0xDE0;
    motion->unk_0C = (s32) ((s32) (target_pos[0] - motion->unk_00) / 2);
    motion->unk_10 = (s32) ((s32) (target_pos[1] - motion->unk_04) / 2);
