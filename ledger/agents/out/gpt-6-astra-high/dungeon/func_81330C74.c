...
void func_80167C74(void *effect_data, S_80167C74_2 *origin, S_80167C74_11 *color) {
    ...
    phase = ((S_80167C74_0 *)self)->unk_12;
    target_pos = ((S_80167C74_0 *)self)->unk_24;
    switch (phase) {
    case 0:
        velocity_y = ((S_80167C74_0 *)self)->unk_60;
        phase_threshold = 0;
        ((S_80167C74_0 *)self)->unk_5C = (s32) ((((S_80167C74_0 *)self)->unk_5C * 4) / 5);
        trail_index = ((S_80167C74_0 *)self)->unk_1C;
        ((S_80167C74_0 *)self)->unk_60 = (s32) ((velocity_y * 4) / 5);
        ((S_80167C74_0 *)self)->unk_64 = (s32) ((((S_80167C74_0 *)self)->unk_64 * 4) / 5);
        ...
        if (phase_threshold >= ((S_80167C74_0 *)self)->unk_18) {
            ((S_80167C74_0 *)self)->unk_12 = (s16) ((u16) ((S_80167C74_0 *)self)->unk_12 + 1);
            case_base = (u8 *)D_80175DD8;
            ((S_80167C74_0 *)self)->unk_68 = (s32) ((s32) ((target_pos->unk_00 - (((S_80167C74_0 *)self)->unk_5C * 0x14)) - (origin->unk_00 + (*(s16 *)(case_base + (((S_80167C74_0 *)self)->unk_1C * 0x60)) << 0x11))) >> 7);
            ((S_80167C74_0 *)self)->unk_6C = (s32) ((s32) ((target_pos->unk_04 - (((S_80167C74_0 *)self)->unk_60 * 0x14)) - (origin->unk_04 + (*(s16 *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + case_base + 2) << 0x11))) >> 7);
            scaled_z = (((S_80167C74_0 *)self)->unk_64 * 0x14) + 0x200000;
            ((S_80167C74_0 *)self)->unk_70 = (s32) ((s32) ((target_pos->unk_08 - scaled_z) - (origin->unk_08 + (*(s16 *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + case_base + 4) << 0x11))) >> 7);
            ((S_80167C74_0 *)self)->unk_1E = 0U;
            goto load_motion_table;
        }
        break;
    case 1:
        phase_tick = ((S_80167C74_0 *)self)->unk_1E + 1;
        ((S_80167C74_0 *)self)->unk_1E = phase_tick;
        if (phase_tick == 0xC) {
        ...
        if ((s16) ((S_80167C74_0 *)self)->unk_1E >= 0x10) {
            ((S_80167C74_0 *)self)->unk_18 = 0;
        }
        ((S_80167C74_0 *)self)->unk_5C = (s32) (((S_80167C74_0 *)self)->unk_5C + ((S_80167C74_0 *)self)->unk_68);
        ((S_80167C74_0 *)self)->unk_60 = (s32) (((S_80167C74_0 *)self)->unk_60 + ((S_80167C74_0 *)self)->unk_6C);
        ((S_80167C74_0 *)self)->unk_64 = (s32) (((S_80167C74_0 *)self)->unk_64 + ((S_80167C74_0 *)self)->unk_70);
        goto load_motion_table;
    default:
...
update_positions:
    ...
    move_x0 = ((S_80167C74_0 *)self)->unk_5C;
    pos_x0 = (u16 *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)table_join);
    if (move_x0 < 0) move_x0 += 0xFFFF;
    *pos_x0 += move_x0 >> 0x10;
    move_y0 = ((S_80167C74_0 *)self)->unk_60;
    pos_y0 = (void *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)table_join);
    if (move_y0 < 0) move_y0 += 0xFFFF;
    pos_y0->unk_02 = (u16) (pos_y0->unk_02 + (move_y0 >> 0x10));
    move_z0 = ((S_80167C74_0 *)self)->unk_64;
    pos_z0 = (void *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)table_join);
    if (move_z0 < 0) move_z0 += 0xFFFF;
    pos_z0->unk_04 = (u16) (pos_z0->unk_04 + (move_z0 >> 0x10));
    move_x1 = ((S_80167C74_0 *)self)->unk_5C;
    pos_x1 = (void *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)table_join);
    if (move_x1 < 0) move_x1 += 0xFFFF;
    pos_x1->unk_06 = (u16) (pos_x1->unk_06 + (move_x1 >> 0x10));
    move_y1 = ((S_80167C74_0 *)self)->unk_60;
    pos_y1 = (void *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)table_join);
    if (move_y1 < 0) move_y1 += 0xFFFF;
    pos_y1->unk_08 = (u16) (pos_y1->unk_08 + (move_y1 >> 0x10));
    move_z1 = ((S_80167C74_0 *)self)->unk_64;
    pos_z1 = (void *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)table_join);
...
clamp_axes:
        clamp_row = ((S_80167C74_0 *)self)->unk_1C;
...
copy_axes:
        ...
        copy_axis += 1;
        copy_row = (u8 *)(copy_row_offset + ((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)table_base));
    ...
    trail_row = (((S_80167C74_0 *)self)->unk_1C * 0x60) + interp_base;
    ...
    if (((S_80167C74_0 *)self)->unk_12 == 0) particle_count = 3;
    particle_index = 1;
    if (particle_index < (particle_count + 1)) {
        ...
        do {
            ...
            sum_x += delta_x;
            particle_index += 1;
            interp_row = (((S_80167C74_0 *)self)->unk_1C * 0x60) + (u8 *)D_80175DD8;
    ...
    head_pos = (u8 *)((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)object_table_base);
...
copy_object_axes:
                    ...
                    *object_pos = *(u16 *)(object_axis_offset + (limit_or_offset + (object_offset + ((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)object_base))));
                    object_axis += 1;
                    object_pos += 1;
                    object_copy_index = object_offset + ((((S_80167C74_0 *)self)->unk_1C * 0x60) + (s32)object_base);
    ...
    life_left = (u16) ((S_80167C74_0 *)self)->unk_18 - 1;
    ((S_80167C74_0 *)self)->unk_18 = life_left;
    if ((life_left << 0x10) <= 0) {
