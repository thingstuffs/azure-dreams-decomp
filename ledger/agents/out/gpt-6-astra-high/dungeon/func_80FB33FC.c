...
void func_80172BFC(void *action, s32 actor_id, void *animation, void *actor) {
    ...
    switch (state) {
        case 0:
            if (((S_80172BFC_1 *)animation)->unk_14 & 0x8000) {
                ((S_80172BFC_0 *)action)->unk_9B = 0xFF;
                ((S_80172BFC_1 *)animation)->unk_14 |= 0x6000;
                func_8009C12C(actor, animation, ((S_80172BFC_2 *)actor)->unk_2A, 1);
                return;
            }
            (*(u8 * *)((u8 *)animation + 0x2C)) = D_80175288;
            func_80047784(animation,
                D_80175288[((D_80083228 + ((S_80172BFC_2 *)actor)->unk_2A + 0x100) >> 9) & 7],
                0);
            ((S_80172BFC_0 *)action)->unk_9B++;
            return;

        case 1:
            if (((((S_80172BFC_1 *)animation)->unk_04 == 3) &&
                 (((S_80172BFC_1 *)animation)->unk_14 & 0x1000)) ||
                (((S_80172BFC_1 *)animation)->unk_14 & 0x8000)) {
                func_800A56E0(0x804);
                func_8009C12C(actor, animation, ((S_80172BFC_2 *)actor)->unk_2A, 1);
                ((S_80172BFC_0 *)action)->unk_9B = 0xFF;
            }
        ...
        case 0xFF:
            if (((S_80172BFC_1 *)animation)->unk_14 & 0xE000) {
                func_800A2B04(actor_id, ((S_80172BFC_1 *)animation)->unk_24, ((S_80172BFC_1 *)animation)->unk_25);
                func_800AD594(actor, 0x100);
                ((S_80172BFC_0 *)action)->unk_8C = &D_80170F6C;
                D_8008346C = 0;
                func_800A4ACC(actor);
                if (((S_80172BFC_2 *)actor)->unk_6D == 0) {
                    ((S_80172BFC_2 *)actor)->unk_46 &= 0x7FFF;
                    return;
                }
