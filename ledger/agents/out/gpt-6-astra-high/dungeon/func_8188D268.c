...
loop:
        {
            ...
            u32 *row_left;
            u32 *row_right;
            register u32 *next_row_left ASM_REG("$6");   /* MATCH pin: load-bearing for the whole function shape */
            register u32 *next_row_right ASM_REG("$7");   /* MATCH pin: load-bearing for the whole function shape */
            u32 *next_row;
            u32 next_right_xy;
            s32 row_start;
            s32 next_row_index;
            ...
            ASM_KEEP(row_right);   /* MATCH pin: load-bearing for the whole function shape */
