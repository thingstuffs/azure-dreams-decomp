...
typedef struct S_8102F0D4_3 {
    u8 pad_00[0x6];
    s16 unk_06;
} S_8102F0D4_3;   /* arg2 in func_8102F0D4 */
...
void func_8102F0D4(void *state, S_8102F0D4_0 *position, S_8102F0D4_3 *entity) {
    u16 coords[3];
    ...
    entity->unk_06 = (s16) ((position_depth - reference_depth) - (*direction_offset * 2));
