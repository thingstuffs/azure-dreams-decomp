...
void func_801741A0(void *effect, S_801741A0_1 *position, S_801741A0_2 *primitive) {
    s16 life;
    s16 angle;
    s16 next_life;
    ...
    position->unk_00 = (s32) (((S_801741A0_0 *)effect)->unk_40 + (func_80064584(angle) * 0x280));
    position->unk_04 = (s32) (((S_801741A0_0 *)effect)->unk_44 + (func_800644B8((s16) ((S_801741A0_0 *)effect)->unk_1E) * 0x280));
    position->unk_08 = (s32) (position->unk_08 + 0xFFF60000);
    ...
    if (life < 0xA) {
        primitive->unk_0C = (s8) ((((S_801741A0_0 *)effect)->unk_00 * life) / 9);
        primitive->unk_0D = (s8) ((((S_801741A0_0 *)effect)->unk_01 * ((S_801741A0_0 *)effect)->unk_1A) / 9);
        primitive->unk_0E = (s8) ((((S_801741A0_0 *)effect)->unk_02 * ((S_801741A0_0 *)effect)->unk_1A) / 9);
    }
