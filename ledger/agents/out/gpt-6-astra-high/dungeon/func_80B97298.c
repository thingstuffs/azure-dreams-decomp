...
typedef struct S_80170A98_0 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_80170A98_0;   /* monster in func_80170A98 */

typedef struct S_80170A98_1 {
    u8 pad_00[0x1C];
    s32 unk_1C;
    u8 pad_20[0x4D];
    s8 unk_6D;
...
} S_80170A98_1;   /* actor in func_80170A98 */

typedef struct S_80170A98_2 {
...
void func_80170A98(void *entity_arg, void *motion_arg, void *monster_arg)
{
    ...
    register s32 facing_angle ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    Callback callback;
    u16 monster_flags;
    s16 floor_height;
    s16 actor_height;
    ...
    if (!(monster_flags & 0x8000)) {
        ...
        if ((*(s16 *)((u8 *)entity + 0x94)) != direction_index) {
            u8 *tile_map = ((S_80170A98_0 *)monster)->unk_2C;
            if (tile_map != 0) {
                func_80047738(monster, tile_map[direction_index], ((S_80170A98_0 *)monster)->unk_04);
            }
            (*(s16 *)((u8 *)entity + 0x94)) = direction;
        }

        if (D_8006CCF8[direction_copy] != 0) {
            ((S_80170A98_0 *)monster)->unk_14 |= 1;
        } else {
            ((S_80170A98_0 *)monster)->unk_14 &= 0xFFFE;
        }

        if (!(((S_80170A98_1 *)actor)->unk_1C & 0x20)) {
    ...
    D_80174F4C[(*(u8 *)((u8 *)entity + 0x9A))](entity, motion, monster, actor);

    if (old_direction != ((S_80170A98_1 *)actor)->unk_6D) {
    ...
    if (!((*(u16 *)((u8 *)entity + 0x98)) & 4)) {
        ...
        if (floor_height < 0x200) {
            ...
            motion->unk_14 = 0;
            ((S_80170A98_1 *)actor)->unk_1C |= 0x08000000;
            (*(u8 *)((u8 *)entity + 0x9D)) = 0;
...
check_adjustment:
    ...
    ((S_80170A98_1 *)actor)->unk_1C &= 0xF7FFFFFF;
