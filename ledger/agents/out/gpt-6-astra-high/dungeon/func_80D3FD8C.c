...
phase_start:
    ...
    {
        register s32 finish_phase ASM_REG("$5");   /* MATCH pin: retail register colouring depends on it */
        func_8009D8A4();
        finish_phase = 5;
        ASM_KEEP(finish_phase);   /* MATCH pin: retail immediate-load split depends on it */
