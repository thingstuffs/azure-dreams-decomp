...
{
    register void *entity ASM_REG("$18") = entity_input;   /* MATCH pin: retail register colouring depends on it */
    S_80170A28_2 *motion = motion_input;
    void *part = part_input;
    register void *entity_base ASM_REG("$17") = entity;   /* MATCH pin: load-bearing for the whole function shape */
