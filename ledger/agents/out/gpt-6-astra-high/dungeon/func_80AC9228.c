...
void func_80174A28(void *action, void *motion, void *sprite, void *actor)
{
    ...
    case 1:
        if ((--((S_80174A28_0 *)action)->unk_96 == 0x12) ||
            ...
            register s32 y_sum ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
            register void *effect_actor ASM_REG("$4");   /* MATCH pin: load-bearing for the whole function shape */
