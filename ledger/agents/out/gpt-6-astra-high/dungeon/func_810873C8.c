...
typedef struct S_80174BC8_2 {
    u8 pad_00[0x8];
    s32 unk_08;
    u8 pad_0C[0x1C];
    s32 unk_28;
} S_80174BC8_2;   /* arg2 in func_80174BC8 */
...
s32 func_80174BC8(void *unused, void *source_data, S_80174BC8_2 *source_state)
{
    u16 offsets[3];
    S_80174BC8_0 *object;
    ...
    if (object != 0) {
        ...
        primitive->unk_28 = source_state->unk_28;
