...
case_1:
    ...
    }
    {
        ...
        ASM_KEEP(saved_phase);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
...
case_2:
    {
        ...
        if (entry != 0) {
            ...
            register u32 tint ASM_REG("$4") = 0;   /* MATCH pin: retail register colouring depends on it */
    ...
    }
    {
        ...
        if (entry != 0) {
            ...
            register u32 tint ASM_REG("$4") = 0x00808080;   /* MATCH pin: retail register colouring depends on it */
