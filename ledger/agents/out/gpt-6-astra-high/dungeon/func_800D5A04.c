...
case_0:
    ((S_800DB164_1 *)visual)->unk_1C = (u16) (((S_800DB164_1 *)visual)->unk_1C - ((rand(ticks_left) & 0xFF) + 0x300));
    ((S_800DB164_1 *)visual)->unk_1E = (u16) (((S_800DB164_1 *)visual)->unk_1E + ((rand() & 0xFF) + 0x200));
...
case_1:
    ((S_800DB164_1 *)visual)->unk_0C = (s32) (((S_800DB164_1 *)visual)->unk_0C + 0xFFF3F3F4);
