...
void func_80174B20(void *state, Rec_D_800E3D7C *position, Rec_D_80082E80 *entity, void *actor) {
    ...
    register s32 tint ASM_REG("$7");   /* MATCH pin: retail schedule: same instructions, different order without it */
    ...
    s32 random_value;
    s32 style_index;
    register s32 style ASM_REG("$3");   /* MATCH pin: retail keeps a computation the compiler would drop */
    s32 position_z;
    ...
    phase = ((S_80174B20_0 *)state)->unk_9B;
    if (phase >= 9U) {
        goto done;
    }
    (void)phase_labels; goto *D_801708B8[(u32)(phase)];
jt_c0:
    ((S_80174B20_0 *)state)->unk_9B = (u8) (((S_80174B20_0 *)state)->unk_9B + 1);
    return;
jt_c1:
    func_80041588(&D_801751F8, &D_8017521C, 0);
    ((S_80174B20_0 *)state)->unk_B0 = 0;
    ((S_80174B20_0 *)state)->unk_9B = (u8) (((S_80174B20_0 *)state)->unk_9B + 1);
...
start_effect:
    ...
    ((S_80174B20_0 *)state)->unk_96 = 0x10U;
    ((S_80174B20_0 *)state)->unk_9B = (u8) (((S_80174B20_0 *)state)->unk_9B + 1);
jt_c3:
    previous_ticks = ((S_80174B20_0 *)state)->unk_96;
    fade_ticks = previous_ticks - 1;
    ((S_80174B20_0 *)state)->unk_96 = fade_ticks;
    if ((fade_ticks << 0x10) > 0) {
        goto fade_color;
    }
    effect_ready = ((S_80174B20_2 *)(&D_8017521D))->unk_00;
    ((S_80174B20_0 *)state)->unk_96 = previous_ticks;
    if (effect_ready == 0) {
        goto done;
    }
    ((S_80174B20_0 *)state)->unk_9B = (u8) (((S_80174B20_0 *)state)->unk_9B + 1);
...
fade_color:
    ...
    scene_color->unk_A8 = (u8) (scene_color->unk_A8 + ((s32) (target_color->unk_00 - scene_color->unk_A8) / (s16) ((S_80174B20_0 *)state)->unk_96));
    scene_color->unk_A9 = (u8) (scene_color->unk_A9 + ((s32) (target_color->unk_01 - scene_color->unk_A9) / (s16) ((S_80174B20_0 *)state)->unk_96));
    scene_color->unk_AA = (u8) (scene_color->unk_AA + ((s32) (target_color->unk_02 - scene_color->unk_AA) / (s16) ((S_80174B20_0 *)state)->unk_96));
    return;
jt_c4:
    ...
    tint = 0x808080;
    call_arg = actor;
    ((S_80174B20_0 *)state)->unk_AC = effect;
    ...
    ASM_KEEP(tint);   /* MATCH pin: retail immediate-load split depends on it */
    ...
    style = style_index;
    ASM_KEEP_NV(style_index);   /* MATCH pin: retail delay-slot fill depends on it */
    call_arg = sprite;
...
spawn_rays:
    ...
    return;
jt_c5:
    sprite = ((S_80174B20_0 *)state)->unk_AC;
...
jt_c6:
check_motion:
    if (((S_80174B20_0 *)state)->unk_9B != 6) {
        goto done;
    }
...
jt_c8:
    finish_ticks = ((S_80174B20_0 *)state)->unk_96 - 1;
    ((S_80174B20_0 *)state)->unk_96 = finish_ticks;
