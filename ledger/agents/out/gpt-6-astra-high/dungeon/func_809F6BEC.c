...
state_zero:
    ...
    if (((S_801743EC_1 *)sprite)->unk_14 & 0x6000) {
        ((S_801743EC_1 *)sprite)->unk_04 = 0;
        ((S_801743EC_1 *)sprite)->unk_05 = 0;
    }
    ((S_801743EC_1 *)sprite)->unk_0C += 0xFFE7E7E8;
    if ((u8)((S_801743EC_1 *)sprite)->unk_0C < 0x30U) {
