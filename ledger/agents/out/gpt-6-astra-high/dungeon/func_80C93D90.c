...
void func_80171590(void *motion_arg, s32 update_arg, void *entity_arg, void *state_arg) {
    ...
    s32 new_x;
    s32 new_y;
    register s16 heading ASM_REG("$18");   /* MATCH pin: retail register colouring depends on it */
    register s16 move_result ASM_REG("$17");   /* MATCH pin: load-bearing for the whole function shape */
