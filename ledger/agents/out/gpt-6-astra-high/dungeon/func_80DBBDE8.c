...
void func_801735E8(void *action_data, S_801735E8_3 *motion, S_801735E8_1 *animation, S_801735E8_2 *actor) {
    S_801735E8_0 *action;
    u16 phase_value;
    u16 elapsed_ticks;
    s32 phase;
...
state0:
    if (animation->unk_14 & 0x8000) {
        action->unk_9B = 3U;
        animation->unk_14 = (u16) (animation->unk_14 | 0x6000);
...
state1:
    ...
    if ((s16) elapsed_ticks != 4 && !(animation->unk_14 & 0xE000)) {
        goto done;
    }
    animation->unk_2C = &D_801753E4;
    func_80047784(animation, D_801753E4[(((s32) (*D_80083228 + actor->unk_2A + 0x100) >> 9) & 7)], 0);
    func_800A56E0(0x808);
    phase_value = action->unk_9B;
    action->unk_96 = 0U;
    action->unk_9B = (u8) (phase_value + 1);
...
state2:
    ...
    if ((s16) phase_value != 4 && !(animation->unk_14 & 0xE000)) {
        goto done;
    }
    func_8009C12C(actor, animation, actor->unk_2A, 1);
    phase_value = action->unk_9B;
