...
/* Builds and queues render packets for a linked list of positioned entries. */
s32 func_8014C884(u8 *entry, u16 *position)
{
    Scratch *scratch = (Scratch *)0x1F800000;
    void **render_globals = D_80083160;
    RenderState *render_state = (RenderState *)render_globals[0];
    ...
    ((RenderState *)render_globals[0])->next_prim = scratch->current;
    return 0;
}
