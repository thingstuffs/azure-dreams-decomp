...
state_zero:
    ASM_KEEP(globals_page);   /* MATCH pin: keeps a statement from moving across a call/branch */
...
process:
    entity_flags = ((S_80173450_1 *)entity)->unk_14;
...
update:
    ((S_80173450_1 *)entity)->unk_1C |= 0x10000000;
    ...
    tile_mask = 0x3000;
    if (((S_80173450_1 *)entity)->unk_1C & 0x2000) {
        tile_mask = 0x300;
    }
