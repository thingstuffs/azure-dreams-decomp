...
typedef struct S_80173738_1 {
    ...
    u8 pad_0F[0x5];
    u16 unk_14;
} S_80173738_1;   /* arg2 in func_80173738 */
...
void func_80173738(void *effect, FuncArg1 *position, S_80173738_1 *primitive) {
    s16 life;
    s16 next_life;
    s32 y_offset;
    s32 base_y;
    s32 z_step;
    register void *primitive_dst ASM_REG("$4");   /* MATCH pin: retail schedule: same instructions, different order without it */
    ...
    z_step = 0xFFF40000U;
    ASM_KEEP_NV(z_step);   /* MATCH pin: keeps a statement from moving across a call/branch */
    ...
    if (primitive->unk_14 & 0x4000) {
        func_8003DB94(primitive, &D_800DEC70, 0);
    }
    life = ((S_80173738_0 *)effect)->unk_1A;
    if (life < 0xA) {
        primitive->unk_0C = (s8) ((((S_80173738_0 *)effect)->unk_00 * life) / 9);
        primitive->unk_0D = (s8) ((((S_80173738_0 *)effect)->unk_01 * ((S_80173738_0 *)effect)->unk_1A) / 9);
        primitive->unk_0E = (s8) ((((S_80173738_0 *)effect)->unk_02 * ((S_80173738_0 *)effect)->unk_1A) / 9);
    }
