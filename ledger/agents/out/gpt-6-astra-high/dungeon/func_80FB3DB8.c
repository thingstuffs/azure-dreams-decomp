...
void func_801735B8(void *fade_state, void *unused, void *visual_data, void *entity) {
    register void *visual ASM_REG("$17");   /* MATCH pin: load-bearing for the whole function shape */
    M2C_UNK *world;
    s32 state;
    s32 entity_flags;
    s32 tracked_entity;
    ...
    case 0:
        ...
        /* fallthrough */
    case 1:
        entity_flags = ((S_801735B8_2 *)entity)->unk_14;
        ...
        /* fallthrough */
    case 2:
        ((S_801735B8_2 *)entity)->unk_1C |= 0x10000000;
        ...
        tile_mask = 0x3000;
        if (((S_801735B8_2 *)entity)->unk_1C & 0x2000) {
            tile_mask = 0x300;
        }
    ...
    ASM_KEEP(visual);   /* MATCH pin: retail schedule: same instructions, different order without it */
}
