...
void func_800D4DE8(void *emitter, S_800D4DE8_1 *position, s32 init_param) {
    s32 particle_index;
    u16 age;
    u16 life_left;
    S_800D4DE8_2 *parent;
    ...
    parent = ((S_800D4DE8_0 *)emitter)->unk_24;
    position->unk_02 =
        (s16)(((S_800D4DE8_7 *)(parent->unk_08))->unk_02 +
              ((S_800D4DE8_0 *)emitter)->unk_3C);
    position->unk_06 =
        (s16)(((S_800D4DE8_7 *)(parent->unk_08))->unk_06 +
              ((S_800D4DE8_0 *)emitter)->unk_3E);
    position->unk_0A =
        (s16)(((S_800D4DE8_7 *)(parent->unk_08))->unk_0A +
              ((S_800D4DE8_0 *)emitter)->unk_40);
    age = ((S_800D4DE8_0 *)emitter)->unk_16 + 1;
    ((S_800D4DE8_0 *)emitter)->unk_16 = age;
    if ((s16)age < 0x14) {
        particle_index = 0;
        do {
            ...
            if (particle != NULL) {
                ...
                particle_motion->unk_0A =
                    particle_motion->unk_0A -
                    (D_800DDC40[((S_800D4DE8_8 *)(((S_800D4DE8_0 *)emitter)->unk_00))->unk_13] >> 1);
            }
            particle_index += 1;
        } while (particle_index < 4);
    }
    life_left = ((S_800D4DE8_0 *)emitter)->unk_1E - 1;
    ((S_800D4DE8_0 *)emitter)->unk_1E = life_left;
    if ((life_left << 0x10) <= 0) {
