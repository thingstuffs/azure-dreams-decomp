...
state_0:
    ...
    {
        register u16 state_or_height ASM_REG("$2") = ((S_8017450C_0 *)state)->unk_9B;   /* MATCH pin: load-bearing for the whole function shape */
        register u16 height_offset ASM_REG("$5") = ((S_8017450C_0 *)state)->unk_90.at02.v;   /* MATCH pin: load-bearing for the whole function shape */
