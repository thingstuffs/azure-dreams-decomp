...
void func_80165018(S_80165018_1 *parent, s32 effect_value, s16 effect_size, s32 offset_x, s32 offset_y,
                   s32 offset_z) {
    ...
    register s32 jitter ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    register s32 coordinate ASM_REG("$3");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */

    effect = func_8003FD64(0x211, parent);
    if (effect != 0) {
        ((S_80165018_0 *)effect)->unk_10 = D_80164DA4;
        jitter = rand() & 7;
        coordinate = ((S_80165018_5 *)(parent->unk_08))->unk_02 + offset_x;
        coordinate -= 3;
        coordinate += jitter;
        ((S_80165018_6 *)(((S_80165018_0 *)effect)->unk_08))->unk_02 = (s16)coordinate;
        jitter = rand() & 7;
        coordinate = ((S_80165018_5 *)(parent->unk_08))->unk_06 + saved_offset_y;
        coordinate -= 3;
        coordinate += jitter;
        ((S_80165018_6 *)(((S_80165018_0 *)effect)->unk_08))->unk_06 = (s16)coordinate;
        jitter = rand() & 7;
        coordinate = ((S_80165018_5 *)(parent->unk_08))->unk_0A + saved_offset_z;
        coordinate -= 3;
        coordinate += jitter;
