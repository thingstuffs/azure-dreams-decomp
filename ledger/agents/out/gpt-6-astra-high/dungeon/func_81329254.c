...
void func_80170A54(void *record_data) {
    ...
    register u8 *memory_base ASM_REG("$4") = (u8 *)0x80080000;   /* MATCH pin: keeps a constant in a register as retail does */
    register u8 *state_data = D_80082E80;
    S_80170A54_1 *active_object;

    ASM_KEEP(state_data);   /* MATCH pin: keeps a constant in a register as retail does */
