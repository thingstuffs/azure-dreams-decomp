...
void func_8196C280(void *effect, void *position, void *sprite) {
    ...
    u16 reduced_scale_y;
    u16 life_left;
    register u16 scale_x ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    u16 scale_y;
    u16 next_scale_y;
    register u16 next_scale_x ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
