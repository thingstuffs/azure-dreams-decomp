...
void *func_80025B78(void *source_data, S_80025B78_2 *source_triplet, S_80025B78_4 *source_state)
{
    ...
    if (object != NULL) {
        ...
        state->unk_04 = source_state->unk_04;
        {
            ...
            ASM_KEEP(word_0);   /* MATCH pin: load-bearing for the whole function shape */
            ASM_KEEP(word_1);   /* MATCH pin: load-bearing for the whole function shape */
            ASM_KEEP(word_2);   /* MATCH pin: load-bearing for the whole function shape */
