...
void func_80172CC8(S_80172CC8_1 *origin, s32 x_offset, s32 y_offset, s32 z_offset, s32 variant) {
    ...
    u16 y;
    u16 z;
    register s32 variant_flag ASM_REG("$21");   /* MATCH pin: load-bearing for the whole function shape */
    ...
    if (node != 0) {
        ...
        ASM_KEEP(variant_flag);   /* MATCH pin: keeps a statement from moving across a call/branch */
    }
}
