...
/* Advances the effect through target selection, movement, particle emission, and cleanup. */
BODY_STORAGE void BODY_NAME(void *effect_in, void *motion_in, void *source_render) {
    static void *const case_labels[] = {
        &&select_target, &&move_effect, &&wait_target, &&emit_burst, &&wait_cleanup, &&cleanup
    };
    void *effect = effect_in;
    void *motion;
    register void *actor ASM_REG("$19");   /* MATCH pin: retail address form (%hi/%lo vs actor_base+offset) depends on it */
    Vec3 offset;
    void * volatile actor_base;
    void *actor_info;
    void *spawned;
    void *particle_data;
    void *render;
    register s32 particles_left ASM_REG("$21");   /* MATCH pin: keeps a constant in a register as retail does */
    S_81844800_5 *particle_page;
    s16 phase;
    s16 timer;
    s16 height_offset;

    actor = ((S_81844800_0 *)effect)->unk_00;
    {
        register void *initial_base ASM_REG("$8");   /* MATCH pin: retail register colouring depends on it */
        initial_base = (u8 *)actor - 0x20;
        actor_base = initial_base;
    }
    ASM_SCHED_BARRIER();   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    phase = ((S_81844800_0 *)effect)->unk_0A.s;
    actor_info = ((S_81844800_1_pre *)actor)[-1].unk_00;
    motion = motion_in;
    if (phase == 0) {
        goto dispatch;
    }
        ...
        do {
            ...
            if (spawned != 0) {
...

                {
                    ...
                    ((S_81844800_4 *)render)->unk_00 = particle_page;
                    ((S_81844800_4 *)render)->unk_14 = flags | 0xC;
                    {
                        u32 page_value = particle_page->unk_04;
...
dispatch:
    {
        s32 phase_index = ((S_81844800_0 *)effect)->unk_0A.s;
        if ((u32)phase_index >= 6) {
            goto done;
        }
        (void)case_labels;
        goto *jtbl_80024008[phase_index];
    }
...
select_target:
    {
        ...
        target = func_800A05A4(
            actor,
            ((S_81844800_7 *)actor_info)->unk_24,
            ((S_81844800_7 *)actor_info)->unk_25,
            ((S_81844800_1 *)actor)->unk_2A,
            (s16)func_800A3820(9));
        ((S_81844800_1 *)actor)->unk_60 = target;
        if (target == 0) {
            ((S_81844800_1 *)actor)->unk_72.s = ((S_81844800_7 *)actor_info)->unk_24;
            ((S_81844800_1 *)actor)->unk_73.s = ((S_81844800_7 *)actor_info)->unk_25;
        } else {
            render = ((S_81844800_8_pre *)target)[-1].unk_00;
            if ((((S_81844800_4 *)render)->unk_14 & 0x8000) != 0) {
                register void *source_info ASM_REG("$8");   /* MATCH pin: retail register colouring depends on it */
                source_info = source_render;
                ASM_KEEP(source_info);   /* MATCH pin: retail register colouring depends on it */
                if ((((S_81844800_9 *)source_info)->unk_14 & 0x8000) != 0) {
                    func_8009CE1C(
                        ((S_81844800_1 *)actor)->unk_60,
                        10,
            ...
            ((S_81844800_1 *)actor)->unk_72.s = ((S_81844800_4 *)render)->unk_24;
            ((S_81844800_1 *)actor)->unk_73.s = ((S_81844800_4 *)render)->unk_25;
        }
        {
            register void *base_before ASM_REG("$8");   /* MATCH pin: retail register colouring depends on it */
            base_before = actor_base;
            if (func_8003DE58(
                ((S_81844800_16 *)(((S_81844800_10 *)base_before)->unk_0C))->unk_08,
                ((S_81844800_10 *)base_before)->unk_0C, &offset, 0) == 0) {
                offset.z = 0;
                offset.y = 0;
                offset.x = 0;
            }
            {
                ...
                base_after = actor_base;
                ((S_81844800_3 *)motion)->unk_00.at02.v = ((S_81844800_17 *)(((S_81844800_11 *)base_after)->unk_08))->unk_02 + offset.x;
                ((S_81844800_3 *)motion)->unk_04.at02.v = ((S_81844800_17 *)(((S_81844800_11 *)base_after)->unk_08))->unk_06 + offset.y;
                ((S_81844800_3 *)motion)->unk_08.at02.v = ((S_81844800_17 *)(((S_81844800_11 *)base_after)->unk_08))->unk_0A + offset.z;
                ((S_81844800_0 *)effect)->unk_50.s = 8;
                {
                    register s32 target_x ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
                    target_x = ((S_81844800_1 *)actor)->unk_72.u;
                    ASM_KEEP(target_x);   /* MATCH pin: retail schedule: same instructions, different order without it */
                    {
                ...
                {
                    register s32 target_y ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
                    target_y = ((S_81844800_1 *)actor)->unk_73.u;
...
move_effect:
    ...
    timer = ((S_81844800_0 *)effect)->unk_50.s - 1;
    ((S_81844800_0 *)effect)->unk_50.s = timer;
    if ((timer << 16) > 0) {
        goto done;
    }
    {
        register u16 timer_reset ASM_REG("$3") = 12;   /* MATCH pin: retail register colouring depends on it */
        phase = ((S_81844800_0 *)effect)->unk_0A.u;
        ((S_81844800_0 *)effect)->unk_50.s = timer_reset;
        goto increment_phase;
    }

wait_target:
    {
        register u16 target_timer ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
        timer = ((S_81844800_0 *)effect)->unk_50.s - 1;
        ((S_81844800_0 *)effect)->unk_50.s = timer;
        if ((timer << 16) > 0) {
            goto done;
        }
        if (((S_81844800_1 *)actor)->unk_60 != 0) {
            target_timer = 10;
            goto start_burst;
        }
        ((S_81844800_0 *)effect)->unk_50.s = 8;
...
emit_burst:
    if ((((S_81844800_0 *)effect)->unk_52.s & 0x7FFF) == 0) {
        ...
        if (spawned != 0) {
            S_81844800_12 *child_data = (u8 *)spawned + 0x20;
            ((S_81844800_2 *)spawned)->unk_10 = func_8002472C;
            func_8004491C(spawned, func_80024868);
            child_data->unk_2A = 8;
            ((S_81844800_2 *)spawned)->unk_20 = effect;
            child_data->unk_04 = ((S_81844800_3 *)motion)->unk_00.at02.v;
            child_data->unk_06 = ((S_81844800_3 *)motion)->unk_04.at02.v;
            child_data->unk_08 = ((S_81844800_3 *)motion)->unk_08.at02.v;
            ((S_81844800_0 *)effect)->unk_52.s++;
            child_data->unk_2C = 0;
        }
    }
    if (((S_81844800_0 *)effect)->unk_50.u == 7 &&
        ((S_81844800_1 *)actor)->unk_60 != 0) {
        func_8009CE1C(
            ((S_81844800_1 *)actor)->unk_60,
            10,
            ((S_81844800_0 *)effect)->unk_09,
    ...
    do {
        ...
        if (spawned != 0) {
            particle_data = (u8 *)spawned + 0x20;
            ASM_KEEP(particle_data);   /* MATCH pin: retail register colouring depends on it */
            render = ((S_81844800_2 *)spawned)->unk_0C;
            ...
            height_offset = (func_80069EF8() & 0x3F) - 176;
            ((S_81844800_14 *)(((S_81844800_2 *)spawned)->unk_08))->unk_08.at02.v = ((S_81844800_3 *)motion)->unk_08.at02.v - height_offset;
...
advance_phase:
    phase = ((S_81844800_0 *)effect)->unk_0A.u;
increment_phase:
    ((S_81844800_0 *)effect)->unk_0A.u = phase + 1;
    goto done;
...
cleanup:
    {
        ...
        if ((((S_81844800_0 *)effect)->unk_52.u & 0x8000) != 0) {
            child_count = ((S_81844800_0 *)effect)->unk_52.s & 0x7FFF;
            ((S_81844800_0 *)effect)->unk_52.s = child_count;
            goto done;
        }
        D_8008346C[0] = 0;
