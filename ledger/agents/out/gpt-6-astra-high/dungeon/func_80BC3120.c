...
s32 func_80172920(S_80172920_3 *action_state, s32 effect_arg, S_80172920_2 *target, void *actor) {
    volatile u64 frame_pad;
    s32 target_direction;
    s32 *global_flags;

    ((S_80172920_0 *)actor)->unk_71 &= 0x7F;
    ...
    if (!(((S_80172920_0 *)actor)->unk_46 & 0x8000) &&
...
success:
    ...
    ((S_80172920_0 *)actor)->unk_84 = 0x7C;
    ((S_80172920_0 *)actor)->unk_85 = 4;
    ((S_80172920_0 *)actor)->unk_6D--;

    func_8009C93C(actor, target, ((S_80172920_0 *)actor)->unk_2A, 1, 0);
    return 1;
}
