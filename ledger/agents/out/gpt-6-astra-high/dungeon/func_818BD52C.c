...
void *func_818BD52C(S_818BD52C_1 *owner, void *source_coords, s32 phase_index, s32 effect_param)
{
    ...
    void *node;
    s32 end_z;
    register void *pinned_node ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    ...
    if (node != 0) {
        ...
        *(Copy24 *)coords = *(Copy24 *)source_coords;
        ...
        ASM_USE(pinned_node);   /* MATCH pin: load-bearing for the whole function shape */
        coords->unk_14 = end_z;
