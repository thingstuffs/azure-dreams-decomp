...
s32 func_801732A4(Entity *input_entity, s32 action_param, Aux *input_aux)
{
    s32 angle_out[2];
    Entity *entity;
    register s32 action_value ASM_REG("$16");
    Aux *aux;
    register Entity *actor ASM_REG("$19");
    u8 *script;
    s32 command;
    register s32 command_byte ASM_REG("$7");
    s32 animation;
    s32 next_phase;
    s32 opcode;
    s32 sequence_index;
