...
void func_80173140(void) {
    ...
    s32 cell_x;
    s32 cell_y;
    register void *object ASM_REG("$18");   /* MATCH pin: retail register colouring depends on it */
    M2C_UNK cell_mask;
    s32 origin_x;
    s32 origin_y;
    void *object_attrs;
    ...
    if (object != NULL) {
        ...
        ((S_80173140_2 *)object_attrs)->unk_0A = (u16) ((S_80173140_5 *)(((S_80173140_3 *)(&D_80083498))->unk_08))->unk_0A;
        ...
        ASM_KEEP(masked_flags);   /* MATCH pin: retail delay-slot fill depends on it */
        initial_offset = -0x20;
        ASM_KEEP(initial_offset);   /* MATCH pin: retail schedule: same instructions, different order without it */
        masked_flags &= 0x2000;
