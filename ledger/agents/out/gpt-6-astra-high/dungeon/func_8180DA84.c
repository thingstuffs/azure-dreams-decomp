...
void *func_80026A84(S_80026A84_2 *origin, S_80026A84_7 *target_pos, s32 effect_param, S_80026A84_0 *source)
{
    u16 offset[3];
    s32 *callback;
    ...
    u16 coord_xz;
    u16 coord_y;
    register void *render_data ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
