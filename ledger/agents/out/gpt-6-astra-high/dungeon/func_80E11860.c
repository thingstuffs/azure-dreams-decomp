...
s32 func_80175060(S_80175060_4 *owner, S_80175060_2 *initial_state) {
    s32 color;
    s32 four;
    s32 phase_rand;
    s32 rotation_rand;
    ...
    if (object != NULL) {
        ...
        func_8004491C(object, &D_80045340);
        {
            s32 copy_word_0;
            s32 copy_word_1;
            register s32 copy_word_2 ASM_REG("$5");   /* MATCH pin: keeps a statement from moving across a call/branch */
            register s32 copy_word_3 ASM_REG("$6");   /* MATCH pin: keeps a statement from moving across a call/branch */

            state = ((S_80175060_0 *)object)->unk_08;
            ASM_KEEP(state);   /* MATCH pin: retail schedule: same instructions, different order without it */
            copy_word_0 = initial_state->unk_00;
            copy_word_1 = initial_state->unk_04;
            copy_word_2 = initial_state->unk_08;
            copy_word_3 = initial_state->unk_0C;
            state->unk_00 = copy_word_0;
            state->unk_04 = copy_word_1;
            state->unk_08.at00.v = copy_word_2;
            state->unk_0C = copy_word_3;
            copy_word_0 = initial_state->unk_10;
            copy_word_1 = initial_state->unk_14;
