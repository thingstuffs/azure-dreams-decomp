...
typedef struct S_80174800_3 {
    ...
    u8 pad_08[0x2];
    u16 unk_0A;
} S_80174800_3;   /* arg1 in func_80174800 */

/* Creates an effect at an offset from the source position with a random rotation. */
void func_80174800(void *unused_ptr, S_80174800_3 *source_pos, s32 unused_value, s16 scale)
{
    void *node;
    S_80174800_0 *part;
    S_80174800_1 *data;
    ...
    if (node != 0) {
        ...
        data->unk_14 |= 0xC;
        pos = (*(void * *)((u8 *)node + 8));
        pos->unk_02 = source_pos->unk_02;
        pos->unk_06 = source_pos->unk_06;
        pos->unk_0A = source_pos->unk_0A - 0x28;
        data = (*(void * *)((u8 *)node + 0xC));
        data->unk_06 = 6;
        data->unk_1E = scale;
        data->unk_1C = scale;
