...
case_1:
    {
        ...
        if ((s16)timer >= 0x52) {
            ...
            FIELD(effect, u16, 0xA) = next_state + 1;
        ...
        if (FIELD(effect, s16, 0x28) == 0x4A) {
            ...
            func_80025CE8(FIELD(effect_position, s16, 2),
                          FIELD(effect_position, s16, 6),
                          FIELD(effect_position, s16, 0xA),
...
case_2:
    {
        ...
        reset_timer = 0x3C;
        current_state = FIELD(effect, u16, 0xA);
