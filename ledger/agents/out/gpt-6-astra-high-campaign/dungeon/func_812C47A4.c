...
void func_80153FA4(void *actor, void *context, void *sprite, void *entity)
{
    ...
    if (!(D_80083462 & 0x2000)) {
...

        {
            ...
            u32 idle_state = 0xE;
            void *current_anim;
            register void *anim_table ASM_REG("$5"); /* MATCH: Merge both anim_table paths in retail's a1 register. */
...
state_ready:
    ...
    if (((Rec_D_800E3D7C *)entity)->unk_6D.as_s8 > 0) {
        ...
        if (((S_80153FA4_2 *)sprite)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto generic;
        }
