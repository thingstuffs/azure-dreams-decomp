...
void func_80159FA4(void *actor, void *context, void *sprite, void *entity)
{
    ...
    if (!(D_80083462 & 0x2000)) {
...

        {
            ...
            u32 next_state = 0xE;
            void *current_anim;
            register void *anim_table ASM_REG("$5"); /* MATCH: merge the two anim_table values in a1 for the shared store. */
...
state_ready:
    ...
    if (((Rec_D_800E3D7C *)entity)->unk_6D.as_s8 > 0) {
        ...
        if (((S_80159FA4_2 *)sprite)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto generic;
        }
        if (!(((Rec_D_800E3D7C *)entity)->unk_44.at02_u16.v & 0x8000)) {
            ...
            behavior = ((Rec_D_800E3D7C *)entity)->unk_44.at02_u16.v | 0x4000;
            ((Rec_D_800E3D7C *)entity)->unk_44.at02_u16.v = behavior;
            if (!(behavior & 0x8000)) {
                goto generic;
            }
        }

        behavior = ((Rec_D_800E3D7C *)entity)->unk_44.at02_u16.v & 0x3FFF;
