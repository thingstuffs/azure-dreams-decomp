...
extern void func_80166510(void *, void *, void *, void *);
...
void func_80165FA4(void *actor, void *actor_aux, void *sprite, void *actor_data)
{
    ...
    if (((Rec_D_800E3D7C *)actor_data)->unk_24.at01_u8.v == 0) {
        ...
        func_80047784(sprite,
            ((u8 *)anim_table)[((D_80083228 + ((Rec_D_800E3D7C *)actor_data)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        return;
    }
    ...
    if (!(D_80083462 & 0x2000)) {
        ...
        {
            u8 current_state = ((S_80165FA4_0 *)actor)->unk_9A;
            u32 next_state = 0xE;
            void *current_anim;
            void *anim_table;
...
state_done:
        ...
        ((Rec_D_800E3D7C *)actor_data)->unk_1C.as_u32 |= 0x40000;
        ...
        if (((Rec_D_800E3D7C *)actor_data)->unk_1C.as_u32 & 0x80000) {
            ...
            delta = ((S_80165FA4_0 *)actor)->unk_92.u - ((S_80165FA4_0 *)actor)->unk_A2.u;
            ((S_80165FA4_0 *)actor)->unk_A2.s = 0;
            ((S_80165FA4_0 *)actor)->unk_9E = 0;
            ((S_80165FA4_0 *)actor)->unk_92.s = delta;
            func_80169078(actor, actor_aux, sprite, actor_data);
            return;
        }

        if ((func_800A1C58(actor_data) << 16) != 0) {
            func_800AAB10(actor, actor_aux, sprite, actor_data);
        }
    }
    ...
    if (((Rec_D_800E3D7C *)actor_data)->unk_6D.as_s8 > 0) {
        ...
        if (((S_80165FA4_2 *)sprite)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto generic;
        }
