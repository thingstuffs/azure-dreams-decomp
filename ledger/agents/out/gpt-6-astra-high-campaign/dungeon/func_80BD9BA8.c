...
void func_801593A8(void *entity, S_801593A8_0 *motion, void *sprite)
{
    ...
    if (!(initial_sprite_flags & 0x8000)) {
        direction = ((D_80083228 + ((S_801593A8_2 *)entity_base)->unk_2A + 0x100) >> 9) & 7;
        ...
        func_800A020C(((S_801593A8_2 *)entity_base)->unk_1C, (u8 *)sprite + 0xC);
        if (!(((S_801593A8_2 *)entity_base)->unk_1C & 0x20)) {
            if (!(((Rec_D_80082E80 *)sprite)->unk_14.at00_u16.v & 0x40)) {
                func_800478B8(sprite);
            }
        } else {
            ((Rec_D_80082E80 *)sprite)->unk_14.at00_u16.v |= 0x7000;
            ((S_801593A8_2 *)entity_base)->unk_1C &= 0xFFFBFFFF;
        }
        ...
        if (flags & 0x40000) {
            ...
            if (!(sprite_flags & 0x40)) {
                ...
                } else if (direction_frames == D_8015C644 || direction_frames == D_8015C66C) {
    ...
    if (flags & 0x40000000) {
        ...
        if (ground_height < 0x200) {
            (*(s16 *)((u8 *)entity + 0x92)) =
                ...
                (((S_801593A8_2 *)entity_base)->unk_88 - ground_height);
            ((S_801593A8_2 *)entity_base)->unk_88 = ground_height;
        }
    }
    motion->unk_0A = ((S_801593A8_2 *)entity_base)->unk_88 +
                             (u16)(*(s16 *)((u8 *)entity + 0x92)) -
                             (*(u16 *)((u8 *)entity + 0xA6));
