...
typedef struct S_800CE08C_0 {
    u8 pad_00[0x6C];
    u16 unk_6C;
} S_800CE08C_0;   /* arg0 in func_800CE08C */


M2C_UNK func_800C4174(S_800CE08C_0 *, M2C_UNK, M2C_UNK);
/* Decrement the countdown and call func_800C4174 when it reaches zero. */
void func_800CE08C(S_800CE08C_0 *object, M2C_UNK context, M2C_UNK update_data) {
    u16 remaining_ticks;
