...
/* Update the record and switch its table when the status reaches four. */
void func_80024FAC(void *record_data) {
    func_80024F7C(record_data);
    if (func_8002168C() >= 4) {
        func_800231E4(0);
        ((S_80024FAC_0 *)((u8 *)record_data - 0x10))->unk_00 = &D_8002593C;
    }
}
