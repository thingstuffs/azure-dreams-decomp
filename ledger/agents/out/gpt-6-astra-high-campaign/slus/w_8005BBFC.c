...
enum E_u16 right_gain_arg;
{
  ...
  if (channel != (-1))
  {
    ...
    if ((((s16) note) >= ((s32) tone_data->f06)) && (((s32) tone_data->f07) >= ((s16) note)))
    {
      ...
      voice_request.f20 = voice_request.f1c;
      ...
      {
        voice_request.f18 = tone_data->f05 | (tone_data->f04 << 8);
      }
      func_8005EC0C(&voice_request);
      if (tone_data->f01 & 4)
      {
