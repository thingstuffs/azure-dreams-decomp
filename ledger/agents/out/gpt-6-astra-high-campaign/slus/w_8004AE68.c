...
/* Compares two records by subtracting their key-indexed table values. */
s32 func_8004AE68(S_8004AE68_Outer *left, S_8004AE68_Outer *right)
{
    return D_800713E4[left->rec->key] - D_800713E4[right->rec->key];
}
