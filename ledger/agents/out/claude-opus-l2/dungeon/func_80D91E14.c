...
/* Run the actor's two-step death sequence: post its message, then spawn the drop and release it. */
void func_80173614(void *work, void *part_a, void *part_b, void *actor)
{
    s32 first;
    s32 result;
    s32 saved_first;
