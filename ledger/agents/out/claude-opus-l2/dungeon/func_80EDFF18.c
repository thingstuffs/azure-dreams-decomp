...
typedef struct S_80171718_0 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    void * unk_10;
} S_80171718_0;   /* object in func_80171718 */

typedef struct S_80171718_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_80171718_1;   /* result in func_80171718 */

typedef struct S_80171718_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_80171718_2;   /* part0 in func_80171718 */

typedef struct S_80171718_3 {
    u8 pad_00[0x24];
    s8 unk_24;
    s8 unk_25;
    u8 pad_26[0x6];
    void * unk_2C;
} S_80171718_3;   /* part1 in func_80171718 */

typedef struct S_80171718_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0xA];
    u8 unk_9A;
    u8 pad_9B[0x1];
    s8 unk_9C;
} S_80171718_4;   /* result_copy in func_80171718 */
...
void *func_80171718(s16 spawn_flags, s8 attr_a, s8 attr_b, s32 attr_c)
{
    s32 kind;
    s32 flags0;
    s32 flags1;
    ...
    result = (u8 *)object;
    result += 0x20;
    ((S_80171718_0 *)object)->unk_10 = D_801718E0;
    ((S_80171718_1 *)result)->unk_13 = 34;
...

    {
        ...
        part0 = ((S_80171718_0 *)object)->unk_08;
        handler = (u8 *)page + 0x4EB8;
        part0->unk_0A = attr_c;
        part1 = ((S_80171718_0 *)object)->unk_0C;
        kind = spawn_flags & 3;
        part1->unk_25 = attr_b;
        result_copy = result;
    ...
    if (kind == 1) {
        flags0 = ((S_80171718_1 *)result)->unk_14;
        flags1 = ((S_80171718_1 *)result)->unk_1C;
        flags0 |= 0x6000;
        flags1 |= 0x6000;
        ((S_80171718_1 *)result)->unk_14 = flags0;
        ((S_80171718_1 *)result)->unk_1C = flags1;
        goto common;
    }
