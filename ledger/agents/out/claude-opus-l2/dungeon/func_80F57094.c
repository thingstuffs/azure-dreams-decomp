...
typedef struct S_8014C894_0 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    void * unk_10;
} S_8014C894_0;   /* obj in func_8014C894 */

typedef struct S_8014C894_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_8014C894_1;   /* work in func_8014C894 */

typedef struct S_8014C894_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_8014C894_2;   /* part_a in func_8014C894 */

typedef struct S_8014C894_3 {
    u8 pad_00[0x24];
    s8 unk_24;
    s8 unk_25;
    u8 pad_26[0x6];
    void * unk_2C;
} S_8014C894_3;   /* part_b in func_8014C894 */

typedef struct S_8014C894_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0xA];
    u8 unk_9A;
    u8 pad_9B[0x1];
    s8 unk_9C;
} S_8014C894_4;   /* actor in func_8014C894 */
...
extern u8 D_8014CA68[];
extern M2C_UNK D_8014CE94;
extern u8 D_80150A7C[];
...
void *func_8014C894(s16 flags, s16 kind_id, s16 variant, s16 spawn_value)
{
    s32 kind;
    void *obj;
    S_8014C894_2 *part_a;
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        ((S_8014C894_0 *)obj)->unk_10 = D_8014CA68;
        work->unk_13 = 0x24;
        func_8004491C(obj, &D_80045340);

        part_a = ((S_8014C894_0 *)obj)->unk_08;
        part_a->unk_0A = saved_spawn;
        part_b = ((S_8014C894_0 *)obj)->unk_0C;
        kind = flags & 3;
        part_b->unk_25 = saved_variant;
        actor = work;
        part_b->unk_2C = D_80150A7C;
