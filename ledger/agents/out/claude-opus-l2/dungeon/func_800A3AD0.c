                    ...
                    if (func_80033BC0(0x11F9) != 0) {
                        if (func_80033BC0(0x11FC) == 0) {
                            if ((s16)func_800A697C(0xD, 2) == 0) {
                                *(u8 *)&result = 2;
                                *((u8 *)&result + 1) = 0xD;
                                *(s16 *)((u8 *)*(void **)((u8 *)actor - 0x14) + 0x12) = 0xC;
                            }
                        }
                    }
                }
...
/* MECHANISM: A four-byte stack result and actor-only s0 lifetime produce the 0x20 frame.
