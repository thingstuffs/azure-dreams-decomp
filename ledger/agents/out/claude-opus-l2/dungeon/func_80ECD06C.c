...
typedef struct S_8015886C_0 {
    ...
    void * unk_0C;
    void * unk_10;
} S_8015886C_0;   /* obj in func_8015886C */

typedef struct S_8015886C_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_8015886C_1;   /* work in func_8015886C */

typedef struct S_8015886C_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_8015886C_2;   /* part_a in func_8015886C */

typedef struct S_8015886C_3 {
    u8 pad_00[0x12];
    s16 unk_12;
    u8 pad_14[0x10];
    s8 unk_24;
    ...
    s32 unk_28;
    void * unk_2C;
} S_8015886C_3;   /* part_b in func_8015886C */

typedef struct S_8015886C_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0x2];
    s16 unk_92;
    ...
    u8 pad_A0[0x8];
    u16 unk_A8;
} S_8015886C_4;   /* actor in func_8015886C */

typedef struct S_8015886C_5 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8015886C_5;   /* current in func_8015886C */

typedef struct S_8015886C_6 {
    u8 pad_00[0x2];
    s16 unk_02;
    u16 unk_04;
    u16 unk_06;
    u8 pad_08[0x90];
    u32 unk_98;
} S_8015886C_6;   /* child in func_8015886C */

typedef struct S_8015886C_7 {
    u8 pad_00[0xC];
    u32 unk_0C;
    u16 unk_10;
    s16 unk_12;
    ...
    u8 pad_16[0x12];
    u32 unk_28;
} S_8015886C_7;   /* elem in func_8015886C */

typedef struct S_8015886C_8 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8015886C_8;   /* base in func_8015886C */

typedef struct S_8015886C_9 {
    u8 pad_00[0x10];
    void * unk_10;
} S_8015886C_9;   /* ((S_8015886C_8 *)base)->unk_A4 in func_8015886C */
...
void *func_8015886C(s16 spawn_flags, s16 kind_id, s16 variant, s16 spawn_value)
{
    s32 kind;
    void *work;
    s8 saved_kind_id;
    ...
    if (obj != 0) {
        ...
        part_b = ((S_8015886C_0 *)obj)->unk_0C;
        kind = spawn_flags & 3;
        part_b->unk_2C = D_8015C18C;
        part_b->unk_24 = saved_kind_id;
        part_b->unk_25 = saved_variant;

        if (kind == 1) {
            left = ((S_8015886C_1 *)work)->unk_14 | 0x6000;
...
normal_kind:
        if (((spawn_flags & ~3) << 16) == 0) {
            if (!(((S_8015886C_1 *)work)->unk_14 & 0x200)) {
                left = func_800A6D30();
                if (left & 1) {
                    ((S_8015886C_1 *)work)->unk_1C |= 0x200;
                    right = func_800A6D30();
                    func_800A48F0(work, 1, (right & 0x3F) | 0x20);
                    part_b->unk_2C = D_8015C1CC;
                }
            }
        }
...
call_actor_setup:
        ...
        actor->unk_9A = 0xFF;
        actor->unk_9C = -1;
        actor->unk_8C = D_801591A4;
        ((S_8015886C_1 *)work)->unk_1C |= 0x00040000;
        actor->unk_92 = -16;
        flags = actor->unk_98;
        actor->unk_A8 = 0;
        actor->unk_9E = 1;
        ...
        do {
            ...
            if (child_obj != 0) {
                ...
                while (i < ((S_8015886C_6 *)child)->unk_02) {
                    ...
                    ((S_8015886C_9 *)(base->unk_A4))->unk_10 = D_800D78C0;

                    func_80047784(elem, 39, 0, child_arg);
                    elem_offset += 48;
                    i++;
                    ((S_8015886C_6 *)child)->unk_06 = 0;
                    func_800478E8(part_b, D_800D71A8, 0);
                    ((S_8015886C_6 *)child)->unk_98 = (u8 *)obj + 30;
                }
            }
