...
typedef struct S_8015E86C_0 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    void * unk_10;
} S_8015E86C_0;   /* obj in func_8015E86C */

typedef struct S_8015E86C_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_8015E86C_1;   /* work in func_8015E86C */

typedef struct S_8015E86C_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_8015E86C_2;   /* part_a in func_8015E86C */

typedef struct S_8015E86C_3 {
    u8 pad_00[0x12];
    s16 unk_12;
    u8 pad_14[0x10];
    s8 unk_24;
    ...
    s32 unk_28;
    void * unk_2C;
} S_8015E86C_3;   /* part_b in func_8015E86C */

typedef struct S_8015E86C_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0x2];
    s16 unk_92;
    ...
    u8 pad_A0[0x8];
    u16 unk_A8;
} S_8015E86C_4;   /* actor in func_8015E86C */

typedef struct S_8015E86C_5 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8015E86C_5;   /* current in func_8015E86C */

typedef struct S_8015E86C_6 {
    u8 pad_00[0x2];
    s16 unk_02;
    u16 unk_04;
    u16 unk_06;
    u8 pad_08[0x90];
    u32 unk_98;
} S_8015E86C_6;   /* child in func_8015E86C */

typedef struct S_8015E86C_7 {
    u8 pad_00[0xC];
    u32 unk_0C;
    u16 unk_10;
    s16 unk_12;
    ...
    u8 pad_16[0x12];
    u32 unk_28;
} S_8015E86C_7;   /* elem in func_8015E86C */

typedef struct S_8015E86C_8 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8015E86C_8;   /* base in func_8015E86C */

typedef struct S_8015E86C_9 {
    u8 pad_00[0x10];
    void * unk_10;
} S_8015E86C_9;   /* ((S_8015E86C_8 *)base)->unk_A4 in func_8015E86C */
...
extern u8 D_8015EB64[];
extern u8 D_8015F1A4[];
extern u8 D_8016218C[];
extern u8 D_801621CC[];

/* Spawn this overlay's effect object: allocate it, fill its two parts from the attributes and arm its handlers. */
void *func_8015E86C(s16 spawn_flags, s16 attr_a, s16 attr_b, s16 attr_c)
{
    s32 kind;
    void *work;
    s8 held_a;
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        ((S_8015E86C_0 *)obj)->unk_10 = D_8015EB64;
        ((S_8015E86C_1 *)work)->unk_13 = 0x21;
        func_8004491C(obj, &D_80045340);
        actor = work;

        part_a = ((S_8015E86C_0 *)obj)->unk_08;
        part_a->unk_0A = attr_c;
        part_b = ((S_8015E86C_0 *)obj)->unk_0C;
        kind = spawn_flags & 3;
        part_b->unk_2C = D_8016218C;
        part_b->unk_24 = held_a;
        part_b->unk_25 = held_b;

        if (kind == 1) {
            left = ((S_8015E86C_1 *)work)->unk_14 | 0x6000;
...
call_actor_setup:
        ...
        actor->unk_9A = 0xFF;
        actor->unk_9C = -1;
        actor->unk_8C = D_8015F1A4;
        ((S_8015E86C_1 *)work)->unk_1C |= 0x00040000;
        actor->unk_92 = -16;
        flags = actor->unk_98;
        actor->unk_A8 = 0;
        actor->unk_9E = 1;
        ...
        do {
            ...
            ((S_8015E86C_5 *)current)->unk_A4 = child_obj;
            if (child_obj != 0) {
                void *child;

                child = (u8 *)child_obj + 0x20;

                ((S_8015E86C_6 *)child)->unk_02 = 1;
                i = 0;
                base = current;
                elem_offset = 8;
