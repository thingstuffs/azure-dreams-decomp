...
typedef struct S_80158894_0 {
    ...
    void * unk_0C;
    void * unk_10;
} S_80158894_0;   /* obj in func_80158894 */
...
typedef struct S_80158894_1 {
    ...
    u8 pad_18[0x4];
    s32 unk_1C;
} S_80158894_1;   /* work in func_80158894 */

typedef struct S_80158894_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_80158894_2;   /* part_a in func_80158894 */
...
typedef struct S_80158894_3 {
    ...
    u8 pad_26[0x6];
    void * unk_2C;
} S_80158894_3;   /* part_b in func_80158894 */
...
typedef struct S_80158894_4 {
    ...
    u8 pad_9B[0x1];
    s8 unk_9C;
} S_80158894_4;   /* actor in func_80158894 */
...
extern M2C_UNK D_80158E94;
extern u8 D_8015CA7C[];
...
void *func_80158894(s16 spawn_flags, s16 attr_a, s16 attr_b, s16 attr_c)
{
    s32 kind;
    void *obj;
    S_80158894_2 *part_a;
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        ((S_80158894_0 *)obj)->unk_10 = D_80158A68;
        work->unk_13 = 0x24;
        func_8004491C(obj, &D_80045340);

        part_a = ((S_80158894_0 *)obj)->unk_08;
        part_a->unk_0A = held_c;
        part_b = ((S_80158894_0 *)obj)->unk_0C;
        kind = spawn_flags & 3;
        part_b->unk_25 = held_b;
        actor = work;
        part_b->unk_2C = D_8015CA7C;
