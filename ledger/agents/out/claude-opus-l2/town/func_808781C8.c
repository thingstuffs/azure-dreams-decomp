...
extern void func_80702180(s32 index, s32 value);
extern s32 func_80702260(void);
extern void func_80702670(u16 value);
extern void func_807026C0(s32 value);
extern s32 func_80702714(u16 value);

/* Advance the shop entry at `index`: start its 0x1F9 step when eligible, otherwise just clear it. */
