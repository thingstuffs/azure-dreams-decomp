...
/* Advance the town scene: finish early on flag 0x1068, else arm the 0x949/0x94A record or run the step check, then hand back to the scene callback. */
s32 func_800182FC(s32 kind, void *param)
{
    func_80016CC4();
