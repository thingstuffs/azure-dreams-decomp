...
/* Processes dungeon input, conditionally advancing the counter and applying extra result steps. */
void func_800ACF88(void *input_data, void *context) {
    ...
    result = func_80099194(D_800E0C78, func_80099734(original_input, initial_result));
    if (!(flag_page[0x3714 / 2] & 1)) {
