...
loop_1:
    ...
    if (temp_v0 != NULL) {
        ...
        M2C_FIELD(temp_a1, s8 *, 0xD) = (u8)arithmetic_v1;
        M2C_FIELD(temp_a1, u16 *, 0x1C) = reload_a0;
        M2C_FIELD(temp_a2, s16 *, 0x38) = var_s1;
        if (var_s1 == temp_s2) {
            M2C_FIELD(temp_a2, s16 *, 0x38) = 7;
        }
        M2C_FIELD(temp_a2, s16 *, 0x30) = temp_s2;
        goto block_8;
    }
block_8:
    var_s1 += 1;
