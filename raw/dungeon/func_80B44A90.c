...
state_0:
    if (FIELD(arg2, u16, 0x14) & 0x6000) {
        FIELD(arg2, u8 *, 0x2C) = D_80175A6C;
        func_80047784(
            arg2,
            D_80175A6C[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
...
state_2:
    if (FIELD(arg3, u32, 0x1C) & 0x08000000) {
        ...
        FIELD(arg2, u8 *, 0x2C) = D_80175A74;
        func_80047784(
            arg2,
            D_80175A74[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u8, 0x9B)++;
    }
