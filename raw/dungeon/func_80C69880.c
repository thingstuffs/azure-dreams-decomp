...
void *func_80171080(s16 arg0, s8 arg1, s8 arg2, s32 arg3)
{
    s32 kind;
    ...
    ASM_KEEP(result);
    FIELD(object, void *, 0x10) = D_80171248;
    FIELD(result, s8, 0x13) = 19;
...
store_flags:
    ...
    if ((func_800A6D30() & 1) != 0) {
        ...
        FIELD(part1, void *, 0x2C) = D_80174310;
    }
...
common:
    ...
    FIELD(result_copy, void *, 0x8C) = &D_80171650;
