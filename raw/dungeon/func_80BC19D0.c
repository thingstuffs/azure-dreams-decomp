...
void *func_801711D0(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        FIELD(obj, void *, 0x10) = D_801713A8;
        FIELD(work, s8, 0x13) = 0xF;
        ...
        actor = work;
        FIELD(part_b, void *, 0x2C) = D_80174634;
...
normal_kind:
        ...
        if (((arg0 & ~3) << 16) == 0) {
            if (!(FIELD(work, s32, 0x14) & 0x200)) {
                ...
                FIELD(part_b, void *, 0x2C) = D_80174684;
                goto post_kind;
            }
        }
        goto call_a1_setup;
...
call_a1_setup:
        ...
        FIELD(actor, void *, 0x8C) = &D_801719DC;
