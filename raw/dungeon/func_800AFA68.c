...
{
  u8 sp28[0x20];
  register u8 *transform_dst ASM_REG("$4") = sp28;
  s32 var_s5 = 0;
  register u8 *mat ASM_REG("$22") = (u8 *) 0x1F8000D0;
  register u8 *mat_arg ASM_REG("$5");
  register u8 *vec ASM_REG("$20") = (u8 *) 0x1F800050;
  u8 *viewport = (u8 *) 0x1F800090;
  register u8 *viewport2 ASM_REG("$23") = (u8 *) 0x1F800094;
  u8 *transform_dst_b;
  u8 *dst_a;
  register u8 *mat_arg_a ASM_REG("$5");
  register u32 page_color ASM_REG("$8");
  register u8 *init_global ASM_REG("$8");
  register u8 *d6_store_base1 ASM_REG("$8");
  register u8 *d6_store_base2 ASM_REG("$8");
  register u8 *scratch ASM_REG("$17");
  volatile u16 sp48;
  volatile u16 sp4A;
  volatile u16 sp4C;
  register u16 init_v1 ASM_REG("$3");
  register u16 init_a1 ASM_REG("$5");
  register u16 init_a2 ASM_REG("$6");
  s32 sp50[3];
  ...
  u16 arg_x;
  u16 arg_y;
  register void *a2p ASM_REG("$8");
  u16 ang_a;
  u16 rot_a;
  register u16 rot_b ASM_REG("$6");
  u8 bx_a;
  u8 by_a;
  u8 bx_b;
  u8 by_b;
  ...
  void *temp_v1;
  void *global_root;
  ASM_KEEP_MEM_NV(viewport2, *((void **) (((s8 *) (&D_80083160)) + 0)));
  ...
  *((u8 **) (scratch + 0x018)) = temp_a3;
    ...
    *((u16 *) (((s8 *) temp_s0) + 0x10)) = temp_v0;
    if (temp_s3 != 0)
    {
        ...
        *((s32 *) (scratch + 0x0ec)) = (s32) ((s16) first_v0);
        ...
        if (!((*((u8 *) (((s8 *) temp_s3) + 0))) & 0x20))
        {
          ...
          *((s32 *) (scratch + 0x014)) = (s32) temp_v1_3;
          ...
          {
            register void *c1_a0 ASM_REG("$4") = scratch + 0x70;
            register void *c1_a1 ASM_REG("$5") = scratch + 0x78;
            register void *c1_a2 ASM_REG("$6") = scratch + 0x80;
            register void *c1_a3 ASM_REG("$7") = scratch + 0x88;
      ...
      *((s32 *) (scratch + 0x0c0)) = temp_v0_7;
      ASM_KEEP_MEMDEP_NV(temp_v0_7, page_color, *((s32 *) (scratch + 0x0c0)));
      temp_v1_7 = temp_v0_7;
      ASM_KEEP_MEM_NV(temp_v1_7, *((s32 *) (scratch + 0x0c0)));
      temp_v0_10 = temp_v0_7 * 4;
      d6_store_base1 = (u8 *) 0x80070000;
      ASM_KEEP_NV(d6_store_base1);
      d6_store_base1 -= 13008;
      ASM_USE_NV(d6_store_base1);
      *((s32 *) (((s8 *) d6_store_base1) + 0x1C)) = temp_v0_10;
      temp_v1_7 -= 4;
      *((s32 *) (scratch + 0x0c0)) = temp_v1_7;
      if (temp_v1_7 < 0x1E0U)
      {
        register u8 *post_global ASM_REG("$8");
        mat_arg_a = mat;
        dst_a = scratch + 0x100;
        ASM_USE_NV(dst_a);
        ...
        *((u16 *) (scratch + 0x100)) = (s16) ((*((u16 *) (((s8 *) a2p) + 0x16))) + (((s32) (raw48 << 0x10)) >> 0x11));
        ...
        ASM_KEEP_NV(post_global);
        post_global += 12640;
        ASM_USE_NV(post_global);
        rot_a = sp4A;
            ...
            *((u8 *) (((s8 *) temp_s0_3) + 7)) = 0x2CU;
            ...
            if (!((*((u8 *) (((s8 *) temp_s0_3) + 7))) & 2))
            {
              ...
              *((s32 *) (scratch + 0x0c0)) = temp_v0_11;
              ASM_KEEP_MEMDEP_NV(temp_v0_11, page_color, *((s32 *) (scratch + 0x0c0)));
              temp_v0_10 = temp_v0_11 * 4;
              d6_store_base2 = (u8 *) 0x80070000;
              ASM_KEEP_NV(d6_store_base2);
              d6_store_base2 -= 13008;
              ASM_USE_NV(d6_store_base2);
              ...
              *((u16 *) (scratch + 0x0ba)) = (u16) (ld0ba - 0x78);
              ...
              ASM_USE_NV(transform_dst_b);
              mat_arg_c = mat;
              ASM_KEEP_NV(mat_arg_c);
              ...
              *((u16 *) (scratch + 0x102)) = 0U;
              ...
              func_80064CF0((M2C_UNK *) vec);
              {
                register void *call_a0 ASM_REG("$4") = scratch + 0x70;
                register void *call_a1 ASM_REG("$5") = scratch + 0x78;
                register void *call_a2 ASM_REG("$6") = scratch + 0x80;
                register void *call_a3 ASM_REG("$7") = scratch + 0x88;
                u16 call_y;
                u16 call_x;
  ...
  if (var_s5 >= 0x20)
  {
    register u8 *final_global ASM_REG("$8") = (u8 *) (&D_80083160);
