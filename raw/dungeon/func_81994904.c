...
void func_80024104(void *arg0) {
    ...
    index = 0;
slot_loop:
    if (FIELD(arg0, s16, 0x46 + (((s32)index << 16) >> 15)) != 0) {
        index++;
        if (index < 8) {
            goto slot_loop;
        }
    ...
    if (index != 8) {
        ...
        if (obj != 0) {
            work = (u8 *)obj + 0x20;
            FIELD(work, s16, 0x2A) = 7;
            FIELD(work, s16, 0x2C) = 7;
            FIELD(work, s16, 0x32) = index;
            FIELD(work, void *, 0x60) = arg0;
            FIELD(obj, void *, 0x10) = D_8002405C;
            ...
            from = FIELD(D_800814A8, void *, -0x18);
            to = FIELD(obj, void *, 8);
            ((s32 *)to)[0] = ((s32 *)from)[0];
            ((s32 *)to)[1] = ((s32 *)from)[1];
            ((s32 *)to)[2] = ((s32 *)from)[2];
            ...
            *(PackedVec3 *)((u8 *)obj + 0x92) = D_8002533C;
            ...
            FIELD(work, u8, 0x7A) = (u8)rect->x - 0x40;
            FIELD(work, u8, 0x7B) = (u8)rect->y;
        }
    }

    timer = FIELD(arg0, u16, 0x2A) - 1;
    FIELD(arg0, u16, 0x2A) = timer;
    if ((s16)timer <= 0) {
