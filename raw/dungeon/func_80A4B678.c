...
void func_80174E78(Source *src, Vec3i *vec)
{
    ...
    for (; i < 16; i++) {
        ...
        register Entity *call_arg ASM_REG("$4");
        register s32 fifty ASM_REG("$2");
        register s32 trig_arg ASM_REG("$4");
        register s32 raw_value ASM_REG("$2");
        register u8 intensity ASM_REG("$2");
        register u8 held_intensity ASM_REG("$3");
