...
L1:
    ...
    if (FIELD(arg2, u16, 0x14) & 0x6000) {
        FIELD(arg2, u8 *, 0x2C) = D_80175C68;
        func_80047784(
            arg2,
            D_80175C68[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u8, 0x9B)++;
    }
...
L3:
    {
        ...
        func_8009C12C(arg3, arg2, FIELD(arg3, s16, 0x2A), 1);
        FIELD(arg2, u8 *, 0x2C) = D_80175C70;
        func_80047784(
            arg2,
            D_80175C70[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
