...
void *func_8016A89C(s32 arg0, s32 arg1, s32 arg2, s32 arg3)
{
...

    {
        ...
        init_root = allocated;
        setup = &D_80045340;
        FIELD(init_root, void *, 0x10) = D_8016ABB8;
        FIELD(object, u8, 0x13) = 17;
        ...
        if (flags0 == 0) {
            if ((FIELD(object, s32, 0x14) & 0x200) == 0) {
                if (func_800A6D30() & 1) {
                    ...
                    FIELD(part, void *, 0x2C) = D_8016E4FC;
                }
            }
        }
...
flags_done:
    ...
    FIELD(stable_object, void *, 0x8C) = D_8016B3A8;
    FIELD(object, s32, 0x1C) |= 0x40000;
    FIELD(stable_object, s16, 0x92) = -48;
