...
s32 func_8015E884(u8 *arg0, u16 *arg1)
{
    ...
    for (;;) {
        ...
        register u32 link ASM_REG("$3");
        register u32 color_r ASM_REG("$3");
        register u32 color_g ASM_REG("$6");
        register u32 color_b ASM_REG("$7");
        register u32 code_command ASM_REG("$2");
