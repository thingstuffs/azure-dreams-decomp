...
void func_80172090(void *arg0, M2C_UNK arg1, void *arg2, void *arg3) {
    ...
    if (!(*D_80083462 & 0x2000) && ((func_800A2B5C(arg3) << 0x10) == 0)) {
        ...
        if ((func_800A2B5C(arg3) << 0x10) == 0) {
            ...
            M2C_FIELD(arg2, u8 **, 0x2C) = D_8017423C;
            func_80047784(arg2, D_8017423C[((s32) (*D_80083228 + M2C_FIELD(arg3, s16 *, 0x2A) + 0x100) >> 9) & 7], 0);
