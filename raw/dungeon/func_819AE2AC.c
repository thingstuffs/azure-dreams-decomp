...
#ifndef NON_MATCHING
register s32 volatile v0_carrier ASM_REG("$2");
#endif

s32 func_80025AAC(void *arg0, s32 arg1, Entry *arg2)
{
    register void *state ASM_REG("$19") = arg0;
    register s32 value ASM_REG("$20") = arg1;
    register Entry *entry ASM_REG("$16") = arg2;
    u8 *base;
    register s32 i ASM_REG("$18");
    register u8 *ptr ASM_REG("$17");
