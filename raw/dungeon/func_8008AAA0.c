...
void func_80090200(void *arg0, M2C_UNK arg1, void *arg2, void *arg3) {
    M2C_FIELD(arg0, s8 *, 0x9A) = 0xD;
    M2C_FIELD(arg0, s8 *, 0x9B) = 0;
    M2C_FIELD(arg0, s32 *, 0x8C) = 0;
    M2C_FIELD(arg0, s16 *, 0x96) = 0;
    func_80094E34();
    M2C_FIELD(arg3, s32 *, 0x1C) = (s32) (M2C_FIELD(arg3, s32 *, 0x1C) & ~0x20);
    M2C_FIELD(arg2, M2C_UNK **, 0x2C) = &D_800DD0E8;
    func_80048A44(arg2, *((((s32) (D_80083228 + M2C_FIELD(arg3, s16 *, 0x2A) + 0x100) >> 9) & 7) + &D_800DD0E8), 0, 1);
}
