...
s32 func_818B7E14(void *arg0, DungeonSource *arg1)
{
    ...
    u8 *sub;
    DungeonSource *dst;
    register DungeonObject *result ASM_REG("$2");
    register s32 copy0 ASM_REG("$4");
    register s32 copy1 ASM_REG("$5");
    register s32 copy2 ASM_REG("$6");
    register s32 copy3 ASM_REG("$7");
