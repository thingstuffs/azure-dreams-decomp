...
s32 func_8009FE94(s32 x0, s32 y0, s32 arg2, s32 x1, volatile s32 y1) {
    register s32 raw_x0 ASM_REG("$6") = x0;
    register s32 raw_y0 ASM_REG("$8") = y0;
    register s32 dx_raw ASM_REG("$2");
    register s32 held_x1 ASM_REG("$16");
    register s32 loaded_y1 ASM_REG("$3");
    register s32 held_y1 ASM_REG("$21");
    s32 dx;
    s32 dy;
    s32 dx_small;
    s32 x1_short;
