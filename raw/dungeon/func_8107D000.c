...
void func_8014CA10(void) __attribute__((noreturn));
...
void *BODY_NAME(s16 arg0, s8 arg1, s8 arg2, s16 arg3) {
    ...
    {
        var_s0 = temp_v0 + 0x20;
        M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_8014CAA4;
        ...
        temp_s5 = var_s0;
        M2C_FIELD(temp_s2, M2C_UNK **, 0x2C) = &D_8014FFB8;
        ...
        if (((arg0 & ~3) << 0x10) == 0) {
            if (!(M2C_FIELD(var_s0, s32 *, 0x14) & 0x200)) {
                ...
                M2C_FIELD(temp_s2, M2C_UNK **, 0x2C) = &D_80150000;
                ASM_SCHED_BARRIER();
                goto post_a6d30;
            }
        }
...
call_a1_setup:
        ...
        M2C_FIELD(temp_s5, M2C_UNK **, 0x8C) = &D_8014CF68;
