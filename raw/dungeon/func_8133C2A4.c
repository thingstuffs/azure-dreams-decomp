...
{
    s32 angle_out[2];
    register Entity *ent ASM_REG("$17");
    register s32 saved_arg1 ASM_REG("$16");
    register Aux *aux ASM_REG("$18");
    register Entity *ent_arg3 ASM_REG("$19");
    register u8 *script ASM_REG("$4");
    register s32 code ASM_REG("$5");
    register s32 raw_kind ASM_REG("$7");
...
case_C8_state1:
    {
        s16 *angle_base;
        register u8 *c8_sequence ASM_REG("$5");
