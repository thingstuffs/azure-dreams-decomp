...
void *func_800C9850(u8 arg0, u8 arg1, u16 arg2) {
    register u16 arg2_s1 ASM_REG("$17") = arg2;
    register u8 arg0_s4 ASM_REG("$20") = arg0;
    register u8 arg1_s5 ASM_REG("$21") = arg1;
    void *ent;  /* s3 */
    ...
    register s32 idx ASM_REG("$2");
    register u8 *result_page ASM_REG("$2");
    register D80089430_t *result_base ASM_REG("$6");
    register s32 result0 ASM_REG("$3");
    register s32 result4 ASM_REG("$4");
    register s32 result8 ASM_REG("$5");
    register s32 flags ASM_REG("$6");
    register void *call_ent ASM_REG("$4");
    ...
    if (ent != 0) {
        ...
        ASM_USE(result8);
        {
            register s32 resultA ASM_REG("$3");
        ...
        call_ent = ent;
        call_zero = 0;
        ASM_KEEP4(flags, call_ent, call_zero, sub);
