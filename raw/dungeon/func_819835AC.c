...
void func_80024DAC(void *arg0, void *arg1, void *arg2) {
    ...
    s32 temp_v1_11;
    s32 divisor16;
    register s32 division_numerator ASM_REG("$2");
    ...
    void *temp_v0_10;
    void *temp_v0_4;
    register void *var_a2 ASM_REG("$6");
    void *var_s0;
    M2C_UNK *state0_move;
    void *state0_actor;
    void *state0_height_actor;
    register s32 state0_second ASM_REG("$2");
    s32 state0_delta_x;
    s32 state0_delta_y;
    register s32 update_v0 ASM_REG("$2");
    register s32 update_v1 ASM_REG("$3");
    s32 update_a0;
    s32 update_a1;
    void *state1_global;
    s32 compare_v1;
    ...
    void *state1_actor;
    void *state2_stage;
    register void *list_sentinel ASM_REG("$2");
    u8 tile_x;
    u16 tile_counter;
    u8 tile_y;
    s32 tile_div;
    ...
    s32 tile_call_arg;
    s32 common_speed;
    register s32 common_pitch ASM_REG("$2");
    s32 state6_timer_signed;
    u16 state6_timer;
    u16 state6_next;
    u16 state6_height;
    s32 state6_spin_arg;
    register s32 state6_velocity ASM_REG("$2");
