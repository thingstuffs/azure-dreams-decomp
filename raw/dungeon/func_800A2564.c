...
s32 func_800A7CC4(s32 arg0, s32 arg1, void *arg2) {
    ...
    u8 *ent;
    u8 *prim;
    register u8 *pc ASM_REG("$16");
    u8 *w;
    register u8 *q ASM_REG("$18");
    s32 n0, n1, n2, n5;
    u8 n3, n4;
    s32 xa, xb, ya, yb;
    register s32 xa2 ASM_REG("$4");
    s32 xb2;
    register s32 ya2 ASM_REG("$5");
    s32 yb2;
    s32 bx, by, yc, sb, sb2;
    u8 ub, ub2;
    s32 c0, c1, c2, c3;
    ...
    register u8 *a1v ASM_REG("$5");
    register s32 calc104 ASM_REG("$6");
    register s32 calc102 ASM_REG("$3");
    ...
    do {
        if (((Ent4 *)((i * 4) + (s32)D_800E3548))->b1 != 0) {
            ...
            n5 = n1;
            ASM_KEEP_NV(n5);
            ASM_KEEP_DEP_NV(n5, n1 * 4);
            ASM_KEEP_MEMDEP_NV(n5, a0v, U32(cd, 0x1C));
            U32(cd, 0x1C) = n1 * 4;
            n5 -= 2;
            U32(sp, 0xC0) = n5;
            if ((u32)n5 < 0x1E0) {
