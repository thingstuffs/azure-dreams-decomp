...
state_0:
    if (FIELD(arg2, u16, 0x14) & 0x6000) {
        FIELD(arg2, u8 *, 0x2C) = D_80173C94;
        func_80047784(
            arg2,
            D_80173C94[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u16, 0x98) |= 8;
        FIELD(arg1, s32, 0x14) = 0xFFF20000;
...
state_2:
    if (FIELD(arg3, u32, 0x1C) & 0x08000000) {
        ...
        FIELD(arg2, u8 *, 0x2C) = D_80173C9C;
        func_80047784(
            arg2,
            D_80173C9C[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u8, 0x9B)++;
    }
