...
void func_80093C70(s32 arg0, void *arg1, void *arg2) {
    void *temp_s0;
    void *temp_v0;
    void *temp_v1;
    void *temp_v1_2;
    ...
    if (temp_v0 != NULL) {
        ...
        M2C_FIELD(temp_s0, s32 *, 0x28) = (s32) M2C_FIELD(arg2, s32 *, 0x28);
        M2C_FIELD(temp_s0, s16 *, 0x1E) = 0x1000;
        M2C_FIELD(temp_s0, s16 *, 0x1C) = 0x1000;
        temp_flags = M2C_FIELD(temp_s0, volatile u16 *, 0x14);
        M2C_FIELD(temp_s0, s16 *, 6) = 4;
        M2C_FIELD(temp_s0, u16 *, 0x14) = (u16) (temp_flags | 0x200);
        ASM_MEM_BARRIER();
        if (D_80082E94 & 1) {
            M2C_FIELD(temp_s0, u16 *, 0x14) = (u16) (M2C_FIELD(temp_s0, u16 *, 0x14) | 1);
        }
        func_80048A44(temp_s0, 0xCE, 0, 3);
        func_8004491C(temp_v0, &D_80045340);
        temp_v1_2 = temp_v0 + 0x20;
        M2C_FIELD(temp_v0, void **, 0x20) = arg2;
        M2C_FIELD(temp_v1_2, s16 *, 6) = 0x10;
        M2C_FIELD(temp_s0, s32 *, 0xC) = 0x2C808080;
        M2C_FIELD(temp_v1_2, s16 *, 8) = 1;
    }
}
