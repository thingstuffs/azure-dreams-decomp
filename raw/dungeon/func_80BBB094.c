...
{
    register s32 arg0Reg ASM_REG("$18") = arg0;
    register Func80BBB094PartC *result ASM_REG("$16") = 0;
    register s32 arg1Reg ASM_REG("$21") = arg1;
    register unsigned long slot1 ASM_REG("$17");
    register s32 arg2Reg ASM_REG("$20");
    register Func80BBB094PartC *resultAlias;
    register Func80BBB094Object *obj ASM_REG("$19");
    register Func80BBB094PartA *partA ASM_REG("$22");
    register s16 savedArg0 ASM_REG("$23");
    Func80BBB094PartB *partB;
    register unsigned long slot2 ASM_REG("$2");
    s32 mode;
    s32 flag;
    s32 randomTest;
    u32 word14;
