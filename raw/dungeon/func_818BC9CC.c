...
{
    register void *arg0 ASM_REG("$22") = input0;
    register void *arg1 ASM_REG("$19") = input1;
    register u8 *scratch ASM_REG("$18");
    register u8 *packet ASM_REG("$17");
    register u8 *extra ASM_REG("$16");
    u8 *ctx;
    u8 *base;
    u32 hiA;
    u32 hiB;
    register s32 tp_x ASM_REG("$4");
    register s32 tp_y ASM_REG("$5");
    register s32 tp_w ASM_REG("$6");
    u32 extentX;
    register u32 extentY ASM_REG("$23");
    u32 index;
    register u32 lowMask ASM_REG("$20");
    register s32 i ASM_REG("$21");
    register u32 tail01 ASM_REG("$3");
    register u32 tail2 ASM_REG("$2");
    s32 angle;
    u16 tile;
    u16 value;
    u8 color;
