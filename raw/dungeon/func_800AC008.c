...
void func_800B1768(s16 arg0, s32 arg1, s32 arg2, s32 arg3, s16 arg4, u16 arg5) {
    ...
    s16 arg0_reg = arg0;
    register s32 arg1_reg ASM_REG("$19") = arg1;
    register u8 *arg2_reg ASM_REG("$21") = (u8 *)arg2;
    register s32 temp_s6 ASM_REG("$22") = arg3;
    register s32 count ASM_REG("$20") = 0;
    register s32 arg3_ff ASM_REG("$23");
    register AcObject *obj ASM_REG("$16");
    AcHeader *header;
    AcMeta *meta;
    register AcSub *sub ASM_REG("$18");
    register s32 *table_entry ASM_REG("$16");
    register u8 *base ASM_REG("$2");
    void *new_buf;
    register void *buf ASM_REG("$17");
    register void *call_arg ASM_REG("$4");
    register void *prev_arg ASM_REG("$5");
    register s32 hard_zero ASM_REG("$0");
    register u32 color1 ASM_REG("$2");
    register u32 color2 ASM_REG("$3");
    register u32 tail_flags ASM_REG("$2");
    register u32 tail_field1c ASM_REG("$3");
...
shared_setup:
            ...
            *(s32 *)((u8 *)buf + 0x10) = sub->field18;
            ...
            ASM_USE2_NV(tail_flags, tail_field1c);
            tail_flags |= 2;
            ((u8 *)buf)[1] = tail_flags;
