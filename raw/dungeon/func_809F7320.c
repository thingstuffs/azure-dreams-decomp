...
void func_80174B20(void *arg0, void *arg1, void *arg2, void *arg3) {
    static void *const jt_keep[] = { &&jt_c0, &&jt_c1, &&jt_c2, &&jt_c3, &&jt_c4, &&jt_c5, &&jt_c6, &&jt_c7, &&jt_c8 };
    register s32 temp_a3 ASM_REG("$7");
    register void *temp_a1_base ASM_REG("$5");
    register void *temp_a0_2 ASM_REG("$4");
    register s32 temp_v0_flags ASM_REG("$2");
    register u16 temp_v1_count ASM_REG("$3");
    s16 temp_v0_4;
    s16 var_s0;
    s32 temp_a0;
    s32 temp_flag;
    ...
    register s32 temp_v1_copy ASM_REG("$3");
    register void *temp_a0_arg ASM_REG("$4");
    u16 temp_v0;
    u16 temp_v0_6;
    u16 temp_v1_2;
    u8 temp_v1;
...
jt_c3:
    ...
    temp_flag = M2C_FIELD(&D_8017521D, u8 *, 0);
...
block_12:
    ...
    M2C_FIELD(temp_s0_base, u8 *, 0xA8) = (u8) (M2C_FIELD(temp_s0_base, u8 *, 0xA8) + ((s32) (M2C_FIELD(temp_a1, u8 *, 0) - M2C_FIELD(temp_s0_base, u8 *, 0xA8)) / (s16) M2C_FIELD(arg0, u16 *, 0x96)));
    M2C_FIELD(temp_s0_base, u8 *, 0xA9) = (u8) (M2C_FIELD(temp_s0_base, u8 *, 0xA9) + ((s32) (M2C_FIELD(temp_a1, u8 *, 1) - M2C_FIELD(temp_s0_base, u8 *, 0xA9)) / (s16) M2C_FIELD(arg0, u16 *, 0x96)));
    M2C_FIELD(temp_s0_base, u8 *, 0xAA) = (u8) (M2C_FIELD(temp_s0_base, u8 *, 0xAA) + ((s32) (M2C_FIELD(temp_a1, u8 *, 2) - M2C_FIELD(temp_s0_base, u8 *, 0xAA)) / (s16) M2C_FIELD(arg0, u16 *, 0x96)));
    return;
jt_c4:
    ...
    M2C_FIELD(temp_v0_2, M2C_UNK **, 0x10) = &D_801749F4;
    ...
    ASM_KEEP(temp_a3);
    temp_v1_copy = M2C_FIELD(arg1, s32 *, 8);
    M2C_FIELD(temp_a1_base, s16 *, 0x5218) = -4;
    M2C_FIELD(temp_a2, s32 *, 8) = temp_v1_copy;
    ...
    temp_a0_arg = temp_s0;
block_16:
    func_8003DB94(temp_a0_arg, &D_8014A000[M2C_FIELD(D_80175200, s32 *, (s16) var_v1 * 4)], 0);
...
jt_c7:
    ...
    M2C_FIELD(arg3, void **, 0x60) = temp_v0_5;
    if (temp_v0_5 == NULL) {
        goto block_28;
    }
    M2C_FIELD(arg0, u16 *, 0x96) = 0x10U;
...
jt_c8:
    ...
    temp_v0_flags = M2C_FIELD(temp_a1_base, s32 *, 0x14A0);
    temp_v1_count = M2C_FIELD(temp_a0_2, u16 *, 0xA);
    M2C_FIELD(temp_a1_base, s32 *, 0x14A0) = temp_v0_flags | 0x8000;
    M2C_FIELD(temp_a0_2, u16 *, 0xA) = temp_v1_count - 1;
