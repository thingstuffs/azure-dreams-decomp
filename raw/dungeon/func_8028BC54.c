...
void func_8001EC54(void)
{
    ...
    register s32 budget;
    s32 index;
    register s32 decrement ASM_REG("$18");
    register s32 amount ASM_REG("$21");
    register s32 flag ASM_REG("$20");
    s32 type;
    s32 cell_index;
    s32 scan_x;
    s32 scan_y;
    ...
    s32 entry_state;
    register volatile DungeonEntry *entry ASM_REG("$17");
    register volatile DungeonCell *cell ASM_REG("$16");
