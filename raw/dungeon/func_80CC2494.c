...
s32 func_80175C94(void *arg0, s32 arg1, s32 arg2, s32 arg3) {
    register s32 held_arg1 ASM_REG("$17") = arg1;
    register s32 held_arg2 ASM_REG("$18") = arg2;
    register s32 held_arg3 ASM_REG("$19") = arg3;
    register void *held_arg0 ASM_REG("$16") = arg0;
    register s32 zero_case_value ASM_REG("$2");
    register s32 tail_return ASM_REG("$2");
    s16 result;
    s32 shifted_arg3;
