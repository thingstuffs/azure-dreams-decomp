...
void func_80172334(void *arg0, M2C_UNK arg1, void *arg2, void *arg3) {
    ...
    temp_v0 = M2C_FIELD(arg0, u16 *, 0xA6) + 1;
    M2C_FIELD(arg0, u16 *, 0xA6) = temp_v0;
    if ((u32) (temp_v0 & 0xFFFF) >= 0x3DU) {
        D_80083460_t *ctr = &D_80083460;
        u8 *table = &D_80175F20;

        M2C_FIELD(arg0, u16 *, 0xA6) = 0x3CU;
        ...
        func_80047784(arg2, *((((s32) (D_80083228 + M2C_FIELD(arg3, s16 *, 0x2A) + 0x100) >> 9) & 7) + table), 0);
    }
}
