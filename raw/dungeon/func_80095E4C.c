...
void *func_8009B5AC(Source *arg0, s32 arg1, s32 arg2) {
    ...
    s32 probe_result;
    s32 index;
    register s32 tail34 ASM_REG("$4");
    s32 tail3c;
    s32 elem_value;
    register u8 *dead_state ASM_REG("$2");
    register u16 tx ASM_REG("$16");
    register u16 ty ASM_REG("$17");
