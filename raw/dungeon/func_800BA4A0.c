...
s32 func_800BFC00(void *arg0, s32 arg1, s16 arg2)
{
    ...
    if (FIELD(arg0, u8, 0x26) == FIELD(arg0, u8, 0x68)) {
        temp_v1 = FIELD(arg0, u8, 0);
        if (temp_v1 < 0xFF) {
            FIELD(arg0, u8, 0) = temp_v1 + 1;
            func_80041E70(arg0);
        }
    }

    temp_a0 = FIELD(arg0, u8, 0x26);
    temp_v1_2 = temp_a0 & 0xFF;
    if (temp_v1_2 < 0xFF && temp_v1_2 < FIELD(arg0, u8, 0x68)) {
        FIELD(arg0, u8, 0x26) = temp_a0 + 1;
    }
