...
void func_8001D0F4(DungeonRect *arg0)
{
    u16 tile;
    s32 count_calc;
    register s32 count_value ASM_REG("$2");
    register s32 value ASM_REG("$2");
    register s32 stored_value ASM_REG("$4");
    s32 first_random;
    s32 count;
    u32 random_value;
    u16 table_flags;
    ...
    u8 *base;
    s32 off;
    register DungeonSpot *entry ASM_REG("$19");
    u32 xoff;
    u32 yoff;
