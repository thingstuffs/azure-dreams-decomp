...
void func_80024AD0(void *arg0, void *arg1, void *arg2)
{
    ...
    Point point;
    CoordTable table;
    register void *s4 ASM_REG("$20");
    register u32 s0 ASM_REG("$16");
    register u32 s5 ASM_REG("$21");
    s32 state;
    register void *arg0_r ASM_REG("$19") = arg0;
    register void *arg1_r ASM_REG("$18") = arg1;
    register void *arg2_r ASM_REG("$17") = arg2;
#define arg0 arg0_r
#define arg1 arg1_r
#define arg2 arg2_r
...
state1:
    ...
    u16 base_height;
    void *info;
    register void *entry1 ASM_REG("$7");
    void *entry;
...
state2:
    ...
    s32 result;
    void *info;
    register void *entry ASM_REG("$7");
    s0 = 0;
    do {
        register void *call_obj ASM_REG("$4");
        register s32 call_code ASM_REG("$6");
        register s32 call_shade ASM_REG("$7");
...
state3:
    {
    register void *entry ASM_REG("$7");
    register void *dst ASM_REG("$3");
    register s32 state_count ASM_REG("$7");
    register void *new_obj ASM_REG("$4");
    void *info;
    s32 current_count;
    {
        u16 angle = FIELD(arg2, u16, 0x1A) + 400;
...
state4:
    ...
    if (FIELD(arg0, s16, 0x82) >= 100) {
        register void *final_info ASM_REG("$3");
        register u32 final_mask ASM_REG("$4");
