...
state_zero:
    ...
    FIELD(arg2, u8 *, 0x2C) = D_8016F9A8;
    func_80047784(
        arg2,
        D_8016F9A8[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
...
state_two:
    if (FIELD(arg3, s32, 0x1C) & 0x08000000) {
        ...
        FIELD(arg2, u8 *, 0x2C) = D_8016F9B8;
        func_80047784(
            arg2,
            D_8016F9B8[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u8, 0x9B)++;
    }
    goto decrement_timer;
...
state_three:
    if (FIELD(arg2, u8 *, 0x2C) == D_8016F988) {
        goto decrement_timer;
    }
    FIELD(arg2, u8 *, 0x2C) = D_8016F988;
    func_80047784(
        arg2,
        D_8016F988[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
...
collision_check:
    if ((func_800AD9B4(arg2, arg3) << 16) > 0) {
        FIELD(arg0, void *, 0x8C) = &D_8016B7F4;
        func_800A9A04(arg3);
    }
}
