...
extern void func_80170C28(void) __attribute__((noreturn));
extern void func_80170CBC(void) __attribute__((noreturn));
extern void func_80170D3C(void) __attribute__((noreturn));
...
void func_80170A94(void *input0, void *input1, void *input2)
{
  ...
  register void *entry_arg0 ASM_REG("$4") = input0;
  void *arg1 = input1;
  register s32 direction ASM_REG("$18");
  ...
  s32 random_value;
  s32 delta;
  register s32 clear_delta ASM_REG("$2");
  register s32 actor_mask ASM_REG("$2");
  s32 accumulator_probe;
  s32 tail_value;
  s32 correction;
  register void *physics ASM_REG("$19") = arg0;
