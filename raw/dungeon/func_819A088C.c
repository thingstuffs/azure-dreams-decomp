...
void func_819A088C(void *arg0, void *arg1, void *arg2, s16 arg3)
{
    ...
    FIELD(scratch, u16, 0xB0) = FIELD(arg0, u16, 0x54);
    FIELD(scratch, u16, 0xB8) = FIELD(arg0, u16, 0x5A);
    FIELD(scratch, u16, 0xC0) = FIELD(arg0, u16, 0x60);
    FIELD(scratch, u16, 0xC8) = FIELD(arg0, u16, 0x66);
    FIELD(scratch, u16, 0xB2) = FIELD(arg0, u16, 0x56);
    FIELD(scratch, u16, 0xBA) = FIELD(arg0, u16, 0x5C);
    FIELD(scratch, u16, 0xC2) = FIELD(arg0, u16, 0x62);
    FIELD(scratch, u16, 0xCA) = FIELD(arg0, u16, 0x68);
    FIELD(scratch, u16, 0xB4) = FIELD(arg0, u16, 0x58);
    FIELD(scratch, u16, 0xBC) = FIELD(arg0, u16, 0x5E);
    FIELD(scratch, u16, 0xC4) = FIELD(arg0, u16, 0x64);
    FIELD(scratch, u16, 0xCC) = FIELD(arg0, u16, 0x6A);
