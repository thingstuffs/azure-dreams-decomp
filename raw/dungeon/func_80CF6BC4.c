...
jt_c1:
    ...
    case 13:
        FIELD(arg2, u8 *, 0x2C) = D_80169DDC;
        func_80047784(arg2,
            D_80169DDC[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 14:
        FIELD(arg2, u8 *, 0x2C) = D_80169DE4;
        func_80047784(arg2,
            D_80169DE4[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 15:
        FIELD(arg2, u8 *, 0x2C) = D_80169DEC;
        func_80047784(arg2,
            D_80169DEC[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
