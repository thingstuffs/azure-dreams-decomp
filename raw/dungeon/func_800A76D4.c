...
s32 func_800ACE34(StructArg0 *arg0, s32 arg1, StructArg2 *arg2) {
    register StructArg0 *s0 ASM_REG("$16") = arg0;
    register StructArg2 *s1 ASM_REG("$17") = arg2;
    u8 v1 = s0->unk9B;
    register u8 t0 ASM_REG("$8");
    register s32 a1 ASM_REG("$5");
    register u8 a3 ASM_REG("$7");
    register s32 a0 ASM_REG("$4");
    register u8 a2 ASM_REG("$6");
    register s32 q_v1 ASM_REG("$3");
    register u16 d_v1 ASM_REG("$3");
