...
void func_81008664(void *_arg0, void *_arg1, void *_arg2, void *volatile arg3) {
    ...
    s16 temp_v0;
    s16 temp_v0_2;
    register s32 temp_v0_3 ASM_REG("$16");
    s16 temp_v0_4;
    s16 temp_v0_8;
    s16 temp_v0_9;
    ...
    s32 temp_v0_6;
    s32 temp_v0_7;
    register s32 temp_selector_v0 ASM_REG("$2");
    register s32 var_s6 ASM_REG("$22");
    u16 temp_v0_5;
    register u32 temp_v1 ASM_REG("$3");
    register u32 temp_angle ASM_REG("$3");
    register u32 temp_flags1 ASM_REG("$2");
    register u32 temp_flags2 ASM_REG("$2");
    register u32 temp_flags16 ASM_REG("$2");
    register u32 temp_mask ASM_REG("$3");
    register u32 temp_rm ASM_REG("$2");
    register u32 temp_arg2_flag ASM_REG("$2");
    register u32 call1_x ASM_REG("$4");
    register u32 call1_y ASM_REG("$5");
    register u32 call2_x ASM_REG("$4");
    register u32 call2_y ASM_REG("$5");
    register s32 temp_divisor ASM_REG("$3");
    register s32 temp_numer1 ASM_REG("$2");
    register s32 temp_numer2 ASM_REG("$2");
    register u8 *temp_table_c0a ASM_REG("$2");
    register u8 *temp_table_c0b ASM_REG("$2");
    register s16 *temp_ptr_c0b ASM_REG("$4");
    register u32 case4_x ASM_REG("$2");
    register u32 case4_y ASM_REG("$2");
    register void *case4_a0 ASM_REG("$4");
    register void *case4_a0b ASM_REG("$4");
    register u32 case4_saved ASM_REG("$2");
    register M2C_UNK *case4_handler ASM_REG("$2");
    register u8 *case4_global ASM_REG("$3");
    register u32 case4_count ASM_REG("$2");
    register u32 case1_v0 ASM_REG("$2");
    register u32 case1_v1 ASM_REG("$3");
    register u32 case1_t0 ASM_REG("$8");
    register s32 case1_a0 ASM_REG("$4");
    register u32 temp_stack14 ASM_REG("$8");
    register u32 temp_stack16 ASM_REG("$8");
    register u8 *case2_state_table ASM_REG("$2");
    register u32 case2_state_idx ASM_REG("$3");
    register u32 case2_y ASM_REG("$8");
    register u8 *case2_step_table ASM_REG("$2");
    register u8 *case2_obj_table ASM_REG("$8");
    register u8 *case2_sp1c ASM_REG("$8");
    register u32 case2_cce8 ASM_REG("$2");
    register u32 case2_sp18 ASM_REG("$8");
    register u32 case2_v1_y ASM_REG("$3");
    register u32 case2_a0_x ASM_REG("$4");
    register void *block_sp10 ASM_REG("$8");
    register s32 block_v0 ASM_REG("$2");
    u8 next_state;
    u8 *temp_table;
    u8 *temp_table2;
    register u8 *temp_callback ASM_REG("$5");
    register u32 temp_cb_idx1 ASM_REG("$2");
    register u32 temp_cb_idx2 ASM_REG("$2");
    register u32 temp_cb_idx3 ASM_REG("$2");
    register u32 temp_cb_idx4 ASM_REG("$2");
    s16 *temp_global16;
    void *temp_a0_2;
    register void *temp_sp10 ASM_REG("$8");
    register void *temp_arg3_1 ASM_REG("$8");
    register void *temp_arg3_2 ASM_REG("$8");
    register void *temp_arg3_3 ASM_REG("$8");
    register void *temp_arg3_4 ASM_REG("$8");
    register void *temp_arg3_5 ASM_REG("$8");
    register void *temp_arg3_6 ASM_REG("$8");
    register void *temp_arg3_7 ASM_REG("$8");
    register void *temp_arg3_8 ASM_REG("$8");
    register void *temp_arg3_9 ASM_REG("$8");
    register void *temp_arg3_10 ASM_REG("$8");
    register void *temp_arg3_11 ASM_REG("$8");
    register void *temp_arg3_12 ASM_REG("$8");
    register void *temp_arg3_13 ASM_REG("$8");
    register void *temp_s1 ASM_REG("$17");
    register void *temp_s4 ASM_REG("$20");
    register void *temp_s5 ASM_REG("$21");
    register void *arg0 ASM_REG("$18") = _arg0;
    register void *arg1 ASM_REG("$23") = _arg1;
...
block_19:
    ...
    ASM_KEEP_NV(temp_table_c0b);
    temp_ptr_c0b = (s16 *) (temp_a0 + (u32) temp_table_c0b);
    ASM_KEEP_NV(temp_ptr_c0b);
    temp_numer2 = *temp_ptr_c0b;
    ASM_KEEP_NV(temp_numer2);
    temp_numer2 <<= 0x16;
    ...
    {
        register u32 case0_zero ASM_REG("$6");
        ...
        ASM_KEEP_NV(temp_arg3_3);
        ASM_KEEP_NV(temp_cb_idx1);
...
block_22:
    ...
    {
        register s32 case1_state ASM_REG("$2");
        case1_state = 0x10;
    ...
    ASM_KEEP_NV(temp_arg3_5);
    ASM_KEEP_NV(temp_cb_idx2);
...
block_50:
    ...
    {
        register s32 case3_v0 ASM_REG("$2");
        register u32 case3_v1 ASM_REG("$3");
        register s32 case3_a0 ASM_REG("$4");
        register u32 case3_t0 ASM_REG("$8");

        ASM_SCHED_BARRIER();
        case3_v1 = M2C_FIELD(temp_arg3_10, u16 *, 0x2A);
        ASM_KEEP_NV(case3_v1);
        case3_v0 = 8;
        ASM_KEEP_NV(case3_v0);
        M2C_FIELD(arg1, s32 *, 0x14) = 0;
...
block_54:
    ...
    temp_arg3_11 = arg3;
    ASM_KEEP_NV(temp_arg3_11);
    {
        register u32 case4_flags ASM_REG("$2");
        register u32 case4_mask ASM_REG("$3");
        register u32 case4_call_x ASM_REG("$4");
        register u32 case4_call_y ASM_REG("$5");

        ASM_SCHED_BARRIER();
        case4_flags = M2C_FIELD(temp_arg3_11, s32 *, 0x1C);
        ASM_KEEP_NV(case4_flags);
        case4_mask = 0x40000;
        ASM_KEEP_NV(case4_mask);
