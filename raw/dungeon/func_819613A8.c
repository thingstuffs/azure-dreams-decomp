...
void func_819613A8(s16 arg0, s32 arg1, void *arg2) {
    ...
    register s32 temp_sum ASM_REG("$2");
    register s32 temp_t5 ASM_REG("$13");
    register s32 temp_t6 ASM_REG("$14");
    register s32 temp_t7 ASM_REG("$15");
    register u16 temp_s4 ASM_REG("$20");
    register s32 temp_tail ASM_REG("$2");
    register TempObj *temp_arg0 ASM_REG("$4");
    register void *temp_init ASM_REG("$2");
    register s8 *temp_base ASM_REG("$2");
    register void *temp_a2 ASM_REG("$6");
    register s16 *temp_t3 ASM_REG("$11");
    register s32 temp_t4 ASM_REG("$12");
    register TempObj *temp_v0 ASM_REG("$17");
    ...
    if (temp_v0 != NULL) {
        ...
        temp_t7 = ((s16 *)arg2)[5];
        ASM_KEEP4(temp_v1, temp_a0, temp_sum, temp_t4);
        ASM_KEEP4(temp_t5, temp_t6, temp_t7, temp_a2);
        temp_v1 += temp_t2;
        temp_a0 += temp_t0;
        temp_sum += temp_t4;
        temp_sum += temp_t5;
        ...
        temp_v0_2 = ((u16) M2C_FIELD(arg2, s16 *, 2) + temp_t2) - 0x20;
        ((TempOutput *)temp_a2)->field20 = temp_v0_2;
        ((TempOutput *)temp_a2)->field10 = temp_v0_2;
        temp_v0_3 = ((u16) M2C_FIELD(arg2, s16 *, 2) + ((temp_t1 - 2) << 6)) - 0x20;
        ((TempOutput *)temp_a2)->field28 = temp_v0_3;
        ((TempOutput *)temp_a2)->field18 = temp_v0_3;
        temp_v0_4 = ((u16) M2C_FIELD(arg2, s16 *, 6) + temp_t0) - 0x20;
        ((TempOutput *)temp_a2)->field1A = temp_v0_4;
        ((TempOutput *)temp_a2)->field12 = temp_v0_4;
        temp_a1 = (temp_a1 - 2) << 6;
        temp_v0_5 = ((u16) M2C_FIELD(arg2, s16 *, 6) + temp_a1) - 0x20;
        ((TempOutput *)temp_a2)->field2A = temp_v0_5;
        ((TempOutput *)temp_a2)->field22 = temp_v0_5;
        ((TempOutput *)temp_a2)->field14 = (s16) ((u16) M2C_FIELD(arg2, s16 *, 0xA) + (u16) temp_t3[0]);
        ASM_MEM_BARRIER();
        ((TempOutput *)temp_a2)->field1C = (s16) ((u16) M2C_FIELD(arg2, s16 *, 0xA) + (u16) temp_t3[1]);
        temp_s0 -= 0x80;
        ASM_KEEP(temp_s0);
        ASM_MEM_BARRIER();
        temp_sum = (u16) M2C_FIELD(arg2, s16 *, 0xA);
