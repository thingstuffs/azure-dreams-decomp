...
state_zero:
    ...
    FIELD(arg2, u8 *, 0x2C) = D_8016EED0;
    func_80047784(
        arg2,
        D_8016EED0[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
...
state_two:
    if (FIELD(arg3, u32, 0x1C) & 0x08000000) {
        ...
        FIELD(arg2, u8 *, 0x2C) = D_8016EED8;
        func_80047784(
            arg2,
            D_8016EED8[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u8, 0x9B)++;
    }
    goto update_countdown;
...
update_countdown:
    ...
    if ((func_800AD9B4(arg2, arg3) << 16) > 0) {
        FIELD(arg0, s32 *, 0x8C) = &D_8016BCE8;
        func_800A9A04(arg3);
    }
}
