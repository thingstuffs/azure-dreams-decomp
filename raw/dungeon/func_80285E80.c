...
s32 func_80018E80(void)
{
    ...
    s32 encounter;
    s16 *floor_base;
    register DungeonPage80285E80 *final_page ASM_REG("$2");
    register s32 final_floor ASM_REG("$3");
...
third_pair:
            {
            s32 value;
            register s32 level ASM_REG("$7");
            s32 randbit;
            register s32 i ASM_REG("$4");
            u8 *left;
            u8 *right;
            register s32 scratch ASM_REG("$3");
            register DungeonState80285E80 *dungeon ASM_REG("$8");
