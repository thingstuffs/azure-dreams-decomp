...
s32 func_800248C8(void *arg0)
{
    ...
    FIELD(scratch, u16, 0x64) = FIELD(arg, u16, 0x1A);
    FIELD(scratch, u16, 0x66) = FIELD(arg, u16, 0x1E);
    FIELD(scratch, u16, 0x68) = FIELD(arg, u16, 0x22);
    FIELD(scratch, u16, 0x6C) = FIELD(arg, u16, 0x32);
    FIELD(scratch, u16, 0x6E) = FIELD(arg, u16, 0x36);
    FIELD(scratch, u16, 0x70) = FIELD(arg, u16, 0x3A);
