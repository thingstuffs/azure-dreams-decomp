...
s32 func_800AA6B4(void *arg0, M2C_UNK arg1, void *arg2, s32 arg3) {
    if (M2C_FIELD(arg0, s16 *, 0x64) > 0) {
    ...
    if (arg3 != 0) {
        if (!(M2C_FIELD(arg0, s32 *, 0x1C) & 0x20)) {
            M2C_FIELD(arg2, s32 *, 0x2C) = arg3;
            func_80047784(arg2, *((u8 *) arg3 + (((s32) (D_80083228[0] + M2C_FIELD(arg0, s16 *, 0x2A) + 0x100) >> 9) & 7)), 0);
        }
    }
    return 1;
}
