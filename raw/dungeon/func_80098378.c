...
void func_8009DAD8(s32 arg0) {
    ...
    s32 mode;
    u8 *playerLater;
    register long a0Value ASM_REG("$4");
    register s32 firstY ASM_REG("$5");
    register u8 *firstColour ASM_REG("$6");
    register s32 firstContext ASM_REG("$7");
    register s32 distance ASM_REG("$2");
    register long pageOrTwo ASM_REG("$20");
    register long callPage ASM_REG("$8");
    register long flagsPage ASM_REG("$16");
    register long loopFlagsPage ASM_REG("$22");
