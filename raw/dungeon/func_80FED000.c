...
void *BODY_NAME(s32 arg0, s8 arg1, s8 arg2, s16 arg3) {
    ...
    s32 sp28;
    s32 temp_v1;
    register s32 call_count ASM_REG("$4");
    register void *call_target ASM_REG("$5");
    register void *check_obj ASM_REG("$4");
    register s8 saved_arg1 ASM_REG("$22");
    register s16 saved_arg3 ASM_REG("$18");
    register s8 saved_arg2 ASM_REG("$21");
    register DungeonSub2 *temp_s2 ASM_REG("$18");
    register void *temp_s4 ASM_REG("$20");
    register DungeonNode *temp_v0 ASM_REG("$17");
    register DungeonSub1 *var_s0 ASM_REG("$16");
    register DungeonSub1 *temp_s5 ASM_REG("$21");
    register void *arg0_alias ASM_REG("$19");
    register DungeonArgBits temp_s7 ASM_REG("$23");
    register s32 temp_flag0 ASM_REG("$2");
    register s32 temp_flag1 ASM_REG("$3");
    register s32 temp_mask ASM_REG("$2");
    ...
    saved_arg3 = arg3;
    saved_arg2 = arg2;
    ASM_KEEP_DEP_NV(saved_arg1, call_count);
    ASM_KEEP_DEP_NV(saved_arg3, call_target);
    ASM_KEEP_DEP_NV(saved_arg2, call_target);
