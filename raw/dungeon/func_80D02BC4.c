...
jt_c1:
    ...
    case 13:
        FIELD(arg2, u8 *, 0x2C) = D_8015DDDC;
        func_80047784(arg2,
            D_8015DDDC[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 14:
        FIELD(arg2, u8 *, 0x2C) = D_8015DDE4;
        func_80047784(arg2,
            D_8015DDE4[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 15:
        FIELD(arg2, u8 *, 0x2C) = D_8015DDEC;
        func_80047784(arg2,
            D_8015DDEC[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
