...
s32 func_80174B98(void *arg0, void *arg1, void *arg2)
{
  ...
  s32 xb;
  s32 yb;
  register s32 r20 ASM_REG("$20");
  s32 limit;
  register s32 tile_w;
  register s32 tag_mask ASM_REG("$23");
      ...
      do
      {
        ...
        if (limit >= i)
        {
          ...
          do
          {
            ...
            sh4 = sc.outer << 2;
            itmp = r20 + 80;
            ASM_USE2_NV(r20, itmp);
            ASM_KEEP4_NV(sh4, sh4, sh4, sh4);
            r20 = itmp + sh4;
            base = *((u8 **) gp);
            p16 = *((u8 **) (base + 0x8D0));
