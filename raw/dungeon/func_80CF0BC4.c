...
jt_c1:
    ...
    case 13:
        FIELD(arg2, u8 *, 0x2C) = D_8016FDDC;
        func_80047784(arg2,
            D_8016FDDC[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 14:
        FIELD(arg2, u8 *, 0x2C) = D_8016FDE4;
        func_80047784(arg2,
            D_8016FDE4[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 15:
        FIELD(arg2, u8 *, 0x2C) = D_8016FDEC;
        func_80047784(arg2,
            D_8016FDEC[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
