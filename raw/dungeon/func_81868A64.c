...
void func_81868A64(s32 arg0, void *arg1, s8 arg2) {
    void *temp_s0;
    void *temp_s0_2;
    void *temp_v0;
    ...
    if (temp_v0 != NULL) {
        ...
        M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_8002418C;
        M2C_FIELD(temp_v0, s32 *, 0x20) = arg0;
        M2C_FIELD(temp_s0, s8 *, 0xE) = arg2;
        M2C_FIELD(temp_s0, s8 *, 0xD) = arg2;
        M2C_FIELD(temp_s0, s8 *, 0xC) = arg2;
        ...
        M2C_FIELD(temp_s0_2, s16 *, 0xA) = (s16) ((M2C_FIELD(arg1, u16 *, 0xA) + (rand() % 17)) - 8);
    }
}
