...
s32 func_8009074C(s16 arg0, u16 *arg1, u16 *arg2) {
    ...
    s32 var_v0_5;
    register s32 var_v0_6 ASM_REG("$2");
    register u16 temp_a2 ASM_REG("$6");
    register u16 temp_v1 ASM_REG("$3");
    u16 var_v0;
    register u16 normalized ASM_REG("$2");
    u32 global_value;
    u32 temp_v0;
...
jt_c2:
    ...
    }
    {
        ...
        register s32 tail_a3 ASM_REG("$7");
...
block_27:
    ...
    {
        register u16 wrap_hi ASM_REG("$3");
        register u16 wrap_lo ASM_REG("$2");
