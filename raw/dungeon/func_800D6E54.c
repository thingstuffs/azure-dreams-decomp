...
void func_800DC5B4(void *arg0) {
    u8 temp_a0;
    void **state;

    state = (void **)&D_800814A8;
    temp_a0 = M2C_FIELD(*state, u8 *, 0x11);
    if (temp_a0 != M2C_FIELD(arg0, s32 *, 0x30)) {
        func_800DBD5C(temp_a0, M2C_FIELD(arg0, s32 *, 0x30), 2, 0x18A, 0x190, 0);
        M2C_FIELD(arg0, s32 *, 0x30) = M2C_FIELD(*state, u8 *, 0x11);
    }
}
