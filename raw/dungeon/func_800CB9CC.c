...
s32 func_800D112C(s16 arg0, s32 arg1, s32 arg2) {
    ...
    register u8 *x_base ASM_REG("$2");
    register u16 *x_step ASM_REG("$9");
    u8 *bounds;
    s16 x_acc;
    s16 y_acc;
    s16 x;
    ...
    {
        register u8 *y_base ASM_REG("$2");
        register u16 *y_step ASM_REG("$2");
    ...
    do {
        ...
        {
            register u16 *loop_x_step ASM_REG("$10");
        ...
        {
            register u8 *loop_y_base ASM_REG("$2");
            register s32 loop_byte_offset ASM_REG("$10");
            register u16 *loop_y_step ASM_REG("$2");
