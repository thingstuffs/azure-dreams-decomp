 ...
 */
void func_80026404(s32 arg0, s32 arg1) {
    register s32 b ASM_REG("$16") = arg1;
    if (func_8009D218(arg0, 4) == 0) {
        register s32 c ASM_REG("$6") = (u32)(b & 0xFF) >> 2;
        if ((func_800A48F0(arg0, 0x17, c + 2) << 16) != 0) {
            func_80099844(arg0, D_800E1D28);
        }
    }
}
