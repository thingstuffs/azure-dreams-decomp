...
void func_80093D8C(s32 arg0, void *arg1, void *arg2) {
    void *temp_a0;
    void *temp_v0;
    void *temp_v1;
    ...
    if (temp_v0 != NULL) {
        ...
        M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_80093A94;
        ...
        M2C_FIELD(temp_a0, s32 *, 0x28) = (s32) M2C_FIELD(arg2, s32 *, 0x28);
        M2C_FIELD(temp_a0, s16 *, 0x1E) = 0x1000;
        M2C_FIELD(temp_a0, u16 *, 0x14) = 0xCU;
        M2C_FIELD(temp_a0, s16 *, 0x10) = 0x20;
        M2C_FIELD(temp_a0, s32 *, 0xC) = 0xF8F8F8;
        M2C_FIELD(temp_a0, s16 *, 0x1C) = 0;
        M2C_FIELD(temp_a0, s16 *, 6) = 4;
        M2C_FIELD(temp_a0, u16 *, 0x14) = (u16) (M2C_FIELD(temp_a0, u16 *, 0x14) | 0x200);
        func_80048A44(temp_a0, 0xD0, 0, 2);
        func_8004491C(temp_v0, &D_80045340);
        M2C_FIELD(temp_v0, void **, 0x20) = arg2;
        M2C_FIELD(temp_v0, s16 *, 0x26) = 0x10;
    }
}
