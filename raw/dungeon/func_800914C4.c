...
void func_80096C24(void *obj, s32 arg1, void *actor, void *map)
{
    register u8 *globals;
    register s16 kind;
    register s32 result ASM_REG("$21");
    register u16 *state;
    register u16 *state2;
    register u8 *state_base;
    register u8 *handler;
    register s32 n;
    register void *tail_obj ASM_REG("$4");
    ...
    {
        register u8 *adjust_base ASM_REG("$3");
        s32 index;
    ...
    {
        s16 kind;
        register u8 *late_handler ASM_REG("$5");
    ...
    {
        register void *call_map ASM_REG("$4");
...
after_positive_9701C:
    ...
    register u8 *nonpositive_handler ASM_REG("$3");
    register s32 map_flags ASM_REG("$2");
