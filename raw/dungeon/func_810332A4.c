...
void func_80174AA4(void *arg0, void *arg1, void *arg2)
{
    ...
    void *object;
    void *new_object;
    register void *display ASM_REG("$16");
    register void *transform ASM_REG("$18");
    s32 blocked;
    s32 mask;
    register s32 xshift ASM_REG("$2");
    s32 xwork;
    s32 mask1;
    s32 nsum;
    register s32 early_blocked ASM_REG("$4");
    register s32 axt ASM_REG("$5");
    ...
    s32 ax;
    s32 ay;
    register s32 x1 ASM_REG("$5");
    register s32 sound ASM_REG("$3");
    s32 value0;
    s32 value11;
    u16 timer;
    void *held_arg0;
...
state_2:
    ...
    ASM_KEEP_DEP_NV(xshift, nsum);
    ASM_KEEP_DEP_NV(xshift, early_blocked);
    nsum += early_blocked;
...
checks_done:
    if (FIELD(arg0, s16, 0x26) == 1) {
        ...
        mask1 = 0xFFEFFFFF;
        ASM_KEEP4_NV(mask1, mask1, mask1, mask1);
...
object_common:
    ...
    ASM_KEEP_DEP_NV(early_blocked, xshift);
    early_blocked <<= 6;
    ASM_KEEP_NV(early_blocked);
    sound += xshift;
