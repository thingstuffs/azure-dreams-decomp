...
DungeonObject *func_800C7380(s16 arg0, s32 arg1, u16 arg2, s32 arg3, s32 arg4) {
    DungeonHomes homes;
    s32 color;
    register DungeonObject *temp_s4 ASM_REG("$20");
    DungeonObject *temp_v0;
    DungeonState *var_s2;
    register DungeonCoord *temp_s3 ASM_REG("$19");
    ...
    s32 var_fp;
    s32 var_s6;
    register u16 held_arg2 ASM_REG("$16");
    register u32 temp_t0 ASM_REG("$8");
    ...
    if (temp_s4 != NULL) {
        s16 var_s5;
        register u16 limit_v0 ASM_REG("$2");
        ASM_KEEP_NV(temp_s4);
        ...
        do {
            ...
            if (temp_v0 != NULL) {
                register DungeonObject *call_a0 ASM_REG("$4");
