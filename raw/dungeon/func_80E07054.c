...
{
    register s32 v_s2 ASM_REG("$18") = arg0;
    register u8 *v_s0 ASM_REG("$16") = 0;
    register s32 v_s5 ASM_REG("$21") = arg1;
    register long v_s1 ASM_REG("$17");
    register long v_s4 ASM_REG("$20");
    register u8 *v_s3 ASM_REG("$19");
    register u8 *v_s6 ASM_REG("$22");
    register s32 v_s7 ASM_REG("$23");
    register s32 alloc_kind ASM_REG("$4");
    register u8 *alloc_data ASM_REG("$5");
    ...
    v_s1 = arg3;
    ASM_KEEP_DEP_NV(v_s1, alloc_data);
    v_s4 = arg2;
    ASM_KEEP_DEP_NV(v_s4, alloc_data);
