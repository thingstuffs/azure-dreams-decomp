...
void *func_80171780(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    s32 kind;
    void *obj;
    void *part_a;
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        FIELD(obj, void *, 0x10) = D_80171964;
        FIELD(work, s8, 0x13) = 0x19;
        ...
        actor = work;
        FIELD(part_b, void *, 0x2C) = D_800E2348;
        FIELD(part_b, s8, 0x24) = saved_arg1;
        FIELD(work, s16, 0x9E) = 0;
...
normal_kind:
        ...
        if (((arg0 & ~3) << 16) == 0) {
            if (!(FIELD(work, s32, 0x14) & 0x200)) {
                ...
                FIELD(part_b, void *, 0x2C) = D_800E23A8;
                goto post_kind;
            }
        }
        goto call_a1_setup;
...
call_a1_setup:
        ...
        FIELD(actor, void *, 0x8C) = &D_80171F1C;
        FIELD(work, s32, 0x1C) |= 0x40000;
        FIELD(actor, s16, 0x92) = -0x20;
