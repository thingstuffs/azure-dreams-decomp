...
{
    register s32 kind ASM_REG("$22");
    register s16 result ASM_REG("$20");
    register s32 best_score ASM_REG("$19");
    register s32 best_value ASM_REG("$21");
    register s32 count ASM_REG("$18");
    register u8 *item_data ASM_REG("$23");
    register s16 index ASM_REG("$17");
    register s32 value ASM_REG("$16");
    register u16 raw_index ASM_REG("$3");
    register u32 item_page ASM_REG("$2");
    register s32 loop_index ASM_REG("$2");
    register s32 tripled_index ASM_REG("$3");
    register u8 item ASM_REG("$2");
    register s32 item_offset ASM_REG("$3");
