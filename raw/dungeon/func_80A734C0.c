...
void func_80172CC0(void *arg0, void *arg1, void *arg2, void *arg3) {
    ...
    case 0:
        ...
        if (FIELD(entity, u32, 0x1C) & 0x2000) {
            u32 kind = (FIELD(entity, u16, 0x46) & 0x3FFF) - 1;
            if (kind >= 7) {
                goto item_none;
            }
            (void)jt_keep;
...
item_8:
        ...
        {
            s32 kind = FIELD(entity, u16, 0x46) & 0x3FFF;
            if (kind == 2) {
                goto item_b_value;
            }
            if (kind < 3) {
...
copy_existing:
                    {
                        ...
                        ASM_KEEP(owner);
                        FIELD(entity, u8, 0x72) = FIELD(owner, u8, 0x24);
                        FIELD(entity, u8, 0x73) = FIELD(owner, u8, 0x25);
                    }
                    goto object_ready;
                }
            } else {
                ...
                node = func_800A05A4(
                    ...
                    FIELD(arg2, u8, 0x24),
                    FIELD(arg2, u8, 0x25),
                    FIELD(entity, s16, 0x2A),
                    0x10);
                FIELD(entity, void * volatile, 0x60) = node;
                ASM_KEEP(node);
                x = FIELD(entity, s8, 0x72);
                y = FIELD(entity, s8, 0x73);
                if (x < 0) {
                    x = -x;
                }
                if (y < 0) {
                ...
                FIELD(entity, s8, 0x72) = x;
                FIELD(entity, s8, 0x73) = y;
            }
        }
...
no_item:
        ...
        FIELD(entity, u8, 0x73) = 0;
        FIELD(entity, u8, 0x72) = 0;
    ...
    case 2:
        ...
        FIELD(arg2, void *, 0x2C) = D_80174180;
        func_80047784(
            arg2,
            D_80174180[((D_80083228 + FIELD(entity, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u16, 0xA8) = 0x10;
        FIELD(arg0, u8, 0x9B)++;
        goto end;

    case 3:
        {
            s16 timer = FIELD(arg0, u16, 0xA8) - 1;
        ...
        if (FIELD(arg2, void *, 0x2C) != D_80174148) {
            FIELD(arg2, void *, 0x2C) = D_80174148;
            func_80047784(
                arg2,
                D_80174148[((D_80083228 + FIELD(entity, s16, 0x2A) + 0x100) >> 9) & 7],
                0);
        }
