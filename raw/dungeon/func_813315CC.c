...
void func_801685CC(void *arg0, void *arg1, s32 arg2, s32 arg3, u16 arg4)
{
    ...
    register u8 *part ASM_REG("$16");
    register void *render ASM_REG("$7");
    register void *dest ASM_REG("$3");
    s32 mode;
    register s32 neg_one ASM_REG("$3");
    register u32 sixty ASM_REG("$4");
    register void *callback_obj ASM_REG("$4");
    register s32 table_offset ASM_REG("$5");
    register u8 *position_base ASM_REG("$6");
    register s32 table_index ASM_REG("$2");
    register void *callback_data ASM_REG("$5");
    register s32 third_direction ASM_REG("$3");
    register void *db_render ASM_REG("$4");
    register void *db_data ASM_REG("$5");
    u8 *copy_src_init;
    ...
    u8 *var_t1;
    u8 *out_base;
    register s32 out_index ASM_REG("$2");
