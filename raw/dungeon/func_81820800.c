...
BODY_STORAGE void BODY_NAME(void *arg0, void *arg1, void *arg2) {
    ...
    void *state_obj;
    void *owner;
    register void *input2 ASM_REG("$16");
    ...
    s32 temp_v1;
    s16 var_s4;
    register M2C_UNK temp_a0 ASM_REG("$4");
    u16 header_raw;
    u16 duration;
    u16 temp_s0;
    u16 temp_s1;
