...
void *BODY_NAME(s32 arg0, s8 arg1, s8 arg2, s16 arg3) {
    ...
    if (obj != NULL) {
        ...
        ASM_SCHED_BARRIER();
        work = obj + 0x20;
        M2C_FIELD(obj, M2C_UNK **, 0x10) = &D_8014CA78;
        ...
        actor = work;
        M2C_FIELD(part_b, M2C_UNK **, 0x2C) = &D_80150880;
        ...
        if (((arg0 & ~3) << 16) == 0) {
            if (!(M2C_FIELD(work, s32 *, 0x14) & 0x200)) {
                ...
                if (!(left & 1)) {
                    ...
                    M2C_FIELD(part_b, M2C_UNK **, 0x2C) = &D_801508E0;
            }
        }
post_kind:
        ...
        M2C_FIELD(actor, M2C_UNK **, 0x8C) = &D_8014D058;
