...
s32 func_8009D218(void *arg0, s32 arg1, void *arg2) {
    u8 *temp_v0;

    if (!(arg1 & 8) && (arg2 != NULL)) {
        if (arg1 & 1) {
            if (((func_80042900(arg0, 0x16) << 0x10) != 0) && (M2C_FIELD(arg2, s8 *, 0x13) >= 0)) {
        ...
        if (arg1 & 2) {
            if ((((func_80042900(arg0, 0x16) << 0x10) != 0) || ((func_80042900(arg0, 0x17) << 0x10) != 0)) && (M2C_FIELD(arg2, s8 *, 0x13) >= 0)) {
                return func_8009D34C();
            }
            goto block_17;
        }
        if (!(arg1 & 4) || (((func_80042900(arg0, 0x16) << 0x10) == 0) && ((func_80042900(arg0, 0x15) << 0x10) == 0)) || (M2C_FIELD(arg2, s8 *, 0x13) < 0)) {
block_17:
            if (arg2 != NULL) {
                temp_v0 = M2C_FIELD(arg0, u8 **, 0x50);
                if (temp_v0 != NULL) {
                    if ((*temp_v0 == 3) && (M2C_FIELD(arg2, s8 *, 0x13) >= 0) && (func_800A6D30() & 3)) {
                        /* Duplicate return node #22. Try simplifying control flow for better match */
                        func_800CB82C(M2C_FIELD(arg0, s32 *, -0x18), arg0, arg2);
                        func_8009D368();
                        return 1;
                    }
