...
void func_800B6AC4(void *arg0, void *arg1, void *arg2, void *arg3) {
    ...
    s32 saved_word;
    s32 var_v0;
    register s32 var_v0_test ASM_REG("$2");
    s32 var_v0_2;
    s32 temp_v0_11;
    u8 temp_v0_4;
    u16 temp_v0;
    ...
    u8 *var_v0_3;
    u8 temp_v1;
    register u8 next_state ASM_REG("$2");
    void *temp_a0_2;
    void *temp_a0_4;
    void *temp_a0_5;
    void *temp_a0_6;
    ...
    void *temp_v1_6;
    void *temp_v1_7;
    register void *temp_v1_8 ASM_REG("$3");
...
jt_c0: {
    register u8 *case0_page ASM_REG("$2");
    case0_page = (u8 *)0x80080000;
    ASM_KEEP_NV(case0_page);
...
block_10: {
    register u8 *ptr ASM_REG("$2");
    register u8 *saved ASM_REG("$3");
