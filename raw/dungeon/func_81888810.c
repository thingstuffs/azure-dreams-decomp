...
extern void func_80026264() __attribute__((noreturn));
...
void func_80026010(void) {
    Cell *base;
    register Cell *current ASM_REG("$23");
    Cell *p1;
    Cell *p2;
    Cell *p4;
    void *obj;
    register void *motion ASM_REG("$16");
    void *angles;
    void *dst;
    s32 i;
    s32 block;
    ...
    s32 byte_offset;
    register s32 y1 ASM_REG("$5");
    register s32 y2 ASM_REG("$6");
    register s32 y3 ASM_REG("$7");
    register s32 value ASM_REG("$4");
    register s32 z1 ASM_REG("$8");
    register s32 z2 ASM_REG("$9");
    register s32 z3 ASM_REG("$10");
