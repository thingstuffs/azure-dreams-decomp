...
{
    register s32 mode_arg ASM_REG("$18") = arg0;
    register u8 byte_arg1 ASM_REG("$21") = arg1;
    register s16 half_arg3 ASM_REG("$17") = arg3;
    register u8 byte_arg2 ASM_REG("$20") = arg2;
    u8 *result;
    u8 *allocation;
    register u8 *part_a ASM_REG("$22");
    u8 *part_b;
    u8 *secondary;
    s16 saved_arg0;

    ASM_KEEP_NV(mode_arg);
    result = 0;
