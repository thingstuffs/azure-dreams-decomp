...
void func_801713A8(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    if (FIELD(arg3, u8, 0x25) == 0) {
        ...
        if (FIELD(arg2, u8 *, 0x2C) == D_801744FC) {
            return;
        }
        FIELD(arg2, u8 *, 0x2C) = D_801744EC;
        func_80047784(
            arg2,
            D_801744EC[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        return;
    }
    ...
    if ((D_80083462 & 0x2000) == 0) {
        ...
        if ((FIELD(arg2, u8 *, 0x2C) != D_80174494) &&
            (FIELD(arg2, u8 *, 0x2C) != D_8017449C)) {
            FIELD(arg0, s16, 0xA8) = 0;
            FIELD(arg2, u8 *, 0x2C) = D_8017449C;
            func_80047784(
                arg2,
                D_8017449C[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
                FIELD(arg0, s16, 0xA8));
        }
...
case_7:
        {
            ...
            owner = D_800814A8;
            FIELD(arg3, s16, 0x2A) = new_distance;
...
case_default:
    ...
    if ((s16)func_8009FD7C(
            FIELD(arg2, u8, 0x24), FIELD(arg2, u8, 0x25),
            FIELD(map_base, u8, 0x24), FIELD(map_base, u8, 0x25)) == 0) {
        return;
    }
    FIELD(arg3, s16, 0x2A) = func_800A0818(
        FIELD(arg2, u8, 0x24), FIELD(arg2, u8, 0x25),
        FIELD(map_base, u8, 0x24), FIELD(map_base, u8, 0x25), &distance);
}
