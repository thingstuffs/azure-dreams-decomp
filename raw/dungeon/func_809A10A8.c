...
extern void func_80172DB4(void) __attribute__((noreturn));
...
L1:
    ...
    FIELD(arg2, u8 *, 0x2C) = D_80175E58;
    func_80047784(arg2,
        D_80175E58[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
...
L2:
    ...
    FIELD(arg2, u8 *, 0x2C) = D_80175E60;
    func_80047784(arg2,
        D_80175E60[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
    func_800A56E0(0x808);
    FIELD(arg0, u8, 0x9B)++;
    func_80172DB4();
...
L3:
    {
        ...
        FIELD(arg2, u8 *, 0x2C) = D_80175E68;
        func_80047784(arg2,
            D_80175E68[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
...
L4:
    ...
    FIELD(arg0, s32 *, 0x8C) = &D_801710EC;
    D_8008346C = 0;
