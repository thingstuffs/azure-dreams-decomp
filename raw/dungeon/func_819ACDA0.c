...
initialize:
    ...
    base.y = origin->y;
    entity = D_800E3D7C;
    base.z = FIELD(entity, u16, 0x88) - 0x50;
    index =
...
update_position:
        ...
        final_state = FIELD(motion, volatile u16, 0x2C);
        {
            register u16 five ASM_REG("$3");
