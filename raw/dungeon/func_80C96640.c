...
void func_80173E40(void *arg0, void *arg1, void *arg2, s16 arg3)
{
...

    {
        ...
        FIELD(state, u8 *, 0x8D0) = packet + 0x24;
    }

    FIELD(scratch, u16, 0xB0) = FIELD(arg0, u16, 0x44);
    FIELD(scratch, u16, 0xB8) = FIELD(arg0, u16, 0x4A);
    FIELD(scratch, u16, 0xC0) = FIELD(arg0, u16, 0x50);
    FIELD(scratch, u16, 0xC8) = FIELD(arg0, u16, 0x56);
    FIELD(scratch, u16, 0xB2) = FIELD(arg0, u16, 0x46);
    FIELD(scratch, u16, 0xBA) = FIELD(arg0, u16, 0x4C);
    FIELD(scratch, u16, 0xC2) = FIELD(arg0, u16, 0x52);
    FIELD(scratch, u16, 0xCA) = FIELD(arg0, u16, 0x58);
    FIELD(scratch, u16, 0xB4) = FIELD(arg0, u16, 0x48);
    FIELD(scratch, u16, 0xBC) = FIELD(arg0, u16, 0x4E);
    FIELD(scratch, u16, 0xC4) = FIELD(arg0, u16, 0x54);
    FIELD(scratch, u16, 0xCC) = FIELD(arg0, u16, 0x5A);
    ...
    if ((u32)index < 0x1E0) {
        if ((((u16)(FIELD(packet, u16, 8) + 0x20) < 0x181) &&
            ...
            FIELD(packet, u32, 0xC) = FIELD(arg0, u32, 8);
            FIELD(packet, u32, 0x14) = FIELD(arg0, u32, 0xC);
            FIELD(packet, u32, 0x1C) = FIELD(arg0, u32, 0x10);
            ...
            packet = FIELD(*(u8 **)global, u8 *, 0x8D0);
            FIELD(*(u8 **)global, u8 *, 0x8D0) = packet + 0xC;
