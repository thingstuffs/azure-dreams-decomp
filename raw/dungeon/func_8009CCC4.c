...
s32 func_800A2424(void *arg0, s32 arg1) {
    ...
    s32 value;
    s32 work;
    register s32 shared_t0 ASM_REG("$8");
    volatile s32 *table;
    ...
    *(s32 *)(s1 + 0x18) = table[s2] - 1;
...

    {
        ...
        register s32 product ASM_REG("$16");
        {
            ...
            register s32 right_byte ASM_REG("$4");
            left_byte = s3[4];
            right_byte = s4[4];
    ...
    {
        register s32 left_byte ASM_REG("$2");
        register s32 right_byte ASM_REG("$5");
        register s32 product ASM_REG("$16");
        s32 left_product;
    ...
    if (s1[0x13] != 0) {
        i = 2;
        {
            register u8 *flags_base ASM_REG("$7");
            u8 *table2;
            register u8 *p ASM_REG("$5");
            register s32 id ASM_REG("$4");
            u8 *flagp;
            flags_base = flags;
            table2 = D_8006DE24;
            ASM_SCHED_BARRIER();
