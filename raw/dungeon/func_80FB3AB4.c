...
void func_801732B4(void *arg0, void *arg1, void *arg2, void *arg3)
{
    s16 timer;
    s32 value;
    s32 *state;
    ...
    case 0:
        func_800AD4D0(arg3);
        FIELD(arg1, s32, 0x0C) = ((s16 *)&D_8006CCD8)[index] << 17;
        FIELD(arg1, s32, 0x10) = ((s16 *)&D_8006CCE8)[index] << 17;
        FIELD(arg0, u8, 0x9B)++;
    ...
    case 1:
        FIELD(arg1, s32, 0x0C) -= ((s16 *)&D_8006CCD8)[index] << 14;
        FIELD(arg1, s32, 0x10) -= ((s16 *)&D_8006CCE8)[index] << 14;
