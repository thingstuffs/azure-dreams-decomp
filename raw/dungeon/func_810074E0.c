...
void func_80172CE0(void *arg0, void *arg1, void *arg2, void *arg3)
{
    s16 timer;
    s32 value;
    s32 *state;
    ...
    case 0:
        ...
        FIELD(arg1, s32, 0x0C) =
            -*(s16 *)(&D_8006CCD8 +
                (((u16)FIELD(arg3, s16, 0x6A) >> 8) & 0xE)) << 15;
        FIELD(arg1, s32, 0x10) =
            -*(s16 *)(&D_8006CCE8 +
                (((u16)FIELD(arg3, s16, 0x6A) >> 8) & 0xE)) << 15;
        FIELD(arg0, u8, 0x9B)++;
    ...
    case 1:
        FIELD(arg1, s32, 0x0C) +=
            *(s16 *)(&D_8006CCD8 +
                (((u16)FIELD(arg3, s16, 0x6A) >> 8) & 0xE)) << 10;
        {
            register s32 offset ASM_REG("$2");

            offset = ((u16)FIELD(arg3, s16, 0x6A) >> 8) & 0xE;
            FIELD(arg1, s32, 0x10) +=
