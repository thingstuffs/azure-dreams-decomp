...
void func_80024078(State *arg0)
{
    ...
    case 0: {
        ...
        object = D_800814A8;
        FIELD(object, void *, 0xF4) = D_800281FC;
        FIELD(object, s16, 0x96) = 0x14;
        FIELD(object, u8, 0xA8) = arg0->field_8;
        ...
        parent = arg0->field_0;
        ASM_KEEP(parent);
        child = func_80024578(FIELD(parent, void *, -0x18));
        arg0->child = child;
        if (child == 0) {
            break;
        }
        ...
        ASM_KEEP(duration);
        {
            register s16 discarded_state ASM_REG("$3");

            discarded_state = FIELD(arg0, volatile s16, 0xA);
            ASM_KEEP(discarded_state);
        }
        phase = -1;
    ...
    case 1:
        if (FIELD(arg0->child, s16, 0x2C) != 1) {
            break;
        }
        arg0->timer_1C = 0x18;
        arg0->state++;
