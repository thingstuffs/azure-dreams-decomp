...
void func_80975244(void *unused, void *arg1, void *arg2, void *arg3) {
    s32 temp_t0;
    void *temp_s0;
    void *temp_v0;
    void *temp_v1;
    ...
    if (temp_v0 != NULL) {
        ...
        M2C_FIELD(temp_v1, s16 *, 0xAA) = 7;
        M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_80170970;
        M2C_FIELD(temp_v1, void **, 0xB0) = arg1;
        ...
        M2C_FIELD(temp_s0, M2C_UNK **, 0x2C) = &D_80174128;
        func_80047784(temp_s0, *((((s32) (*D_80083228 + M2C_FIELD(arg3, s16 *, 0x2A) + 0x100) >> 9) & 7) + D_80174128), 0);
