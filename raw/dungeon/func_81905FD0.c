...
void func_81905FD0(void *in0, void *in1, void *in2)
{
    ...
    register void *arg1 ASM_REG("$18") = in1;
    ...
    s32 state;
    u8 level;
    register u8 *rect_ptr ASM_REG("$20");
    register u8 *copy_base ASM_REG("$2") = D_80024004;

    register void *owner ASM_REG("$23");
    void *base;
    void *initial_source;
    ASM_KEEP(arg0);
    ASM_KEEP(arg2);
    ...
    *(Copy32 *)(local + 24) = *(Copy32 *)D_80024014;
    ...
    case 2:
        ...
        {
            register void *source_coords ASM_REG("$7");
    ...
    case 3: {
        ...
        {
            s16 phase;
            register u8 *scratch_source ASM_REG("$19");

            FIELD(arg0, u16, 0x82) = FIELD(arg0, u16, 0x82) + 1;
            phase = (s16)FIELD(arg0, u16, 0x82);
            if (phase == 1) {
                register s32 mid ASM_REG("$2");
                register void *carry_rect ASM_REG("$5");
                register void *carry_scratch ASM_REG("$6");
                s32 c880;
                s32 c84;
                s32 c832;
        ...
        {
        register void *node1 ASM_REG("$22");
        register void *node2 ASM_REG("$20");
        register void *node3 ASM_REG("$19");
        register void *node4 ASM_REG("$17");
        register void *subnode ASM_REG("$18");
        register void *obj_part ASM_REG("$16");
        void *obj_coords;
        ...
        if (node4 != 0) {
            register void *a0v ASM_REG("$4");
            register void *a1v ASM_REG("$5");
            register void *d408 ASM_REG("$2");
            void *own60;
