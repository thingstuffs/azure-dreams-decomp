...
void func_800B63A8(void *arg0, void *arg1, void *arg2) {
    ...
    M2C_FIELD(arg1, s32 *, 0xC) = (s32) (M2C_FIELD(arg1, s32 *, 0xC) + M2C_FIELD(arg0, s32 *, 0));
    M2C_FIELD(arg1, s32 *, 0x10) = (s32) (M2C_FIELD(arg1, s32 *, 0x10) + M2C_FIELD(arg0, s32 *, 4));
    temp_lo = M2C_FIELD(arg0, s32 *, 8) * M2C_FIELD(arg0, s16 *, 0x10);
    M2C_FIELD(arg1, s32 *, 0x14) = (s32) (M2C_FIELD(arg1, s32 *, 0x14) + temp_lo);
    ...
    M2C_FIELD(arg1, s32 *, 4) = (s32) (M2C_FIELD(arg1, s32 *, 4) + temp_a0);
    M2C_FIELD(arg1, s32 *, 8) = (s32) (M2C_FIELD(arg1, s32 *, 8) + temp_a2);
    func_800478B8(arg2, arg1, temp_a2);
    temp_v1 = M2C_FIELD(arg2, u8 *, 0xC);
    if (temp_v1 != 0) {
        temp_v0 = temp_v1 - M2C_FIELD(arg0, u8 *, 0x14);
        M2C_FIELD(arg2, u8 *, 0xC) = temp_v0;
        if ((u32) (temp_v0 & 0xFF) >= 0x81U) {
            M2C_FIELD(arg2, u8 *, 0xC) = 0x80U;
        }
    }
    temp_v1_2 = M2C_FIELD(arg2, u8 *, 0xD);
    if (temp_v1_2 != 0) {
        temp_v0_2 = temp_v1_2 - M2C_FIELD(arg0, u8 *, 0x16);
        M2C_FIELD(arg2, u8 *, 0xD) = temp_v0_2;
        if ((u32) (temp_v0_2 & 0xFF) >= 0x81U) {
            M2C_FIELD(arg2, u8 *, 0xD) = 0x80U;
        }
    }
    temp_v1_3 = M2C_FIELD(arg2, u8 *, 0xE);
    if (temp_v1_3 != 0) {
        temp_v0_3 = temp_v1_3 - M2C_FIELD(arg0, u8 *, 0x18);
        M2C_FIELD(arg2, u8 *, 0xE) = temp_v0_3;
        if ((u32) (temp_v0_3 & 0xFF) >= 0x81U) {
            M2C_FIELD(arg2, u8 *, 0xE) = 0x80U;
        }
    }
    temp_v0_4 = M2C_FIELD(arg0, u16 *, 0xE) - 1;
