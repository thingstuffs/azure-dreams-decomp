...
void func_800C6B40(s32 arg0, void *arg1, void *arg2, s16 arg3) {
    ...
    register u16 inner_f0 ASM_REG("$3");
    u16 temp_v0_15;
    u32 temp_h12;
    u32 temp_d10a;
    u32 temp_d10b;
    ...
    *(u16 *)(scratch + 0x000) = (u16)M2C_FIELD(arg1, u16 *, 2);
    *(u16 *)(scratch + 0x002) = (u16)M2C_FIELD(arg1, u16 *, 6);
    *(u16 *)(scratch + 0x004) = (u16)M2C_FIELD(arg1, u16 *, 0xA);
    ...
    *(u32 *)(scratch + 0x0C0) = temp_v0_2;
    if (temp_v0_2 < 0x1E0U) {
        ...
        *(u16 *)(scratch + 0x100) = (u16)M2C_FIELD(arg2, u16 *, 0x16);
        *(u16 *)(scratch + 0x104) = (s16)(M2C_FIELD(arg2, u16 *, 0x1A) - (u16)*(u32 *)(scratch + 0x034));
        *(u16 *)(scratch + 0x102) = (s16)((((u16)*(u32 *)(scratch + 0x038) + 0x100) & 0x1FF) + (temp_h18 = (s32)M2C_FIELD(arg2, u16 *, 0x18) - 0x100));
        a0p = scratch + 0x100;
        ASM_CLOBBER("$5");
        ...
        *(u32 *)(scratch + 0x030) = (void *)M2C_FIELD(arg2, u16 *, 0x1C);
        *(u32 *)(scratch + 0x034) = (void *)M2C_FIELD(arg2, u16 *, 0x1E);
        *(u32 *)(scratch + 0x038) = NULL;
        ...
        temp_h14 = M2C_FIELD(arg2, u16 *, 0x14);
        var_s3 = M2C_FIELD(arg2, void **, 8);
        *(u16 *)(scratch + 0x024) = (u16)temp_h14;
        do {
        if (!(M2C_FIELD(var_s3, u8 *, 0) & 0x20)) {
            *(u32 *)(scratch + 0x008) = (s32)M2C_FIELD(var_s3, u8 *, 8);
            *(u32 *)(scratch + 0x00C) = (s32)M2C_FIELD(var_s3, u8 *, 9);
            *(u32 *)(scratch + 0x010) = (s32)M2C_FIELD(var_s3, u8 *, 0xA);
            *(u32 *)(scratch + 0x014) = (s32)M2C_FIELD(var_s3, u8 *, 0xB);
            if ((M2C_FIELD(var_s3, u8 *, 0) ^ (u32)*(u16 *)(scratch + 0x024)) & 1) {
            ...
            *(u16 *)(scratch + 0x078) = temp_v0_7;
            if ((M2C_FIELD(var_s3, u8 *, 0) ^ (u32)*(u16 *)(scratch + 0x024)) & 2) {
        ...
        do {
            ...
            do {
                var_a1_3 = 0;
                M2C_FIELD(var_s0, u16 *, 1) = (u16)(var_s6 >> 0x10);
                M2C_FIELD(var_s0, u16 *, 9) = (u16)((s32)(var_s6 + var_t3) >> 0x10);
                M2C_FIELD(var_s0, u16 *, 0x11) = (u16)(var_s5 >> 0x10);
                M2C_FIELD(var_s0, u16 *, 0x19) = (u16)((s32)(var_s5 + var_t2) >> 0x10);
                M2C_FIELD(var_s0, u16 *, 3) = (u16)(var_s7 >> 0x10);
                M2C_FIELD(var_s0, u16 *, 0xB) = (u16)(var_a3 >> 0x10);
                M2C_FIELD(var_s0, u16 *, 0x13) = (u16)((s32)(var_s7 + var_t4) >> 0x10);
                M2C_FIELD(var_s0, s16 *, 0x1B) = (s16)var_t0;
                if ((u32)((M2C_FIELD(var_s0, u16 *, 1) + 0x20) & 0xFFFF) < 0x181U) {
                    temp_u = (M2C_FIELD(var_s0, u16 *, 3) + 0x20) & 0xFFFF;
                    var_a1_3 = temp_u < 0x121U;
                }
                var_v1 = 0;
                if ((u32)((M2C_FIELD(var_s0, u16 *, 9) + 0x20) & 0xFFFF) < 0x181U) {
                    temp_u = (M2C_FIELD(var_s0, u16 *, 0xB) + 0x20) & 0xFFFF;
                    var_v1 = temp_u < 0x121U;
                }
                var_a0_4 = 0;
                temp_a1 = var_a1_3 | var_v1;
                if ((u32)((M2C_FIELD(var_s0, u16 *, 0x11) + 0x20) & 0xFFFF) < 0x181U) {
                    temp_u = (M2C_FIELD(var_s0, u16 *, 0x13) + 0x20) & 0xFFFF;
                    var_a0_4 = temp_u < 0x121U;
                }
                var_v1_2 = 0;
                temp_a1b = temp_a1 | var_a0_4;
                if ((u32)((M2C_FIELD(var_s0, u16 *, 0x19) + 0x20) & 0xFFFF) < 0x181U) {
                    var_v1_2 = var_t7 < 0x121U;
                }
                if ((temp_a1b | var_v1_2) != 0) {
                    temp_v1_3 = M2C_FIELD(arg2, u8 *, 0xF);
                    ...
                    M2C_FIELD(var_s0, s8 *, 5) = (s8)var_s2;
                    M2C_FIELD(var_s0, s8 *, 6) = (s8)var_s4;
                    M2C_FIELD(var_s0, s8 *, 0xD) = (s8)var_a0_5;
                    M2C_FIELD(var_s0, s8 *, 0xE) = (s8)var_s4;
                    M2C_FIELD(var_s0, s8 *, 0x15) = (s8)var_s2;
                    M2C_FIELD(var_s0, s8 *, 0x16) = (s8)var_v1_3;
                    M2C_FIELD(var_s0, s8 *, 0x1D) = (s8)var_a0_5;
                    M2C_FIELD(var_s0, s8 *, 0x1E) = (s8)var_v1_3;
                    M2C_FIELD(var_s0, s8 *, -4) = 9;
                    temp_h12 = M2C_FIELD(arg2, u16 *, 0x12);
                    M2C_FIELD(arg2, u16 *, 0x14) = (u16)(M2C_FIELD(arg2, u16 *, 0x14) & 0x7FFF);
                    temp_h12 += M2C_FIELD(var_s3, u16 *, 6);
                    M2C_FIELD(var_s0, s16 *, 7) = (s16)temp_h12;
                    if (M2C_FIELD(arg2, u16 *, 0x10) != 0) {
                        temp_v0_15 = M2C_FIELD(arg2, u16 *, 0x10) + (M2C_FIELD(var_s3, u16 *, 4) & 0xFF9F);
                    } else {
                        temp_v0_15 = M2C_FIELD(var_s3, u16 *, 4);
                    }
                    M2C_FIELD(var_s0, u16 *, 0xF) = temp_v0_15;
                    M2C_FIELD(var_s0, s32 *, -3) = (s32)M2C_FIELD(arg2, s32 *, 0xC);
                    M2C_FIELD(var_s0, s8 *, 0) = 0x2C;
                    temp_v1_4 = *(u16 *)(scratch + 0x024);
                    if (temp_v1_4 & 8) {
                        if (!(temp_v1_4 & 4)) {
                            var_v0_2 = 0x2C;
                            M2C_FIELD(var_s0, s8 *, 0) = var_v0_2;
                        } else {
                            var_v0_2 = 0x2E;
                            M2C_FIELD(var_s0, s8 *, 0) = var_v0_2;
                        }
        ...
        temp_v0_16 = (s32 (*)(s32, void *, void *, void *, s32))M2C_FIELD(var_s3, void **, 8);
        if (temp_v0_16 != NULL) {
        ...
        temp_last = (s8)M2C_FIELD(var_s3, u8 *, 0);
        var_s3 += 0xC;
        } while (temp_last >= 0);
        func_80064A40();
    }
