...
void *func_80ABF07C(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    s32 kind;
    void *obj;
    void *part_a;
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        FIELD(obj, void *, 0x10) = D_8014CA50;
        ...
        actor = work;
        FIELD(part_b, void *, 0x2C) = D_80150C3C;
...
normal_kind:
        ...
        if (((arg0 & ~3) << 16) == 0) {
            if (!(FIELD(work, s32, 0x14) & 0x200)) {
                ...
                FIELD(part_b, void *, 0x2C) = D_80150C8C;
                goto post_kind;
            }
        }
        goto call_a1_setup;
...
call_a1_setup:
        ...
        FIELD(actor, void *, 0x8C) = &D_8014CE7C;
