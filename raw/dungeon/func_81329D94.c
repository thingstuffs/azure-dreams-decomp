...
void func_80171594(u8 x,u8 y,s32 z) {
 register s32 rz ASM_REG("$16")=z;
 register u8 rx ASM_REG("$20")=x;
 register u8 ry ASM_REG("$21")=y;
 register void *o ASM_REG("$18"),*p ASM_REG("$19"),*a ASM_REG("$17"),*b ASM_REG("$16"); s32 q; u8 bx,by;
 register void *call_o ASM_REG("$4");
 ASM_KEEP4_NV(rz,rx,ry,rz);
