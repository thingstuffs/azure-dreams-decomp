...
void *func_80027534(s16 arg0, s16 arg1, s16 arg2)
{
  ...
  register s16 held_arg1 ASM_REG("$5") = arg1;
  register s16 held_arg2 ASM_REG("$6") = arg2;
  register s32 init0 ASM_REG("$6");
  register s32 init1 ASM_REG("$3");
  register void *init_obj ASM_REG("$4");
  register void *init_stack ASM_REG("$5");
  register s32 shifted ASM_REG("$2");
  register s32 five ASM_REG("$2");
  int new_var;
  register s32 inner_arg ASM_REG("$4");
  s32 call_result;
  ...
  ASM_USE_G_NV(D_80083228);
  sp.sp10 = init0;
  sp.sp14 = init1;
  temp_s0 = (((s32) (D_80083228 + 0x500)) >> 9) & 7;
  var_s5 = 0;
  ASM_USE2_NV(init_obj, init_stack);
  {
    register u16 initial_width ASM_REG("$8");
  ...
  do
  {
    var_s4 = 0;
    {
      register s32 sp28_value ASM_REG("$8");
      sp28_value = sp.sp28;
      new_var = 1;
      five = 5;
      temp_s6 = five - var_s5;
    ...
    {
      {
        register void *call_obj ASM_REG("$4") = temp_v0;
        register void *call_data ASM_REG("$5") = D_800CEEFC;
      ...
      }
      {
        ...
        register u16 value18 ASM_REG("$8");
        register u16 value1A ASM_REG("$8");
      ...
      {
        register s32 product ASM_REG("$8");
      ...
      {
        register s32 color ASM_REG("$5") = 0x808080;
        ...
        *((s16 *) (((s8 *) temp_a0) + 0x1C)) = 0x400;
        ASM_SCHED_BARRIER();
        {
          register void *late_address ASM_REG("$2") = D_80028880;
        ...
        *((s16 *) (((s8 *) temp_s2) + 0x66)) = 0xC;
        {
          register u16 final_width ASM_REG("$8");
          final_width = sp.sp20;
