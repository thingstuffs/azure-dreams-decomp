...
extern s32 func_800BCB7C(s32, s32, DungeonTables *, Cell *);
extern s32 func_800BCBA4(s32, s32, DungeonTables *, Cell *);
...
s32 func_800BCB04(s32 arg0, s32 arg1, s16 arg2) {
    ...
    if (xblock < 0) {
        work->index = 0;
        return func_800BCB7C(xblock, arg1, tables, cells);
    }
    if (xblock < 0x40) {
        yblock = arg1 & 0xFFFF;
    } else {
    ...
    if (yblock < 0) {
        work->best = 0;
        return func_800BCBA4(xblock, arg1, tables, cells);
    }
    if (yblock >= 0x40) {
        work->best = 0x3F;
    }
...
process_primitive:
    if (!(primitive->flags & 1)) {
        register u16 work_x ASM_REG("$4");
        register u16 work_y ASM_REG("$5");
        u16 vertex_index;
        u16 p3_x;
        u16 p3_y;
        ...
        if (func_800BCE7C((Work *)work) != 0) {
            ...
            register s32 limit ASM_REG("$4") = work->limit;
