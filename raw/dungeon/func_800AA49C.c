...
s32 func_800AFBFC(Arg0_800AFBFC *arg0, s32 unused, Arg2_800AFBFC *arg2) {
    register s32 previous ASM_REG("$21") = 0;
    s32 result;
    register s32 pos ASM_REG("$16");
    register s32 next_pos ASM_REG("$17");
    register s32 pos_hold ASM_REG("$22");
    s32 x0;
    s32 y1;
    register s16 *scratch ASM_REG("$18") = (s16 *)0x1F800000;
    register void *view ASM_REG("$8");
    register State_80083160 *state ASM_REG("$2");
    register void *page_color ASM_REG("$3");
    volatile s16 initial_pos;
    void *temp;
    s32 angle2;
    register u16 flags ASM_REG("$4");
    s32 byte;
    register s32 next_byte ASM_REG("$2");
    s32 angle0;
    register s32 angle1 ASM_REG("$23");

    state = D_80083160[0];
    ASM_KEEP_MEMDEP(state, page_color, D_80083160[0]);
    ...
    *(void **)((u8 *)scratch + 0x118) = temp;
    ...
    pos = (s16)pos;
    {
    register s32 axis ASM_REG("$19");
    s32 raw_axis;
    s32 raw_y;
    register s32 call_pos ASM_REG("$4");
    register void *call_arg1 ASM_REG("$5");
    register s16 *call_arg2 ASM_REG("$6");
    register s32 call_arg3 ASM_REG("$7");
    register s32 scaled_y ASM_REG("$3");
    register s32 work_x ASM_REG("$16");
    ...
    {
    register u16 raw_pos ASM_REG("$8");
    s32 axis;
    s32 raw_axis;
    s32 raw_y;
    register s32 call_pos ASM_REG("$4");
    ...
    ASM_KEEP_NV(view);
    {
        register State_80083160 *final_state ASM_REG("$3");
