...
extern s32 func_800C400C();
extern s32 func_800C3FF0();
...
s32 func_800C3D3C(void *arg0, s32 arg1, s16 arg2, s32 arg3) {
    ...
    s32 y;
    s32 idx;
    register s32 c68 ASM_REG("$6");
    register s32 mask ASM_REG("$5");
    register s32 av1 ASM_REG("$20");
    s32 se;
    u16 *cell;
    ...
    if ((u32) arg0 <= 0x9FFFFFFFU) {
        ...
        if (func_800AD6FC(arg0, U16(D_800DDE84, U8(arg0, 0x13) * 2) & 3, av1) == 0) {
            ...
            {
                register s32 tail_one ASM_REG("$2");
                tail_one = 1;
                ASM_TAILSLOT_PIN(tail_one);
                return func_800C400C();
            }
        }
