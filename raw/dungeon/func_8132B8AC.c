...
void func_801730AC(void *in0, void *in1, void *in2) {
    ...
    u8 *case11_current;
    u8 *state_row;
    register u8 *state_base ASM_REG("$3");
    u8 *state_table;
    void *temp_s3;
    register s32 tail_test ASM_REG("$2");
    register s32 tail_state ASM_REG("$2");
    register u8 *tail_sprite ASM_REG("$5");
    register void *particle_a0 ASM_REG("$4");
    register s32 particle_a2 ASM_REG("$6");
    register s32 particle_a3 ASM_REG("$7");
    s32 particle_random;
...
jt_c6:
    ...
    {
        register void *case6_a0 ASM_REG("$4") = arg0;
        register void *case6_a1 ASM_REG("$5") = arg1;
        register void *case6_a2 ASM_REG("$6");
        u8 case6_state;
...
loop_31:
    ...
    ASM_KEEP4(particle_a0, particle_a2, particle_a3, temp_s3);
