...
s32 func_800BF074(void *arg0, s32 arg1, s16 arg2, s32 arg3) {
    s32 *base;
    s32 temp_v0;
    s32 var_s1;
    ...
    if ((u32)arg0 <= 0x9FFFFFFF) {
        ...
        base = D_80082EB0;
        var_s1 = temp_v0;
        temp_v0 = func_80099194(D_800E11F5, func_80099368(FIELD(base, void *, 4), temp_v0));
        FIELD(FIELD(base, void *, 4), u8, 3) &= 0x7F;
        func_800A90E8(FIELD(base, void *, 4));
        func_80099290(func_80099194(D_80089374, func_80099368(FIELD(base, void *, 4), temp_v0)));
