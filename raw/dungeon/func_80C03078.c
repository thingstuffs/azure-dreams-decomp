...
extern M2C_UNK D_80158A58;
extern M2C_UNK D_80159014;
extern M2C_UNK D_8015C20C;
extern M2C_UNK D_8015C25C;
void *func_8003FD64();
...
extern void func_80158958(void) __attribute__((noreturn));
extern void func_801589C4(void) __attribute__((noreturn));

void *func_80158878(s16 arg0, s8 arg1, s8 arg2, s16 arg3) {
    s32 unksp24;
    s32 sp24;
    s32 temp_v1;
    s32 state_flags0;
    ...
    unksp24 = (s32) *(s8 *)-0x3E28;
    temp_v0 = func_8003FD64(0x112, &D_80083498);
    if (temp_v0 == NULL) {
        goto done;
    }
    var_s0 = temp_v0 + 0x20;
    M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_80158A58;
    ...
    temp_s5 = var_s0;
    M2C_FIELD(temp_s2, M2C_UNK **, 0x2C) = &D_8015C20C;
    ...
    if (((arg0 & ~3) << 0x10) == 0) {
        if (!(M2C_FIELD(var_s0, s32 *, 0x14) & 0x200)) {
            if (func_800A6D30(temp_v0, temp_s4) & 1) {
                ...
                M2C_FIELD(temp_s2, M2C_UNK **, 0x2C) = &D_8015C25C;
            }
        }
    }
    ...
    M2C_FIELD(var_s0, M2C_UNK **, 0x8C) = &D_80159014;
