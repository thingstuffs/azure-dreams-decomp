...
void *func_80170878(void *arg0, s32 arg1, s32 arg2, s32 arg3)
{
    ...
    ASM_KEEP(result);
    FIELD(created, void *, 0x10) = func_80170A58;
    FIELD(result, s8, 0x13) = 0x10;
    ...
    actor = result;
    FIELD(part_b, void *, 0x2C) = D_8017420C;
    ...
    if (((saved_arg0 & ~3) << 16) == 0) {
        if (!(FIELD(result, u32, 0x14) & 0x200)) {
            ...
            if (func_800A6D30() & 1) {
                ...
                FIELD(part_b, void *, 0x2C) = D_8017425C;
            }
        }
    }
...
setup:
    ...
    FIELD(actor, void *, 0x8C) = D_80171014;
    FIELD(result, u32, 0x1C) |= 0x40000;
