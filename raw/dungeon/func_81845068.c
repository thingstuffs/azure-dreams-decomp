...
s32 func_81845068(u8 *arg0)
{
    ...
    Packed8 packed;
    Coord coords[3];
    register u8 *node ASM_REG("$21");
    register u8 *current ASM_REG("$22");
    register u8 *next ASM_REG("$4");
    u8 *global;
    register u8 *alloc_ctx ASM_REG("$3");
    register u8 *table_ctx ASM_REG("$2");
    register u8 *table_entry ASM_REG("$4");
    u8 *prim;
    Coord *coord_base;
    register Coord *coord ASM_REG("$16");
    ...
    s32 temp;
    register s32 color0 ASM_REG("$3");
    register s32 color1 ASM_REG("$2");
    s32 random;
    register u32 mask ASM_REG("$19");
    register u32 table_word ASM_REG("$2");
    u16 x0;
    u16 y0;
    u16 y1;
    ...
    do {
        ...
        if ((u32)index < 0x1E0) {
            ...
            {
                register u32 high_mask ASM_REG("$5") = 0xFF000000;
