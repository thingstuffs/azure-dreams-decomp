...
s32 func_800259DC(void *arg0) {
    ...
    do {
        ...
        FIELD(scratch, void *, 0x70) = FIELD(arg0, void *, 0x34);
        FIELD(scratch, void *, 0x78) = FIELD(arg0, void *, 0x3C);
        FIELD(scratch, void *, 0x80) = FIELD(arg0, void *, 0x44);
        value2 = FIELD(arg0, void *, 0x4C);
        FIELD(scratch, u16, 0x74) = FIELD(arg0, u16, 0x38);
        FIELD(scratch, u16, 0x7C) = FIELD(arg0, u16, 0x40);
        FIELD(scratch, u16, 0x84) = FIELD(arg0, u16, 0x48);
        FIELD(scratch, void *, 0x88) = value2;
        FIELD(scratch, u16, 0x8C) = FIELD(arg0, u16, 0x50);
        ...
        if (count < 0x1E0U) {
            value0 = FIELD(arg0, s32, 0x54);
            FIELD(obj, s32, 0xC) = value0;
            FIELD(obj, s32, 4) = value0;
            value1 = FIELD(arg0, s32, 0x58);
