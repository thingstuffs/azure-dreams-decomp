...
BODY_STORAGE void BODY_NAME(void *arg0_in, void *arg1_in, void *arg2) {
    ...
    register void *temp_a1_4 ASM_REG("$5");
    void *temp_a1_5;
    void *temp_fp;
    ...
    register s32 temp_init_word ASM_REG("$2");
    void *cb_page;
    void *spr_page;
    register void *arg0 ASM_REG("$22") = arg0_in;
    register void *arg1 ASM_REG("$23") = arg1_in;
...
state_0:
    if (*M2C_FIELD(arg0, u16 **, 4) & 0x80) {
        ...
        if (!(M2C_FIELD(temp_s0, u16 *, 0x14) & 0x8000) || !(M2C_FIELD(arg2, u16 *, 0x14) & 0x8000)) {
            ...
            temp_init_word += 1;
            ASM_TAILSLOT_PIN(temp_init_word);
            func_80024490();
            return;
        }
        goto state_F0_end;
