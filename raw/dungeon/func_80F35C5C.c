...
void func_8017345C(void *arg0, void *arg1, void *arg2, void *arg3)
{
    s16 timer;
    s32 value;
    s32 *state;
    ...
    table_index = (FIELD(arg3, u16, 0x6A) >> 9) & 7;

    switch (FIELD(arg0, u8, 0x9B)) {
    case 0:
        func_800AD4D0(arg3);
        FIELD(arg1, s32, 0x0C) = ((s16 *)&D_8006CCD8)[table_index] << 17;
        FIELD(arg1, s32, 0x10) = ((s16 *)&D_8006CCE8)[table_index] << 17;
        FIELD(arg0, u8, 0x9B)++;
