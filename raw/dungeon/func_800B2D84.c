...
void func_800B84E4(DungeonPosition *position, DungeonParameters *parameters, s32 arg2, s32 arg3)
{
  ...
  s32 position_word;
  s32 final_value;
  register u8 *global_page ASM_REG("$4");
  register u8 *geometry_arg ASM_REG("$4");
  register s32 setup_arg ASM_REG("$4");
  ...
  *((volatile s32 *) (((volatile u8 *) hw) + 0x14)) = parameters->y1;
  ...
  ASM_SCHED_BARRIER();
  {
    register u8 *end_page ASM_REG("$8");
    end_page = D_80083160;
    ASM_KEEP(end_page);
