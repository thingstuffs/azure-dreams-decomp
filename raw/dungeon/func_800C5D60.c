...
void *func_800CB4C0(void *arg0, s16 arg1) {
    ...
    if (temp_v0 != NULL) {
        M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_800CB374;
        ...
        if ((arg1 << 0x10) == 0) {
            M2C_FIELD(temp_v0, void **, 8) = M2C_FIELD(arg0, void **, 8);
            return func_800CB5BC();
        }
        temp_v1 = M2C_FIELD(temp_v0, void **, 8);
        M2C_FIELD(temp_v1, u16 *, 2) = (u16) M2C_FIELD(M2C_FIELD(arg0, void **, 8), u16 *, 2);
        M2C_FIELD(temp_v1, u16 *, 6) = (u16) M2C_FIELD(M2C_FIELD(arg0, void **, 8), u16 *, 6);
        M2C_FIELD(temp_v1, u16 *, 0xA) = (u16) M2C_FIELD(M2C_FIELD(arg0, void **, 8), u16 *, 0xA);
        temp_v0_3 = M2C_FIELD(arg0, void **, 0xC);
        ASM_KEEP(temp_v0_3);
        temp_s32 = M2C_FIELD(temp_v0_3, s32 *, 0xC);
        M2C_FIELD(temp_s0, s16 *, 0x10) = 0x60;
        M2C_FIELD(temp_s0, s32 *, 0xC) = temp_s32;
        ASM_SCHED_BARRIER();
        M2C_FIELD(temp_s0, s16 *, 6) = -1;
        ASM_SCHED_BARRIER();
        temp_v0_2 = temp_v0 + 0x20;
        ASM_KEEP(temp_v0_2);
        M2C_FIELD(temp_v0_2, void **, 0xA8) = arg0;
        M2C_FIELD(temp_v0_2, s16 *, 0xB4) = arg1;
        M2C_FIELD(temp_v0_2, s16 *, 0x96) = 8;
    }
    ASM_KEEP(temp_v0);
    return temp_v0;
}
