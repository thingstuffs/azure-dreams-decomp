...
void func_8008FF18(u8 *a0, s32 *a1, u16 *a2, s32 *a3) {
    ...
    register u8 *arg0 ASM_REG("$17") = a0;
    register s32 *arg1 ASM_REG("$16") = a1;
    register u16 *arg2 ASM_REG("$18") = a2;
    register s32 *arg3 ASM_REG("$19") = a3;
    s16 *var_s4;
...
jt_c11:
    ...
    if (var_s4[2] != 0) {
        register s32 div_v0 ASM_REG("$2");
        register s32 div_v1 ASM_REG("$3");
