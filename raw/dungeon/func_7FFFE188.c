...
void func_7FFFE188(void *arg0, M2C_UNK arg1, void *arg2, M2C_UNK arg3) {
    s32 *base;
    u16 temp_v0;

    base = D_80080000 + 0xDE0;
    M2C_FIELD(arg2, s32 *, 0xC) = (s32) ((s32) (base[0] - M2C_FIELD(arg2, s32 *, 0)) / 2);
    M2C_FIELD(arg2, s32 *, 0x10) = (s32) ((s32) (base[1] - M2C_FIELD(arg2, s32 *, 4)) / 2);
    func_8009539C(arg2);
