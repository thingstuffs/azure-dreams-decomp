...
case_0:
    {
        register s32 rect0 ASM_REG("$7");
        register s32 rect1 ASM_REG("$6");
        void *owner;
        ChildObj *child;
        u16 state;
...
case_1:
    {
        ...
        register GlobalObj *owner ASM_REG("$3");
        Position *position;
...
case_2:
    {
        register s32 resetTimer ASM_REG("$3");
        register u16 deadState ASM_REG("$2");
