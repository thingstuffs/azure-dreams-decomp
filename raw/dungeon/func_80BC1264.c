...
void func_80BC1264(void *arg0, void *arg1) {
    ...
    M2C_FIELD(arg0, s32 *, 0x48) = (s32) (M2C_FIELD(arg0, s32 *, 0x48) + M2C_FIELD(arg0, s32 *, 0x54));
    var_v0 = abs(M2C_FIELD(arg0, s16 *, 0x36) - M2C_FIELD(arg1, s16 *, 2));
    if (var_v0 < 0x10) {
        var_v0_2 = abs(M2C_FIELD(arg0, s16 *, 0x38) - M2C_FIELD(arg1, s16 *, 6));
        if (var_v0_2 < 0x10) {
