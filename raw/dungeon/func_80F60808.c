...
void func_80F60808(void *arg0, void *arg1, void *arg2, void *arg3) {
    ...
    if (!(state[1] & 0x2000) && ((func_800A2BDC(arg3) << 0x10) == 0)) {
        ...
        M2C_FIELD(arg2, M2C_UNK **, 0x2C) = &D_801741D4;
        func_80047784(arg2, D_801741D4[(((s32) (*D_80083228 + M2C_FIELD(arg3, s16 *, 0x2A) + 0x100) >> 9) & 7)], 0);
