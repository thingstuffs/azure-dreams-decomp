...
{
    register u8 *spad ASM_REG("$18");
    register u8 *global_base ASM_REG("$22");
    register u32 page_color ASM_REG("$2");
    u8 *global_ptr;
    u8 *initial_ptr;
    register u8 *var_s4 ASM_REG("$20");
    register u8 *temp_s0 ASM_REG("$16");
    register u8 *temp_s1 ASM_REG("$17");
    u8 temp_v0_2;
    u8 temp_v0_3;
    u8 temp_v0_4;
    register u8 temp_v1 ASM_REG("$3");
    register u8 temp_sum_rhs ASM_REG("$2");
    u16 copy_half;
    register u16 last_half ASM_REG("$3");
    u32 temp_v0;
    register u32 copy_word ASM_REG("$3");
    ...
    register void *arg0_reg ASM_REG("$19") = arg0;
    register void *arg2_reg ASM_REG("$21") = arg2;
    ...
    *((u32 *) (spad + 0x20)) = (u32) (initial_ptr + 0xB0);
    ASM_KEEP_MEMDEP(spad, page_color, *((u8 **) D_80083160_addr));
    temp_s0 = var_s4 + 7;
    ASM_KEEP(temp_s0);
