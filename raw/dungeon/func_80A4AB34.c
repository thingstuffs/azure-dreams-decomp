...
void func_80174334(void *arg0, void *arg1, void *arg2, s16 arg3)
{
    ...
    FIELD(scratch, u16, 0xB0) = FIELD(arg0, u16, 0x64);
    FIELD(scratch, u16, 0xB8) = FIELD(arg0, u16, 0x6A);
    FIELD(scratch, u16, 0xC0) = FIELD(arg0, u16, 0x70);
    FIELD(scratch, u16, 0xC8) = FIELD(arg0, u16, 0x76);
    FIELD(scratch, u16, 0xB2) = FIELD(arg0, u16, 0x66);
    FIELD(scratch, u16, 0xBA) = FIELD(arg0, u16, 0x6C);
    FIELD(scratch, u16, 0xC2) = FIELD(arg0, u16, 0x72);
    FIELD(scratch, u16, 0xCA) = FIELD(arg0, u16, 0x78);
    FIELD(scratch, u16, 0xB4) = FIELD(arg0, u16, 0x68);
    FIELD(scratch, u16, 0xBC) = FIELD(arg0, u16, 0x6E);
    FIELD(scratch, u16, 0xC4) = FIELD(arg0, u16, 0x74);
    FIELD(scratch, u16, 0xCC) = FIELD(arg0, u16, 0x7A);
    ...
    if ((u32)index < 0x1E0) {
        if ((((u16)(FIELD(packet, u16, 8) + 0x20) < 0x181) &&
            ...
            FIELD(packet, u32, 4) = FIELD(arg0, u32, 4);
            FIELD(packet, u32, 0x10) = FIELD(arg0, u32, 8);
            FIELD(packet, u32, 0x1C) = FIELD(arg0, u32, 0xC);
            FIELD(packet, u32, 0x28) = FIELD(arg0, u32, 0x10);
