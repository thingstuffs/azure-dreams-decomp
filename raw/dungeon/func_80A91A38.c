...
state_zero:
    func_800AD4D0(arg3);
    FIELD(arg1, s32, 0xC) = ((s16 *)&D_8006CCD8)[direction] << 18;
...
state_one:
    FIELD(arg1, s32, 0xC) -= ((s16 *)&D_8006CCD8)[direction] << 14;
...
continue_state_one:
    FIELD(arg2, u8 *, 0x2C) = D_80156150;
    func_80047784(
        arg2,
        D_80156150[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
    FIELD(arg0, u8, 0x9B)++;
    goto done;
