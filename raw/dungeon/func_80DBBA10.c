...
void func_80173210(State *arg0, Motion *arg1, Actor *arg2, Entity *arg3)
{
    s32 scratch[2];
    s32 index;
    register u32 table ASM_REG("$5");
    u8 state;
    u32 flags;
    ...
    case 0:
        ...
        table = (u32)D_801753D4;
        *(u32 * volatile)((u8 *)arg2 + 0x2C) = table;
        index = (D_80083228 + arg3->direction2A + 0x100) >> 9;
        func_80047784(arg2, *(u8 *)((index & 7) + table), 0);
        arg0->flags98 |= 8;
    ...
    case 1:
        ...
        if (arg0->timer9E != 0) {
            ...
            arg1->dy10 = (((arg2->y25 << 6) - y_origin) << 16) /
                         arg0->timer9E;
            arg0->velocityA0 = -func_800644B8(arg0->timer9E * 0x199) << 9;
        }
        arg0->position90 += arg0->velocityA0;
        arg0->timer9E--;
        if (arg0->timer9E >= 0) {
...
end_state:
    ...
    if ((func_800AD9B4(arg2, arg3) << 16) > 0) {
        arg0->field8C = D_80171E20;
        func_800A9A04(arg3);
    }
}

/* MECHANISM: The four live arguments plus scratch[2] produce retail's 0x38 frame
