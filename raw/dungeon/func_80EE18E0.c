...
state_zero:
    ...
    FIELD(arg2, u8 *, 0x2C) = D_80174ED0;
    func_80047784(
        arg2,
        D_80174ED0[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
...
state_two:
    if (FIELD(arg3, u32, 0x1C) & 0x08000000) {
        ...
        FIELD(arg2, u8 *, 0x2C) = D_80174ED8;
        func_80047784(
            arg2,
            D_80174ED8[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
            0);
        FIELD(arg0, u8, 0x9B)++;
    }
    goto update_countdown;
