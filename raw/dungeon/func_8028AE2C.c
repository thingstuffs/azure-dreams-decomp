...
void func_8001DE2C(void) {
    DungeonArea *area;
    register u32 area_page ASM_REG("$2");
    register u32 shift_base ASM_REG("$8");
    s16 *tile;
    s32 area_index;
    s32 x;
    s32 y;
    ...
    register s32 x_end ASM_REG("$22");
    register s32 y_end ASM_REG("$23");
    register s32 amount_small ASM_REG("$20");
    register s32 amount_large ASM_REG("$21");

    area_index = 0;
    amount_small = 0x20;
    amount_large = 0x100;
    area_page = 0x800E0000;
    ASM_KEEP_NV(area_page);
