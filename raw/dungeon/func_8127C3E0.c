...
active:
    ...
    if (flags & 0x410) {
        if (flags & 0x400) {
            other = func_8009F09C(arg3, FIELD(arg2, u8, 0x24),
                                  FIELD(arg2, u8, 0x25));
            if (other != 0) {
        ...
        if (func_8009F2E0(arg3, FIELD(arg2, u8, 0x24),
                          FIELD(arg2, u8, 0x25),
    ...
    if (flags & 0x2000) {
        ...
        if (flags & 0x20000) {
            ...
            u8 *buffer;
            {
                ...
                s32 direction = FIELD(D_800803DC, u16, 0x2A);
                s32 table_index =
            ...
            if (func_800996B0(coordinate, arg2, arg3, 0x20) <= 0) {
                FIELD(arg3, s16, 0x2A) = func_8009F608(
                    FIELD(arg2, u8, 0x24), FIELD(arg2, u8, 0x25),
    ...
    other = func_8009F2E0(arg3, FIELD(arg2, u8, 0x24),
                          FIELD(arg2, u8, 0x25),
                          FIELD(arg3, s16, 0x2A));
    if (other != 0 &&
...
direct_move:
    func_8009FB34(arg2, FIELD(arg0, s8, 0x9C), arg3,
                  (u8 *)arg0 + 0x98);
...
loop_body:
    ...
    if (i == 0 &&
        *(u16 *)&D_800814B4 != FIELD(arg2, u16, 0x24)) {
        ASM_SCHED_BARRIER();
        if (func_80098F70(arg3,
                (u8 *)FIELD(D_800803DC, void *, 0x58) + 0x20) != 0) {
            return;
        }
    }
