...
void func_801759A0(Obj0 *arg0, void *arg1, Obj2 *arg2, Obj3 *arg3)
{
    Obj2 *obj2 = arg2;
    Obj3 *obj3 = arg3;
    u32 table;
...
kind13_default:
        ...
        table = (u32)D_80175E54;
        goto first_join;
kind13_alternate:
        current = (u32)obj2->table2c;
        table = (u32)D_80175E24;
        goto first_join;
...
kind14_default:
        current = (u32)obj2->table2c;
        table = (u32)D_80175E5C;
        goto first_join;
kind14_alternate:
        current = (u32)obj2->table2c;
        table = (u32)D_80175E2C;
        goto first_join;
...
kind15_default:
        current = (u32)obj2->table2c;
        table = (u32)D_80175E64;
        goto first_join;
kind15_alternate:
        current = (u32)obj2->table2c;
        table = (u32)D_80175E34;
        goto first_join;
...
after_first_update:
    ...
    switch (obj3->kind48) {
    case 13:
        if (obj2->table2c != D_80175E54 ||
            (obj3->flags1c & 0x208) != 0) {
            return;
        }
        new_table = (u32)&D_80175DC4;
        *(u32 * volatile)((u8 *)obj2 + 0x2c) = new_table;
        index = (D_80083228 + obj3->value2a + 0x100) >> 9;
        func_80047784(obj2, *(u8 *)((index & 7) + new_table), 0);
        return;
    case 14:
        if (obj2->table2c != D_80175E5C ||
            (obj3->flags1c & 0x208) != 0) {
            return;
        }
        new_table = (u32)&D_80175DCC;
        *(u32 * volatile)((u8 *)obj2 + 0x2c) = new_table;
        index = (D_80083228 + obj3->value2a + 0x100) >> 9;
        func_80047784(obj2, *(u8 *)((index & 7) + new_table), 0);
        return;
    case 15:
        if (obj2->table2c != D_80175E64 ||
            (obj3->flags1c & 0x208) != 0) {
            return;
        }
        new_table = (u32)&D_80175DD4;
        *(u32 * volatile)((u8 *)obj2 + 0x2c) = new_table;
        index = (D_80083228 + obj3->value2a + 0x100) >> 9;
        func_80047784(obj2, *(u8 *)((index & 7) + new_table), 0);
        return;
