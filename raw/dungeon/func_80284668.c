...
void func_80017668(s16 arg0, s16 arg1, s16 arg2, s32 arg3, u16 arg4) {
    register s32 outer ASM_REG("$10");
    register u16 value ASM_REG("$11");
    register s32 inner ASM_REG("$7") = arg3;
    register s32 arg2_shift ASM_REG("$6");
    register s32 arg0_shift ASM_REG("$4");
    register s32 column ASM_REG("$8");
    register s32 row;
    s16 *settings;
