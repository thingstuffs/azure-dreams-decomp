...
{
#ifdef __mips__
    register void *arg0 ASM_REG("$21") = param0;
    ...
    void *owner;
#ifdef __mips__
    register u8 *base ASM_REG("$22");
#else
    u8 *base;
#endif
#ifdef __mips__
    register void *effect ASM_REG("$16");
    ...
    {
#ifdef __mips__
        register void *setup_part ASM_REG("$18");
#else
        void *setup_part;
#endif
        s32 delta;
        ...
        do {
            ...
            if (effect != 0) {
                ...
                {
                    register void *texture_data ASM_REG("$2");
...
case0:
    {
        register void *control ASM_REG("$2");
...
case3:
{
    s32 offset;
#ifdef __mips__
    register void *loop_other ASM_REG("$18");
    register s32 modulo_magic ASM_REG("$22");
    register s32 a1_reserve ASM_REG("$5");
    register s32 a2_reserve ASM_REG("$6");
    register s32 a3_reserve ASM_REG("$7");
#else
    void *loop_other;
#endif
    ...
    do {
        ...
        {
            MipsProduct product;
            register s32 mod_value ASM_REG("$2");
            register s32 mod_sign ASM_REG("$3");
...
{
#ifdef __mips__
    register void *case5_setup_part ASM_REG("$18");
#else
