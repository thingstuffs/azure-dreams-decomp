...
void func_80024758(void *arg0, void *arg1, void *arg2, u16 arg3) {
    ...
    s32 sp54;
    s32 sp58;
    register u8 *scratch ASM_REG("$21") = (u8 *)0x1F800000;
    u8 *page;
    u8 *page0;
    register u32 page_color ASM_REG("$3");
    u8 **pp;
    u8 *node;
    s32 lim_a1;
    s32 lim_a0;
    ...
    page0 = D_80083160;
    ASM_KEEP_MEMDEP(page0, page_color, D_80083160);
                ...
                if ((u32)tv0 < 0x1E0U) {
                    ...
                    L_C:
                        ...
                        *(u8 *)((u8 *)arg2 + 0xF) = flg;
                        ...
                        {
                            register u32 mask ASM_REG("$4") = 0x00FFFFFF;
                            register u32 mask2 ASM_REG("$5") = 0xFF000000;
                            s32 *slot;
