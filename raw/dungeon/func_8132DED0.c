...
void func_80164ED0(void *arg0, s32 arg1, s16 arg2, s32 arg3, s32 arg4, s32 arg5)
{
    ...
    if (temp_v0 != NULL) {
        M2C_FIELD(temp_v0, void **, 0x10) = D_80164DA4;
        ...
        M2C_FIELD(M2C_FIELD(temp_v0, void **, 8), s32 *, 0x14) = (s32)
            (((rand() & 0x7FFF) - 0x4000) << 6);
        M2C_FIELD(temp_s0, s16 *, 0x32) = arg2;
        M2C_FIELD(temp_s0, s16 *, 0x34) = arg2;
