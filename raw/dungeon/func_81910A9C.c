...
{
  register u8 *arg0p ASM_REG("$21");
  register s32 divshift ASM_REG("$20");
  register s32 arg2r;
  register u32 lomask ASM_REG("$22");
  register s32 phase ASM_REG("$23");
  register u8 *sc ASM_REG("$18");
  u8 *new_var;
  register u8 *packet ASM_REG("$19");
  register void *p84 ASM_REG("$17");
  register u8 *work88 ASM_REG("$16");
  s32 i = 0;
  s32 shift0;
  arg0p = arg0;
