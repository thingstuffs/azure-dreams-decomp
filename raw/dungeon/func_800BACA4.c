...
void func_800C0404(DungeonObject *obj, MotionState *motion, EffectState *effect) {
    ...
    u8 *list;
    s32 i;
    register s32 firstConst ASM_REG("$4");
    register Primitive *firstCallArg ASM_REG("$4");
    ...
    {
        register RenderState *postState ASM_REG("$3");
        postState = *stateSlot;
...

    {
        ...
        if (i == 0) {
            ...
            if (obj->handle[0x13] == 0 &&
                ...
                u8 *table = D_80083120;
                s16 *slot;
                register void *callArg ASM_REG("$4");
                D_800814E8 = value;
