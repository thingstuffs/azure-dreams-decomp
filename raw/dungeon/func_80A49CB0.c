...
state_zero:
    ...
    FIELD(arg2, void *, 0x2C) = D_80175894;
    func_80047784(arg2,
        D_80175894[((D_80083228 + FIELD(arg3, s16, 0x2A) + 0x100) >> 9) & 7],
        0);
...
state_one_active:
    ...
    ASM_KEEP(global_base);
    {
        ...
        if (flags & 0x80000) {
            ...
            old_value = FIELD(copy_arg0, u16, 0xB6);
            FIELD(copy_arg0, u16, 0xB6) = 0;
            FIELD(copy_arg0, u16, 0xB8) = 0;
