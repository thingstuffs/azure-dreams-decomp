...
void func_80093894(void) {
    ...
    object = data + 0x20;
    context = D_80110EB8;
    arg1 = FIELD(data, void *, 8);
    arg2 = FIELD(data, void *, 0xC);

    if (FIELD(context, s32, 8) == 3) {
        Unk96134Bytes *source = FIELD(context, Unk96134Bytes *, 0);
        ...
        if (!check) {
            ...
            if (work.bytes.unk1 == 0x13) {
                register void *callback_slot ASM_REG("$2");
                register void (*callback)(void *, void *, void *) ASM_REG("$3");
...
process:
        work.pos.unk0 = FIELD(arg1, s32, 0);
        work.pos.unk4 = FIELD(arg1, s32, 4);
        work.pos.unk8 = FIELD(arg1, s32, 8) + D_800D0428;
        mode = 0;
        ...
        result = func_8009DFD8(FIELD(&D_80110EB8, void *, 0), &work.pos, mode);
        if (result != 0) {
            Unk96134State *state = (Unk96134State *)D_800CFCB4;
            void *next;

            next = (u8 *)result + 0x20;
            FIELD(object, void *, 0x2C) = next;
            state->unk10 = next;
            state->unk18 = 0;
