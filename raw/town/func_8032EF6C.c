...
{
    register DataRecord *var_s0 ASM_REG("$16");
    register u8 *var_s1 ASM_REG("$17");
    register s32 var_s2 ASM_REG("$18");
    register u32 var_s3 ASM_REG("$19");
    register u32 var_s4 ASM_REG("$20");
    register u32 var_s5 ASM_REG("$21");
    register u32 var_v0 ASM_REG("$2");
    register s32 var_v1 ASM_REG("$3");
    register u32 var_a0 ASM_REG("$4");
