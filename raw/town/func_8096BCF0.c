...
{
    register s32 slot ASM_REG("$16");
    register TownObject *obj ASM_REG("$17") = arg0;
    register s16 value ASM_REG("$18");
    register s32 iteration ASM_REG("$19");
    register s32 input ASM_REG("$20");
    register void **lo_digits ASM_REG("$21");
    register void **hi_digits ASM_REG("$22");
