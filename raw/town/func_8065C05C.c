...
void func_8065C05C(void *arg0) {
    ...
    register s32 index;
    register s32 tag ASM_REG("$19");
    register u8 *page ASM_REG("$20");
    register void *base_copy ASM_REG("$2");
    register u32 end ASM_REG("$3");
    register void *out ASM_REG("$16");
