...
object_loop:
    {
    void *loop_cur;
    register void *loop_next ASM_REG("$2");
    ...
    {
    void *q0;
    register void *q8 ASM_REG("$3");
    s32 left;
    register s32 q0v ASM_REG("$2");
    register s32 right ASM_REG("$2");
    s32 pv0;
    register s32 pvc ASM_REG("$4");
    ...
    {
    register void *q0 ASM_REG("$4");
    void *q8;
    register void *qc ASM_REG("$4");
    s32 left;
    s32 q0v;
    s32 extra;
    s32 right;
    register s32 qcv ASM_REG("$4");
    ...
    {
    void *q0;
    register void *q8 ASM_REG("$2");
    void *qc;
    s32 left;
    register s32 q0v ASM_REG("$2");
    s32 right;
    register s32 qcv ASM_REG("$4");
    register s32 qce ASM_REG("$3");
    ...
    s32 sx;
    s32 sy;
    register s32 say ASM_REG("$2");
    register s32 pick ASM_REG("$3");
    ...
    {
    s32 dx;
    register s32 dax ASM_REG("$5");
    s32 dy;
    s32 dz;
    register s32 daz ASM_REG("$4");
