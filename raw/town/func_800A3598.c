...
void func_800A0CF8(u8 *arg0, s32 arg1, s32 arg2, s32 arg3) {
    s16 temp;

    temp = func_800A0F9C(D_80100B70, arg2, *(s16 *)(arg0 + 0x90));
    do { *(s16 *)(arg0 + 0x90) = temp; } while (0);
    if ((s32)(temp << 0x10) == 0) {
        func_800A12AC(D_80100B70, arg2, arg3);
        *(void **)(arg0 + 0x50) = D_800A0DAC;
        func_8003E1C4(0);
