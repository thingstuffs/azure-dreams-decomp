...
void func_800A7B98(s32 arg0, M2C_UNK arg1, void *arg2) {
    void *temp_s0;
    void *temp_v0;
    void *temp_v1;
    ...
    if (temp_v0 != NULL) {
        ...
        M2C_FIELD(temp_v1, s32 *, 8) = (s32) M2C_FIELD(arg2, s32 *, 8);
        M2C_FIELD(temp_v1, u16 *, 0x14) = (u16) M2C_FIELD(arg2, u16 *, 0x14);
        func_80033CD8(temp_s0, &D_80045340);
        M2C_FIELD(temp_s0, s16 *, 0x6C) = 5;
    }
}
