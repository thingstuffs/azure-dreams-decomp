...
block_common:
    ...
    while (temp_ret < 3 ? var_a2 < 2 : var_a2 < 1) {
        var_v1 = var_a2 * 4;
        temp_v1 = M2C_FIELD((base + var_v1), void **, 0xB18);
        data_offset = (var_a2 * 0x108) + 0x80;
        M2C_FIELD(temp_v1, s32 *, 0) = (s32) (base + data_offset);
        M2C_FIELD(M2C_FIELD(temp_v1, void **, 4), s16 *, 8) = 0xA9;
        M2C_FIELD(M2C_FIELD(temp_v1, void **, 4), s16 *, 0xA) = (s16) ((var_a2 * 0x10) + 0x110);
        var_a2 += 1;
    }
    return;
fake_tail:
