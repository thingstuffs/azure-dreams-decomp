...
void func_800168B4(s32 *arg0, s32 arg1, s32 *arg2)
{
    ...
    if (*arg0 != 0) {
        ...
        do {
            ...
            if ((M2C_FIELD((temp_a1 & 0x7E0) +
                          *((s32 *)((u8 *)M2C_FIELD(D_80016000, s32 *, 0x30) +
                                    (temp_a3 * 4))), s16 *, 0xA) != 0) ||
                (temp_a3 != 0)) {
                if (var_s0->active != 0) {
...
loop_join:
    ...
    FIELD(FIELD(D_80016000, void *, 0x20), ReportFunc, 0x168)(
        ...
        if (*arg0 != 0) {
            ...
            do {
                ...
                if (temp_a1 != var_t0) {
                    ...
                    var_a2++;
                    var_t0 = temp_a1;
                    table = (s32 **)M2C_FIELD(D_80016000, s32 *, 0x30);
