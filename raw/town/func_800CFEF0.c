...
void func_800CD650(void *arg0, M2C_UNK arg1, M2C_UNK arg2) {
    s32 *temp_v0;
    u16 temp_v0_2;

    if ((func_800C30E0() == 0) && ((temp_v0 = func_8008FAC0(arg0, &D_800CFCB4), (temp_v0 == NULL)) || (*temp_v0 == 2)) && (temp_v0_2 = M2C_FIELD(arg0, u16 *, 0x6C) - 1, M2C_FIELD(arg0, u16 *, 0x6C) = temp_v0_2, ((temp_v0_2 << 0x10) <= 0))) {
