...
s32 func_800A71F0(void *arg0, s32 arg1, M2C_UNK arg2) {
    ...
    M2C_FIELD(temp_a1, s32 *, 0) = (s32) M2C_FIELD(arg0, s32 *, 0);
    M2C_FIELD(temp_a1, s32 *, 4) = (s32) M2C_FIELD(arg0, s32 *, 4);
    M2C_FIELD(temp_a1, s32 *, 8) = (s32) (M2C_FIELD(arg0, s32 *, 8) + 0xFFDC0000);
    M2C_FIELD(temp_a1, s32 *, 0xC) = (s32) D_800D0DF0;
    M2C_FIELD(temp_a1, s32 *, 0x10) = (s32) M2C_FIELD(&D_800D0DF0, s32 *, 4);
    M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_800A7338;
    M2C_FIELD(temp_s0, s32 *, 0x54) = arg1;
