...
void func_800B8B00(s32 arg0) {
    ...
    u8 *page;
    u8 *page2;
    register volatile u8 *store_base ASM_REG("$1");
...
loop_3:
        ...
        if (M2C_FIELD(temp_v1, u8 *, 0x33A4) != var_a2) {
            var_a0 += 1;
            if (M2C_FIELD(temp_v1, u8 *, 0x33A5) != var_a2) {
                var_a1 += 1;
                if (var_a0 >= 5) {
                    var_a0_2 = 0;
                    page2 = (u8 *)0x80010000;
...
loop_7:
                    do {
                        ...
                        var_a0_2 += 1;
                        if (M2C_FIELD(temp_v1_2, u8 *, 0x33A5) == 0) {
                            M2C_FIELD(temp_v1_2, u8 *, 0x33A5) = var_t0;
                            return;
                        }
                        var_a1_2 += 1;
                    } while (var_a0_2 < 5);
