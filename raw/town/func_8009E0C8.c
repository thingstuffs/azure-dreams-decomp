...
void func_8009B828(void *arg0, M2C_UNK arg1, void *arg2, M2C_UNK arg3) {
    s32 temp_a1;
    u16 temp_v0;

    temp_a1 = M2C_FIELD(arg2, s32 *, 8);
    M2C_FIELD(arg2, s32 *, 0x14) = (s32) ((s32) ((D_80083788 + D_800D0428) - temp_a1) / 2);
