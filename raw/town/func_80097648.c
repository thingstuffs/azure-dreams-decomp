...
void func_80094DA8(TownObject *arg0) {
    ...
    s32 result_x;
    s32 scaled_x;
    register s32 magnitude_x ASM_REG("$2");
    s32 value_x;
    s32 sign_value_x;
    s32 delta_x;
    register s32 clamp_value_x ASM_REG("$2");
    register s32 clamp_magnitude_x ASM_REG("$3");
    s32 result_y;
    s32 scaled_y;
    register s32 magnitude_y ASM_REG("$2");
    s32 value_y;
    s32 sign_value_y;
    s32 delta_y;
    s32 clamp_value_y;
    register s32 clamp_magnitude_y ASM_REG("$3");
