...
s32 func_8002263C(Actor *p, s16 *pi, s32 *ox, s32 *oy) {
    register Box *q ASM_REG("$8");
    register s32 i ASM_REG("$3");
    s32 idx;
    s32 k;
    register s32 km ASM_REG("$8");
    s32 adx;
    s32 ady;
    s32 d0;
    s32 px;
...
Lc2:
    {
        register s32 d12 ASM_REG("$8");
        register s32 zy2 ASM_REG("$11");
        register s32 zh2 ASM_REG("$4");
        register s32 s2 ASM_REG("$2");
        s32 zx2;
        s32 py2;
        s32 px2;
        s32 t2v;
...
Lc3:
    {
        register s32 s3 ASM_REG("$2");
        register s32 d13 ASM_REG("$8");
        register s32 pi3 ASM_REG("$4");
        register s32 zx3 ASM_REG("$3");
        s32 zy3;
        s32 py3;
        s32 px3;
        u8 *zb3;
...
Lc4:
    {
        register s32 s4 ASM_REG("$2");
        register s32 d14 ASM_REG("$8");
        register s32 pi4 ASM_REG("$4");
        register s32 zy4 ASM_REG("$11");
        register s32 zx4 ASM_REG("$10");
        register s32 t4v ASM_REG("$3");
        s32 py4;
        s32 px4;
        u8 *zb4;
        zb4 = (u8 *)D_80024020;
...
Lc5:
    {
        register s32 s5 ASM_REG("$2");
        register s32 d15 ASM_REG("$8");
        register s32 zw5 ASM_REG("$4");
        s32 zy5;
        s32 zx5;
        s32 nx5;
        s32 py5;
