...
{
    TownRecord *records;
    register TownRecord *record ASM_REG("$16");
    register u8 *flagBase ASM_REG("$18");
    register u8 *argPtr ASM_REG("$23");
    register s32 count ASM_REG("$21");
    register s32 best ASM_REG("$20");
    register s32 bestIndex ASM_REG("$19");
