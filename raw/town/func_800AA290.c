...
M2C_UNK func_800A7AA8();                            /* extern */

void func_800A79F0(void *arg0, s32 arg1, void *arg2) {
    u16 temp_v0;
    s32 temp_v0_2;
    s32 var_v1;
    s32 var_v0;
    ...
    var_v0 = func_800644B8((s16) M2C_FIELD(arg0, u16 *, 0x6C) * 0xBA);
    if (var_v0 < 0) {
        var_v0 += 3;
    }
    M2C_FIELD(arg2, s16 *, 0x1E) = (s16) ((var_v0 >> 2) + 0x1000);
}
