...
void func_800A5DF8(void *arg0, void *arg1, M2C_UNK arg2) {
    ...
    register M2C_UNK var_s4 ASM_REG("$20");
    register u8 *var_s1;
    register u8 *var_s3;
    ...
    if (M2C_FIELD(var_s0, s16 *, 0xA) >= temp_v0) {
...
after_effect:
    if (func_800C1D44(func_8008C180(M2C_FIELD(var_v0, s16 *, 2), M2C_FIELD(var_v0, s16 *, 6)) & 0xFFFF) != 0) {
        M2C_FIELD(var_s0, s32 *, 0x14) = (s32) (M2C_FIELD(var_s0, s32 *, 0x14) - func_800A5894(var_s0));
    }
    func_80095094(var_s0);
    func_80095094(var_s0);
    temp_v0_2 = func_80094AA0(M2C_FIELD(var_s1, s16 *, 0xC8), 0, 0x80);
    M2C_FIELD(var_s1, s16 *, 0xC8) = temp_v0_2;
    if ((temp_v0_2 & 0xFFF) < 0x80) {
        M2C_FIELD(var_s1, s16 *, 0xC8) = 0;
    }
    temp_v0_3 = M2C_FIELD(var_s2, u16 *, 0xA) - 1;
    M2C_FIELD(var_s2, u16 *, 0xA) = temp_v0_3;
    ASM_SCHED_BARRIER();
    {
        ...
        quotient_v1 = -0x280;
        if (count_a0 <= 0) {
            M2C_FIELD(var_s2, s16 *, 0xA) = 0;
        }
        tail_v0 = count_a0 > 0
            ? (quotient_v1 = (quotient_v1 - M2C_FIELD(var_s1, s16 *, 0xC4)) / count_a0,
               M2C_FIELD(var_s1, u16 *, 0xC4) + quotient_v1)
            : -0x280;
        M2C_FIELD(var_s1, s16 *, 0xC4) = tail_v0;
        ASM_KEEP(quotient_v1);
    }
    if ((M2C_FIELD(var_s2, s16 *, 0xA) == 0) &&
        (M2C_FIELD(var_s1, s16 *, 0xC8) == 0)) {
        ...
        M2C_FIELD(var_s2, s16 *, 0xA) = 0;
        M2C_FIELD(var_s2, void **, 0) = D_800A5FDC;
    }
