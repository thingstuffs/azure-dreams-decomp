...
void func_8009B9BC(void *arg0, void *arg1, void *arg2, s32 arg3)
{
    ...
    if (current == (s32)&D_800930E4 || current == (s32)&D_80093250) {
        register void *a0r ASM_REG("$4") = arg0;
        register void *a1r ASM_REG("$5") = arg1;
        s32 selector;
        ASM_USE2(arg3, arg3);
        ASM_KEEP(a0r);
        selector = FIELD(FIELD(arg0, void *, 0x58), s32, 8);
        ASM_KEEP(selector);
    ...
    if (current == (s32)&D_800AA5F8) {
        ...
        ASM_USE2(arg3, arg3);
        ASM_KEEP(a0r);
        selector = FIELD(FIELD(arg0, void *, 0x58), s32, 0x14);
        ASM_KEEP(selector);
        func_8009BBDC(a0r, a1r, arg2);
        ASM_SCHED_BARRIER();
        return;
    ...
    if (current == (s32)&D_80093328) {
        ...
        ASM_USE2(arg3, arg3);
        ASM_KEEP(a0r);
        selector = FIELD(FIELD(arg0, void *, 0x58), s32, 0xC);
        ASM_KEEP(selector);
        func_8009BBDC(a0r, a1r, arg2);
        return;
    }
...

    {
        ...
        register void *a1r ASM_REG("$5") = arg1;
        ASM_KEEP(a0r);
        ((DispatchFn)FIELD(FIELD(arg0, void *, 0x58), void *, 0x10))(
            a0r, a1r, arg2, arg3);
    }
    func_8009BBF4();
    return;
