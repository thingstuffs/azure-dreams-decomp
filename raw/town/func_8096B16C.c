...
void func_80123604(void) {
...

    {
        ...
        tail_src += 0x6A18;
#endif
        FIELD(FIELD(FIELD(tail_dst, void *, 0x68), void *, 8), u16, 6) =
            FIELD(tail_src, u16, 0x64);
        FIELD(FIELD(FIELD(tail_dst, void *, 0x68), void *, 8), u16, 8) =
            FIELD(tail_src, u16, 0x66);
        FIELD(FIELD(FIELD(tail_dst, void *, 0x6C), void *, 8), u16, 6) =
            FIELD(tail_src, u16, 0x6C);
        FIELD(FIELD(FIELD(tail_dst, void *, 0x6C), void *, 8), u16, 8) =
