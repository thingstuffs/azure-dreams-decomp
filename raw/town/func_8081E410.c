...
{
    register s32 *world ASM_REG("$16") = (s32 *)D_80083780;
    s32 *close_page;
    s32 dx = (world[0] + (s32)0xFCA00000) >> 16;
    s32 dy = (world[1] + (s32)0xFCA00000) >> 16;
    register void *state ASM_REG("$18");
    register void *other ASM_REG("$22");
    register void *effect ASM_REG("$21");
    register void *sub ASM_REG("$20");
    s32 old_angle;
    LocalPoint point;
    s32 distance;
    register s32 x2 ASM_REG("$7");
    register s32 y2 ASM_REG("$9");
    s32 adx;
    s32 ady;
    s32 limit;
