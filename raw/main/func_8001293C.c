...
void func_8002593C(u8 *object)
{
    ...
    if (input != 0) {
        ...
        if (flags & 0x20) {
            ...
            func_80027AFC(FIELD(object, s32, 0x20), 0);
            goto epilogue;
        }
        if (flags & 0x40) {
            func_80053DA8(0x503);
            if (FIELD(object, s32, 0x48) == 0) {
        ...
        if (input & 0x5000) {
            if (flags & 0x5000) {
                ...
                value = FIELD(object, s32, 0x30);
                if (value >= 13) {
                    FIELD(object, s32, 0x30) = value - 4;
        ...
        if (input & 0xA000) {
            if (input & 0x2000) {
                FIELD(object, s32, 0x48) = 1;
                changed = 1;
                goto direction_check;
            }
            FIELD(object, s32, 0x48) = 0;
            changed = 1;
        }
...
direction_check:
        if (status != 0) {
            func_80053DA8(0x502);
            if (FIELD(object, s32, 0x48) == 1) {
                FIELD(object, s32, 0x28) =
                    func_80049DE8(FIELD(object, s32, 0x28), status, 5);
            } else {
                FIELD(object, s32, 0x44) =
                    func_80049DE8(FIELD(object, s32, 0x44), status, 3);
            }
