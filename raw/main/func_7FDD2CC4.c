...
#define sp74 (((s32 *)(frame + 0x40))[9])
    ...
    if (temp_v0 != NULL) {
        M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_8008A288;
        func_8004491C(temp_v0, &D_8008A794);
        var_s4 = temp_v0 + 0x20;
        M2C_FIELD(M2C_FIELD(temp_v0, void **, 8), s16 *, 6) = 0xF0;
        M2C_FIELD(var_s4, s16 *, 4) = 0x20;
        M2C_FIELD(var_s4, s16 *, 0x14) = (s16) ((u8) D_80013184 >> 5);
        var_s0 = 2;
        M2C_FIELD(var_s4, s16 *, 0xE) = (s16) D_80013180;
        M2C_FIELD(var_s4, s16 *, 0x10) = (s16) D_80013181;
        M2C_FIELD(var_s4, s16 *, 0x12) = (s16) D_80013182;
        do {
        ...
        if ((D_80013186 & 1) == 0) {
            M2C_FIELD(var_s4, u16 *, 0x16) = (u16) (M2C_FIELD(var_s4, u16 *, 0x16) | 2);
        } else {
            M2C_FIELD(var_s4, u16 *, 0x16) = (u16) (M2C_FIELD(var_s4, u16 *, 0x16) & 0xFFFD);
        }
    }
