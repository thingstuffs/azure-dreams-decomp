...
S_80083968 *func_8003E39C(s16 arg0, s32 arg1, s32 arg2)
{
  ...
  u8 idx;
  s32 kff;
  register u8 *hdr ASM_REG("$4");
  u8 *hdr2;
  register S_80083968 *tbl ASM_REG("$6");
  hdr = (u8 *) (&D_800814D1);
  ...
  {
    register u32 page ASM_REG("$2") = 0x80080000;
    ASM_KEEP_NV(page);
  ...
  if ((arg0 & 0xFF) == kff)
  {
    register S_80083968 *e1 ASM_REG("$2");
    ASM_KEEP_NV(tbl);
    e1 = &tbl[idx];
    *((s32 *) e1->unk08) = arg2;
  }
