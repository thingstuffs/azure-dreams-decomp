...
{
    register s32 n ASM_REG("$24") = arg5;
    s16 colors[16];
    s32 i;
    s32 inv;
    register s32 red_a ASM_REG("$12");
    register s32 red_b ASM_REG("$10");
    register s32 green_a ASM_REG("$11");
    s32 green_b, blue_a;
    register s32 blue_b ASM_REG("$17");
    s32 color;
    s32 t;
    register s32 pad16 ASM_REG("$16");
    u32 page;
    register s32 four ASM_REG("$15");
    register u8 *rowbase ASM_REG("$2");
    u8 *row;
