...
S_8004A330_Entity *func_8004A330(s32 p0, s32 p1, s32 p2, s32 p3,
    ...
    register S_8004A330_Entity *entity ASM_REG("$16");
    register S_8004A330_Sub20 *sub20 ASM_REG("$17");
    s32 resptr;
    register s32 saved_p0 ASM_REG("$23") = p0;
    register s32 saved_p1 ASM_REG("$22") = p1;
    register s32 saved_p2 ASM_REG("$20") = p2;
    register s32 saved_p3 ASM_REG("$18") = p3;
    register s32 saved_p4 ASM_REG("$19") = p4;
    register s32 saved_p5 ASM_REG("$21") = p5;
    u16 entity_flags;
    s32 global_flags;
#ifndef NON_MATCHING
    register s32 *global_page ASM_REG("$1");
#endif
