...
{
    register Entity *ent ASM_REG("$17") = arg0;
    s32 s0;
    s32 s2;
    s32 a2;
    register s32 s3 ASM_REG("$19");
    s32 idx;
...
L_case_47:
    ...
    return 1;
L_case_48: {
    register s32 v ASM_REG("$3") = func_800589B8(ent);
    register u32 count ASM_REG("$5");
    s2 = v;
    ASM_KEEP(s2);
    count = D_800869B4[0];
    ASM_KEEP(count);
...
L_case_49: {
    register s32 v ASM_REG("$2") = func_800589B8(ent);
    s2 = v;
    ASM_KEEP(v);
