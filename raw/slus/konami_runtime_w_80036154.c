...
void func_80036154(void *arg0) {
    ...
    temp_v1 = M2C_FIELD(M2C_FIELD(arg0, void **, 0x74), s32 *, 0x10);
...
block_10:
        M2C_FIELD(arg0, M2C_UNK **, 0x68) = var_v0;
    }
    func_80036988(arg0 + 0xC, M2C_FIELD(arg0, void **, 0x74));
    M2C_FIELD(M2C_FIELD(arg0, void **, 0x74), s8 *, 0x85) = 1;
}
