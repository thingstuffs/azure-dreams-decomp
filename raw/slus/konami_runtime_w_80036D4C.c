...
void func_80036D4C(s32 arg0, void *arg1, s32 *arg2, s16 arg3, s32 arg4, s32 arg5) {
    void *temp_s1;
    void *temp_s2;
    void *temp_v0;

    temp_v0 = func_8003FF2C(0x11, arg0, 0x49, &D_80082BC0);
    M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &func_80036F24;
    ...
    M2C_FIELD(temp_s2, s32 *, 0xC) = 0xC0C0C0;
    func_80036C7C(M2C_FIELD(temp_s1, s32 **, 0x44) + 3, &D_8006A958, &D_80082B50);
    func_80036C7C(M2C_FIELD(temp_s1, s32 **, 0x44) + 3, &D_8006A964, &D_80082B60);
    func_80036C7C(M2C_FIELD(temp_s1, s32 **, 0x44) + 3, &D_8006A970, &D_80082B70);
    M2C_FIELD(temp_s2, M2C_UNK **, 8) = &D_80082B60;
    M2C_FIELD(temp_s2, s32 *, 0) = 0;
    M2C_FIELD(temp_s2, s8 *, 4) = 0;
    M2C_FIELD(temp_s2, s8 *, 5) = 0;
    M2C_FIELD(temp_s2, u16 *, 0x14) = (u16) (M2C_FIELD(temp_s2, u16 *, 0x14) | 0x1C);
