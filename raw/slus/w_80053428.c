...
{
    register D80083160_t *base ASM_REG("$19");
    register TPagePkt *tpage_pkt ASM_REG("$17");
    register PolyF4 *poly ASM_REG("$16");
    register u32 mask_lo ASM_REG("$4");
    u32 mask_hi;
    register Ctx *ctx2 ASM_REG("$5");
    register u32 poly_addr ASM_REG("$3");
    s32 abr;
    u16 tp;
    s32 color;
