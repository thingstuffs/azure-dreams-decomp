...
{
    register S_8004F684 *self ASM_REG("$8");
    register s32 i ASM_REG("$10");
    u8 *row;
    register S_8004F684_Entry **slot ASM_REG("$11");
    s32 valA;
    s32 diff;
    s32 m;
    register s32 quot ASM_REG("$3");
    s32 scaled;
    register void *p ASM_REG("$4");
    S_8004F684_Obj *obj;
