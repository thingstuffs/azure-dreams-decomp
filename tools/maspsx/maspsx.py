...
def main() -> None:
    ...
    parser.add_argument("--preserve-casesi-at", action="store_true")
    parser.add_argument("--preserve-return-delay", action="store_true")
    parser.add_argument("--fill-shadowed-return-delay", action="store_true")
    ...
    if args.retain_tail_frame < 0 or args.retain_tail_frame % 4:
        parser.error("--retain-tail-frame must be a non-negative multiple of 4")
    ...
    maspsx_processor = MaspsxProcessor(
        ...
        preserve_casesi_at=args.preserve_casesi_at,
        preserve_return_delay=args.preserve_return_delay,
        fill_shadowed_return_delay=args.fill_shadowed_return_delay,
