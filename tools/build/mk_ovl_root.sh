...
for f in names.tsv slus_006.14.yaml slus_006.14.symbols.txt noreturn_evidence.main.c noreturn_syms.txt noreturn_syms.dungeon.txt noreturn_syms.town.txt noreturn_syms.ovmovie.txt sibcall_syms.txt sibcall_syms.dungeon.txt sibcall_syms.town.txt sibcall_syms.ovmovie.txt noreturn_false_members.jsonl; do
