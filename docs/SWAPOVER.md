...
transform applied: the 4-row dungeon micro window (8,860 B) and the 391-row MAIN boot window
(86,016 B) rebuild byte-identical. The platform-library assembly twins the windows stage are
