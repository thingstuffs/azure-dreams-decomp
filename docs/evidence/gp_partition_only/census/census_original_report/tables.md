...
|---|---|---|---|---|---|
| 6767 | 6765 | 2 | 6765 | 6765 | 6765 |

Errors: compile: module context: gp_d92c_owned: C includes must matc x1; compile: module context: gp_order_bytes_owner: C includes mu x1

**Rows exact under one common genuine ASPSX version: 6598 / 6765** (97.5%); ownerwise genuine-exact with no common version: 0; maspsx-dependent in at least one physical unit: 167 (of which a dependent unit cannot assemble at any version: 0).

Per version (rows exact / rows assembled):

| version | 2.56 | 2.67 | 2.77 | 2.79 | 2.81 | 2.86 |
|---|---|---|---|---|---|---|
| exact | 1996 | 6593 | 6598 | 6598 | 6598 | 6593 |
| assembled | 2048 | 6765 | 6765 | 6765 | 6765 | 6765 |
| %hi/%lo syntax errors | 4697 | 0 | 0 | 0 | 0 | 0 |
...
| slus | 2.7.2-cdk | 454 | 451 | 0 | 51 | 451 | 451 | 451 | 451 | 450 |
...
| **slus** | all | 882 | 869 | 0 | 435 | 869 | 869 | 869 | 869 | 865 |
...
| **tree** | all | 6765 | 6598 | 0 | 1996 | 6593 | 6598 | 6598 | 6598 | 6593 |

## Version sets (which genuine versions reproduce a row)

| exact under | rows |
|---|---|
| 2.67, 2.77, 2.79, 2.81, 2.86 | 4595 |
| all six | 1993 |
| none | 167 |
| 2.77, 2.79, 2.81, 2.86 | 5 |
| 2.56, 2.67, 2.77, 2.79, 2.81 | 3 |
| 2.67, 2.77, 2.79, 2.81 | 2 |
...
|---|---|---|---|---|---|---|---|---|
| slus | 869 | 435 | 869 | 869 | 869 | 869 | 865 | 0 |
...
| tree | 6598 | 1996 | 6593 | 6598 | 6598 | 6598 | 6593 | 0 |

Genuine-exact rows that 2.56 also reproduces, by cell: 2.6.3 252/252, 2.7.2 592/592, 2.7.2-cdk 1137/5671, 2.8.0 5/12, 2.8.1 7/60, 2.91.66 2/3, 2.95.2 1/8
