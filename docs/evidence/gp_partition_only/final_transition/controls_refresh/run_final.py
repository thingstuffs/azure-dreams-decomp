...
LANE = HERE.parent
FIXTURE = HERE / "fixture_final"
LOG = HERE / "final_run.log"
...
def main() -> None:
    ...
    receipt = {
        ...
        "log_sha256": sha(LOG),
        "prepare_receipt_sha256": sha(HERE / "prepare_final_receipt.json"),
    ...
    (HERE / "final_run_receipt.json").write_text(json.dumps(receipt, indent=2) + "\n")
