"""Private contract tests imported only from the partition-only candidate tools."""
...
TOOLS = CANDIDATE / "tools/build"
sys.path.insert(0, str(TOOLS))
import slus_modules as M  # noqa: E402
import slus_partitions as P  # noqa: E402

assert Path(M.__file__).resolve() == TOOLS / "slus_modules.py"
assert Path(P.__file__).resolve() == TOOLS / "slus_partitions.py"
