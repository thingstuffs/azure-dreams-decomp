...
{
    S_8006E704 **read_slots = D_80080AF4;

    if (D_8006E704[entry_index] == read_slots[D_80080AFC]) {
        return 1;
    }
    ...
    if (D_8006E704[entry_index] != read_slots[D_80080AFC]) {
        ...
        {
            S_8006E704 **write_slots = D_80080AF4;
            write_slots[D_80080AFC] = D_8006E704[entry_index];
        }
        func_8003F320();
    }
