...
- C shape / vertex region: continue from staged v12, testing a real split of vertex-3 pointer/y and source-level embedded assignment order. Success criterion is the retail word-104–172 access/order map with the existing frame.
