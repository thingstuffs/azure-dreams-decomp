...
s32 func_8001ADE0(s32 arg0) {
    ...
    if (arg0 != 0) {
        if (arg0 != 1) {
            ...
            temp_v1 = 1;
            temp_v1 <<= temp_v0;
            ASM_KEEP(temp_a1);   /* UNRESOLVED C shape (pin): removing it moves a statement across a call/branch; the source shape that makes it unnecessary has not been found */
