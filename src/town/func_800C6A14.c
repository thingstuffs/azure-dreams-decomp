...
typedef struct S_800C4174_0 {
    u8 pad_00[0x80];
    void * unk_80;
} S_800C4174_0;   /* arg0 in func_800C4174 */

typedef struct S_800C4174_1 {
    u8 pad_00[0x4];
    s32 unk_04;
} S_800C4174_1;   /* ((S_800C4174_0 *)arg0)->unk_80 in func_800C4174 */
...
void func_800C4174(void *arg0, M2C_UNK arg1, M2C_UNK arg2) {
    func_800C2E84(arg0, arg2, ((S_800C4174_1 *)(((S_800C4174_0 *)arg0)->unk_80))->unk_04);
