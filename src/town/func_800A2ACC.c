...
typedef struct S_800A022C_1 {
    u8 pad_00[0xC];
    s32 unk_0C;
    s32 unk_10;
    s32 unk_14;
} S_800A022C_1;   /* arg2 in func_800A022C */
...
void func_800A022C(S_800A022C_2 *arg0, S_800A022C_0 *arg1, S_800A022C_1 *arg2) {
    arg1->unk_15 = 1;
    arg2->unk_0C = 0;
    arg2->unk_10 = 0;
    arg2->unk_14 = 0xFFF20000;
    func_8009539C(arg2);
