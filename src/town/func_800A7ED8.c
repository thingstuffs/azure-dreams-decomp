...
typedef struct S_800A5638_2 {
    M2C_UNK (*unk_00)(void *, void *, M2C_UNK);
} S_800A5638_2;   /* arg0 in func_800A5638 */
...
typedef struct S_800A5638_0 {
    ...
    u8 pad_04[0xA];
    u16 unk_0E;
} S_800A5638_0;   /* arg0 in func_800A5638; pointer addresses record offset 0x10 */

typedef struct S_800A5638_1 {
    u8 pad_00[0x4];
    s32 unk_04;
    s32 unk_08;
    u8 pad_0C[0x4];
    s32 unk_10;
} S_800A5638_1;   /* arg1 in func_800A5638 */
...
void func_800A5638(void *arg0, S_800A5638_1 *arg1, M2C_UNK arg2) {
    func_800953D0(arg1);
    ...
    ((S_800A5638_2 *)arg0)->unk_00(arg0, arg1, arg2);
    if (!(((S_800A5638_0 *)((u8 *)arg0 - 0x10))->unk_0E & 0x8000)) {
        if (arg1->unk_04 <= 0x06500000) {
            arg1->unk_04 = 0x06500000;
            arg1->unk_10 = 0x180000;
            if (arg1->unk_08 > 0) {
                arg1->unk_08 = 0;
            }
        }
        if (((S_800A5638_0 *)((u8 *)arg0 - 0x10))->unk_00 == &D_800903FC) {
