...
void func_80123604(void) {
    ...
    {
        register u8 *tail_src ASM_REG("$5");   /* MATCH pin: retail register colouring depends on it */
        register u8 *tail_dst ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
