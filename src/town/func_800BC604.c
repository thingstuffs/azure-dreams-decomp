...
typedef struct S_800B9D64_0 {
    ...
    u8 * unk_98;
    void * unk_9C;
} S_800B9D64_0;   /* arg0 in func_800B9D64 */
...
typedef struct S_800B9D64_2 {
    u8 pad_00[0x66];
    s16 unk_66;
} S_800B9D64_2;   /* ((S_800B9D64_0 *)arg0)->unk_9C in func_800B9D64 */
...
void func_800B9D64(void *arg0, void *arg1)
{
    ...
    angle = ((S_800B9D64_2 *)(((S_800B9D64_0 *)arg0)->unk_9C))->unk_66;
    sector = angle / 0x200;
    if ((s8)(sector % 4) == ((S_800B9D64_0 *)arg0)->unk_97) {
        value = func_800644B8((s16)(angle % 0x200) * 2);
        ((S_800B9D64_1 *)arg1)->unk_08 = -((value >> 4) * 0x1E00);
        ((S_800B9D64_0 *)arg0)->unk_66 = 30;
        func_800B9EC4();
        return;
    }

    if (((S_800B9D64_0 *)arg0)->unk_66 != 0) {
        s32 value2;
        s32 magnitude;

        ((S_800B9D64_0 *)arg0)->unk_66 = (u16)((S_800B9D64_0 *)arg0)->unk_66 - 3;
        angle2 = ((S_800B9D64_2 *)(((S_800B9D64_0 *)arg0)->unk_9C))->unk_66;
        magnitude = ((func_80064584((s16)(angle2 % 0x200) * 0x18) >> 4)
                     * ((S_800B9D64_0 *)arg0)->unk_66) << 8;
        value2 = -magnitude;
