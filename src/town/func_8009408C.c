...
void func_800917EC(Rec_func_80094268_arg0 *arg0, S_800917EC_0 *arg1, M2C_UNK arg2) {
    u8 *state = D_80083160;
    s16 temp_v0;
    s16 temp_v0_3;
    s32 *temp_s0;
    ...
    if ((temp_v0_2 << 0x10) <= 0) {
        arg0->unk_0A.as_u16 = (u16)(func_800374F4(4) + 3);
    ...
    if ((state_flags & 0xF000) && (state_flags & 0x20)) {
        temp_v0_3 = arg0->unk_3E.as_u16 - 1;
        arg0->unk_3E.as_u16 = (u16)temp_v0_3;
