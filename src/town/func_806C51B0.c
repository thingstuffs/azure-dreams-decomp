...
typedef struct S_806C51B0_2 {
    ...
    s32 unk_04;
    s32 unk_08;
} S_806C51B0_2;   /* ((S_806C51B0_1 *)(((Rec_D_80016000 *)(&D_80016000))->unk_00.at00_pv.v))->unk_1C in func_806C51B0 */
...
} S_806C51B0_3;   /* ((S_806C51B0_1 *)(((Rec_D_80016000 *)(&D_80016000))->unk_00.at00_pv.v))->unk_20 in func_806C51B0 */
