...
void func_8009F374(S_8009F374_1 *arg0, M2C_UNK arg1, S_8009F374_0 *arg2, S_8009F374_2 *arg3) {
    s16 temp_v0;
    s32 var_v0;
    s32 var_v0_2;

    arg2->unk_08 = (s32) (arg0->unk_A0 + (((func_800374F4(0x10) & 0xFFFF) - 8) << 0x10));
    var_v0 = func_800644B8(arg0->unk_6C * 0x199);
    if (var_v0 < 0) {
        var_v0 += 3;
    }
