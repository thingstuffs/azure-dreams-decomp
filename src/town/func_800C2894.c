...
s32 func_800BFFF4(u8 *node)
{
    ...
    do {
        ...
        coordinates[0] = ((S_800BFFF4_0 *)node)->unk_1E; coordinates[1] = ((S_800BFFF4_0 *)node)->unk_22; coordinates[2] = ((S_800BFFF4_0 *)node)->unk_26;
        ...
        next = ((S_800BFFF4_0_pre *)node)[-1].unk_00;
        if (next != 0) {
            node = next + 0x20;
            continue;
        }
