...
typedef struct S_800BC00C_1 {
    u8 pad_00[0xC];
    s32 unk_0C;
    u8 pad_10[0xC];
    u16 unk_1C;
    u16 unk_1E;
} S_800BC00C_1;   /* arg2 in func_800BC00C */
...
s32 func_800BC00C(void *arg0, S_800BC00C_2 *arg1, S_800BC00C_1 *arg2) {
    s16 temp_v1;
    s32 temp_a0;
    s32 temp_a1;
    s32 temp_v0_2;
...
state_0:
    ...
    arg2->unk_1E = temp_v0;
    arg2->unk_1C = temp_v0;
    arg2->unk_0C = (s32) (arg2->unk_0C + 0x80808);
...
state_1:
    ...
    arg2->unk_0C = (s32) (arg2->unk_0C + 0xFFF7F7F8);
    temp_v0_2 = 0xFF;
    if ((u8) arg2->unk_0C == 0) {
