...
typedef struct S_80016BD4_0 {
    s32 unk_00;
    u8 pad_04[0x10];
    s32 unk_14;
} S_80016BD4_0;   /* D_80016000 in func_80016BD4 */
...
extern S_80016BD4_0 *D_80016000;
...
void func_80016BD4(void) {
    ...
    ((S_80016BD4_2 *)(((temp_a1 * 0x10) + temp_a0->unk_10)))->unk_04(temp_a0, temp_a1, D_80016000->unk_00);
}
