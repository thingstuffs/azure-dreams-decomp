...
typedef struct S_80016100_0 {
    u8 pad_00[0x20];
    void * unk_20;
} S_80016100_0;   /* D_80016000 in func_80016100 */

typedef struct S_80016100_1 {
    u8 pad_00[0x330];
    s32 (*unk_330)(M2C_UNK);
    s32 (*unk_334)(M2C_UNK);
} S_80016100_1;   /* ((S_80016100_0 *)D_80016000)->unk_20 in func_80016100 */
...
extern S_80016100_0 *D_80016000;
