...
void func_8070207C(s32 arg0) {
    ...
    s32 temp_s1;   /* MATCH pin: keeps a statement from moving across a call/branch */
    s32 final_index;   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */

    temp_s1 = arg0;
       /* MATCH pin: retail callee-saved set / frame layout depends on it */
    temp_s0 = arg0 * 4;
