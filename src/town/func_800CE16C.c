...
typedef struct S_800CB8CC_3 {
    u8 pad_00[0x10];
    M2C_UNK (*unk_10)(void *, s32, void *);
} S_800CB8CC_3;   /* temp_v0 in func_800CB8CC */
...
s32 func_800CB8CC(s32 arg0, s32 arg1) {
    ...
    temp_s1->unk_9C = arg0;
    ((S_800CB8CC_3 *)temp_v0)->unk_10 = D_800CB9B8;
    ...
    ((S_800CB8CC_3 *)temp_v0)->unk_10(temp_s1, temp_s2, temp_s0);
    return (s32)temp_v0;
}
