...
void func_800CD650(Rec_func_80094268_arg0 *arg0, M2C_UNK arg1, M2C_UNK arg2) {
    s32 *temp_v0;
    u16 temp_v0_2;

    if ((func_800C30E0() == 0) && ((temp_v0 = func_8008FAC0(arg0, &D_800CFCB4), (temp_v0 == NULL)) || (*temp_v0 == 2)) && (temp_v0_2 = arg0->unk_6C.as_u16 - 1, arg0->unk_6C.as_u16 = temp_v0_2, ((temp_v0_2 << 0x10) <= 0))) {
