...
void func_80020618(void *arg0)
{
    ...
    owner = ((S_80020618_0 *)arg0)->unk_0C;
    func_800537D0(
        *((S_80020618_0 *)arg0)->unk_08,
        strlen(((S_80020618_0 *)arg0)->unk_04),
        ((S_80020618_0 *)arg0)->unk_04);

    state = ((S_80020618_0 *)arg0)->unk_00.s;
    switch (state) {
    case 0:
        timer = ((S_80020618_0 *)arg0)->unk_02 - 1;
        ((S_80020618_0 *)arg0)->unk_02 = timer;
        if ((timer << 16) <= 0) {
            ((S_80020618_0 *)arg0)->unk_1C &= 0xFFFD;
            ((S_80020618_0 *)arg0)->unk_00.u++;
        }
        break;
