...
typedef struct S_806F1A40_0 {
    u8 pad_00[0x20];
    void * unk_20;
} S_806F1A40_0;   /* D_80016000 in func_806F1A40 */

typedef struct S_806F1A40_1 {
    u8 pad_00[0x334];
    s32 (*unk_334)(M2C_UNK);
} S_806F1A40_1;   /* ((S_806F1A40_0 *)D_80016000)->unk_20 in func_806F1A40 */
...
extern S_806F1A40_0 *D_80016000;
