...
typedef struct S_806F18F8_2 {
    void * unk_00;
} S_806F18F8_2;   /* &D_80016000 in func_806F18F8 */
...
typedef struct S_806F18F8_5 {
    u8 pad_00[0x20];
    void * unk_20;
} S_806F18F8_5;   /* ((S_806F18F8_2 *)(&D_80016000))->unk_00 in func_806F18F8 */

typedef struct S_806F18F8_6 {
    u8 pad_00[0x228];
    M2C_UNK (*unk_228)(s32 *);
} S_806F18F8_6;   /* ((S_806F18F8_5 *)(((S_806F18F8_2 *)(&D_80016000))->unk_00))->unk_20 in func_806F18F8 */
...
typedef struct S_806F18F8_0 {
    void * unk_00;
} S_806F18F8_0;   /* &D_80016000 in func_806F18F8 */

void func_806F18F8(void) {
    s32 record[6];
    S_806F18F8_1 *state;

    state = ((S_806F18F8_0 *)(&D_80016000))->unk_00;
    record[0] = ((S_806F18F8_3 *)(state->unk_1C))->unk_04;
    record[1] = ((S_806F18F8_3 *)(state->unk_1C))->unk_04;
    record[2] = 0;
    ((S_806F18F8_4 *)(state->unk_20))->unk_208(0);
    ((S_806F18F8_6 *)(((S_806F18F8_5 *)(((S_806F18F8_2 *)(&D_80016000))->unk_00))->unk_20))->unk_228(record);
}
