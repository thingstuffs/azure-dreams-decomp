...
void func_80172DD0(S_80172DD0_1 *arg0, S_80172DD0_2 *arg1, S_80172DD0_3 *arg2, void *arg3)
{
    s16 timer;
    s32 index;
    s32 value;
    ...
    index = (((S_80172DD0_0 *)arg3)->unk_6A >> 9) & 7;
    switch (arg0->unk_9B) {
    case 0:
        func_800AD4D0(arg3);
        arg1->unk_0C =
        ...
        if (((S_80172DD0_0 *)arg3)->unk_1C & 0x228) {
            timer = 8;
        } else {
            timer = -1;
        }
...
increment_state:
    ...
    case 2:
        if (arg0->unk_96.s != 0) {
            ...
            arg1->unk_0C += arg1->unk_0C >> 1;
            arg1->unk_10 += arg1->unk_10 >> 1;
        }
