...
s16 func_800ADDA0(void *arg0, void *arg1, void *arg2, s16 arg3, s16 arg4,
                   s32 arg5) {
    register u16 entityFlags ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
    ...
    if (result && (result != 2) && (result != 3) &&
        ...
        register s16 returnValue ASM_REG("$2") = -1;   /* MATCH pin: retail register colouring depends on it */

        ASM_USE(returnValue);   /* MATCH pin: retail delay-slot contents depend on it */
