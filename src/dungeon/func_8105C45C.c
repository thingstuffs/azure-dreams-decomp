...
typedef struct S_80173C5C_1 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_80173C5C_1;   /* arg2 in func_80173C5C */

typedef struct S_80173C5C_2 {
    u8 pad_00[0x1C];
    s32 unk_1C;
    u8 pad_20[0xA];
    s16 unk_2A;
    ...
    u8 pad_48[0x25];
    s8 unk_6D;
} S_80173C5C_2;   /* arg3 in func_80173C5C */

typedef struct S_80173C5C_3 {
    u8 pad_00[0xC];
    s32 unk_0C;
    s32 unk_10;
    s32 unk_14;
} S_80173C5C_3;   /* arg1 in func_80173C5C */
...
void func_80173C5C(S_80173C5C_0 *arg0, S_80173C5C_3 *arg1, S_80173C5C_1 *arg2, S_80173C5C_2 *arg3) {
...
block_5:
    ...
    arg2->unk_2C = &D_80173FD8;
    func_80047784(arg2, (&D_80173FD8)[((s32) (*D_80083228 + arg3->unk_2A + 0x100) >> 9) & 7], 0);
    arg0->unk_98 = (u16) (arg0->unk_98 | 8);
    arg1->unk_14 = 0xFFF00000;
...
jt_c5:
    ...
    temp_v0 = temp_v1_3;
    temp_v1_3 = arg1->unk_14;
    arg0->unk_A0 = (s32) (temp_v0 + temp_v1_3);
    arg1->unk_14 = (s32) (arg1->unk_14 + 0x30000);
block_10:
    temp_v0 = arg0->unk_90;
    temp_v1_3 = arg0->unk_A0;
    temp_a0 = arg0->unk_96.u;
    ...
    arg3->unk_1C = (s32) (arg3->unk_1C | 0x8000000);
    goto block_e5c;
jt_c2:
jt_c6:
    arg0->unk_98 = (u16) (arg0->unk_98 & 0xFFF7);
    ...
    arg2->unk_2C = &D_80173FE0;
    func_80047784(arg2, ((u8 *) ((u32) ((((s32) (*D_80083228 + arg3->unk_2A + 0x100) >> 9) & 7) + (u32) &D_80173FE0)))[0], 0);
    goto block_e5c;
jt_c3:
    if (!(arg2->unk_14 & 0xE000)) {
        goto block_20;
    }
    arg2->unk_2C = D_80173FD0;
    func_80047784(arg2, D_80173FD0[((s32) (*D_80083228 + arg3->unk_2A + 0x100) >> 9) & 7], 0);
    block_e5c:
    temp_state = arg0->unk_9B;
    block_e60:
...
jt_c7:
    ...
    arg2->unk_2C = D_80173FB8;
    func_80047784(arg2, D_80173FB8[((s32) (*D_80083228 + arg3->unk_2A + 0x100) >> 9) & 7], 0);
