...
typedef struct S_80176084_1 {
    ...
    u8 pad_2C[0x1A];
    u16 unk_46;
} S_80176084_1;   /* arg3 in func_80176084 */

typedef struct S_80176084_2 {
    u8 pad_00[0x6];
    s16 unk_06;
    u8 pad_08[0xC];
    u16 unk_14;
    ...
    u8 unk_24;
    u8 unk_25;
} S_80176084_2;   /* arg2 in func_80176084 */

typedef struct S_80176084_3 {
    u8 pad_00[0xC];
    s32 unk_0C;
    s32 unk_10;
    s32 unk_14;
} S_80176084_3;   /* arg1 in func_80176084 */
...
void func_80176084(void *arg0, void *arg1, void *arg2, void *arg3) {
    ...
    func_80047784(arg2, D_800E2448[((s32)(D_80083228 + ((S_80176084_1 *)arg3)->unk_2A + 0x100) >> 9) & 7], 0);
    if ((((S_80176084_2 *)arg2)->unk_14 & 0x8000) ||
        (func_800A56E0(0x801), ((((S_80176084_2 *)arg2)->unk_14 & 0x8000) != 0))) {
block_10:
        temp_v0 = ((S_80176084_0 *)arg0)->unk_96;
        ((S_80176084_0 *)arg0)->unk_96 = (u16)(temp_v0 - 1);
        if (((temp_v0 << 0x10) <= 0) || (((S_80176084_2 *)arg2)->unk_14 & 0xE000)) {
            ((S_80176084_3 *)arg1)->unk_14 = 0;
            ((S_80176084_3 *)arg1)->unk_10 = 0;
            ((S_80176084_3 *)arg1)->unk_0C = 0;
            func_800A2B04(arg1, ((S_80176084_2 *)arg2)->unk_24, ((S_80176084_2 *)arg2)->unk_25);
            ((S_80176084_1 *)arg3)->unk_1C |= 0x40000;
            ((S_80176084_0 *)arg0)->unk_B5 = 0;
            ((S_80176084_0 *)arg0)->unk_98 |= 8;
            (*(M2C_UNK * *)((u8 *)arg2 + 0x2C)) = (M2C_UNK *)D_800E23E0;
            func_80047784(arg2, D_800E23E0[((s32)(D_80083228 + ((S_80176084_1 *)arg3)->unk_2A + 0x100) >> 9) & 7], 0);
...
block_15:
            ...
            if (((temp_v0_2 << 0x10) <= 0) || (((S_80176084_2 *)arg2)->unk_14 & 0xE000)) {
                ((S_80176084_2 *)arg2)->unk_06 = 0;
                ...
                if (((S_80176084_0 *)arg0)->unk_B4 == 0) {
                    ...
                    ((S_80176084_1 *)arg3)->unk_46 &= 0x7FFF;
                }
