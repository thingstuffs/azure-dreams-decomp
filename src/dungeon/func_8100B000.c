...
void *BODY_NAME(s32 arg0, s8 arg1, s8 arg2, s16 arg3) {
    ...
    void *obj;
    register S_8100B000_2 *part_a ASM_REG("$20");   /* UNRESOLVED C shape (pin): removing it changes the address form (%hi/%lo vs base+offset); the source shape that makes it unnecessary has not been found */
    S_8100B000_3 *part_b;
    S_8100B000_4 *actor;
