...
typedef struct S_80174704_0 {
    ...
    u8 unk_9B;
    u8 pad_9C[0x10];
    union { void * s; u8 * u; } unk_AC;   /* accessed as both */
...
typedef struct S_80174704_3 {
    ...
    u8 pad_05[0x3];
    void * unk_08;
    union { u8 * s; s32 u; } unk_0C;   /* accessed as both */
...
jt_c1:
    ...
    ((S_80174704_1 *)arg3)->unk_8A = ((S_80174704_1 *)arg3)->unk_2A.s;
...
jt_c2:
    {
        ...
        direction = ((D_80083228[0] + ((S_80174704_1 *)arg3)->unk_2A.u + 0x100) >> 9) & 7;
        angle = ((S_80174704_1 *)arg3)->unk_2A.s;
...
direction_not_ready:
        ...
        ((S_80174704_1 *)arg3)->unk_2A.s = angle + 0x200;
        return;
...
direction_ready:
        ...
        ((S_80174704_0 *)arg0)->unk_96.s = 0x10;
        ((S_80174704_0 *)arg0)->unk_9B++;
    }

jt_c3:
    {
        u16 old_timer = ((S_80174704_0 *)arg0)->unk_96.s;
        u16 timer = old_timer - 1;
        u8 *target;

        ((S_80174704_0 *)arg0)->unk_96.s = timer;
        if ((s32)(timer << 16) <= 0) {
            u8 finished = D_80174E3D[0];
            ((S_80174704_0 *)arg0)->unk_96.s = old_timer;
            if (finished == 0) {
                goto done;
            }
            ((S_80174704_0 *)arg0)->unk_9B++;
...
jt_c4:
    ...
    ((S_80174704_3 *)var_s0)->unk_10.s = D_801745D8;
    func_8004491C(var_s0, D_80173F68);
    color = 0x00808080;
    ((S_80174704_0 *)arg0)->unk_AC.s = var_s0;
    ...
    var_s0 = ((S_80174704_3 *)var_s0)->unk_0C.s;
    ((S_80174704_3 *)var_s0)->unk_1E = 0x1000;
    ((S_80174704_3 *)var_s0)->unk_1C = 0x1000;
    ((S_80174704_3 *)var_s0)->unk_0C.u = color;
    {
...
jt_c5:
    {
        u16 old_timer = ((S_80174704_0 *)arg0)->unk_96.s;
        ((S_80174704_0 *)arg0)->unk_96.s = old_timer + 1;
        if ((s16)old_timer < 30) {
    ...
    var_s0 = ((S_80174704_0 *)arg0)->unk_AC.u;
    var_s0 = ((S_80174704_3 *)var_s0)->unk_0C.s;
    if (((S_80174704_3 *)var_s0)->unk_14 & 0xE000) {
        ...
        func_8009A028(arg3);
        var_s0 = (u8 *)arg3 - 0x20;
        ((S_80174704_3 *)var_s0)->unk_10.u |= 0x80000000;
    }
...
jt_c7:
    {
        ...
        ((S_80174704_0 *)arg0)->unk_96.s = 0x10;
        ((S_80174704_0 *)arg0)->unk_9B++;
        ((S_80174704_11 *)(((S_80174704_1 *)arg3)->unk_60))->unk_2A = ((S_80174704_1 *)arg3)->unk_2A.s;
        {
...
jt_c8:
    {
        u16 timer = ((S_80174704_0 *)arg0)->unk_96.s - 1;
        ((S_80174704_0 *)arg0)->unk_96.s = timer;
        if ((s32)(timer << 16) > 0) {
            goto done;
        }
