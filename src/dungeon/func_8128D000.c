...
void BODY_NAME(void *root_data, void *out_coords, void *dst_data)
{
    ...
    out_coords = owner->unk_0C;
    coord_data = owner->unk_08;

    if (!(((S_8128D000_2 *)out_coords)->unk_14 & 0x80)) {
        dst->unk_14 &= 0xFF7F;
    }
    ...
    dst->unk_1C = ((S_8128D000_2 *)out_coords)->unk_1C;
    dst->unk_1E = ((S_8128D000_2 *)out_coords)->unk_1E;
    dst->unk_14 = ((S_8128D000_2 *)out_coords)->unk_14;
    ...
    if (((S_8128D000_0 *)root)->unk_B6 == 1) {
        ...
        if (!(((S_8128D000_2 *)out_coords)->unk_14 & 0x8000) &&
            ((S_8128D000_2 *)out_coords)->unk_04.u16 == 0x10C) {
            func_800A4398(0x709);
        }
    }
    ...
    if (((S_8128D000_0 *)root)->unk_B6 == 2) {
        ...
        if (!(((S_8128D000_2 *)out_coords)->unk_14 & 0x8000) &&
            ((S_8128D000_2 *)out_coords)->unk_04.u16 == 0x104) {
            func_800A4398(0x709);
        }
    }
