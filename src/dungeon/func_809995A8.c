...
extern void func_8014CF3C(void) __attribute__((noreturn));
extern void func_8014CFE4(void) __attribute__((noreturn));
extern void func_8014D050(void) __attribute__((noreturn));
extern void func_8014D408(void) __attribute__((noreturn));
...
void func_8014CDA8(void *arg0_, void *arg1_, void *arg2_)
{
    ...
    D_80150168[(*(u8 *)((u8 *)arg0 + 0x9A))](arg0, arg1, arg2, arg0);
    if ((s16)old_state != (*(s8 *)((u8 *)arg0 + 0x6D))) {
        func_800AA36C(arg0, arg1, arg2, arg0);
    }

    ((S_8014CDA8_0 *)arg1)->unk_00.at00.v += ((S_8014CDA8_0 *)arg1)->unk_0C;
    ((S_8014CDA8_0 *)arg1)->unk_04.at00.v += ((S_8014CDA8_0 *)arg1)->unk_10;

    if (!((*(u32 *)((u8 *)arg0 + 0x1C)) & 0x40000) &&
        !((*(u16 *)((u8 *)arg0 + 0x98)) & 8)) {
        ((S_8014CDA8_0 *)arg1)->unk_14 += (*(s8 *)((u8 *)arg0 + 0x9D)) * 0x14000;
        (*(u8 *)((u8 *)arg0 + 0x9D))++;
        func_8014CF3C();
    }
    ...
    if (!(part_flags & 0x8000)) {
        direction = ((D_80083228 + ((S_8014CDA8_2 *)state)->unk_2A + 0x100) >> 9) & 7;
        direction_copy = direction;
        if ((*(s16 *)((u8 *)arg0 + 0x94)) != direction_copy) {
            func_80047738(arg2,
                (*(u8 *)((u8 *)(((S_8014CDA8_1 *)arg2)->unk_2C) + direction_copy)),
                ((S_8014CDA8_1 *)arg2)->unk_04.s8);
        ...
        func_800A020C(((S_8014CDA8_2 *)state)->unk_1C.s, (u8 *)arg2 + 0xC);
        if (!(((S_8014CDA8_2 *)state)->unk_1C.u & 0x20)) {
            ...
            ((S_8014CDA8_1 *)arg2)->unk_14 |= 0x7000;
            ((S_8014CDA8_2 *)state)->unk_1C.u &= 0xFFFBFFFF;
        }

        {
            u32 masked_flags;
            masked_flags = ((S_8014CDA8_2 *)state)->unk_1C.u & 0xF7FFFFFF;
            ((S_8014CDA8_2 *)state)->unk_1C.u = masked_flags;
        ...
        if (!(((S_8014CDA8_1 *)arg2)->unk_14 & 0x40)) {
            if (((S_8014CDA8_1 *)arg2)->unk_2C == D_801500E0) {
                if (((S_8014CDA8_1 *)arg2)->unk_04.u16 == 0x100) {
                    (*(u16 *)((u8 *)arg0 + 0x9E)) = 0;
                }
                ...
                (*(s32 *)((u8 *)arg0 + 0xA0)) = func_800644B8(call_arg) << 7;
                if (((S_8014CDA8_1 *)arg2)->unk_04.u16 == 0x103) {
                    (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_801500E0;
                    tail_index = D_80083228;
                    tail_state = ((S_8014CDA8_2 *)state)->unk_2A;
                    tail_arg = arg2;
                    tail_index = ((tail_index + tail_state + 0x100) >> 9) & 7;
                    tail_value = &D_801500E0[tail_index];
play_tail_value_1:
    ...
    ((S_8014CDA8_1 *)arg2)->unk_14 = (part_flags & 0x800)
        ? (part_flags & 0x8FFF)
        : (part_flags | 0x7000);
    ((S_8014CDA8_2 *)state)->unk_1C.u &= 0xF7FFFFFF;
    if (!(((S_8014CDA8_2 *)state)->unk_1C.u & 0x40000)) {
reset_offset:
        ...
        if (!((*(u16 *)((u8 *)arg0 + 0x98)) & 8)) {
            ground = func_800BCB04(((S_8014CDA8_0 *)arg1)->unk_00.at02.v,
                ((S_8014CDA8_0 *)arg1)->unk_04.at02.v,
                (s16)(((S_8014CDA8_2 *)state)->unk_88 - 0x20));
            delta = ground - ((S_8014CDA8_2 *)state)->unk_88;
            if (delta < (*(s16 *)((u8 *)arg0 + 0x92))) {
                (*(s16 *)((u8 *)arg0 + 0x92)) = delta;
                (*(u8 *)((u8 *)arg0 + 0x9D)) = 0;
                ((S_8014CDA8_0 *)arg1)->unk_14 = 0;
                ((S_8014CDA8_2 *)state)->unk_1C.u |= 0x08000000;
                func_8014D408();
            }
        }
        goto final_adjustment;
...
final_adjustment:
    flags = ((S_8014CDA8_2 *)state)->unk_1C.u;
    if (flags & 0x40000000) {
        ((S_8014CDA8_2 *)state)->unk_1C.u = flags & 0xBFFFFFFF;
        ground = func_800BCB04(
            (((S_8014CDA8_1 *)arg2)->unk_24 << 6) | 0x20,
            (((S_8014CDA8_1 *)arg2)->unk_25 << 6) | 0x20,
            (s16)(((S_8014CDA8_2 *)state)->unk_88 - 0x20));
        if (ground < 0x200) {
            (*(s16 *)((u8 *)arg0 + 0x92)) =
                (((S_8014CDA8_2 *)state)->unk_88 - ground) +
                (*(u16 *)((u8 *)arg0 + 0x92));
            ((S_8014CDA8_2 *)state)->unk_88 = ground;
        }
    }

    ((S_8014CDA8_0 *)arg1)->unk_0A = ((S_8014CDA8_2 *)state)->unk_88 +
        (*(u16 *)((u8 *)arg0 + 0x92)) - (*(u16 *)((u8 *)arg0 + 0xA2));
    ((S_8014CDA8_1 *)arg2)->unk_14 |= 0x40;
}
