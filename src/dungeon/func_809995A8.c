...
extern void D_8014D4D4(void);
extern u8 D_801500E0[];
extern u8 D_801500E8[];
extern Callback D_80150168[];


typedef struct S_8014CDA8_0 {
    ...
    s32 unk_10;
    s32 unk_14;
} S_8014CDA8_0;   /* arg1 in func_8014CDA8 */

typedef struct S_8014CDA8_1 {
    u8 pad_00[0x4];
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_8014CDA8_1;   /* arg2 in func_8014CDA8 */

typedef struct S_8014CDA8_2 {
    u8 pad_00[0x1C];
    ...
    u8 pad_2C[0x5C];
    u16 unk_88;
} S_8014CDA8_2;   /* state in func_8014CDA8 */

/* Updates entity callbacks, movement, directional animation, and ground height. */
void func_8014CDA8(void *entity_in, void *motion_in, void *sprite_in)
{
    ...
    if (D_80083462 & 0x2000) {
        ...
        if (paused_callback == (Callback)D_8014D4D4) {
    ...
    D_80150168[(*(u8 *)((u8 *)entity + 0x9A))](entity, motion, sprite, entity);
    if ((s16)prev_state != (*(s8 *)((u8 *)entity + 0x6D))) {
        func_800AA36C(entity, motion, sprite, entity);
    }

    ((S_8014CDA8_0 *)motion)->unk_00.at00.v += ((S_8014CDA8_0 *)motion)->unk_0C;
    ((S_8014CDA8_0 *)motion)->unk_04.at00.v += ((S_8014CDA8_0 *)motion)->unk_10;

    if (!((*(u32 *)((u8 *)entity + 0x1C)) & 0x40000) &&
        !((*(u16 *)((u8 *)entity + 0x98)) & 8)) {
        ((S_8014CDA8_0 *)motion)->unk_14 += (*(s8 *)((u8 *)entity + 0x9D)) * 0x14000;
        (*(u8 *)((u8 *)entity + 0x9D))++;
    } else {
        (*(u8 *)((u8 *)entity + 0x9D)) = 0;
    }
    (*(s32 *)((u8 *)entity + 0x90)) += ((S_8014CDA8_0 *)motion)->unk_14;
    sprite_flags = ((S_8014CDA8_1 *)sprite)->unk_14;

    if (!(sprite_flags & 0x8000)) {
        direction = ((D_80083228 + ((S_8014CDA8_2 *)entity_state)->unk_2A + 0x100) >> 9) & 7;
        direction_index = direction;
        if ((*(s16 *)((u8 *)entity + 0x94)) != direction_index) {
            func_80047738(sprite,
                (*(u8 *)((u8 *)(((S_8014CDA8_1 *)sprite)->unk_2C) + direction_index)),
                ((S_8014CDA8_1 *)sprite)->unk_04.s8);
            (*(s16 *)((u8 *)entity + 0x94)) = direction;
        }
        {
            u32 flip_flags;
            if (D_8006CCF8[direction_index] != 0) {
                flip_flags = ((S_8014CDA8_1 *)sprite)->unk_14 | 1;
            } else {
                flip_flags = ((S_8014CDA8_1 *)sprite)->unk_14 & 0xFFFE;
            }
            ((S_8014CDA8_1 *)sprite)->unk_14 = flip_flags;
        }
        func_800A020C(((S_8014CDA8_2 *)entity_state)->unk_1C.s, (u8 *)sprite + 0xC);
        if (!(((S_8014CDA8_2 *)entity_state)->unk_1C.u & 0x20)) {
            if (!(((S_8014CDA8_1 *)sprite)->unk_14 & 0x40)) {
                func_800478B8(sprite);
            }
        } else {
            ((S_8014CDA8_1 *)sprite)->unk_14 |= 0x7000;
            ((S_8014CDA8_2 *)entity_state)->unk_1C.u &= 0xFFFBFFFF;
        }

        {
            u32 masked_flags;
            masked_flags = ((S_8014CDA8_2 *)entity_state)->unk_1C.u & 0xF7FFFFFF;
            ((S_8014CDA8_2 *)entity_state)->unk_1C.u = masked_flags;
        ...
        if (!(((S_8014CDA8_1 *)sprite)->unk_14 & 0x40)) {
            if (((S_8014CDA8_1 *)sprite)->unk_2C == D_801500E0) {
                ...
                if (((S_8014CDA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    anim_table = D_801500E8;
                    (*(u8 * *)((u8 *)sprite + 0x2C)) = anim_table;
                    anim_direction = D_80083228;
                    facing_angle = ((S_8014CDA8_2 *)entity_state)->unk_2A;
                    anim_sprite = sprite;
                ...
                if (((S_8014CDA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    ...
                    anim_sprite = sprite;
                    anim_direction = ((anim_direction + facing_angle + 0x100) >> 9) & 7;
                    anim_entry = &D_801500E0[anim_direction];
play_animation_1:
...
reset_offset:
        ...
        if (!((*(u16 *)((u8 *)entity + 0x98)) & 8)) {
            ground_height = func_800BCB04(((S_8014CDA8_0 *)motion)->unk_00.at02.v,
                ((S_8014CDA8_0 *)motion)->unk_04.at02.v,
                (s16)(((S_8014CDA8_2 *)entity_state)->unk_88 - 0x20));
            ground_delta = ground_height - ((S_8014CDA8_2 *)entity_state)->unk_88;
            if (ground_delta < (*(s16 *)((u8 *)entity + 0x92))) {
                (*(s16 *)((u8 *)entity + 0x92)) = ground_delta;
                (*(u8 *)((u8 *)entity + 0x9D)) = 0;
                ((S_8014CDA8_0 *)motion)->unk_14 = 0;
                ((S_8014CDA8_2 *)entity_state)->unk_1C.u |= 0x08000000;
                goto final_adjustment;
            }
        }
        goto final_adjustment;
...
final_adjustment:
    entity_flags = ((S_8014CDA8_2 *)entity_state)->unk_1C.u;
    if (entity_flags & 0x40000000) {
        ((S_8014CDA8_2 *)entity_state)->unk_1C.u = entity_flags & 0xBFFFFFFF;
        ground_height = func_800BCB04(
            (((S_8014CDA8_1 *)sprite)->unk_24 << 6) | 0x20,
            (((S_8014CDA8_1 *)sprite)->unk_25 << 6) | 0x20,
            (s16)(((S_8014CDA8_2 *)entity_state)->unk_88 - 0x20));
        if (ground_height < 0x200) {
            (*(s16 *)((u8 *)entity + 0x92)) =
                (((S_8014CDA8_2 *)entity_state)->unk_88 - ground_height) +
                (*(u16 *)((u8 *)entity + 0x92));
            ((S_8014CDA8_2 *)entity_state)->unk_88 = ground_height;
        }
    }

    ((S_8014CDA8_0 *)motion)->unk_0A = ((S_8014CDA8_2 *)entity_state)->unk_88 +
        (*(u16 *)((u8 *)entity + 0x92)) - (*(u16 *)((u8 *)entity + 0xA2));
    ((S_8014CDA8_1 *)sprite)->unk_14 |= 0x40;
}
