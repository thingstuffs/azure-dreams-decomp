...
void func_80172ED0(S_80172ED0_0 *arg0, S_80172ED0_1 *arg1, S_80172ED0_3 *arg2, void *arg3)
{
    s16 timer;
    s32 value;
    s32 *state;
    ...
    case 0:
        ...
        arg1->unk_0C =
            *(s16 *)((u8 *)&D_8006CCD8 +
                     ((((S_80172ED0_2 *)arg3)->unk_6A >> 8) & 0xE)) << 19;
        arg1->unk_10 =
            *(s16 *)((u8 *)&D_8006CCE8 +
                     ((((S_80172ED0_2 *)arg3)->unk_6A >> 8) & 0xE)) << 19;
        arg0->unk_9B++;

        if (((S_80172ED0_2 *)arg3)->unk_28 == 0) {
            goto start_action;
        }
        ...
        if (((S_80172ED0_2 *)arg3)->unk_1C & 0x228) {
            timer = 8;
        } else {
            timer = -1;
        }
