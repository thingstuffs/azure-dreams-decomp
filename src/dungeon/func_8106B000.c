...
typedef struct S_8106B000_0 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    M2C_UNK * unk_10;
} S_8106B000_0;   /* temp_v0 in BODY_NAME */

typedef struct S_8106B000_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    ...
    u8 pad_20[0x78];
    u16 unk_98;
} S_8106B000_1;   /* var_s0 in BODY_NAME */

typedef struct S_8106B000_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_8106B000_2;   /* temp_s4 in BODY_NAME */

typedef struct S_8106B000_3 {
    u8 pad_00[0x14];
    u16 unk_14;
    u8 pad_16[0xE];
    s8 unk_24;
    ...
    u8 pad_26[0x6];
    M2C_UNK * unk_2C;
} S_8106B000_3;   /* temp_s2 in BODY_NAME */

typedef struct S_8106B000_4 {
    u8 pad_00[0x8C];
    M2C_UNK * unk_8C;
    u8 pad_90[0xA];
    u8 unk_9A;
    ...
    u8 pad_9D[0xD];
    s16 unk_AA;
} S_8106B000_4;   /* temp_s5 in BODY_NAME */
...
void *BODY_NAME(s16 arg0, s8 arg1, s8 arg2, s16 arg3) {
    ...
    {
        var_s0 = temp_v0 + 0x20;
        ((S_8106B000_0 *)temp_v0)->unk_10 = &D_8015EAA4;
        var_s0->unk_13 = 0x2B;
        func_8004491C(temp_v0, &D_80045340);
        temp_s4 = ((S_8106B000_0 *)temp_v0)->unk_08;
        temp_s4->unk_0A = saved_arg3;
        temp_s2 = ((S_8106B000_0 *)temp_v0)->unk_0C;
        temp_v1 = arg0 & 3;
        temp_s2->unk_25 = saved_arg2;
        temp_s5 = var_s0;
        temp_s2->unk_2C = &D_80161FB8;
