...
typedef struct S_80174C44_1 {
    ...
    u8 pad_49[0x21];
    u16 unk_6A;
} S_80174C44_1;   /* arg3 in func_80174C44 */

typedef struct S_80174C44_2 {
    u8 pad_00[0x2];
    s16 unk_02;
    u8 pad_04[0x2];
    s16 unk_06;
    ...
    s32 unk_10;
    s32 unk_14;
} S_80174C44_2;   /* arg1 in func_80174C44 */

typedef struct S_80174C44_3 {
    u8 pad_00[0x14];
    u16 unk_14;
    u8 pad_16[0xE];
    u8 unk_24;
    u8 unk_25;
} S_80174C44_3;   /* arg2 in func_80174C44 */
...
void func_80174C44(S_80174C44_0 *arg0, S_80174C44_2 *arg1, S_80174C44_3 *arg2, void *arg3)
{
    s32 initial_state;
    s32 kind;
    s16 timer;
...
state_1:
    ...
    arg1->unk_0C =
        *(s16 *)((u8 *)&D_8006CCD8 +
            ((((S_80174C44_1 *)arg3)->unk_6A >> 8) & 0xE)) << 18;
    arg1->unk_10 =
        *(s16 *)((u8 *)&D_8006CCE8 +
            ((((S_80174C44_1 *)arg3)->unk_6A >> 8) & 0xE)) << 18;
    goto done;
