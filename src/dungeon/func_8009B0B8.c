...
s32 func_800A0818(s16 arg0, s16 arg1, s16 arg2, s16 arg3, u16 *arg4) {
...

    {
        ...
        temp_v0 = test_result;
        ASM_KEEP_NV(test_result);   /* MATCH pin: retail register colouring depends on it */
...
in_range:
    *arg4 &= 0xFFFD;
    ASM_USE(temp_v0);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
