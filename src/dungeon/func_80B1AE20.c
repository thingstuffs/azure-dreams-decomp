...
void func_80172620(void *arg0, s32 arg1, void *arg2, void *arg3) {
    s32 state;
    ...
    switch (state) {
        case 0:
            if (((S_80172620_1 *)arg2)->unk_14 & 0x8000) {
                ...
                func_8009C12C(arg3, arg2, ((S_80172620_2 *)arg3)->unk_2A, 1);
                return;
            }
            (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_801739F0;
            func_80047784(arg2,
                D_801739F0[((D_80083228 + ((S_80172620_2 *)arg3)->unk_2A + 0x100) >> 9) & 7],
                0);
            ((S_80172620_0 *)arg0)->unk_9B++;
            return;

        case 1:
            if (((((S_80172620_1 *)arg2)->unk_04 == 6) &&
