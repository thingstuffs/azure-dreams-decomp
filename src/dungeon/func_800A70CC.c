...
s32 func_800AC82C(Rec_func_800A9E70_arg0 *arg0, Rec_D_800E3D7C *arg1, Rec_D_80082E80 *arg2, void *arg3) {
    u16 sp18[3];
    u16 sp20;
    u16 sp22;
    M2C_UNK var_a2;
    ...
    if (func_8004CAE8(((EarlyCallData *) temp_a1)->value, 0) != 0) {
        arg0->unk_9B.as_u8 = (u8) (arg0->unk_9B.as_u8 + 1);
block_6:
        ...
        if (!((*(s32 *)((u8 *)arg3 + 0x1C)) & 0x80000)) {
            ...
            temp_v0_3 = func_800BCB04(arg1->unk_00.at02_u16.v, arg1->unk_04.at02_u16.v, (s16) ((*(u16 *)((u8 *)arg3 + 0x88)) - 0x20));
            if (temp_v0_3 < 0x200) {
                arg0->unk_90.at02_s16.v = 0;
        ...
        if (func_8003DE58(temp_a1->unk_08, temp_a1, sp18, 0) != 0) {
            arg1->unk_00.at02_u16.v = (u16) ((u16) *D_800E3DA8 + (temp_s2->unk_02 + sp18[0]));
            arg1->unk_04.at02_u16.v = (u16) ((u16) D_800E3DA8[1] + (temp_s2->unk_06 + sp18[1]));
            temp_a0 = ((S_800AC82C_7 *)((*(void **)((u8 *)arg3 + 0x60))))->unk_88;
            (*(u16 *)((u8 *)arg3 + 0x88)) = temp_a0;
            arg0->unk_90.at02_s16.v = (s16) (((temp_s2->unk_0A + sp18[2]) - temp_a0) + 8);
            arg2->unk_06.as_s16 = 0x10;
