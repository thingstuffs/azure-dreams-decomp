...
typedef struct S_80158884_0 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    void * unk_10;
} S_80158884_0;   /* obj in func_80158884 */

typedef struct S_80158884_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_80158884_1;   /* work in func_80158884 */

typedef struct S_80158884_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_80158884_2;   /* part_a in func_80158884 */

typedef struct S_80158884_3 {
    u8 pad_00[0x24];
    s8 unk_24;
    s8 unk_25;
    u8 pad_26[0x6];
    void * unk_2C;
} S_80158884_3;   /* part_b in func_80158884 */

typedef struct S_80158884_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0xA];
    u8 unk_9A;
    u8 pad_9B[0x1];
    s8 unk_9C;
} S_80158884_4;   /* actor in func_80158884 */
...
void *func_80158884(s16 arg0, s16 arg1, s16 arg2, s16 arg3)
{
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        ((S_80158884_0 *)obj)->unk_10 = D_80158A58;
        work->unk_13 = 5;
