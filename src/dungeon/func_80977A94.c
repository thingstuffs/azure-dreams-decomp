...
void func_80173294(S_80173294_0 *arg0, S_80173294_1 *arg1, S_80173294_3 *arg2, void *arg3)
{
    s16 timer;
    s32 value;
    s32 value2;
...
state_0:
    ...
    arg1->unk_0C =
        -*(s16 *)((u8 *)&D_8006CCD8 +
            ((((S_80173294_2 *)arg3)->unk_6A >> 8) & 0xE)) << 15;
    arg1->unk_10 =
        -*(s16 *)((u8 *)&D_8006CCE8 +
            ((((S_80173294_2 *)arg3)->unk_6A >> 8) & 0xE)) << 15;
    arg0->unk_9B++;

    if (((S_80173294_2 *)arg3)->unk_28 == 0) {
        goto reset_motion;
    }
    ...
    timer = -1;
    if (((S_80173294_2 *)arg3)->unk_1C & 0x228) {
        timer = 8;
    }
    arg0->unk_96.s = timer;
...
state_2:
    ...
    if (timer != 0) {
        ...
        current = arg1->unk_02;
        current -= 0x20;
        arg1->unk_0C = ((coord - current) << 15) / timer;
