...
void func_801530EC(void *actor, void *context, void *sprite, void *entity)
{
    ...
    if (D_80083462 & 0x1000) {
        ((S_801530EC_0 *)actor)->unk_9A = 0xE;
        func_8015369C(actor, context, sprite, entity);
        return;
    }
    ...
    if (!(D_80083462 & 0x2000)) {
...

        {
            ...
            if (((S_801530EC_0 *)actor)->unk_9A != 0xE) {
                ((S_801530EC_0 *)actor)->unk_9A = 0xE;
                ((S_801530EC_0 *)actor)->unk_B2 = 0;
            }

            current_anim = ((S_801530EC_2 *)sprite)->unk_2C;
            if (current_anim == D_80157EB8) {
                if (((S_801530EC_2 *)sprite)->unk_14 & 0xE000) {
                    u8 *reset_anim = D_80157E40;

                    (*(void * *)((u8 *)sprite + 0x2C)) = reset_anim;
                    func_80047784(sprite,
                        reset_anim[((D_80083228 + ((Rec_D_800E3D7C *)entity)->unk_2A.as_s16 + 0x100) >> 9) & 7],
                        0);
                    ((S_801530EC_2 *)sprite)->unk_05 = 1;
                    ((S_801530EC_0 *)actor)->unk_A2.s = 0;
                    ((S_801530EC_0 *)actor)->unk_9E = 0;
                }
            } else {
                anim_table = D_80157E40;
        ...
        if (((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 & 0x80000) {
            ...
            position_delta = ((S_801530EC_0 *)actor)->unk_92.u - ((S_801530EC_0 *)actor)->unk_A2.u;
            ((S_801530EC_0 *)actor)->unk_A2.s = 0;
            ((S_801530EC_0 *)actor)->unk_9E = 0;
            ((S_801530EC_0 *)actor)->unk_92.s = position_delta;
            func_80156574(actor, context, sprite, entity);
            return;
        }
    ...
    if (((Rec_D_800E3D7C *)entity)->unk_6D.as_s8 > 0) {
        ...
        if (((S_801530EC_2 *)sprite)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto generic;
        }
...
generic:
    ...
    if (!(((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 & 0x2000)) {
        ...
        if (((Rec_D_800814A8 *)D_800814A8)->unk_9A == 0x17) {
            func_80154358(actor, context, sprite, entity);
        }
    }
}
