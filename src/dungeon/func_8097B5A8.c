...
void func_8016ADA8(void *entity_in, void *motion_in, void *sprite_in)
{
    ...
    old_state_id = (s8)(*(u8 *)((u8 *)entity + 0x6D));
    ...
    D_8016E168[(*(u8 *)((u8 *)entity + 0x9A))](entity, motion, sprite, entity);
    if ((s16)old_state_id != (*(s8 *)((u8 *)entity + 0x6D))) {
        func_800AA36C(entity, motion, sprite, entity);
    }

    ((S_8016ADA8_0 *)motion)->unk_00.at00.v += ((S_8016ADA8_0 *)motion)->unk_0C;
    ((S_8016ADA8_0 *)motion)->unk_04.at00.v += ((S_8016ADA8_0 *)motion)->unk_10;

    if (!((*(u32 *)((u8 *)entity + 0x1C)) & 0x40000) &&
        !((*(u16 *)((u8 *)entity + 0x98)) & 8)) {
        ((S_8016ADA8_0 *)motion)->unk_14 += (*(s8 *)((u8 *)entity + 0x9D)) * 0x14000;
        (*(u8 *)((u8 *)entity + 0x9D))++;
    } else {
        (*(u8 *)((u8 *)entity + 0x9D)) = 0;
    }
    (*(s32 *)((u8 *)entity + 0x90)) += ((S_8016ADA8_0 *)motion)->unk_14;
    ...
    if (!(sprite_flags & 0x8000)) {
        ...
        if ((*(s16 *)((u8 *)entity + 0x94)) != sprite_direction) {
            func_80047738(sprite,
                (*(u8 *)((u8 *)(((S_8016ADA8_1 *)sprite)->unk_2C) + sprite_direction)),
                ((S_8016ADA8_1 *)sprite)->unk_04.s8);
            (*(s16 *)((u8 *)entity + 0x94)) = direction;
        }
        {
            u32 facing_flags;
            if (D_8006CCF8[sprite_direction] != 0) {
                facing_flags = ((S_8016ADA8_1 *)sprite)->unk_14 | 1;
            } else {
                facing_flags = ((S_8016ADA8_1 *)sprite)->unk_14 & 0xFFFE;
            }
            ((S_8016ADA8_1 *)sprite)->unk_14 = facing_flags;
        }
        func_800A020C(((S_8016ADA8_2 *)entity_state)->unk_1C.s, (u8 *)sprite + 0xC);
        if (!(((S_8016ADA8_2 *)entity_state)->unk_1C.u & 0x20)) {
            if (!(((S_8016ADA8_1 *)sprite)->unk_14 & 0x40)) {
                func_800478B8(sprite);
            }
        } else {
            ((S_8016ADA8_1 *)sprite)->unk_14 |= 0x7000;
            ((S_8016ADA8_2 *)entity_state)->unk_1C.u &= 0xFFFBFFFF;
        }

        {
            u32 masked_flags;
            masked_flags = ((S_8016ADA8_2 *)entity_state)->unk_1C.u & 0xF7FFFFFF;
            ((S_8016ADA8_2 *)entity_state)->unk_1C.u = masked_flags;
        ...
        if (!(((S_8016ADA8_1 *)sprite)->unk_14 & 0x40)) {
            if (((S_8016ADA8_1 *)sprite)->unk_2C == D_8016E0E0) {
                if (((S_8016ADA8_1 *)sprite)->unk_04.u16 == 0x100) {
                ...
                if (((S_8016ADA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    anim_table = D_8016E0E8;
                    (*(u8 * *)((u8 *)sprite + 0x2C)) = anim_table;
                    anim_direction = D_80083228;
                    facing_angle = ((S_8016ADA8_2 *)entity_state)->unk_2A;
                    anim_sprite = sprite;
                ...
                if (((S_8016ADA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    ...
                    anim_sprite = sprite;
                    anim_direction = ((anim_direction + facing_angle + 0x100) >> 9) & 7;
                    anim_entry = &D_8016E0E0[anim_direction];
play_animation_1:
    ...
    ((S_8016ADA8_1 *)sprite)->unk_14 = (sprite_flags & 0x800)
        ? (sprite_flags & 0x8FFF)
        : (sprite_flags | 0x7000);
    ((S_8016ADA8_2 *)entity_state)->unk_1C.u &= 0xF7FFFFFF;
    if (!(((S_8016ADA8_2 *)entity_state)->unk_1C.u & 0x40000)) {
reset_offset:
        ...
        if (!((*(u16 *)((u8 *)entity + 0x98)) & 8)) {
            ground_height = func_800BCB04(((S_8016ADA8_0 *)motion)->unk_00.at02.v,
                ((S_8016ADA8_0 *)motion)->unk_04.at02.v,
                (s16)(((S_8016ADA8_2 *)entity_state)->unk_88 - 0x20));
            ground_delta = ground_height - ((S_8016ADA8_2 *)entity_state)->unk_88;
            if (ground_delta < (*(s16 *)((u8 *)entity + 0x92))) {
                (*(s16 *)((u8 *)entity + 0x92)) = ground_delta;
                (*(u8 *)((u8 *)entity + 0x9D)) = 0;
                ((S_8016ADA8_0 *)motion)->unk_14 = 0;
                ((S_8016ADA8_2 *)entity_state)->unk_1C.u |= 0x08000000;
                goto final_adjustment;
            }
        }
        goto final_adjustment;
...
low_height_adjustment:
            height_work = height_offset < -0x28;
            if (height_work) {
                height_work = height_bits + 8;
                (*(s16 *)((u8 *)entity + 0x92)) = height_work;
            }
...
final_adjustment:
    entity_flags = ((S_8016ADA8_2 *)entity_state)->unk_1C.u;
    if (entity_flags & 0x40000000) {
        ((S_8016ADA8_2 *)entity_state)->unk_1C.u = entity_flags & 0xBFFFFFFF;
        ground_height = func_800BCB04(
            (((S_8016ADA8_1 *)sprite)->unk_24 << 6) | 0x20,
            (((S_8016ADA8_1 *)sprite)->unk_25 << 6) | 0x20,
            (s16)(((S_8016ADA8_2 *)entity_state)->unk_88 - 0x20));
        if (ground_height < 0x200) {
            (*(s16 *)((u8 *)entity + 0x92)) =
                (((S_8016ADA8_2 *)entity_state)->unk_88 - ground_height) +
                (*(u16 *)((u8 *)entity + 0x92));
            ((S_8016ADA8_2 *)entity_state)->unk_88 = ground_height;
        }
    }

    ((S_8016ADA8_0 *)motion)->unk_0A = ((S_8016ADA8_2 *)entity_state)->unk_88 +
        (*(u16 *)((u8 *)entity + 0x92)) - (*(u16 *)((u8 *)entity + 0xA2));
    ((S_8016ADA8_1 *)sprite)->unk_14 |= 0x40;
}
