...
record_setup:
            target_record = ((S_8017472C_2_pre *)target)[-1].unk_00;
            ((S_8017472C_1 *)actor)->unk_72.s = ((S_8017472C_3 *)target_record)->unk_24;
            ((S_8017472C_1 *)actor)->unk_73.s = ((S_8017472C_3 *)target_record)->unk_25;
            goto move_setup;
        }
