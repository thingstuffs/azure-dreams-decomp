...
void func_80173408(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    state = ((S_80173408_0 *)arg0)->unk_9B.s;
    if ((u32)state >= 5) {
        return;
    }
    (void)jt_keep;
...
L1:
    ((S_80173408_3 *)arg1)->unk_0C -=
        *(s16 *)((u8 *)&D_8006CCD8 +
                 (((u16)((S_80173408_4 *)arg3)->unk_2A.s >> 8) & 0xE)) << 14;
    ...
    (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_80175C48;
    func_80047784(arg2,
        D_80175C48[((D_80083228 + ((S_80173408_4 *)arg3)->unk_2A.u + 0x100) >> 9) & 7],
        0);
    func_801753DC((u8 *)arg0 - 0x20, (u8 *)arg3 + 0x2A);
    (void)((S_80173408_0 *)arg0)->unk_9B.u;
    ((S_80173408_0 *)arg0)->unk_96.s = 0;
    func_80173698();
...
L2:
    {
        ...
        index = ((u16)((S_80173408_4 *)arg3)->unk_2A.s >> 8) & 0xE;
        ...
        ((S_80173408_0 *)arg0)->unk_96.u = timer;
        if (timer < 9) {
            return;
        }
    }
    (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_80175C50;
    func_80047784(arg2,
        D_80175C50[((D_80083228 + ((S_80173408_4 *)arg3)->unk_2A.u + 0x100) >> 9) & 7],
        0);
    func_800A56E0(0x808);
    ((S_80173408_0 *)arg0)->unk_9B.s++;
    return;
...
L3:
    {
        ...
        if (((S_80173408_0 *)arg0)->unk_96.s == 10) {
            func_8009C12C(arg3, arg2, ((S_80173408_4 *)arg3)->unk_2A.u, 1);
        }
        base_x = (s16 *)&D_8006CCD8;
        base_y = (s16 *)&D_8006CCE8;
        index = ((u16)((S_80173408_4 *)arg3)->unk_2A.s >> 8) & 0xE;
        ...
        (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_80175C58;
        func_80047784(arg2,
            D_80175C58[((D_80083228 + ((S_80173408_4 *)arg3)->unk_2A.u + 0x100) >> 9) & 7],
            0);

        velocity_x = -*(s16 *)((u8 *)base_x +
            (((u16)((S_80173408_4 *)arg3)->unk_2A.s >> 8) & 0xE)) << 18;
...
L4:
    ...
    D_8008346C = 0;
    func_800A4ACC(arg3);
    ((S_80173408_4 *)arg3)->unk_46 &= 0x7FFF;
}
