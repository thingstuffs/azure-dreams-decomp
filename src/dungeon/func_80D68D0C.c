...
state_0:
    ...
    {
        register u16 motion_angle ASM_REG("$2") = FIELD(arg0, u8, 0x9B);   /* MATCH pin: load-bearing for the whole function shape */
        register u16 final_angle ASM_REG("$5") = FIELD(arg0, u16, 0x92);   /* MATCH pin: load-bearing for the whole function shape */
