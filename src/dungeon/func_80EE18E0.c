...
typedef struct S_801730E0_2 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_801730E0_2;   /* arg2 in func_801730E0 */
...
typedef struct S_801730E0_3 {
    ...
    s32 unk_10;
    s32 unk_14;
} S_801730E0_3;   /* arg1 in func_801730E0 */
...
state_one:
    ...
    if (remaining != 0) {
        tile_x = ((S_801730E0_2 *)arg2)->unk_24;
        position = ((S_801730E0_3 *)arg1)->unk_02;
        tile_x <<= 6;
        position -= 0x20;
        ((S_801730E0_3 *)arg1)->unk_0C = ((tile_x - position) << 16) / remaining;

        position_y = ((S_801730E0_3 *)arg1)->unk_06;
        position_y -= 0x20;
        ((S_801730E0_3 *)arg1)->unk_10 =
            (((((S_801730E0_2 *)arg2)->unk_25 << 6) - position_y) << 16) /
...
state_two:
    if (((S_801730E0_1 *)arg3)->unk_1C.s & 0x08000000) {
        ((S_801730E0_0 *)arg0)->unk_98 &= 0xFFF7;
        ((S_801730E0_3 *)arg1)->unk_14 = 0;
        ((S_801730E0_3 *)arg1)->unk_10 = 0;
        ((S_801730E0_3 *)arg1)->unk_0C = 0;
        func_800A2B04(arg1, ((S_801730E0_2 *)arg2)->unk_24, ((S_801730E0_2 *)arg2)->unk_25);
...
state_three:
    table = D_80174EB8;
    if (((S_801730E0_2 *)arg2)->unk_2C != table) {
    ...
    if (flags & 0x2000) {
        ...
        if (flags & 0x20000) {
            ((S_801730E0_1 *)arg3)->unk_2A = func_800A0818(
                ((S_801730E0_2 *)arg2)->unk_24, ((S_801730E0_2 *)arg2)->unk_25,
