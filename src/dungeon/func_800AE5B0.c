...
void func_800B3D10(s16 arg0, s32 arg1, Rec_D_800E3D7C *arg2) {
...
jt_c0:
{
    ...
    s32 flags = arg2->unk_14.as_s32 | 1;
    arg2->unk_14.as_s32 = flags;
...
{
    s32 result = (s32) (arg2->unk_20 * ((S_800B3D10_1 *)(&D_800E3D68))->unk_00) / (s32) (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + 1);
    s32 flags = arg2->unk_14.as_s32 | 2;
    arg2->unk_14.as_s32 = flags;
    arg2->unk_20 = (s16) ((u16) arg2->unk_20 + result);
    return;
}
...
{
    s32 result = (s32) (arg2->unk_20 * ((S_800B3D10_1 *)(&D_800E3D68))->unk_00) / (s32) (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + 1);
    s32 flags = arg2->unk_14.as_s32 | 4;
    arg2->unk_14.as_s32 = flags;
    arg2->unk_20 = (s16) ((u16) arg2->unk_20 + result);
    return;
}
jt_c6:
    temp_a0 = arg2->unk_4C.as_pv;
    arg2->unk_14.as_s32 = (s32) (arg2->unk_14.as_s32 | 1);
    ...
    if (((S_800B3D10_6 *)(((Rec_D_800E3D7C *)arg2)->unk_4C.as_pv))->unk_00 == 5) {
    ...
    return;
jt_c7:
    temp_a0_2 = arg2->unk_4C.as_pv;
    arg2->unk_14.as_s32 = (s32) (arg2->unk_14.as_s32 | 2);
    ...
    if (((S_800B3D10_6 *)(((Rec_D_800E3D7C *)arg2)->unk_4C.as_pv))->unk_00 == 6) {
        arg2->unk_20 = (s16) ((u16) arg2->unk_20 + ((var_a0 * (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 >> 1))) / (s32) (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + 1)));
    } else {
        arg2->unk_20 = (s16) ((u16) arg2->unk_20 + ((var_a0 * ((S_800B3D10_1 *)(&D_800E3D68))->unk_00) / (s32) (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + 1)));
    }
    return;
jt_c8:
    temp_a0_3 = arg2->unk_4C.as_pv;
    arg2->unk_14.as_s32 = (s32) (arg2->unk_14.as_s32 | 4);
    ...
    if (((S_800B3D10_6 *)(((Rec_D_800E3D7C *)arg2)->unk_4C.as_pv))->unk_00 == 7) {
        arg2->unk_20 = (s16) ((u16) arg2->unk_20 + ((var_a0 * (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 >> 1))) / (s32) (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + 1)));
    } else {
        arg2->unk_20 = (s16) ((u16) arg2->unk_20 + ((var_a0 * ((S_800B3D10_1 *)(&D_800E3D68))->unk_00) / (s32) (((S_800B3D10_1 *)(&D_800E3D68))->unk_00 + 1)));
    }
...
jt_c39:
jt_c42:
    arg2->unk_14.as_s32 = arg2->unk_14.as_s32 | 1;
    return;
jt_c13:
jt_c40:
jt_c43:
    arg2->unk_14.as_s32 = arg2->unk_14.as_s32 | 2;
    return;
jt_c15:
jt_c18:
    arg2->unk_14.as_s32 = arg2->unk_14.as_s32 | 1;
...
jt_c41:
jt_c44:
    var_v0_4 = arg2->unk_14.as_s32 | 4;
block_42:
    arg2->unk_14.as_s32 = var_v0_4;
block_43:
    return;
}
