...
void func_80173510(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    state = ((S_80173510_0 *)arg0)->unk_9B.s;
    if ((u32)state >= 6) {
        return;
    }
    (void)jt_keep;
...
L0:
    if (((S_80173510_1 *)arg2)->unk_14 & 0x8000) {
        ...
        ((S_80173510_0 *)arg0)->unk_9B.s = 5;
        ((S_80173510_0 *)arg0)->unk_96.s = 0;
    ...
    ((S_80173510_0 *)arg0)->unk_96.s = 2;
    ((S_80173510_0 *)arg0)->unk_98 &= 0xFFF7;
    ((S_80173510_0 *)arg0)->unk_9B.s++;
    return;
...
L1:
    {
        ...
        ((S_80173510_0 *)arg0)->unk_96.s = timer - 1;
        if ((s16)timer > 0 && !(((S_80173510_1 *)arg2)->unk_14 & 0x8000)) {
            return;
        }

        ((S_80173510_0 *)arg0)->unk_96.s = 0x12;
...
L2:
    {
        ...
        if (((S_80173510_0 *)arg0)->unk_96.u == 0xB) {
            ((S_80173510_3 *)arg1)->unk_0C = 0;
            ((S_80173510_3 *)arg1)->unk_10 = 0;
        }

        eight = 8;
        if (((S_80173510_0 *)arg0)->unk_96.u == eight) {
            u8 *model;
...
L3:
    {
        ...
        timer = ((S_80173510_0 *)arg0)->unk_96.s - 1;
        ((S_80173510_0 *)arg0)->unk_96.s = timer;
        ...
        if (((S_80173510_0 *)arg0)->unk_96.u > 0 &&
            !(((S_80173510_1 *)arg2)->unk_14 & 0x8000)) {
            return;
        }
        (void)((S_80173510_0 *)arg0)->unk_9B.u;
        state_step = 2;
...
L5:
    {
        ...
        if (timer != 0) {
            ...
            delta -= position;
            ((S_80173510_3 *)arg1)->unk_10 =
                (delta << 16) / ((S_80173510_0 *)arg0)->unk_96.u;
        }

        ((S_80173510_0 *)arg0)->unk_96.s--;
        if (((S_80173510_0 *)arg0)->unk_96.u > 0 &&
            !(((S_80173510_1 *)arg2)->unk_14 & 0x8000)) {
            return;
        }
