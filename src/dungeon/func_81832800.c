...
BODY_STORAGE void BODY_NAME(void *arg0_in, void *arg1_in, void *arg2) {
    ...
    s32 temp_v0_2;
    s32 temp_v0_3;
    register s32 temp_v0_6 ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    s32 temp_v1_4;
    s32 temp_v1_5;
    s32 temp_v1_6;
    s32 temp_v1_7;
    ...
    void *temp_v0_7;
    void *temp_v1_2;
    register u32 temp_flags ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
    register s32 temp_init_word ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    void *cb_page;
    void *spr_page;
    register void *arg0 ASM_REG("$22") = arg0_in;   /* MATCH pin: load-bearing for the whole function shape */
    register void *arg1 ASM_REG("$23") = arg1_in;   /* MATCH pin: load-bearing for the whole function shape */

    ASM_KEEP_NV(arg0);   /* MATCH pin: keeps a statement from moving across a call/branch */
...
state_0:
    if (*M2C_FIELD(arg0, u16 **, 4) & 0x80) {
        ...
        if (!(M2C_FIELD(temp_s0, u16 *, 0x14) & 0x8000) || !(M2C_FIELD(arg2, u16 *, 0x14) & 0x8000)) {
            ...
            temp_init_word += 1;
            ASM_TAILSLOT_PIN(temp_init_word);   /* MATCH pin: retail delay-slot fill depends on it */
            func_80024490();
            return;
        }
        goto state_F0_end;
...
state_1:
    ...
    ASM_KEEP(temp_v0_6);   /* MATCH pin: retail delay-slot fill depends on it */
    temp_v1_4 = 6;
    ASM_TAILSLOT_PIN(temp_v1_4);   /* MATCH pin: retail delay-slot contents depend on it */
    func_80024488();
    return;
