...
#define arg2 held_arg2
    ...
    case 0:
jt_0:
        ((Rec_D_800E3D7C *)arg3)->unk_14.as_s32 = (s32) (((Rec_D_800E3D7C *)arg3)->unk_14.as_s32 & ~7);
...
jt_1:
        if (((S_800B348C_0 *)arg0)->unk_A6 != 0) {
            ...
            func_80048A44(arg2, D_800DD030[((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7], 0, 1);
...
jt_2:
            if (((S_800B348C_0 *)arg0)->unk_A6 == 0) {
                ...
                func_80048A44(arg2, D_800DD068[((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7], 0, 1);
...
jt_3:
        if (((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0xE000) {
            ...
            ((Rec_D_800E3D7C *)arg1)->unk_10.at00_s32.v = (s32) (*(s16 *)((u8 *)&D_8006CCE8 + temp_v1_2) << 0x11);
            ((Rec_D_800E3D7C *)arg1)->unk_14.as_s32 = 0xFFEBC000;
            (*(u8 **)((u8 *)arg2 + 0x2C)) = D_800DD070;
            func_80048A44(arg2, D_800DD070[((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7], 0, 1);
            {
                u8 *next_v0;

                if (((Rec_D_800E3D7C *)arg3)->unk_4C.as_s32 != 0) {
                    next_v0 = D_800DD078;
                } else {
                    next_v0 = D_800DD0A8;
                }
...
jt_4:
        if (((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0xE000) {
            ...
            func_80048A44(arg2, *(temp_a1 + (((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7)), 0, 1);
            if (((Rec_D_800E3D7C *)arg3)->unk_4C.as_s32 != 0) {
                register u32 page_v0 ASM_REG("$2");   /* UNRESOLVED C shape (pin): removing it rematerialises a constant retail keeps in a register; the source shape that makes it unnecessary has not been found */
                register u8 *next_v1 ASM_REG("$3");   /* UNRESOLVED C shape (pin): removing it changes the whole function shape; the source shape that makes it unnecessary has not been found */
                ...
                ASM_TAILSLOT_PIN(next_v1);   /* UNRESOLVED C shape (pin): removing it changes a delay-slot's contents; the source shape that makes it unnecessary has not been found */
                func_800B3744();
                return;
            }
            {
                ...
                ASM_KEEP(next_v1);   /* UNRESOLVED C shape (pin): removing it changes the whole function shape; the source shape that makes it unnecessary has not been found */
                state_9b = ((S_800B348C_0 *)arg0)->unk_9B;
...
jt_15:
        ...
        if (((temp_v0 << 0x10) <= 0) || (((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0x8000)) {
            var_a0 = 0x606;
            if (((Rec_D_800E3D7C *)arg3)->unk_4C.as_s32 != 0) {
                var_a0 = 0x605;
            }
            ...
            func_80048A44(arg2, *(temp_a1_2 + (((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7)), 0, 1);
...
jt_6:
        ...
        temp_a1_3 = ((Rec_D_800E3D7C *)arg1)->unk_14.as_s32;
        ...
        if ((s16)temp_v0_2 < 0) {
            temp_v1_3 = ((u16) ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 >> 8) & 0xE;
            ((Rec_D_800E3D7C *)arg1)->unk_0C.as_s32 = (s32) (*(s16 *)((u8 *)&D_8006CCD8 + temp_v1_3) << 0x11);
            ((Rec_D_800E3D7C *)arg1)->unk_10.at00_s32.v = (s32) (*(s16 *)((u8 *)&D_8006CCE8 + temp_v1_3) << 0x11);
            ((Rec_D_800E3D7C *)arg1)->unk_14.as_s32 = temp_a1_3;
            ...
            func_80048A44(arg2, *(temp_a1_4 + (((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7)), 0, 1);
            ((S_800B348C_0 *)arg0)->unk_CC = D_800DD088;
            func_800B3D10(((S_800B348C_0 *)arg0)->unk_A8, ((Rec_D_800E3D7C *)arg3)->unk_60.as_pv, arg3);
            return;
        }
        break;
    case 7:
jt_7:
        ...
        if (((S_800B348C_0 *)arg0)->unk_96.s == 0) {
            if (((S_800B348C_0 *)arg0)->unk_102 == 0) {
                ...
                temp_a2 = func_8009C12C(arg3, arg2, ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16, 1);
                if (temp_a2 != 0) {
                ...
                temp_a0 = ((Rec_D_800E3D7C *)arg3)->unk_60.as_pv;
                if (temp_a0 != NULL) {
                    ((S_800B348C_5 *)temp_a0)->unk_14 = (s32) (((S_800B348C_5 *)temp_a0)->unk_14 | 0x01000000);
                }
            }
        }
        if (((s16) ((S_800B348C_0 *)arg0)->unk_96.u <= 0) && (((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0xE000)) {
            (*(u8 **)((u8 *)arg2 + 0x2C)) = D_800DD088;
            func_80048A44(arg2, D_800DD088[((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7], 0, 1);
...
jt_8:
        if (((S_800B348C_0 *)arg0)->unk_A2 & 0x10) {
            ...
            if ((s16) ((S_800B348C_0 *)arg0)->unk_96.u <= 0) {
                ...
                func_80048A44(arg2, D_800DD090[((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7], 0, 1);
...
jt_9:
        if (((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0xE000) {
            ...
            func_80048A44(arg2, D_800DD098[((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7], 0, 1);
            ((S_800B348C_0 *)arg0)->unk_96.u = 2U;
            delta_x = ((Rec_D_80082E80 *)arg2)->unk_24 << 6;
            delta_y = ((Rec_D_800E3D7C *)arg1)->unk_00.at02_s16.v;
            delta_y -= 0x20;
            delta_x -= delta_y;
            ((Rec_D_800E3D7C *)arg1)->unk_0C.as_s32 = (s32) ((delta_x << 0x10) / (s16) ((S_800B348C_0 *)arg0)->unk_96.u);
            delta_y = ((Rec_D_800E3D7C *)arg1)->unk_04.at02_s16.v - 0x20;
            ((Rec_D_800E3D7C *)arg1)->unk_10.at00_s32.v = (s32) ((s32) (((((Rec_D_80082E80 *)arg2)->unk_25 << 6) - delta_y) << 0x10) / (s16) ((S_800B348C_0 *)arg0)->unk_96.u);
load_state_9b:
            state_9b = ((S_800B348C_0 *)arg0)->unk_9B;
bump_state_9b:
...
jt_10:
        ...
        if (((temp_v0_4 << 0x10) <= 0) || (((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0x8000)) {
            ((Rec_D_800E3D7C *)arg1)->unk_14.as_s32 = 0;
            ((Rec_D_800E3D7C *)arg1)->unk_10.at00_s32.v = 0;
            ((Rec_D_800E3D7C *)arg1)->unk_0C.as_s32 = 0;
            func_800A2B04(arg1, ((Rec_D_80082E80 *)arg2)->unk_24, ((Rec_D_80082E80 *)arg2)->unk_25);
            {
                ...
                func_80048A44(case10_arg2, D_800DD0A0[((s32) (D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7], 0, 1);
            }
            ...
            end_flags = ((Rec_D_800E3D7C *)arg3)->unk_14.as_s32;
            end_timer_state = *(s16 *)((u8 *)end_timer_state - 0xDB8);
            end_flags &= end_mask;
            ((Rec_D_800E3D7C *)arg3)->unk_14.as_s32 = end_flags;
