...
typedef struct S_80172AF8_5 {
    ...
    s32 unk_10;
    s32 unk_14;
} S_80172AF8_5;   /* arg1 in func_80172AF8 */

typedef struct S_80172AF8_6 {
    u8 pad_00[0xA6];
    u16 unk_A6;
} S_80172AF8_6;   /* D_800814A8 in func_80172AF8 */
...
void func_80172AF8(void *arg0, void *arg1, void *arg2, void *arg3)
{
    u16 pending[4];
    u8 *sel;
    ...
    special = 0;
    switch (((S_80172AF8_0 *)arg0)->unk_9B) {
    case 0:
        if (((S_80172AF8_1 *)arg3)->unk_1C & 0x2000) {
            static void *const sw_keep[] = {&&sw_c, &&sw_b, &&sw_a, &&sel_none};
            extern void *const D_80170838[];
            u32 swi = (u32)((((S_80172AF8_1 *)arg3)->unk_46 & 0x3FFF) - 1);
        ...
        switch (((S_80172AF8_1 *)arg3)->unk_46 & 0x3FFF) {
        case 3:
        kind_c:
            sel = (u8 *)arg3 + 0xE;
            break;
        ...
        if (*sel != 0) {
            ((S_80172AF8_0 *)arg0)->unk_98 &= 0xFF7F;
            ASM_KEEP(sel);   /* MATCH pin: retail delay-slot fill depends on it */
            {
                ...
                if (flag != 0) {
                    obj = D_800814A8;
                    ((S_80172AF8_1 *)arg3)->unk_60 = obj;
                    goto have_obj;
                }
            }
            if (((MotionEntry *)D_8006DE24)[*sel].kind == 2) {
                obj = ((S_80172AF8_1 *)arg3)->unk_60;
                if (obj == 0) {
                    goto do_step;
                }
            have_obj:
                rec = ((S_80172AF8_2_pre *)obj)[-1].unk_00;
                ((S_80172AF8_1 *)arg3)->unk_72.s = ((S_80172AF8_3 *)rec)->unk_24;
                ((S_80172AF8_1 *)arg3)->unk_73.s = ((S_80172AF8_3 *)rec)->unk_25;
                goto do_step;
            }
            ((S_80172AF8_1 *)arg3)->unk_60 =
                func_800A05A4(arg3, ((S_80172AF8_4 *)arg2)->unk_24, ((S_80172AF8_4 *)arg2)->unk_25,
                              ((S_80172AF8_1 *)arg3)->unk_2A, 0x10);
            ASM_KEEP(arg3);   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
            x = ((S_80172AF8_1 *)arg3)->unk_72.u;
            y = ((S_80172AF8_1 *)arg3)->unk_73.u;
            if (x < 0) {
                x = -x;
            }
            if (y < 0) {
            ...
            ((S_80172AF8_1 *)arg3)->unk_72.s = x;
            ((S_80172AF8_1 *)arg3)->unk_73.s = y;
        do_step:
            pending[0] = ((S_80172AF8_5 *)arg1)->unk_02;
            pending[1] = ((S_80172AF8_5 *)arg1)->unk_06;
            pending[2] = ((S_80172AF8_5 *)arg1)->unk_0A;
            if (func_800A94A0(arg3, sel, special, (u8 *)arg0 + 0x98) == 0) {
                return;
            }
            ((S_80172AF8_4 *)arg2)->unk_14 &= 0xF7FF;
            func_800A56E0(0x703);
            func_800DA840(pending, (*sel - 1) % 3);
            ((S_80172AF8_0 *)arg0)->unk_9B = ((S_80172AF8_0 *)arg0)->unk_9B + 1;
            return;
        }

        ((S_80172AF8_5 *)arg1)->unk_14 = 0;
        ((S_80172AF8_5 *)arg1)->unk_10 = 0;
        ((S_80172AF8_5 *)arg1)->unk_0C = 0;
        func_800A2B04(arg1, ((S_80172AF8_4 *)arg2)->unk_24, ((S_80172AF8_4 *)arg2)->unk_25);
        D_8008346C = 0;
        ((S_80172AF8_6 *)D_800814A8)->unk_A6 = (*(u16 *)((u8 *)D_800814A8 + 0xA6)) - 1;
        func_800A4ACC(arg3);
        ((S_80172AF8_1 *)arg3)->unk_6D.s = ((S_80172AF8_1 *)arg3)->unk_6D.s - 1;
        ((S_80172AF8_0 *)arg0)->unk_8C = D_80170E70;
        ((S_80172AF8_1 *)arg3)->unk_73.s = 0;
        ((S_80172AF8_1 *)arg3)->unk_72.s = 0;
        ((S_80172AF8_1 *)arg3)->unk_46 &= 0x7FFF;
        return;

    case 1:
        if (func_8003F270() != 0) {
            ((S_80172AF8_4 *)arg2)->unk_14 |= 0x800;
            return;
        }
        ((S_80172AF8_4 *)arg2)->unk_14 &= 0xF7FF;
        ((S_80172AF8_0 *)arg0)->unk_9B = ((S_80172AF8_0 *)arg0)->unk_9B + 1;
        /* fallthrough */
    case 2:
        if ((((S_80172AF8_4 *)arg2)->unk_04 == 4 && (((S_80172AF8_4 *)arg2)->unk_14 & 0x1000)) ||
            (((S_80172AF8_4 *)arg2)->unk_14 & 0xE000)) {
            ((S_80172AF8_4 *)arg2)->unk_14 |= 0x800;
            ((S_80172AF8_0 *)arg0)->unk_96 = 0x20;
            ((S_80172AF8_0 *)arg0)->unk_98 |= 0x80;
        }
        counter = ((S_80172AF8_0 *)arg0)->unk_96 - 1;
        ((S_80172AF8_0 *)arg0)->unk_96 = counter;
        if ((s16)counter <= 0) {
            ((S_80172AF8_0 *)arg0)->unk_96 = 0;
            ((S_80172AF8_4 *)arg2)->unk_14 &= 0xF7FF;
        }
        if ((((S_80172AF8_4 *)arg2)->unk_14 & 0xE000) == 0) {
            return;
        }
        ((S_80172AF8_5 *)arg1)->unk_14 = 0;
        ((S_80172AF8_5 *)arg1)->unk_10 = 0;
        ...
        func_800A2B04(arg1, ((S_80172AF8_4 *)arg2)->unk_24, ((S_80172AF8_4 *)arg2)->unk_25);
        {
            ...
            if (((S_80172AF8_4 *)arg2)->unk_2C != table) {
                (*(u8 * *)((u8 *)arg2 + 0x2C)) = table;
                func_80047784(arg2,
                    table[((D_80083228 + ((S_80172AF8_1 *)arg3)->unk_2A + 0x100) >> 9) & 7],
                    0);
            }
        }
        block = (u8 *)&D_80083460;
        if (((S_80172AF8_7 *)block)->unk_0C != 0) {
            return;
        }
        ((S_80172AF8_7 *)block)->unk_0A = ((S_80172AF8_7 *)block)->unk_0A - 1;
        ((S_80172AF8_4 *)arg2)->unk_14 &= 0xF7FF;
        ((S_80172AF8_0 *)arg0)->unk_8C = D_80170E70;
        func_800A4ACC(arg3);
        if (((S_80172AF8_1 *)arg3)->unk_6D.u > 0) {
            ((S_80172AF8_1 *)arg3)->unk_6D.s = ((S_80172AF8_1 *)arg3)->unk_6D.s - 1;
        }
        ((S_80172AF8_1 *)arg3)->unk_73.s = 0;
        ((S_80172AF8_1 *)arg3)->unk_72.s = 0;
...
/* MECHANISM: ROWBASE rebuild. Defined under the TRUE-space name func_80172AF8 so
