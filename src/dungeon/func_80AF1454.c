...
void func_80172C54(void *action, void *motion, void *sprite, void *actor)
{
    s32 state;
    s32 move_ticks;
    s32 target_x;
...
state_zero:
    ...
    func_80047784(
        sprite,
        D_801759A8[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
...
state_two:
    if (((Rec_D_800E3D7C *)actor)->unk_1C.as_s32 & 0x08000000) {
        ...
        func_80047784(
            sprite,
            D_801759B8[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        ((S_80172C54_0 *)action)->unk_9B++;
    }
    goto decrement_timer;
...
state_three:
    ...
    func_80047784(
        sprite,
        D_80175988[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
