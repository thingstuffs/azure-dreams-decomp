...
void *func_800ADC4C(S_800ADC4C_2 *arg0, s32 arg1, s16 arg2, s8 *arg3) {
    ...
    if (temp_v0 != NULL) {
        ...
        temp_v1->unk_02 = (u16) arg0->unk_02;
        temp_v1->unk_06 = (u16) arg0->unk_06;
        temp_v1->unk_0A = (u16) arg0->unk_0A;
