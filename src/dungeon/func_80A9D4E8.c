...
void func_80172CE8(void *arg0, void *arg1, void *arg2, void *arg3) {
    ...
    special = 0;
    state = ((S_80172CE8_0 *)arg0)->unk_9B;
    switch (state) {
    case 0:
        if ((*(u32 *)((u8 *)arg3 + 0x1C)) & 0x2000) {
            u32 kind = ((*(u16 *)((u8 *)arg3 + 0x46)) & 0x3FFF) - 1;
            if (kind >= 7) {
                goto item_none;
            }
            (void)jt_keep;
...
item_8:
        ...
        {
            s32 kind = (*(u16 *)((u8 *)arg3 + 0x46)) & 0x3FFF;
            if (kind == 2) {
                goto item_b_value;
            }
            if (kind < 3) {
...
item_ready:
        ...
        ((S_80172CE8_0 *)arg0)->unk_98 &= 0xFF7F;
        {
            s32 special_test;
...
copy_existing:
                    {
                        ...
                        (*(u8 *)((u8 *)arg3 + 0x73)) = ((S_80172CE8_2 *)owner)->unk_25;
                    }
                    goto object_ready;
                }
            } else {
                ...
                node = func_800A05A4(
                    arg3,
                    ((S_80172CE8_3 *)arg2)->unk_24,
                    ((S_80172CE8_3 *)arg2)->unk_25,
                    (*(s16 *)((u8 *)arg3 + 0x2A)),
                    0x10);
...
no_item:
        ...
        func_800A4ACC(arg3);
        (*(u8 *)((u8 *)arg3 + 0x6D))--;
        ((S_80172CE8_0 *)arg0)->unk_8C = &D_80170E7C;
        (*(u8 *)((u8 *)arg3 + 0x73)) = 0;
        (*(u8 *)((u8 *)arg3 + 0x72)) = 0;
    ...
    case 1:
        if (!(((S_80172CE8_3 *)arg2)->unk_14 & 0xE000)) {
            goto end;
        }
        (*(void * *)((u8 *)arg2 + 0x2C)) = D_80174C7C;
        func_80047784(
            arg2,
            D_80174C7C[((D_80083228 + (*(s16 *)((u8 *)arg3 + 0x2A)) + 0x100) >> 9) & 7],
            0);
increment_state:
        ((S_80172CE8_0 *)arg0)->unk_9B++;
        goto end;

    case 2:
        if (func_8003F270()) {
            ((S_80172CE8_3 *)arg2)->unk_14 |= 0x800;
            goto end;
        }
        ((S_80172CE8_3 *)arg2)->unk_14 &= 0xF7FF;
        ((S_80172CE8_0 *)arg0)->unk_9B++;
    ...
    case 3:
        if ((((S_80172CE8_3 *)arg2)->unk_04 == 5 &&
             (((S_80172CE8_3 *)arg2)->unk_14 & 0x1000)) ||
            (((S_80172CE8_3 *)arg2)->unk_14 & 0xE000)) {
            ((S_80172CE8_3 *)arg2)->unk_14 |= 0x800;
            ((S_80172CE8_0 *)arg0)->unk_96 = 0x10;
            ((S_80172CE8_0 *)arg0)->unk_98 |= 0x80;
        }

        {
            u16 timer = ((S_80172CE8_0 *)arg0)->unk_96 - 1;
            ((S_80172CE8_0 *)arg0)->unk_96 = timer;
            if ((s16)timer <= 0) {
                ((S_80172CE8_0 *)arg0)->unk_96 = 0;
                ((S_80172CE8_3 *)arg2)->unk_14 &= 0xF7FF;
            }
        }
        ...
        if (((S_80172CE8_3 *)arg2)->unk_2C != D_80174C3C) {
            (*(void * *)((u8 *)arg2 + 0x2C)) = D_80174C3C;
            func_80047784(
                arg2,
                D_80174C3C[((D_80083228 + (*(s16 *)((u8 *)arg3 + 0x2A)) + 0x100) >> 9) & 7],
                0);
        }
