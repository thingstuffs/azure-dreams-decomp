...
typedef struct S_8017357C_3 {
    ...
    u8 pad_66[0x7];
    s8 unk_6D;
} S_8017357C_3;   /* arg3 in func_8017357C */
...
state_zero:
    ...
    if ((((S_8017357C_1 *)arg2)->unk_14 & 0xE000) == 0) {
        return;
    }
    ...
    index = (D_80083228 + ((S_8017357C_3 *)arg3)->unk_2A + 0x100) >> 9;
...
state_one:
    if (((S_8017357C_3 *)arg3)->unk_25 == 0) {
        if (D_80083462 & 0x1000) {
            return;
        }

        if ((((S_8017357C_3 *)arg3)->unk_64 != 0) &&
        ...
        if (((S_8017357C_3 *)arg3)->unk_1C & 0x100) {
            func_800AA258(callArg0, arg1, arg2, arg3);
            return func_801737BC();
        }

        if (((S_8017357C_3 *)arg3)->unk_1C & 0x80000) {
    ...
    ((S_8017357C_3 *)arg3)->unk_1C &= ~0x200;
}
