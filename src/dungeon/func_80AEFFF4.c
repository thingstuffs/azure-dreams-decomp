...
typedef struct S_801717F4_0 {
    ...
    s16 unk_9E;
    s16 unk_A0;
} S_801717F4_0;   /* arg0 in func_801717F4 */

typedef struct S_801717F4_1 {
    u8 pad_00[0x1C];
    u32 unk_1C;
    u8 pad_20[0x5];
    u8 unk_25;
    ...
    u8 pad_66[0x7];
    s8 unk_6D;
} S_801717F4_1;   /* arg3 in func_801717F4 */
...
typedef struct S_801717F4_3 {
    u8 pad_00[0x58];
    void * unk_58;
} S_801717F4_3;   /* D_800814A8 in func_801717F4 */
...
#define arg3 p3
    ...
    if (((S_801717F4_1 *)arg3)->unk_25 == 0) {
        ...
        func_80047784(arg2,
            table[((D_80083228 + ((S_801717F4_1 *)arg3)->unk_2A + 0x100) >> 9) & 7],
            0);
        func_80171D58();
        return;
    }

    if (((S_801717F4_1 *)arg3)->unk_1C & 0x200) {
        if (((S_801717F4_2 *)arg2)->unk_2C == D_801759E8) {
            ((S_801717F4_0 *)arg0)->unk_9A = 0xD;
            ((S_801717F4_0 *)arg0)->unk_9B = 1;
            ((S_801717F4_0 *)arg0)->unk_8C = 0;
            ((S_801717F4_1 *)arg3)->unk_1C &= 0xFFFBFFFF;
            func_80171D58();
            return;
        }
    ...
    if (!(D_80083462 & 0x2000)) {
        if (((S_801717F4_1 *)arg3)->unk_1C & 0x100) {
        ...
        {
            u32 current_state = ((S_801717F4_0 *)arg0)->unk_9A;
            u32 actor_state;
            ...
            if (current_state != actor_state) {
                ...
                ((S_801717F4_0 *)arg0)->unk_9E = 0;
                ((S_801717F4_0 *)arg0)->unk_A0 = 0x14;
                ((S_801717F4_0 *)arg0)->unk_9A = actor_state;
            }
        }

        ((S_801717F4_0 *)arg0)->unk_98 &= 0xFFF3;

        if (((S_801717F4_1 *)arg3)->unk_64 != 0) {
            if (func_800AA6B4(arg0, arg1, arg2, D_80175998) != 0) {
                return;
            }
        }

        if (((S_801717F4_1 *)arg3)->unk_1C & 0x80000) {
            func_800AA888(arg0, arg1, arg2, arg3);
            func_80174258(arg0, arg1, arg2, arg3);
            (*(void * *)((u8 *)arg2 + (0x2C))) = D_80175988;
            func_80047784(arg2,
                D_80175988[((D_80083228 + ((S_801717F4_1 *)arg3)->unk_2A + 0x100) >> 9) & 7],
                0);
            ((S_801717F4_0 *)arg0)->unk_90 = 0;
            func_80171D58();
            return;
        }
    ...
    if (((S_801717F4_1 *)arg3)->unk_6D > 0) {
        if (((S_801717F4_1 *)arg3)->unk_1C & 0x20) {
            goto special_cleanup;
        }
        if (((S_801717F4_2 *)arg2)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto ordinary_cleanup;
        }
        if (!(((S_801717F4_1 *)arg3)->unk_46 & 0x8000)) {
            if (D_80083462 & 0x2000) {
                if ((s16)func_8009A180(arg3,
                        (u8 *)((S_801717F4_3 *)D_800814A8)->unk_58 + 0x20) != 0) {
                    return;
                }
            }
            ...
            state = ((S_801717F4_1 *)arg3)->unk_46 | 0x4000;
            ((S_801717F4_1 *)arg3)->unk_46 = state;
            if (!(state & 0x8000)) {
                goto ordinary_cleanup;
            }
        }

        state = ((S_801717F4_1 *)arg3)->unk_46 & 0x3FFF;
        if ((u32)(state - 1) >= 12) {
            goto ordinary_cleanup;
        }
        (void)jt_keep;
...
#ifndef __mips__
#endif
            ((S_801717F4_1 *)arg3)->unk_2A = direction;
