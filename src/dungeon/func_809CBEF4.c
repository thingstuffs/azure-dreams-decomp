...
void func_801736F4(void *arg0, void *arg1, void *arg2, void *arg3)
{
    s32 state;
...
state_zero:
    {
        ...
        base = &D_80083460;
        ((S_801736F4_2 *)base)->unk_0A--;
        table = D_80173CDC;
        (*(void * *)((u8 *)arg2 + 0x2C)) = table;
        func_80047784(arg2,
            table[((D_80083228 + ((S_801736F4_3 *)arg3)->unk_2A + 0x100) >> 9) & 7],
            0);
...
state_one:
    {
        ...
        if (((S_801736F4_3 *)arg3)->unk_25 != 0) {
            s32 *base;

            (*(void * *)((u8 *)arg2 + 0x2C)) = D_80173CD4;
            func_80047784(arg2,
                D_80173CD4[((D_80083228 + ((S_801736F4_3 *)arg3)->unk_2A + 0x100) >> 9) & 7],
                0);
        ...
        if (((S_801736F4_4 *)global)->unk_02 & 0x1000) {
            goto done;
        }

        if (((S_801736F4_3 *)arg3)->unk_64 != 0) {
        ...
        flags = ((S_801736F4_3 *)arg3)->unk_1C;
        if (flags & 0x100) {
        ...
        func_80047784(arg2,
            D_80173CD4[((D_80083228 + ((S_801736F4_3 *)arg3)->unk_2A + 0x100) >> 9) & 7],
            0);
        ((S_801736F4_3 *)arg3)->unk_1C |= 0x40000;
        ((S_801736F4_4 *)global)->unk_0A++;
    }
...
state_two:
    if (((S_801736F4_1 *)arg2)->unk_14 & 0xE000) {
        ...
        base = &D_80083460;
        ((S_801736F4_2 *)base)->unk_0A--;
        ((S_801736F4_3 *)arg3)->unk_1C &= ~0x208;
