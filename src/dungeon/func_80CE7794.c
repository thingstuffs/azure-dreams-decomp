...
void func_80170F94(void *arg0, void *arg1, void *arg2)
{
    ...
    value = ((S_80170F94_2 *)arg2)->unk_1C + 100;
    ((S_80170F94_2 *)arg2)->unk_1C = value;
    if (value > 0x1000) {
        ((S_80170F94_2 *)arg2)->unk_1C = 0x1000;
    }

    value = ((S_80170F94_2 *)arg2)->unk_1E + 100;
    ((S_80170F94_2 *)arg2)->unk_1E = value;
    if (value > 0x1000) {
        ((S_80170F94_2 *)arg2)->unk_1E = 0x1000;
    }
    ...
    if (((S_80170F94_2 *)arg2)->unk_14 & 0x8000) {
        (*(u16 *)((u8 *)arg0 + -2)) |= 0x8000;
        D_800814A0 |= 0x8000;
    }
}
