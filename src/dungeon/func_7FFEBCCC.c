...
void func_7FFEBCCC(S_7FFEBCCC_3 *source, s32 color) {
    s32 packed_color;
    S_7FFEBCCC_1 *render_state;
    S_7FFEBCCC_4 *sprite;
    S_7FFEBCCC_0 *effect;
    S_7FFEBCCC_2 *position;

    effect = func_8003CF18(0x12);
    if (effect != NULL) {
        render_state = effect->unk_0C;
        effect->unk_10 = &D_8010D648;
        ...
        position->unk_02 =
            (u16)((S_7FFEBCCC_5 *)(source->unk_08))->unk_02;
        position->unk_06 =
            (u16)((S_7FFEBCCC_5 *)(source->unk_08))->unk_06;
        position->unk_0A =
            (u16)((S_7FFEBCCC_5 *)(source->unk_08))->unk_0A;
