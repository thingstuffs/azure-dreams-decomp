...
void func_80172AAC(S_80172AAC_1 *arg0, M2C_UNK arg1, M2C_UNK arg2, void *arg3) {
    ((S_80172AAC_0 *)arg3)->unk_71 = (u8) (((S_80172AAC_0 *)arg3)->unk_71 & 0x7F);
    if (!(D_80083462 & 0x2000) && ((func_800A2B5C(arg3) << 0x10) == 0)) {
        ...
        if ((func_800A2B5C(arg3) << 0x10) == 0) {
            ...
            arg0->unk_9A = 0x11;
            arg0->unk_9B = 0;
            ((S_80172AAC_0 *)arg3)->unk_6D = (u8) (((S_80172AAC_0 *)arg3)->unk_6D - 1);
            func_8009C93C(arg3, arg2, ((S_80172AAC_0 *)arg3)->unk_2A, 1, 0);
            ((S_80172AAC_0 *)arg3)->unk_84 = 0x7C;
            ((S_80172AAC_0 *)arg3)->unk_85 = 4;
        }
    }
}
