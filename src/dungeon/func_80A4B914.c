...
/* Updates an effect, then fades its colors to neutral and marks it finished. */
void func_80175114(void *entity_data, void *unused, void *source_data)
{
    ...
    if (entity[0x9A] == 0) {
        ...
        frame_count = *(u16 *)(entity + 0x96);
        *(u16 *)(entity + 0x96) = frame_count + 1;
        if ((frame_count & 3) == 1) {
            D_8017591C[0]++;
            return;
        }
