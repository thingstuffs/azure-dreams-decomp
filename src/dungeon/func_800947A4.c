...
typedef struct S_80099F04_0 {
    s32 unk_00;
} S_80099F04_0;   /* &D_800814A8 in func_80099F04 */
...
void func_80099F04(s32 arg0) {
    ...
    var_s0 = arg0 + 0x20;
    if (var_s0 != ((S_80099F04_0 *)(&D_800814A8))->unk_00) {
        do {
            if (!(var_s0->unk_14 & 0x4000)) {
                func_80099EA4(var_s0);
            }
            var_s0 = var_s0->unk_5C + 0x20;
        } while (var_s0 != ((S_80099F04_0 *)(&D_800814A8))->unk_00);
    }
}
