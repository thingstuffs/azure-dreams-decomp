...
typedef struct S_80170D44_3 {
    ...
    u16 unk_1C;
    u16 unk_1E;
} S_80170D44_3;   /* arg2 in func_80170D44 */
...
void func_80170D44(void *arg0, S_80170D44_1 *arg1, S_80170D44_3 *arg2)
{
    s16 count;
    s32 shade;
    u16 pos;
    ...
    count = ((S_80170D44_0 *)arg0)->unk_96.s - 1;
    shade = (s32)(count * 0x50) / (s16)((S_80170D44_0 *)arg0)->unk_A8;
    ((S_80170D44_0 *)arg0)->unk_96.s = (u16)count;
    arg2->unk_0E = (s8)shade;
    arg2->unk_0D = (s8)shade;
    arg2->unk_0C = (s8)shade;
    func_800478B8(arg2);

    if (((S_80170D44_0 *)arg0)->unk_96.u <= 0) {
        ((S_80170D44_0_pre *)arg0)[-1].unk_00 = (u16)(((S_80170D44_0_pre *)arg0)[-1].unk_00 | 0x8000);
