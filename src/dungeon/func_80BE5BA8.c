...
typedef struct S_8014D3A8_1 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_8014D3A8_1;   /* arg2 in func_8014D3A8 */
...
void func_8014D3A8(void *arg0, S_8014D3A8_0 *arg1, void *arg2)
{
    ...
    D_801506A0[(*(u8 *)((u8 *)arg0 + 0x9A))](arg0, arg1, arg2, arg0);
    {
    ...
    initial_mode = ((S_8014D3A8_1 *)arg2)->unk_14;

    if (!(initial_mode & 0x8000)) {
        index = ((D_80083228 + ((S_8014D3A8_2 *)base)->unk_2A + 0x100) >> 9) & 7;
        if ((*(s16 *)((u8 *)arg0 + 0x94)) != index) {
            func_80047738(arg2,
                *(u8 *)(((S_8014D3A8_1 *)arg2)->unk_2C + index),
                ((S_8014D3A8_1 *)arg2)->unk_04);
            (*(s16 *)((u8 *)arg0 + 0x94)) = index;
        }
        if (D_8006CCF8[index] != 0) {
            u32 tail_value;

            tail_value = ((S_8014D3A8_1 *)arg2)->unk_14 | 1;
            ASM_TAILSLOT_PIN(tail_value);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
            func_8014D5E4();
            return;
        }

        ((S_8014D3A8_1 *)arg2)->unk_14 &= 0xFFFE;
        func_800A020C(((S_8014D3A8_2 *)base)->unk_1C, (u8 *)arg2 + 0xC);
        if (!(((S_8014D3A8_2 *)base)->unk_1C & 0x20)) {
            if (!(((S_8014D3A8_1 *)arg2)->unk_14 & 0x40)) {
                func_800478B8(arg2);
                goto clear_8000000;
            }
        } else {
            ((S_8014D3A8_1 *)arg2)->unk_14 |= 0x7000;
            ((S_8014D3A8_2 *)base)->unk_1C &= 0xFFFBFFFF;
        }

clear_8000000:
        ((S_8014D3A8_2 *)base)->unk_1C &= 0xF7FFFFFF;
        flags = ((S_8014D3A8_2 *)base)->unk_1C;
        if (flags & 0x40000) {
            mode = ((S_8014D3A8_1 *)arg2)->unk_14;
            if (!(mode & 0x40)) {
                u8 *kind = ((S_8014D3A8_1 *)arg2)->unk_2C;

                if (kind == D_80150634) {
                    if (((S_8014D3A8_1 *)arg2)->unk_04 == 3 && (mode & 0x1000)) {
    ...
    if (initial_mode & 0x800) {
        ((S_8014D3A8_1 *)arg2)->unk_14 = initial_mode & 0x8FFF;
    } else {
        ((S_8014D3A8_1 *)arg2)->unk_14 = initial_mode | 0x7000;
    }
    ((S_8014D3A8_2 *)base)->unk_1C &= 0xF7FFFFFF;
    flags = ((S_8014D3A8_2 *)base)->unk_1C;
    ...
    if (!(flags & 0x40000)) {
        ...
        if (!((*(u16 *)((u8 *)arg0 + 0x98)) & 8)) {
            value = func_800BCB04(arg1->unk_00.at02.v,
                                  arg1->unk_04.at02.v,
                                  (s16)(((S_8014D3A8_2 *)base)->unk_88 - 0x20)) -
                    ((S_8014D3A8_2 *)base)->unk_88;
            if (value < (*(s16 *)((u8 *)arg0 + 0x92))) {
                (*(s16 *)((u8 *)arg0 + 0x92)) = value;
                (*(u8 *)((u8 *)arg0 + 0x9D)) = 0;
                arg1->unk_14 = 0;
                ((S_8014D3A8_2 *)base)->unk_1C |= 0x08000000;
                func_8014D910();
                return;
            }
        }
...
finish_motion:
    flags = ((S_8014D3A8_2 *)base)->unk_1C;
    if (flags & 0x40000000) {
        ((S_8014D3A8_2 *)base)->unk_1C = flags & 0xBFFFFFFF;
        value = func_800BCB04((((S_8014D3A8_1 *)arg2)->unk_24 << 6) | 0x20,
                              (((S_8014D3A8_1 *)arg2)->unk_25 << 6) | 0x20,
                              (s16)(((S_8014D3A8_2 *)base)->unk_88 - 0x20));
        if (value < 0x200) {
            (*(s16 *)((u8 *)arg0 + 0x92)) =
                (u16)(*(s16 *)((u8 *)arg0 + 0x92)) +
                (((S_8014D3A8_2 *)base)->unk_88 - value);
            ((S_8014D3A8_2 *)base)->unk_88 = value;
        }
    }
    arg1->unk_0A = ((S_8014D3A8_2 *)base)->unk_88 +
                             (u16)(*(s16 *)((u8 *)arg0 + 0x92)) -
                             (*(u16 *)((u8 *)arg0 + 0xA6));
    ((S_8014D3A8_1 *)arg2)->unk_14 |= 0x40;
}
