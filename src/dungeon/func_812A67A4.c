...
typedef struct S_80171FA4_1 {
    ...
    u8 pad_66[0x7];
    s8 unk_6D;
} S_80171FA4_1;   /* arg3 in func_80171FA4 */
...
typedef struct S_80171FA4_3 {
    u8 pad_00[0x58];
    void * unk_58;
} S_80171FA4_3;   /* D_800814A8 in func_80171FA4 */
...
void func_80171FA4(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    if (((S_80171FA4_1 *)arg3)->unk_25 == 0) {
        void *table;

        func_800AA79C(arg0, arg1, arg2, arg3);
        if (((S_80171FA4_2 *)arg2)->unk_2C == D_80175C90) {
            return;
        }
        table = D_80175CA0;
        (*(void * *)((u8 *)arg2 + (0x2C))) = table;
        func_80047784(arg2,
            ((u8 *)table)[((D_80083228 + ((S_80171FA4_1 *)arg3)->unk_2A + 0x100) >> 9) & 7],
            0);
        func_801724F0();
        return;
    }

    if (((S_80171FA4_1 *)arg3)->unk_1C & 0x200) {
        if (((S_80171FA4_2 *)arg2)->unk_2C == D_80175C90) {
            ((S_80171FA4_0 *)arg0)->unk_9A = 0xD;
            ((S_80171FA4_0 *)arg0)->unk_9B = 1;
            ((S_80171FA4_0 *)arg0)->unk_8C = 0;
            ((S_80171FA4_1 *)arg3)->unk_1C &= 0xFFFBFFFF;
            func_801724F0();
            return;
        }
    ...
    if (!(D_80083462 & 0x2000)) {
        if (((S_80171FA4_1 *)arg3)->unk_1C & 0x100) {
        ...
        ASM_KEEP(arg0);   /* MATCH pin: retail delay-slot fill depends on it */
        {
            ...
            if (current_state != actor_state) {
                ((S_80171FA4_0 *)arg0)->unk_9A = actor_state;
                ((S_80171FA4_0 *)arg0)->unk_B6 = 0;
            }
            current = ((S_80171FA4_2 *)arg2)->unk_2C;
            if (current == D_80175CA8) {
                ...
                if (current != table) {
                    ...
                    func_80047784(arg2,
                        ((u8 *)table)[((D_80083228 + ((S_80171FA4_1 *)arg3)->unk_2A + 0x100) >> 9) & 7],
                        0);
                    ((S_80171FA4_2 *)arg2)->unk_05 = 1;
                    ((S_80171FA4_0 *)arg0)->unk_A2.s = 0;
                    ((S_80171FA4_0 *)arg0)->unk_9E = 0;
                }
            }
        }

        ((S_80171FA4_1 *)arg3)->unk_1C |= 0x40000;
        ((S_80171FA4_0 *)arg0)->unk_98 &= 0xFFF7;

        if (((S_80171FA4_1 *)arg3)->unk_64 != 0) {
            if (func_800AA6B4(arg0, arg1, arg2, D_80175C38) != 0) {
                return;
            }
        }

        if (((S_80171FA4_1 *)arg3)->unk_1C & 0x80000) {
            s16 delta;

            func_800AA888(arg0, arg1, arg2, arg3);
            delta = ((S_80171FA4_0 *)arg0)->unk_92.u - ((S_80171FA4_0 *)arg0)->unk_A2.u;
            ((S_80171FA4_0 *)arg0)->unk_A2.s = 0;
            ((S_80171FA4_0 *)arg0)->unk_9E = 0;
    ...
    result = func_8009FB34(((S_80171FA4_2 *)arg2)->unk_24.at00.v, ((S_80171FA4_2 *)arg2)->unk_24.at01.v);
    ((S_80171FA4_2 *)arg2)->unk_26 = result;

    if (((S_80171FA4_1 *)arg3)->unk_6D > 0) {
        if (((S_80171FA4_1 *)arg3)->unk_1C & 0x20) {
            goto case_12;
        }
        if (((S_80171FA4_2 *)arg2)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto generic;
        }
        if (!(((S_80171FA4_1 *)arg3)->unk_46 & 0x8000)) {
            if (D_80083462 & 0x2000) {
                if ((func_8009A180(arg3,
                        (u8 *)((S_80171FA4_3 *)D_800814A8)->unk_58 + 0x20) << 16) != 0) {
                    return;
                }
            }
            ...
            state = ((S_80171FA4_1 *)arg3)->unk_46 | 0x4000;
            ((S_80171FA4_1 *)arg3)->unk_46 = state;
            if (!(state & 0x8000)) {
                goto generic;
            }
        }

        state = ((S_80171FA4_1 *)arg3)->unk_46 & 0x3FFF;
        if ((u32)(state - 1) >= 12) {
            goto generic;
        }
        (void)jt_keep;
...
jt_c7:
        ...
        coordinate = func_800A0818(
            ((S_80171FA4_2 *)arg2)->unk_24.at00.v, ((S_80171FA4_2 *)arg2)->unk_24.at01.v,
            ((S_80171FA4_4 *)origin)->unk_24, ((S_80171FA4_4 *)origin)->unk_25,
            &scratch);
        player = D_800814A8;
#ifndef __mips__
#endif
        ((S_80171FA4_1 *)arg3)->unk_2A = coordinate;
...
generic:
    ...
    if (!(((S_80171FA4_1 *)arg3)->unk_1C & 0x2000)) {
        s32 index = result;

        if ((index < 0) ||
            !(((DungeonRecord *)D_800E2970)[index].flags & 2)) {
            if (!(((S_80171FA4_1 *)arg3)->unk_1C & 0x430)) {
                u8 *origin = D_80082E80;

                if ((func_8009FD7C(
                        ((S_80171FA4_2 *)arg2)->unk_24.at00.v, ((S_80171FA4_2 *)arg2)->unk_24.at01.v,
                        ((S_80171FA4_4 *)origin)->unk_24, ((S_80171FA4_4 *)origin)->unk_25) << 16) != 0) {
                    ((S_80171FA4_1 *)arg3)->unk_2A = func_800A0818(
                        ((S_80171FA4_2 *)arg2)->unk_24.at00.v, ((S_80171FA4_2 *)arg2)->unk_24.at01.v,
                        ((S_80171FA4_4 *)origin)->unk_24, ((S_80171FA4_4 *)origin)->unk_25,
                        &scratch);
                }
