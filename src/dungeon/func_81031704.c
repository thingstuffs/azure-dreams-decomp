...
void func_80172F04(S_80172F04_0 *arg0, S_80172F04_3 *arg1, Rec_D_80082E80 *arg2, void *arg3)
{
    ...
    ASM_KEEP_NV(arg2);   /* UNRESOLVED C shape (pin): removing it changes the register colouring; the source shape that makes it unnecessary has not been found */
    ASM_KEEP_NV(arg1);   /* UNRESOLVED C shape (pin): removing it drops a computation retail keeps; the source shape that makes it unnecessary has not been found */
    actor = arg3;
    state = arg0->unk_9B;
    if (state == 1) {
        goto state_1;
