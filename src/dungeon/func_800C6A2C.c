...
s32 func_800CC18C(void *arg0) {
    register s32 value ASM_REG("$2");   /* MATCH pin: retail delay-slot fill depends on it */
    register s32 numerator ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
    s32 range;
