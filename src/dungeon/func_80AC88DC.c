...
typedef struct S_801740DC_3 {
    ...
    u8 pad_66[0x7];
    s8 unk_6D;
} S_801740DC_3;   /* arg3 in func_801740DC */
...
typedef struct S_801740DC_5 {
    u8 pad_00[0x58];
    void * unk_58;
} S_801740DC_5;   /* D_800814A8 in func_801740DC */
...
state_zero:
    if (!(((S_801740DC_1 *)arg2)->unk_14 & 0xE000)) {
        goto done;
    }
    {
        u8 *counter_base;
    ...
    index = (D_80083228 + ((S_801740DC_3 *)arg3)->unk_2A + 0x100) >> 9;
    func_80047784(arg2, D_80174E4C[index & 7], 0);
    goto increment_state;

state_one:
    if (((S_801740DC_3 *)arg3)->unk_25 != 0) {
        u8 *counter_base;
    ...
    flags = ((S_801740DC_3 *)arg3)->unk_1C;
    if (flags & 0x100) {
    ...
    if (((S_801740DC_3 *)arg3)->unk_6D == 0) {
        goto done;
    }
    if ((func_800A2C34(arg3) << 16) != 0) {
        if ((func_8009A180(arg3,
                (u8 *)((S_801740DC_5 *)D_800814A8)->unk_58 + 0x20) << 16) != 0) {
            goto done;
        }
    }
    func_800A9A0C(arg3);
