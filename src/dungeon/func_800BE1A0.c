...
s32 func_800C3900(Rec_D_800E3D7C *arg0, s32 arg1, s16 arg2) {
    ...
    if (((u32) (arg0->unk_10.at03_u8.v - 1) < 0x2EU) && ((u32) arg0 <= 0x9FFFFFFFU)) {
        func_800A63B8(arg0, arg1, arg2);
        temp_s1 = ((u32) arg0->unk_1C.as_u32 >> 3) & 1;
        if (func_800AD6FC(arg0, (((u16 *) D_800DDE84)[arg0->unk_10.at03_u8.v] >> 6) & 3, 0) == 0) {
            func_800A5F38(arg0, arg1);
            return 1;
        }
        temp_v0 = temp_s1;
        if (temp_v0 != 0) {
            arg0->unk_1C.as_u32 = (u32) (arg0->unk_1C.as_u32 | 8);
        }
        temp_v1 = arg0->unk_1C.as_u32;
        arg0->unk_24.at00_s16.v = 0;
        if (!(temp_v1 & 8)) {
