...
void func_8185CA1C(s32 arg0, void *arg1)
{
    s32 temp_v0_2;
    void *temp_s0;
    int new_var;
    ...
    if (temp_v0 != 0)
    {
        ...
        *((s16 *)(((s8 *)temp_s0) + 0x1E)) = 0x1800;
        *((s16 *)(((s8 *)temp_s0) + 0x1C)) = 0x1800;
        *((s16 *)(((s8 *)temp_s0) + 0x12)) = 0x7E0B;
        *((u16 *)(((s8 *)temp_s0) + 0x10)) =
            (u16)(*((u16 *)(((s8 *)temp_s0) + 0x10)) | 0x60);
        *((u16 *)(((s8 *)temp_s0) + 0x14)) =
            (u16)(*((u16 *)(((s8 *)temp_s0) + 0x14)) | 0x10C);
        ...
        *((u16 *)(((s8 *)temp_s0_2) + 6)) =
            (u16)(*((u16 *)(((s8 *)arg1) + 6)));
        temp_v0_2 = rand();
        *((s16 *)(((s8 *)temp_s0_2) + 0xA)) =
            (s16)((*((u16 *)(((s8 *)arg1) + 0xA)) - 0x20) -
                  (temp_v0_2 % 16));
    }
}
