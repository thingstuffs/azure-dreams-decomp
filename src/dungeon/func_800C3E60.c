...
s32 func_800C95C0(void *arg0, void *arg1, s16 *arg2) {
    void *state = arg0;
    s16 *delta = arg2;
    ...
    for (;;) {
        *(u16 *)(scratch + 0) = ((S_800C95C0_0 *)arg1)->unk_02;
        *(u16 *)(scratch + 2) = (*(u16 *)((u8 *)arg1 + 6));
        *(u16 *)(scratch + 4) = (*(u16 *)((u8 *)arg1 + 0xA));
        *(s32 *)(scratch + 0xC0) =
            func_80065420((void *)scratch, (void *)(scratch + 0xB8),
                           (void *)(scratch + 0x90), (void *)(scratch + 0x94)) -
            *(s16 *)((u8 *)delta + 6);
        func_800C96E8(state, scratch);
        next = ((S_800C95C0_1_pre *)state)[-1].unk_00;
        if (next == NULL)
            break;
        state = next + 0x20;
        arg1 = *(u8 **)(next + 8);
