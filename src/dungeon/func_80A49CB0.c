...
void func_801734B0(void *in_arg0, void *in_arg1, void *in_arg2, void *in_arg3)
{
    void *arg0 = in_arg0;
    void *arg1 = in_arg1;
    void *arg2 = in_arg2;
...
state_zero:
    if (!(((S_801734B0_1 *)arg2)->unk_14 & 0xE000)) {
        goto done;
    }
    (*(void * *)((u8 *)arg2 + 0x2C)) = D_80175894;
    func_80047784(arg2,
        D_80175894[((D_80083228 + ((S_801734B0_2 *)arg3)->unk_2A + 0x100) >> 9) & 7],
        0);
    ((S_801734B0_0 *)arg0)->unk_96 = 0;
    {
...
state_one:
    ...
    func_80047784(arg2,
        D_80175894[((D_80083228 + ((S_801734B0_2 *)arg3)->unk_2A + 0x100) >> 9) & 7],
        0);
    ((S_801734B0_2 *)arg3)->unk_1C.s |= 0x40000;
    if (!(((S_801734B0_1 *)arg2)->unk_14 & 0x8000)) {
        goto increment_counter;
    }
    ((S_801734B0_2 *)arg3)->unk_1C.s &= ~0x200;
...
state_one_active:
    ...
    global_base = page_base + 0x3460;
    {
        ...
        if (((S_801734B0_2 *)arg3)->unk_64 != 0) {
            if (func_800AA6B4(arg0, arg1, arg2, 0) != 0) {
                goto done;
            }
        }
        if (((S_801734B0_2 *)arg3)->unk_25 == 0) {
        ...
        flags = ((S_801734B0_2 *)arg3)->unk_1C.u;
        if (flags & 0x100) {
        ...
        if (flags & 0x80000) {
            ...
            ((S_801734B0_5 *)copy_arg0)->unk_B8 = 0;
            ((S_801734B0_5 *)copy_arg0)->unk_92 = current_value - old_value;
            func_80173C34(copy_arg0, arg1, arg2, arg3);
            goto done;
        }
        if (((S_801734B0_2 *)arg3)->unk_6D == 0) {
            goto done;
        }
        if ((func_800A2C34(arg3) << 16) != 0) {
        ...
        if ((func_80042900(arg3, 1) << 16) != 0) {
            ...
            s8 tile = ((S_801734B0_1 *)arg2)->unk_26;
        ...
        0);
    {
        ...
        late_flags = ((S_801734B0_2 *)arg3)->unk_1C.s;
        late_flags |= 0x40000;
        ((S_801734B0_2 *)arg3)->unk_1C.s = late_flags;
    }
    if (((S_801734B0_1 *)arg2)->unk_14 & 0x8000) {
        ((S_801734B0_2 *)arg3)->unk_1C.u &= ~0x200;
        goto assign_callback;
    }
