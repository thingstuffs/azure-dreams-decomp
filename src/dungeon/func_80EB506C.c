...
typedef struct S_8017086C_0 {
    ...
    void * unk_0C;
    void * unk_10;
} S_8017086C_0;   /* obj in func_8017086C */

typedef struct S_8017086C_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_8017086C_1;   /* work in func_8017086C */

typedef struct S_8017086C_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_8017086C_2;   /* part_a in func_8017086C */

typedef struct S_8017086C_3 {
    u8 pad_00[0x12];
    s16 unk_12;
    u8 pad_14[0x10];
    s8 unk_24;
    ...
    s32 unk_28;
    void * unk_2C;
} S_8017086C_3;   /* part_b in func_8017086C */

typedef struct S_8017086C_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0x2];
    s16 unk_92;
    ...
    u8 pad_A0[0x8];
    u16 unk_A8;
} S_8017086C_4;   /* actor in func_8017086C */

typedef struct S_8017086C_5 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8017086C_5;   /* current in func_8017086C */
...
typedef struct S_8017086C_7 {
    ...
    u8 pad_16[0x12];
    u32 unk_28;
} S_8017086C_7;   /* elem in func_8017086C */

typedef struct S_8017086C_8 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8017086C_8;   /* base in func_8017086C */

typedef struct S_8017086C_9 {
    u8 pad_00[0x10];
    void * unk_10;
} S_8017086C_9;   /* ((S_8017086C_8 *)base)->unk_A4 in func_8017086C */
...
void *func_8017086C(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    ...
    if (obj != 0) {
        ...
        left = ((S_8017086C_1 *)work)->unk_14 | 0x2000;
        right = ((S_8017086C_1 *)work)->unk_1C | 0x2000;
...
normal_kind:
        if (((arg0 & ~3) << 16) == 0) {
            if (!(((S_8017086C_1 *)work)->unk_14 & 0x200)) {
                left = func_800A6D30();
                if (left & 1) {
                    ((S_8017086C_1 *)work)->unk_1C |= 0x200;
                    right = func_800A6D30();
                    func_800A48F0(work, 1, (right & 0x3F) | 0x20);
                    part_b->unk_2C = D_801741CC;
                }
            }
        }
...
call_actor_setup:
        ...
        actor->unk_9A = 0xFF;
        actor->unk_9C = -1;
        actor->unk_8C = D_801711A4;
        ((S_8017086C_1 *)work)->unk_1C |= 0x00040000;
        actor->unk_92 = -16;
        flags = actor->unk_98;
        actor->unk_A8 = 0;
        actor->unk_9E = 1;
        ...
        do {
            ...
            if (child_obj != 0) {
                ...
                while (i < ((S_8017086C_6 *)child)->unk_02) {
                    ...
                    ((S_8017086C_6 *)child)->unk_04 = child_flags | 0x8000;
                    ...
                    ((S_8017086C_6 *)child)->unk_98 = (u8 *)obj + 30;
                }
            }
