...
typedef struct S_80172458_1 {
    u8 pad_00[0x14];
    u16 unk_14;
    u8 pad_16[0xE];
    u8 unk_24;
    u8 unk_25;
} S_80172458_1;   /* arg2 in func_80172458 */

typedef struct S_80172458_2 {
    u8 pad_00[0x1C];
    s32 unk_1C;
    u8 pad_20[0xA];
    s16 unk_2A;
    ...
    u8 pad_48[0x40];
    u16 unk_88;
} S_80172458_2;   /* arg3 in func_80172458 */

typedef struct S_80172458_3 {
    u8 pad_00[0x2];
    s16 unk_02;
    u8 pad_04[0x2];
    s16 unk_06;
    ...
    s32 unk_10;
    s32 unk_14;
} S_80172458_3;   /* arg1 in func_80172458 */
...
state_ge2:
    ...
    goto block_36;
state_zero:
    if (((S_80172458_1 *)arg2)->unk_14 & 0x6000) {
        (*(u8 **)((u8 *)arg2 + 0x2C)) = D_801752CC;
        func_80047784(arg2, D_801752CC[((D_80083228 + ((S_80172458_2 *)arg3)->unk_2A + 0x100) >> 9) & 7], 0);
        ((S_80172458_0 *)arg0)->unk_98 = (u16) (((S_80172458_0 *)arg0)->unk_98 | 8);
        ((S_80172458_2 *)arg3)->unk_1C = (s32) (((S_80172458_2 *)arg3)->unk_1C & 0xF7FFFFFF);
        ((S_80172458_0 *)arg0)->unk_9E = 5;
        ((S_80172458_0 *)arg0)->unk_A0 = 0;
        ((S_80172458_0 *)arg0)->unk_9B = (u8) (((S_80172458_0 *)arg0)->unk_9B + 1);
        ((S_80172458_0 *)arg0)->unk_A6 = func_800BCB04((((S_80172458_1 *)arg2)->unk_24 << 6) | 0x20, (((S_80172458_1 *)arg2)->unk_25 << 6) | 0x20, (s16) (((S_80172458_2 *)arg3)->unk_88 - 0x20));
        ((S_80172458_0 *)arg0)->unk_A8 = (u16) ((S_80172458_3 *)arg1)->unk_0A;
        goto block_10;
    }
    goto block_36;
block_10:
    ...
    if (temp_a0 != 0) {
        temp_result = ((S_80172458_1 *)arg2)->unk_24;
        temp_diff = ((S_80172458_3 *)arg1)->unk_02;
        temp_result <<= 6;
        temp_diff -= 0x20;
        temp_result = ((temp_result - temp_diff) << 0x10) / temp_a0;
        temp_diff = ((S_80172458_3 *)arg1)->unk_06;
        ((S_80172458_3 *)arg1)->unk_0C = temp_result;
        temp_result = ((S_80172458_1 *)arg2)->unk_25;
        temp_diff -= 0x20;
        temp_result <<= 6;
        temp_result -= temp_diff;
        temp_diff = ((S_80172458_0 *)arg0)->unk_9E;
        temp_result = (temp_result << 0x10) / temp_diff;
        ((S_80172458_3 *)arg1)->unk_10 = temp_result;
...
mask_flags:
        ...
        mask_a0 |= 0xFFFF;
        ((S_80172458_2 *)arg3)->unk_1C = (s32) (((S_80172458_2 *)arg3)->unk_1C & mask_a0);
        goto block_32;
case_4:
...
block_32:
    ...
    if (temp_v0 < 0) {
        ...
        ((S_80172458_2 *)arg3)->unk_1C = (s32) (((S_80172458_2 *)arg3)->unk_1C | 0x08000000);
        ((S_80172458_0 *)arg0)->unk_9B = (u8) (((S_80172458_0 *)arg0)->unk_9B + 1);
    }
block_34:
    if (((S_80172458_2 *)arg3)->unk_1C & 0x08000000) {
        ((S_80172458_0 *)arg0)->unk_98 = (u16) (((S_80172458_0 *)arg0)->unk_98 & 0xFFF7);
        ((S_80172458_3 *)arg1)->unk_14 = 0;
        ((S_80172458_3 *)arg1)->unk_10 = 0;
        ((S_80172458_3 *)arg1)->unk_0C = 0;
        func_800A2B04(arg1, ((S_80172458_1 *)arg2)->unk_24, ((S_80172458_1 *)arg2)->unk_25);
        (*(u8 **)((u8 *)arg2 + 0x2C)) = D_801752D4;
        func_80047784(arg2, D_801752D4[((D_80083228 + ((S_80172458_2 *)arg3)->unk_2A + 0x100) >> 9) & 7], 0);
        func_800419EC(4, 8);
        func_800B66C8(arg1);
...
block_36:
    ...
    if ((temp_v0_2 << 0x10) <= 0) {
        ...
        temp_v1_3 = ((S_80172458_2 *)arg3)->unk_1C;
        if (temp_v1_3 & 0x2000) {
            temp_v0_2 = ((S_80172458_2 *)arg3)->unk_46;
            if (temp_v0_2 & 0x8000) {
                ((S_80172458_2 *)arg3)->unk_46 = temp_v0_2 & 0x7FFF;
            }
            goto block_46;
        }
        if (temp_v1_3 & 0x410) {
        ...
        ((S_80172458_2 *)arg3)->unk_2A = func_800A0818(((S_80172458_1 *)arg2)->unk_24, ((S_80172458_1 *)arg2)->unk_25, map_base[0x24], map_base[0x25], &sp18);
block_46:
