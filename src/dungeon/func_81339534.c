...
typedef struct S_80170534_0 {
    ...
    u8 pad_16[0x4];
    u16 unk_1A;
} S_80170534_0;   /* state in func_80170534; pointer addresses record offset 0x2 */
...
void func_80170534(void *arg0, void *arg1, void *arg2) {
    ...
    temp_v1 = ((S_80170534_0 *)((u8 *)state - 0x2))->unk_14.s;
    if ((u32) temp_v1 >= 5) {
        goto state_end;
    }
    input = arg2;
...
state_1:
    temp_v0 = ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A + 1;
    ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A = temp_v0;
    if (!(temp_v0 & 3)) {
        func_800419EC(6, 0xC);
        func_800A56E0(0x818);
    }
    if (!(((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A & 7)) {
        temp_v1 = 0xFF;
        if (input->unk_0C != temp_v1) {
            input->unk_0E.s = temp_v1;
            input->unk_0D.s = temp_v1;
            input->unk_0C = temp_v1;
            func_801705EC();
        }
        temp_v0 = 0x80;
        input->unk_0E.u = temp_v0;
        input->unk_0D.u = temp_v0;
        input->unk_0C = temp_v0;
    }
    if ((s16) ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A == 0x28) {
#ifdef NON_MATCHING
        D_801760D8[0] = 1;
#else
        {
    ...
    if ((s16) ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A >= 0x28) {
        temp_v0 = ((S_80170534_0 *)((u8 *)state - 0x2))->unk_14.u + 1;
        ((S_80170534_0 *)((u8 *)state - 0x2))->unk_14.u = temp_v0;
        return;
    }
    goto state_end;

state_2:
    temp_v0_2 = ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A + 1;
    ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A = temp_v0_2;
    if (!(temp_v0_2 & 3)) {
        func_800A56E0(0x818);
    }
    if (!(((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A & 7)) {
    ...
    if ((s16) ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A >= 0x3C) {
        ((S_80170534_0 *)((u8 *)state - 0x2))->unk_1A = 0U;
        ((S_80170534_0 *)((u8 *)state - 0x2))->unk_14.s = (s16) ((u16) ((S_80170534_0 *)((u8 *)state - 0x2))->unk_14.s + 1);
        input->unk_0E.u = 0x80;
        input->unk_0D.u = 0x80;
        input->unk_0C = 0x80;
        return;
