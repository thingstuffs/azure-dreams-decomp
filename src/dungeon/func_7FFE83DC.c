...
void func_7FFE83DC(S_7FFE83DC_3 *arg0, s32 arg1) {
    s32 temp_arg1;
    S_7FFE83DC_1 *temp_a0;
    S_7FFE83DC_4 *temp_a0_2;
    S_7FFE83DC_0 *temp_v0;
    S_7FFE83DC_2 *temp_v1;

    temp_v0 = func_8003CF18(0x12);
    if (temp_v0 != NULL) {
        temp_a0 = temp_v0->unk_0C;
        temp_v0->unk_10 = &D_8010B158;
        temp_v0->unk_44 = arg0;
        temp_v0->unk_3E = 0x1E;
        temp_a0->unk_10 = 0x20;
        temp_a0->unk_14 =
        ...
        temp_v1->unk_02 =
            (u16)((S_7FFE83DC_5 *)(arg0->unk_08))->unk_02;
        temp_v1->unk_06 =
            (u16)((S_7FFE83DC_5 *)(arg0->unk_08))->unk_06;
        temp_v1->unk_0A =
            (u16)((S_7FFE83DC_5 *)(arg0->unk_08))->unk_0A;
