...
typedef struct S_80171760_0 {
    ...
    s16 unk_9E;
    s16 unk_A0;
} S_80171760_0;   /* arg0 in func_80171760 */

typedef struct S_80171760_1 {
    u8 pad_00[0x1C];
    u32 unk_1C;
    u8 pad_20[0x5];
    u8 unk_25;
    ...
    u8 pad_66[0x7];
    s8 unk_6D;
} S_80171760_1;   /* arg3 in func_80171760 */
...
typedef struct S_80171760_3 {
    u8 pad_00[0x58];
    void * unk_58;
} S_80171760_3;   /* D_800814A8 in func_80171760 */
...
void func_80171760(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    if (((S_80171760_1 *)arg3)->unk_1C & 0x200) {
        if (((S_80171760_2 *)arg2)->unk_2C == D_80174EF0) {
            ((S_80171760_0 *)arg0)->unk_9A = 0xD;
    ...
    if (!(D_80083462 & 0x2000)) {
...

        {
            ...
            ((S_80171760_0 *)arg0)->unk_9E = 0;
            ((S_80171760_0 *)arg0)->unk_A0 = (rand() & 0x1F) + 0xF;
            ((S_80171760_0 *)arg0)->unk_9A = state;
            }
        }

        ((S_80171760_0 *)arg0)->unk_98 &= 0xFFF3;
        if (((S_80171760_1 *)arg3)->unk_64 != 0) {
    ...
    if (((S_80171760_1 *)arg3)->unk_6D > 0) {
        u16 state;

        if (((S_80171760_1 *)arg3)->unk_1C & 0x20) {
            goto case_12;
        }
        if (((S_80171760_2 *)arg2)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto generic;
        }
        if (!(((S_80171760_1 *)arg3)->unk_46 & 0x8000)) {
            if (D_80083462 & 0x2000) {
                if ((func_8009A180(arg3,
                        (u8 *)((S_80171760_3 *)D_800814A8)->unk_58 + 0x20) << 16) != 0) {
                    return;
                }
            }
            ...
            state = ((S_80171760_1 *)arg3)->unk_46 | 0x4000;
            ((S_80171760_1 *)arg3)->unk_46 = state;
            if (!(state & 0x8000)) {
                goto generic;
            }
        }

        state = ((S_80171760_1 *)arg3)->unk_46 & 0x3FFF;
        if ((u32)(state - 1) >= 12) {
            goto generic;
        }
        (void)jt_keep;
...
jt_c7:
        {
            ...
            coordinate = func_800A0818(
                ...
                &scratch);
            player = D_800814A8;
            ((S_80171760_1 *)arg3)->unk_2A = coordinate;
...
generic:
        ...
        if ((index < 0) ||
            ...
            if (!(((S_80171760_1 *)arg3)->unk_1C & 0x430)) {
                u8 *origin = D_80082E80;

                if ((func_8009FD7C(
                        ((S_80171760_2 *)arg2)->unk_24.at00.v, ((S_80171760_2 *)arg2)->unk_24.at01.v,
                        ((S_80171760_4 *)origin)->unk_24, ((S_80171760_4 *)origin)->unk_25) << 16) != 0) {
                    ((S_80171760_1 *)arg3)->unk_2A = func_800A0818(
                        ((S_80171760_2 *)arg2)->unk_24.at00.v, ((S_80171760_2 *)arg2)->unk_24.at01.v,
                        ((S_80171760_4 *)origin)->unk_24, ((S_80171760_4 *)origin)->unk_25,
                        &scratch);
                }
