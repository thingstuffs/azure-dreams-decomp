...
hop_delay:
    ...
    func_80047784(
        sprite,
        D_80168ED0[((D_80083228 + ((S_801670E0_1 *)actor)->unk_2A + 0x100) >> 9) & 7],
        0);
...
hop_move:
    ...
    if (hop_ticks != 0) {
        ...
        target_x <<= 6;
        position_x -= 0x20;
        ((Rec_D_800E3D7C *)motion)->unk_0C.as_s32 = ((target_x - position_x) << 16) / hop_ticks;
...
hop_land:
    if (((S_801670E0_1 *)actor)->unk_1C.s & 0x08000000) {
        ...
        func_80047784(
            sprite,
            D_80168ED8[((D_80083228 + ((S_801670E0_1 *)actor)->unk_2A + 0x100) >> 9) & 7],
            0);
        ((S_801670E0_0 *)motion_state)->unk_9B++;
    }
    goto update_countdown;
...
idle_animation:
    ...
    if (((Rec_D_80082E80 *)sprite)->unk_2C.as_pu8 != anim_table) {
        ...
        func_80047784(
            sprite,
            anim_table[((D_80083228 + ((S_801670E0_1 *)actor)->unk_2A + 0x100) >> 9) & 7],
            0);
    }
