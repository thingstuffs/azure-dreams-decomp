...
typedef struct S_818C29D4_3 {
    u8 * unk_00;
} S_818C29D4_3;   /* D_80083160 in func_818C29D4 */
...
} S_818C29D4_7;   /* ((S_818C29D4_3 *)D_80083160)->unk_00 in func_818C29D4 */
...
s32 func_818C29D4(S_818C29D4_6 *arg0, S_818C29D4_4 *arg1)
{
    ...
    ((S_818C29D4_2 *)scratch)->unk_18.p = ((S_818C29D4_3 *)D_80083160)->unk_00 + 0xB0;
    ...
    poly = ((S_818C29D4_7 *)(((S_818C29D4_3 *)D_80083160)->unk_00))->unk_8D0.p;
    ((S_818C29D4_7 *)(((S_818C29D4_3 *)D_80083160)->unk_00))->unk_8D0.p2 = (u8 *)poly + sizeof(*poly);
    ...
    if (((S_818C29D4_2 *)scratch)->unk_B4.n < 0x1E0U) {
        ...
        packet = ((S_818C29D4_7 *)(((S_818C29D4_3 *)D_80083160)->unk_00))->unk_8D0.p2;
        ASM_KEEP(packet);   /* MATCH pin: retail schedule: same instructions, different order without it */
        lo_mask |= 0xFFFF; ASM_KEEP(lo_mask);
        ((S_818C29D4_7 *)(((S_818C29D4_3 *)D_80083160)->unk_00))->unk_8D0.p2 = packet + 0xC;
