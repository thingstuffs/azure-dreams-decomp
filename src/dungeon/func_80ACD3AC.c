...
state_zero:
    ...
    func_80047784(
        sprite,
        D_8016EE0C[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
...
state_two:
    if (((Rec_D_800E3D7C *)actor)->unk_1C.as_s32 & 0x08000000) {
        ...
        func_80047784(
            sprite,
            D_8016EE14[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        ((S_8016CBAC_0 *)action)->unk_9B++;
    }
    goto decrement_timer;
...
state_three:
    ...
    func_80047784(
        sprite,
        D_8016EDEC[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
...
decrement_timer:
    ...
    ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 = func_800A0818(
        ...
        ((S_8016CBAC_5 *)target_tile)->unk_24,
        ((S_8016CBAC_5 *)target_tile)->unk_25,
        &facing_aux);
