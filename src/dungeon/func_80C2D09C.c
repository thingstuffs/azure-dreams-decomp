...
void *func_8015889C(s32 kind, s32 part_value_24, s32 part_value_25, s32 copy_value)
{
    ...
    register s32 saved_part_value ASM_REG("$18");   /* UNRESOLVED C shape (pin): removing it changes the address form (%hi/%lo vs base+offset); the source shape that makes it unnecessary has not been found */
