...
void func_801732B4(S_801732B4_1 *arg0, S_801732B4_2 *arg1, S_801732B4_3 *arg2, void *arg3)
{
    s16 timer;
    s32 value;
    s32 *state;
    ...
    index = (((S_801732B4_0 *)arg3)->unk_6A >> 9) & 7;

    switch (arg0->unk_9B) {
    case 0:
        func_800AD4D0(arg3);
        arg1->unk_0C = ((s16 *)&D_8006CCD8)[index] << 17;
        arg1->unk_10 = ((s16 *)&D_8006CCE8)[index] << 17;
        arg0->unk_9B++;

        if (((S_801732B4_0 *)arg3)->unk_28 == 0) {
            goto start_action;
        }
        ...
        if (((S_801732B4_0 *)arg3)->unk_1C & 0x228) {
            timer = 8;
        } else {
            timer = -1;
        }
    ...
    case 1:
        arg1->unk_0C -= ((s16 *)&D_8006CCD8)[index] << 14;
        arg1->unk_10 -= ((s16 *)&D_8006CCE8)[index] << 14;
        if (arg0->unk_96.s > 0) {
