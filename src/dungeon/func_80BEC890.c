...
void func_80172090(S_80172090_1 *arg0, M2C_UNK arg1, S_80172090_2 *arg2, void *arg3) {
    ((S_80172090_0 *)arg3)->unk_71 = (u8) (((S_80172090_0 *)arg3)->unk_71 & 0x7F);
    if (!(*D_80083462 & 0x2000) && ((func_800A2B5C(arg3) << 0x10) == 0)) {
        ...
        if ((func_800A2B5C(arg3) << 0x10) == 0) {
            ...
            arg0->unk_8C = 0;
            arg0->unk_9B = 0;
            arg2->unk_2C = D_8017423C;
            func_80047784(arg2, D_8017423C[((s32) (*D_80083228 + ((S_80172090_0 *)arg3)->unk_2A + 0x100) >> 9) & 7], 0);
            ((S_80172090_0 *)arg3)->unk_6D = (u8) (((S_80172090_0 *)arg3)->unk_6D - 1);
            arg0->unk_98 = (u16) (arg0->unk_98 | 8);
            func_8009C93C(arg3, arg2, ((S_80172090_0 *)arg3)->unk_2A, 1, 0);
            ((S_80172090_0 *)arg3)->unk_84 = 0x7C;
            ((S_80172090_0 *)arg3)->unk_85 = 0;
        }
    }
}
