...
typedef struct S_80154B4C_1 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_80154B4C_1;   /* arg2 in func_80154B4C */

typedef struct S_80154B4C_2 {
    u8 pad_00[0x1C];
    s32 unk_1C;
    u8 pad_20[0xA];
    s16 unk_2A;
    u8 pad_2C[0x1A];
    u16 unk_46;
} S_80154B4C_2;   /* arg3 in func_80154B4C */

typedef struct S_80154B4C_3 {
    u8 pad_00[0x2];
    s16 unk_02;
    u8 pad_04[0x2];
    s16 unk_06;
    ...
    s32 unk_10;
    s32 unk_14;
} S_80154B4C_3;   /* arg1 in func_80154B4C */
...
state_zero:
{
    ...
    if (!(((S_80154B4C_1 *)arg2)->unk_14 & 0x6000)) {
        goto decrement_timer;
    }
    state_table = D_80157574;
    (*(u8 * *)((u8 *)arg2 + 0x2C)) = state_table;
    func_80047784(arg2,
        state_table[((D_80083228 + ((S_80154B4C_2 *)arg3)->unk_2A + 0x100) >> 9) & 7],
        0);
    ((S_80154B4C_1 *)arg2)->unk_1E = 0x1000;
    ((S_80154B4C_0 *)arg0)->unk_98 |= 8;
    ((S_80154B4C_2 *)arg3)->unk_1C &= 0xF7FFFFFF;
...
state_one:
    ...
    if (remaining != 0) {
        tile_x = ((S_80154B4C_1 *)arg2)->unk_24;
        x = ((S_80154B4C_3 *)arg1)->unk_02;
        tile_x <<= 6;
        x -= 0x20;
        ((S_80154B4C_3 *)arg1)->unk_0C = ((tile_x - x) << 16) / remaining;

        y = ((S_80154B4C_3 *)arg1)->unk_06;
        y -= 0x20;
        ((S_80154B4C_3 *)arg1)->unk_10 =
            (((((S_80154B4C_1 *)arg2)->unk_25 << 6) - y) << 16) /
    ...
    ((S_80154B4C_2 *)arg3)->unk_1C |= 0x08000000;
    ((S_80154B4C_0 *)arg0)->unk_9B++;
...
state_two:
{
    ...
    if (((S_80154B4C_2 *)arg3)->unk_1C & 0x08000000) {
        ((S_80154B4C_0 *)arg0)->unk_98 &= 0xFFF7;
        ((S_80154B4C_3 *)arg1)->unk_14 = 0;
        ((S_80154B4C_3 *)arg1)->unk_10 = 0;
        ((S_80154B4C_3 *)arg1)->unk_0C = 0;
        func_800A2B04(arg1, ((S_80154B4C_1 *)arg2)->unk_24, ((S_80154B4C_1 *)arg2)->unk_25);
        state_table = D_8015757C;
        (*(u8 * *)((u8 *)arg2 + 0x2C)) = state_table;
        func_80047784(arg2,
            state_table[((D_80083228 + ((S_80154B4C_2 *)arg3)->unk_2A + 0x100) >> 9) & 7],
            0);
        ((S_80154B4C_1 *)arg2)->unk_1E = 0xC00;
        ((S_80154B4C_0 *)arg0)->unk_9B++;
        goto decrement_timer;
    }
    goto decrement_timer;
...
state_three:
    table = D_80157554;
    if (((S_80154B4C_1 *)arg2)->unk_2C != table) {
        (*(u8 * *)((u8 *)arg2 + 0x2C)) = table;
        func_80047784(arg2,
            table[((D_80083228 + ((S_80154B4C_2 *)arg3)->unk_2A + 0x100) >> 9) & 7],
            0);
        ((S_80154B4C_1 *)arg2)->unk_1E = 0x1000;
    }
...
decrement_timer:
    ...
    flags = ((S_80154B4C_2 *)arg3)->unk_1C;
    if (flags & 0x2000) {
        if (((S_80154B4C_2 *)arg3)->unk_46 & 0x8000) {
            ((S_80154B4C_2 *)arg3)->unk_46 &= 0x7FFF;
        }
    ...
    map_base = D_80082E80;
    ((S_80154B4C_2 *)arg3)->unk_2A = func_800A0818(
        ((S_80154B4C_1 *)arg2)->unk_24,
        ((S_80154B4C_1 *)arg2)->unk_25,
