...
extern M2C_UNK D_8014CA58;
extern M2C_UNK D_8014D014;
extern M2C_UNK D_8015020C;
extern M2C_UNK D_8015025C;
void *func_8003FD64();
...
extern void func_8014C958(void) __attribute__((noreturn));
extern void func_8014C9C4(void) __attribute__((noreturn));
...
void *func_8014C878(s16 arg0, s8 arg1, s8 arg2, s16 arg3) {
    ...
    unksp24 = (s32) *(s8 *)0x1D8;
    temp_v0 = func_8003FD64(0x112, &D_80083498);
    if (temp_v0 == NULL) {
        goto done;
    }
    var_s0 = temp_v0 + 0x20;
    M2C_FIELD(temp_v0, M2C_UNK **, 0x10) = &D_8014CA58;
    ...
    temp_s5 = var_s0;
    M2C_FIELD(temp_s2, M2C_UNK **, 0x2C) = &D_8015020C;
    ...
    if (((arg0 & ~3) << 0x10) == 0) {
        if (!(M2C_FIELD(var_s0, s32 *, 0x14) & 0x200)) {
            if (func_800A6D30(temp_v0, temp_s4) & 1) {
                ...
                M2C_FIELD(temp_s2, M2C_UNK **, 0x2C) = &D_8015025C;
            }
        }
    }
    ...
    M2C_FIELD(var_s0, M2C_UNK **, 0x8C) = &D_8014D014;
