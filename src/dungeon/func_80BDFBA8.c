...
void func_801533A8(void *entity, S_801533A8_0 *motion, void *sprite)
{
    ...
    if (!(initial_sprite_flags & 0x8000)) {
        direction = ((D_80083228 + ((S_801533A8_2 *)entity_base)->unk_2A + 0x100) >> 9) & 7;
    ...
    if (!(((Rec_D_80082E80 *)sprite)->unk_14.at00_u16.v & 0x40)) {
        ...
        if (direction_frames == D_80156644 || direction_frames == D_8015666C) {
            (*(s32 *)((u8 *)entity + 0xA4)) -= 0x40000;
            if ((*(s32 *)((u8 *)entity + 0xA4)) <= 0) {
                (*(s32 *)((u8 *)entity + 0xA4)) = 0;
            }
...
finish_motion:
    ...
    motion->unk_0A = ((S_801533A8_2 *)entity_base)->unk_88 +
                             (u16)(*(s16 *)((u8 *)entity + 0x92)) -
                             (*(u16 *)((u8 *)entity + 0xA6));
