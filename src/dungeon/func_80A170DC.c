...
void *func_8014C8DC(s32 kind, s32 part_x, s32 part_y, s32 init_value)
{
   ...
   /* UNRESOLVED C shape (pin): removing it reorders the instructions (same instructions, different order); the source shape that makes it unnecessary has not been found */
...

    {
        ...
        if ((saved_kind & 3) == 1) {
            flags_14 = ((S_8014C8DC_1 *)object)->unk_14 | 0x6000;
            flags_1c = ((S_8014C8DC_1 *)object)->unk_1C | 0x6000;
            goto store_flags;
        }
        if ((saved_kind & 3) >= 2) {
            flags_14 = ((S_8014C8DC_1 *)object)->unk_14 | 0x2000;
            flags_1c = ((S_8014C8DC_1 *)object)->unk_1C | 0x2000;
            goto store_flags;
        }
        goto update_kind;

store_flags:
        ((S_8014C8DC_1 *)object)->unk_14 = flags_14;
        ((S_8014C8DC_1 *)object)->unk_1C = flags_1c;
        goto flags_done;
...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            address_or_count = 1;
            ((S_8014C8DC_6 *)entry)->unk_02 = (s16)address_or_count;
            item_index = 0;
            outer_base = outer;
            ...
            do {
                ...
                item_index++;
                {
                    ...
                    ((S_8014C8DC_6 *)entry)->unk_06 = (s16)address_or_count;
