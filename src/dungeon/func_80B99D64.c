...
void func_80173564(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    state = ((S_80173564_0 *)arg0)->unk_9B;
    if (state == 0) {
        goto state_zero;
    }
    if (state == 1) {
...
state_one:
    if (((Rec_D_800E3D7C *)arg3)->unk_24.at01_u8.v == 0) {
        ...
        {
        void *callArg0 = arg0;   /* UNRESOLVED C shape (pin): removing it changes the basic-block layout; the source shape that makes it unnecessary has not been found */
        ...
        if ((s16)func_800A2C34(arg3) != 0) {
            ...
            owner = D_800814A8;
            if ((s16)func_8009A180(arg3, (u8 *)((S_80173564_4 *)owner)->unk_58 + 0x20) != 0) {
                return;
            }
        }
