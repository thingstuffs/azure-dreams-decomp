...
common:
...

    {
        ...
        register s32 sine_scale ASM_REG("$3") = FIELD(arg0, s16, 0x62);   /* MATCH pin: retail register colouring depends on it */
...

    {
        ...
        s32 first_angle = FIELD(arg0, s16, 0x18);
        register s32 scale ASM_REG("$4") = FIELD(arg0, s16, 0x62);   /* MATCH pin: retail register colouring depends on it */
...

        {
            ...
            s32 second_angle = FIELD(arg0, s16, 0x18);
