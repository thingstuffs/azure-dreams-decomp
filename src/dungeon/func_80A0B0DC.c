...
void *func_801588DC(s32 arg0, s32 arg1, s32 arg2, s32 arg3)
{
...

    {
        ...
        temp_t0 = (uptr)((S_801588DC_2 *)((void *)temp_t0))->unk_08.at00.v;
        stack.copy = (void *)temp_t0;
        ((S_801588DC_2 *)((void *)temp_t0))->unk_08.at02.v = saved_arg3;
        temp_t0 = (uptr)stack.root;
        stable_object = object;
        part = ((S_801588DC_2 *)((void *)temp_t0))->unk_0C;
        ((S_801588DC_3 *)part)->unk_2C = part_callback;
    }
    ((S_801588DC_3 *)part)->unk_24 = (s8)(s32)outer;
    ((S_801588DC_3 *)part)->unk_25 = saved_arg2;

    {
        ...
        if ((saved_kind & 3) == 1) {
            flags0 = ((S_801588DC_1 *)object)->unk_14 | 0x6000;
            flags1 = ((S_801588DC_1 *)object)->unk_1C | 0x6000;
            goto store_flags;
        }
        if ((saved_kind & 3) >= 2) {
            flags0 = ((S_801588DC_1 *)object)->unk_14 | 0x2000;
            flags1 = ((S_801588DC_1 *)object)->unk_1C | 0x2000;
            goto store_flags;
        }
        goto update_kind;

store_flags:
        ((S_801588DC_1 *)object)->unk_14 = flags0;
        ((S_801588DC_1 *)object)->unk_1C = flags1;
        goto flags_done;
...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            temp_t0 = 1;
            ((S_801588DC_6 *)entry)->unk_02 = (s16)temp_t0;
            inner_index = 0;
            outer_base = outer;
            ...
            do {
                ...
                ((S_801588DC_9 *)outer_child)->unk_10 = (void *)temp_t0;
                ...
                inner_index++;
                {
                    ...
                    ((S_801588DC_6 *)entry)->unk_06 = (s16)temp_t0;
                    func_800478E8(call_part, call_data, call_one);
                }
                temp_t0 = (uptr)stack.root;
                new_link = (u8 *)temp_t0 + 0x1E;
                inner_more = inner_index < ((S_801588DC_6 *)entry)->unk_02;
        ...
        outer = (u8 *)outer + 4;
        {
            ...
            outer_limit = ((S_801588DC_4 *)stable_object)->unk_9E;
            temp_t0++;
