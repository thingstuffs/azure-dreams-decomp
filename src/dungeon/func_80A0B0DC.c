...
void *func_801588DC(s32 kind, s32 part_x, s32 part_y, s32 copy_value)
{
...

    {
        ...
        copy = ((S_801588DC_2 *)root)->unk_08.at00.v;
        ((S_801588DC_2 *)copy)->unk_08.at02.v = saved_copy_value;
        stable_object = object;
        part = ((S_801588DC_2 *)root)->unk_0C;
        ((S_801588DC_3 *)part)->unk_2C = part_callback;
    }
    ((S_801588DC_3 *)part)->unk_24 = saved_part_byte_24;
...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            ((S_801588DC_6 *)(void *)saved_kind)->unk_02 = 1;
            item_index = 0;
            outer_base = outer;
            table = D_8015D168;
            item_offset = 8;
            do {
                ...
                item_offset += 0x30;
                item_index++;
                ((S_801588DC_6 *)(void *)saved_kind)->unk_06 = 1;
                func_800478E8(part, D_800D71A8, 1);
                more_items = item_index < ((S_801588DC_6 *)(void *)saved_kind)->unk_02;
                ((S_801588DC_6 *)(void *)saved_kind)->unk_98 = (u8 *)root + 0x1E;
            } while (more_items);
        }
        outer = (u8 *)outer + 4;
        {
