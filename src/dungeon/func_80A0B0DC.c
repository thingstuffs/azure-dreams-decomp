...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            address_or_count = 1;
            ((S_801588DC_6 *)(void *)saved_kind)->unk_02 = (s16)address_or_count;
            item_index = 0;
            do {
                outer_base = outer;
            } while (0);
            ...
            do {
                ...
                item_index++;
                {
                    ...
                    ((S_801588DC_6 *)(void *)saved_kind)->unk_06 = (s16)address_or_count;
                ...
                ((S_801588DC_6 *)(void *)saved_kind)->unk_98 = (void *)table_page;
            } while (more_items);
        }
        outer = (u8 *)outer + 4;
        {
