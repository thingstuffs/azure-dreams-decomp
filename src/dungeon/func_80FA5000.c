...
extern u8 D_80152A70[];
extern u8 D_80156AD4[];
...
void *BODY_NAME(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        ((S_80FA5000_0 *)obj)->unk_10 = D_80152A70;
        ((S_80FA5000_1 *)work)->unk_13 = 0x26;
        func_8004491C(obj, &D_80045340);

        part_a = ((S_80FA5000_0 *)obj)->unk_08;
        ((S_80FA5000_2 *)part_a)->unk_0A = saved_arg3;
        part_b = ((S_80FA5000_0 *)obj)->unk_0C;
        kind = arg0 & 3;
        part_b->unk_25 = saved_arg2;
        actor = work;
        part_b->unk_2C = D_80156AD4;
        part_b->unk_24 = saved_arg1;

        if (kind == 1) {
            left = ((S_80FA5000_1 *)work)->unk_14 | 0x6000;
            right = ((S_80FA5000_1 *)work)->unk_1C | 0x6000;
            goto write_kind;
        }
        if (kind < 2) {
            goto normal_kind;
        ...
        left = ((S_80FA5000_1 *)work)->unk_14 | 0x2000;
        right = ((S_80FA5000_1 *)work)->unk_1C | 0x2000;
write_kind:
        ((S_80FA5000_1 *)work)->unk_14 = left;
        ((S_80FA5000_1 *)work)->unk_1C = right;
        goto post_kind;
...
normal_kind:
        ...
        if (((arg0 & ~3) << 16) == 0) {
            if (!(((S_80FA5000_1 *)work)->unk_14 & 0x200)) {
                ...
                ((S_80FA5000_1 *)work)->unk_1C |= 0x200;
...
call_a1_setup:
        ...
        ((S_80FA5000_1 *)work)->unk_1C |= 0x40000;
        actor->unk_A0 = 0;
        actor->unk_92 = -0x30;
