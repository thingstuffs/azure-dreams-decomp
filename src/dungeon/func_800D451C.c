...
typedef struct S_800D9C7C_0 {
    ...
    u8 pad_29[0x41];
    u16 unk_6A;
} S_800D9C7C_0;   /* arg3 in func_800D9C7C */
...
typedef struct S_800D9C7C_2 {
    ...
    s32 unk_10;
    s32 unk_14;
} S_800D9C7C_2;   /* arg1 in func_800D9C7C */
...
void func_800D9C7C(S_800D9C7C_1 *arg0, S_800D9C7C_2 *arg1, S_800D9C7C_3 *arg2, void *arg3)
{
    s16 timer;
    s32 index;
    s32 value;
    ...
    index = (((S_800D9C7C_0 *)arg3)->unk_6A >> 9) & 7;
    switch (arg0->unk_9B) {
    case 0:
        func_800AD4D0(arg3);
        arg1->unk_0C =
        ...
        if (((S_800D9C7C_0 *)arg3)->unk_1C & 0x228) {
            timer = 8;
        } else {
            timer = -1;
        }
