...
typedef struct S_80024660_0 {
    ...
    s16 unk_12;
    s16 unk_14;
} S_80024660_0;   /* arg0 in func_80024660 */
...
void func_80024660(void *arg0, void *arg1, void *arg2) {
    ...
    cnt = ((S_80024660_0 *)arg0)->unk_10;
    temp_v1 = ((S_80024660_0 *)arg0)->unk_0A;
    temp_s7 = ((S_80024660_0 *)arg0)->unk_00;
    ((S_80024660_0 *)arg0)->unk_10 = cnt + 1;
    if ((u32) temp_v1 >= 7U) {
        goto block_52;
    }
    (void)jt_keep; goto *D_80024020[(u32)(temp_v1)];
jt_c0:
    ((S_80024660_0 *)arg0)->unk_10 = 0U;
    ((S_80024660_0 *)arg0)->unk_0A = (s16) ((u16) ((S_80024660_0 *)arg0)->unk_0A + 1);
    ((S_80024660_0 *)arg0)->unk_0E = (u16) (((u16) ((S_80024660_1 *)temp_s7)->unk_2A >> 9) & 7);
...
block_5:
    ...
    {
        register u16 temp_d2 ASM_REG("$3");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
...
block_8:
    ...
    if (!(*((S_80024660_0 *)arg0)->unk_04 & 0x80)) {
        goto block_52;
    }
...
block_16:
    ...
    ((S_80024660_0 *)arg0)->unk_12 = var_a0;
loop_17:
    if (var_a1[12] <= ((S_80024660_0 *)arg0)->unk_12) {
        goto block_19;
    }
    ((S_80024660_0 *)arg0)->unk_12 = (s16) (u16) var_a1[12];
block_19:
    var_s1 += 1;
    var_a1 += 1;
    if (var_s1 < 3) {
    ...
    temp_v0_2 = (u16) ((S_80024660_0 *)arg0)->unk_12 << 0x10;
    temp_v1_4 = (temp_v0_2 >> 0x14) + (temp_v0_2 >> 0x15);
    ((S_80024660_0 *)arg0)->unk_12 = temp_v1_4;
    if (temp_v1_4 != 0) {
        goto block_22;
    }
    ((S_80024660_0 *)arg0)->unk_12 = 1;
block_22:
    ((S_80024660_5 *)arg1)->unk_0C = (s32) ((s32) (((S_80024660_8 *)var_s3)->unk_00.at00.v - ((S_80024660_5 *)arg1)->unk_00.at00.v) / (s16) ((S_80024660_0 *)arg0)->unk_12);
    ((S_80024660_5 *)arg1)->unk_10 = (s32) ((s32) (((S_80024660_8 *)var_s3)->unk_04.at00.v - ((S_80024660_5 *)arg1)->unk_04.at00.v) / (s16) ((S_80024660_0 *)arg0)->unk_12);
    ((S_80024660_5 *)arg1)->unk_14 = (s32) ((s32) (((S_80024660_8 *)var_s3)->unk_08.at00.v - ((S_80024660_5 *)arg1)->unk_08.at00.v) / (s16) ((S_80024660_0 *)arg0)->unk_12);
    func_800A56E0(0x300, var_a1);
    var_v0 = (u16) ((S_80024660_0 *)arg0)->unk_0A + 1;
    goto block_41;
    } else {
    register s32 temp_a1_3 ASM_REG("$5");   /* MATCH pin: load-bearing for the whole function shape */
    register s32 temp_a0 ASM_REG("$4");   /* MATCH pin: load-bearing for the whole function shape */
    register u16 saved_y_t0 ASM_REG("$8");   /* MATCH pin: load-bearing for the whole function shape */
    register u16 *tptr ASM_REG("$8");   /* MATCH pin: load-bearing for the whole function shape */
    u16 *first_ptr;
    register s32 search_z ASM_REG("$6");   /* MATCH pin: load-bearing for the whole function shape */
    register u32 dead_page ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    s32 var_fp;
    register s32 var_s4 ASM_REG("$20");   /* MATCH pin: load-bearing for the whole function shape */
    register s32 var_s6 ASM_REG("$22");   /* MATCH pin: load-bearing for the whole function shape */
    var_s1 = 0;
    temp_v1_5 = ((S_80024660_3 *)temp_s0)->unk_0C;
    ASM_KEEP(temp_v1_5);   /* MATCH pin: load-bearing for the whole function shape */
    dead_page = 0x80070000;
    ASM_USE(dead_page);   /* MATCH pin: load-bearing for the whole function shape */
    ...
    signed_x = (s16)var_s4;
    signed_y = (s16)var_s6;
    if ((func_800A44E0((signed_x << 6) & 0xFFC0, (signed_y << 6) & 0xFFC0, ((S_80024660_1 *)temp_s7)->unk_88, (s16) (((S_80024660_0 *)arg0)->unk_0E << 9)) << 0x10) != 0) {
        break;
    }
    temp_v0_3 = (s16) ((S_80024660_0 *)arg0)->unk_0E;
    tptr = D_8006CCD8;
    first_ptr = &tptr[temp_v0_3];
    search_z = (u16) ((S_80024660_1 *)temp_s7)->unk_88;
    ASM_KEEP_DEP_NV(search_z, first_ptr);   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    search_z = (s16) (search_z - 32);
    ASM_KEEP(search_z);   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    tptr = D_8006CCE8;
    temp_a0 = *first_ptr;
    ...
    }
    {
        ...
        register s32 update_idx ASM_REG("$3");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
        u16 *update_xp;
        u16 *update_yp;
        tptr = D_8006CCD8_2;
        update_idx = (s16) ((S_80024660_0 *)arg0)->unk_0E;
        var_s1 += 1;
...
block_28:
    ...
    ASM_KEEP(var_s1);   /* MATCH pin: load-bearing for the whole function shape */
    {
        ...
        temp_a1_3 = var_fp << 16;
        tptr3 = D_8006CCD8_3;
        ASM_KEEP(tptr3);   /* MATCH pin: retail register colouring depends on it */
        temp_a1_3 >>= 10;
        var_a2 = (s16 *)((u8 *)&scratch + 2);
        temp_a1_3 += ((tptr3[(s16) ((S_80024660_0 *)arg0)->unk_0E] + 1) << 5);
        tptr3 = D_8006CCE8_3;
        ((S_80024660_8 *)var_s3)->unk_00.at02.v = temp_a1_3;
        temp_a1_3 = (s16) temp_a1_3;
        saved_y_t0 = scratch.saved_y;
        ASM_KEEP(saved_y_t0);   /* MATCH pin: load-bearing for the whole function shape */
        temp_a0 = ((s32) (saved_y_t0 << 0x10));
        temp_a0 = (temp_a0 >> 0xA) + ((tptr3[(s16) ((S_80024660_0 *)arg0)->unk_0E] + 1) << 5);
    ...
    block_34:
        ...
        ((S_80024660_0 *)arg0)->unk_12 = var_a1_2;
    }
loop_35:
    if (var_a2[12] <= ((S_80024660_0 *)arg0)->unk_12) {
        goto block_37;
    }
    ((S_80024660_0 *)arg0)->unk_12 = (s16) (u16) var_a2[12];
block_37:
    var_s1 += 1;
    var_a2 += 1;
    if (var_s1 < 3) {
    ...
    temp_v0_7 = (u16) ((S_80024660_0 *)arg0)->unk_12 << 0x10;
    temp_v1_7 = (temp_v0_7 >> 0x14) + (temp_v0_7 >> 0x15);
    ((S_80024660_0 *)arg0)->unk_12 = temp_v1_7;
    if (temp_v1_7 != 0) {
        goto block_40;
    }
    ((S_80024660_0 *)arg0)->unk_12 = 1;
...
block_41:
    ((S_80024660_0 *)arg0)->unk_0A = var_v0;
    var_s1 = 0x1F;
    var_s0 = arg0 + 0x7C;
loop_42:
    ...
    goto block_52;
jt_c3:
    if ((s16) ((S_80024660_0 *)arg0)->unk_10 < 0x28) {
        goto block_52;
    }
    func_8002403C(((S_80024660_1 *)temp_s7)->unk_60, ((S_80024660_0 *)arg0)->unk_09, temp_s7);
    goto block_49;
jt_c4:
    if (((S_80024660_0 *)arg0)->unk_14 != 0) {
        goto block_52;
    }
    D_8008346C = 0;
...
jt_c5:
    ...
    if ((s16) ((S_80024660_0 *)arg0)->unk_10 < ((S_80024660_0 *)arg0)->unk_12) {
        goto block_52;
    }
block_49:
    ((S_80024660_0 *)arg0)->unk_10 = 0U;
...
jt_c6:
    ...
    ((S_80024660_0 *)arg0)->unk_0A = 4;
    ((S_80024660_0 *)arg0)->unk_10 = 0U;
block_52:
    ((S_80024660_0 *)arg0)->unk_14 = 0;
    return;
}
