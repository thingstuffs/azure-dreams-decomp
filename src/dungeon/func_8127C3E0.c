...
init_loop:
    ...
    while (++turn_index < 8) {
        ...
        if (func_800996B0(trial_angle, position_arg, actor_arg, 0x20) > 0) {
            ...
            ((S_8127C3E0_1 *)actor_arg)->unk_2A.s = trial_angle;
            ((S_8127C3E0_8 *)((u8 *)actor_arg + (((S_8127C3E0_1 *)actor_arg)->unk_71.u & 0x7F)))->unk_74 =
                ((S_8127C3E0_2 *)position_arg)->unk_24.at00.v;
            ((S_8127C3E0_8 *)((u8 *)actor_arg + (((S_8127C3E0_1 *)actor_arg)->unk_71.u & 0x7F)))->unk_7C =
                ((S_8127C3E0_2 *)position_arg)->unk_24.at01.v;
            ((S_8127C3E0_1 *)actor_arg)->unk_71.u++;
...
loop_test:
...

    {
        ...
        ((S_8127C3E0_1 *)actor_arg)->unk_46 &= 0x7FFF;
        ((S_8127C3E0_5 *)move_state_arg)->unk_9C.u = ((S_8127C3E0_2 *)position_arg)->unk_26.u;
        ((S_8127C3E0_1 *)actor_arg)->unk_6D.u--;
...
success:
    ...
    turn_index = func_800BB784(
        (((S_8127C3E0_2 *)position_arg)->unk_24.at00.v << 6) | 0x20,
        (((S_8127C3E0_2 *)position_arg)->unk_24.at01.v << 6) | 0x20,
        (s16)(((S_8127C3E0_1 *)actor_arg)->unk_88.u - 0x20));
    if (turn_index < 0x200) {
        ((S_8127C3E0_1 *)actor_arg)->unk_88.s = turn_index;
    }
}
