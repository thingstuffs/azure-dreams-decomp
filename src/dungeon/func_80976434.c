...
void func_80171C34(void *move_data, void *context, void *position_data, void *actor_data)
{
    ...
    if (((S_80171C34_1 *)actor)->unk_71.s < 0) {
        goto check_active;
    }
...
accept_state:
    if (((S_80171C34_0 *)dungeon_state)->unk_0C == actor) {
        ((S_80171C34_1 *)actor)->unk_46 = 0xC008;
    }
    return;
...
active:
    ...
    if (actor_flags & 0x410) {
        if (actor_flags & 0x400) {
            target = func_800A02AC(actor, ((S_80171C34_2 *)position)->unk_24.at00.v,
            ...
            if (((S_80171C34_1 *)actor)->unk_14 & 0x80000000) {
                goto init_loop;
            }
            ((S_80171C34_1 *)actor)->unk_14 |= 0x80000000;
            ((S_80171C34_1 *)actor)->unk_2A.u +=
                (func_800A6D30() & 7) << 9;
            goto init_loop;
        }

        if (func_800A04F0(actor, ((S_80171C34_2 *)position)->unk_24.at00.v,
                          ((S_80171C34_2 *)position)->unk_24.at01.v,
                          ((S_80171C34_1 *)actor)->unk_2A.s) == 0) {
            goto init_loop;
        }
        goto success;
    }
    ...
    if (actor_flags & 0x2000) {
        if (((S_80171C34_1 *)actor)->unk_46 & 0x8000) {
            goto init_loop;
        }
        if (actor_flags & 0x20000) {
            ...
            u8 *turn_data;
            {
                ...
                s32 offset_index =
                    ((((S_80171C34_1 *)actor)->unk_45 + ((s16)target_facing >> 9)) & 7) << 1;
                target_x = target_position[0x24] +
                    *(u16 *)((u8 *)&D_8006CCD8 + offset_index);
                target_y = target_position[0x25] +
                    *(u16 *)((u8 *)&D_8006CCE8 + offset_index);
            }

            if (((S_80171C34_2 *)position)->unk_24.at00.v == (u16)target_x &&
                ((S_80171C34_2 *)position)->unk_24.at01.v == (u16)target_y) {
                goto success;
            }
            ...
            ((S_80171C34_1 *)actor)->unk_2A.s = target_angle;
            if (func_8009A8C0(target_angle, position, actor, 0x20) <= 0) {
    ...
    if (((S_80171C34_2 *)position)->unk_26.s >= 0) {
        DungeonRecord *room_records = (DungeonRecord *)D_800E2970;
        if (room_records[((S_80171C34_2 *)position)->unk_26.s].flags & 2) {
            goto direct_move;
        }
    }
    if (((S_80171C34_1 *)actor)->unk_46 & 0x8000) {
    ...
    target = func_800A04F0(actor, ((S_80171C34_2 *)position)->unk_24.at00.v,
                          ((S_80171C34_2 *)position)->unk_24.at01.v,
                          ((S_80171C34_1 *)actor)->unk_2A.s);
    if (target != 0 &&
        (((S_80171C34_3 *)target)->unk_1C & 0x2000) &&
        (s16)func_800A0134(target, actor) < 0x81) {
        if (func_8009A540(
                ((s16)((S_80171C34_1 *)actor)->unk_2A.u >> 9) & 0xFFFF,
                ((S_80171C34_2 *)position)->unk_24.at00.v, ((S_80171C34_2 *)position)->unk_24.at01.v,
                (s16)(((S_80171C34_1 *)actor)->unk_88.u - 0x20)) != 0) {
            goto success;
        }
    }

    if (((S_80171C34_1 *)actor)->unk_1C & 0x20000) {
...
loop_test:
    ...
    if (((S_80171C34_1 *)actor)->unk_6D.s == 0) {
success:
        ((S_80171C34_1 *)actor)->unk_71.u &= 0x7F;
        return;
    }
    ...
    turn_index = func_800BCB04(
        (((S_80171C34_2 *)position)->unk_24.at00.v << 6) | 0x20,
        (((S_80171C34_2 *)position)->unk_24.at01.v << 6) | 0x20,
        (s16)(((S_80171C34_1 *)actor)->unk_88.u - 0x20));
    if (turn_index < 0x200) {
        ((S_80171C34_1 *)actor)->unk_88.s = turn_index;
    }
}
