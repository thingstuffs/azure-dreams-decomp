...
#define arg3 p3
    ...
    if (initial_flags & 0x1000) {
        ...
        func_80171510(arg0, arg1, arg2, arg3);
        return;
    }
    ...
    result = func_8009FB34(((S_80170F68_2 *)arg2)->unk_24.at00.v, ((S_80170F68_2 *)arg2)->unk_24.at01.v);
    ((S_80170F68_2 *)arg2)->unk_26 = result;

    if (((S_80170F68_1 *)arg3)->unk_6D > 0) {
        if (((S_80170F68_1 *)arg3)->unk_1C & 0x20) {
            goto special_cleanup;
        }
        if (((S_80170F68_2 *)arg2)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
        ...
        if (!(((S_80170F68_1 *)arg3)->unk_46 & 0x8000)) {
            ...
            ((S_80170F68_1 *)arg3)->unk_46 |= 0x4000;
            if (!(((S_80170F68_1 *)arg3)->unk_46 & 0x8000)) {
                goto ordinary_cleanup;
            }
        }
...
#ifdef __mips__
        {
            ...
            dispatch_index = (((S_80170F68_1 *)arg3)->unk_46 & 0x3FFF) - 1;
...
handler_case:
#else
        switch (((S_80170F68_1 *)arg3)->unk_46 & 0x3FFF) {
        case 8:
        case 9:
#endif
...
coords_case:
...
#endif
        {
            ...
            direction = func_800A0818(
                ((S_80170F68_2 *)arg2)->unk_24.at00.v, ((S_80170F68_2 *)arg2)->unk_24.at01.v,
                ((S_80170F68_4 *)origin)->unk_24, ((S_80170F68_4 *)origin)->unk_25,
                &scratch);
            global = D_800814A8;
            ((S_80170F68_1 *)arg3)->unk_2A = direction;
            if (((S_80170F68_5 *)global)->unk_9A == 0x11) {
                goto aaf_cleanup;
            }
            goto special_cleanup;
        }
...
ordinary_cleanup:
        ...
        if ((index < 0) || !(((DungeonRecord *)D_800E2970)[index].flags & 2)) {
            if (!(((S_80170F68_1 *)arg3)->unk_1C & 0x430)) {
                u8 *origin = D_80082E80;

                if ((s16)func_8009FD7C(((S_80170F68_2 *)arg2)->unk_24.at00.v,
                        ((S_80170F68_2 *)arg2)->unk_24.at01.v, ((S_80170F68_4 *)origin)->unk_24,
                        ((S_80170F68_4 *)origin)->unk_25) != 0) {
                    ((S_80170F68_1 *)arg3)->unk_2A = func_800A0818(
                        ((S_80170F68_2 *)arg2)->unk_24.at00.v, ((S_80170F68_2 *)arg2)->unk_24.at01.v,
                        ((S_80170F68_4 *)origin)->unk_24, ((S_80170F68_4 *)origin)->unk_25,
                        &scratch);
                }
    ...
    if (((S_80170F68_2 *)arg2)->unk_14 & 0x40) {
        return;
    }
    table = D_80173FB8;
    if (((S_80170F68_2 *)arg2)->unk_2C == table) {
