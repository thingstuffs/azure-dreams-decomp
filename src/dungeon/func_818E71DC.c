...
void func_800249DC(void *arg0, S_800249DC_2 *arg1, S_800249DC_3 *arg2) {
    ...
    temp_ptr = ((Rec_func_800249DC_arg0 *)arg0)->unk_00.at00_pv.v;
    temp_ptr->unk_10 =
        (s32)(temp_ptr->unk_10 | 0x8000);

    temp_v0 = ((Rec_func_800249DC_arg0 *)arg0)->unk_48 - 1;
    ((Rec_func_800249DC_arg0 *)arg0)->unk_48 = temp_v0;
    if ((temp_v0 << 16) > 0) {
        ((Rec_func_800249DC_arg0 *)arg0)->unk_1C =
            (s32)(((Rec_func_800249DC_arg0 *)arg0)->unk_1C + ((Rec_func_800249DC_arg0 *)arg0)->unk_34);
        ((Rec_func_800249DC_arg0 *)arg0)->unk_20 =
            (s32)(((Rec_func_800249DC_arg0 *)arg0)->unk_20 + ((Rec_func_800249DC_arg0 *)arg0)->unk_38);
        ((Rec_func_800249DC_arg0 *)arg0)->unk_24 =
            (s32)(((Rec_func_800249DC_arg0 *)arg0)->unk_24 + ((Rec_func_800249DC_arg0 *)arg0)->unk_3C);
    }

    diff = ((Rec_func_800249DC_arg0 *)arg0)->unk_1C;
    temp_a0 = arg1->unk_00;
    diff -= temp_a0;
    arg1->unk_00 =
        (s32)(temp_a0 + (diff / 5));
    diff = ((Rec_func_800249DC_arg0 *)arg0)->unk_20;
    temp_a0_2 = arg1->unk_04;
    diff -= temp_a0_2;
    arg1->unk_04 =
        (s32)(temp_a0_2 + (diff / 5));
    diff = ((Rec_func_800249DC_arg0 *)arg0)->unk_24;
