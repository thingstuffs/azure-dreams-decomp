...
u32 func_800A2CB8(void *arg0, S_800A2CB8_1 *arg1) {
    ...
    if (((S_800A2CB8_0 *)arg0)->unk_1C & 0x410) {
        return 1;
    }
    if (((S_800A2CB8_0 *)arg0)->unk_13 == 0x2B &&
        (((S_800A2CB8_0 *)arg0)->unk_98 & 0x8000)) {
        return 1;
    }
    if ((arg1->unk_14 & 0x4000) &&
        (((S_800A2CB8_0 *)arg0)->unk_14 & 0x4000)) {
        return ((u16)func_80042900(arg0, 0xC) << 16) != 0;
    }
    return (((((S_800A2CB8_0 *)arg0)->unk_1C ^
