...
u32 func_800A2CB8(void *entity, S_800A2CB8_1 *other_entity) {
    ...
    if (((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 & 0x410) {
        return 1;
    }
    if (((Rec_D_800E3D7C *)entity)->unk_10.at03_u8.v == 0x2B &&
        (((Rec_D_800E3D7C *)entity)->unk_98 & 0x8000)) {
        return 1;
    }
    if ((other_entity->unk_14 & 0x4000) &&
        (((Rec_D_800E3D7C *)entity)->unk_14.as_u32 & 0x4000)) {
        return ((u16)func_80042900(entity, 0xC) << 16) != 0;
    }
    return (((((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 ^
