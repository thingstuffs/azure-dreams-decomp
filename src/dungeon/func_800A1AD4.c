...
found:
    ...
    *(s16 *)scratch = found_y;
    ...
    found_result = 1;
    ASM_LIVE_SIBCALL_PIN(found_result, 1);   /* UNRESOLVED C shape (pin): removing it drops a computation retail keeps; the source shape that makes it unnecessary has not been found */
