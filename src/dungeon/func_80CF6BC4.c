...
jt_c1:
    ...
    case 13:
        ...
        func_80047784(arg2,
            D_80169DDC[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 14:
        (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_80169DE4;
        func_80047784(arg2,
            D_80169DE4[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        goto jt_c4;
    case 15:
        (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_80169DEC;
        func_80047784(arg2,
            D_80169DEC[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
