...
extern void D_801714D4(void);
extern u8 D_801740E0[];
extern u8 D_801740E8[];
extern Callback D_80174168[];


typedef struct S_80170DA8_0 {
    ...
    s32 unk_10;
    s32 unk_14;
} S_80170DA8_0;   /* arg1 in func_80170DA8 */

typedef struct S_80170DA8_1 {
    u8 pad_00[0x4];
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_80170DA8_1;   /* arg2 in func_80170DA8 */

typedef struct S_80170DA8_2 {
    u8 pad_00[0x1C];
    ...
    u8 pad_2C[0x5C];
    u16 unk_88;
} S_80170DA8_2;   /* state in func_80170DA8 */

/* Update entity behavior, movement, directional animation, and ground height. */
void func_80170DA8(void *entity_in, void *motion_in, void *sprite_in)
{
    ...
    if (D_80083462 & 0x2000) {
        pause_callback = (*(Callback *)((u8 *)entity + (0x8C)));
        if (pause_callback == (Callback)D_801714D4) {
            ...
            pause_callback(entity_in, motion_in, sprite_in, entity_in);
            return;
        }
    ...
    D_80174168[(*(u8 *)((u8 *)entity + (0x9A)))](entity, motion, sprite, entity);
    if ((s16)previous_state != (*(s8 *)((u8 *)entity + (0x6D)))) {
        func_800AA36C(entity, motion, sprite, entity);
    }

    ((S_80170DA8_0 *)motion)->unk_00.at00.v += ((S_80170DA8_0 *)motion)->unk_0C;
    ((S_80170DA8_0 *)motion)->unk_04.at00.v += ((S_80170DA8_0 *)motion)->unk_10;

    if (!((*(u32 *)((u8 *)entity + (0x1C))) & 0x40000) &&
        !((*(u16 *)((u8 *)entity + (0x98))) & 8)) {
        ((S_80170DA8_0 *)motion)->unk_14 += (*(s8 *)((u8 *)entity + (0x9D))) * 0x14000;
        (*(u8 *)((u8 *)entity + (0x9D)))++;
    } else {
        (*(u8 *)((u8 *)entity + (0x9D))) = 0;
    }
    (*(s32 *)((u8 *)entity + (0x90))) += ((S_80170DA8_0 *)motion)->unk_14;
    sprite_flags = ((S_80170DA8_1 *)sprite)->unk_14;

    if (!(sprite_flags & 0x8000)) {
        sprite_direction = ((D_80083228 + ((S_80170DA8_2 *)entity_state)->unk_2A + 0x100) >> 9) & 7;
        anim_direction = sprite_direction;
        if ((*(s16 *)((u8 *)entity + (0x94))) != anim_direction) {
            func_80047738(sprite,
                (*(u8 *)((u8 *)(((S_80170DA8_1 *)sprite)->unk_2C) + (anim_direction))),
                ((S_80170DA8_1 *)sprite)->unk_04.s8);
            (*(s16 *)((u8 *)entity + (0x94))) = sprite_direction;
        }
        {
            u32 flip_flags;
            if (D_8006CCF8[anim_direction] != 0) {
                flip_flags = ((S_80170DA8_1 *)sprite)->unk_14 | 1;
            } else {
                flip_flags = ((S_80170DA8_1 *)sprite)->unk_14 & 0xFFFE;
            }
            ((S_80170DA8_1 *)sprite)->unk_14 = flip_flags;
        }
        func_800A020C(((S_80170DA8_2 *)entity_state)->unk_1C.s, (u8 *)sprite + 0xC);
        if (!(((S_80170DA8_2 *)entity_state)->unk_1C.u & 0x20)) {
            if (!(((S_80170DA8_1 *)sprite)->unk_14 & 0x40)) {
                func_800478B8(sprite);
            }
        } else {
            ((S_80170DA8_1 *)sprite)->unk_14 |= 0x7000;
            ((S_80170DA8_2 *)entity_state)->unk_1C.u &= 0xFFFBFFFF;
        }

        {
            u32 airborne_flags;
            airborne_flags = ((S_80170DA8_2 *)entity_state)->unk_1C.u & 0xF7FFFFFF;
            ((S_80170DA8_2 *)entity_state)->unk_1C.u = airborne_flags;
            airborne_flags &= 0x40000;
            if (!airborne_flags) {
                goto reset_offset;
            }
        }
        ...
        if (!(((S_80170DA8_1 *)sprite)->unk_14 & 0x40)) {
            if (((S_80170DA8_1 *)sprite)->unk_2C == D_801740E0) {
                if (((S_80170DA8_1 *)sprite)->unk_04.u16 == 0x100) {
                    (*(u16 *)((u8 *)entity + (0x9E))) = 0;
                }
                bob_tick = (*(u16 *)((u8 *)entity + (0x9E)));
                signed_tick = (s32)((u32)bob_tick << 16) >> 16;
                bob_angle = signed_tick * 0xE3;
                bob_tick++;
                (*(u16 *)((u8 *)entity + (0x9E))) = bob_tick;
                (*(s32 *)((u8 *)entity + (0xA0))) = func_800644B8(bob_angle) << 7;
                if (((S_80170DA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    anim_table = D_801740E8;
                    (*(u8 * *)((u8 *)sprite + (0x2C))) = anim_table;
                    view_direction = D_80083228;
                    facing_angle = ((S_80170DA8_2 *)entity_state)->unk_2A;
                    anim_sprite = sprite;
                    view_direction = ((view_direction + facing_angle + 0x100) >> 9) & 7;
                    anim_entry = &anim_table[view_direction];
                    goto play_next_anim_1;
                }
                ...
                if (((S_80170DA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    ...
                    anim_sprite = sprite;
                    view_direction = ((view_direction + facing_angle + 0x100) >> 9) & 7;
                    anim_entry = &D_801740E0[view_direction];
play_next_anim_1:
    ...
    ((S_80170DA8_1 *)sprite)->unk_14 = (sprite_flags & 0x800)
        ? (sprite_flags & 0x8FFF)
        : (sprite_flags | 0x7000);
    ((S_80170DA8_2 *)entity_state)->unk_1C.u &= 0xF7FFFFFF;
    if (!(((S_80170DA8_2 *)entity_state)->unk_1C.u & 0x40000)) {
reset_offset:
        ...
        if (!((*(u16 *)((u8 *)entity + (0x98))) & 8)) {
            ground_height = func_800BCB04(((S_80170DA8_0 *)motion)->unk_00.at02.v,
                ((S_80170DA8_0 *)motion)->unk_04.at02.v,
                (s16)(((S_80170DA8_2 *)entity_state)->unk_88 - 0x20));
            ground_delta = ground_height - ((S_80170DA8_2 *)entity_state)->unk_88;
            if (ground_delta < (*(s16 *)((u8 *)entity + (0x92)))) {
                (*(s16 *)((u8 *)entity + (0x92))) = ground_delta;
                (*(u8 *)((u8 *)entity + (0x9D))) = 0;
                ((S_80170DA8_0 *)motion)->unk_14 = 0;
                ((S_80170DA8_2 *)entity_state)->unk_1C.u |= 0x08000000;
                goto final_adjustment;
            }
        }
        goto final_adjustment;
...
final_adjustment:
    entity_flags = ((S_80170DA8_2 *)entity_state)->unk_1C.u;
    if (entity_flags & 0x40000000) {
        ((S_80170DA8_2 *)entity_state)->unk_1C.u = entity_flags & 0xBFFFFFFF;
        ground_height = func_800BCB04(
            (((S_80170DA8_1 *)sprite)->unk_24 << 6) | 0x20,
            (((S_80170DA8_1 *)sprite)->unk_25 << 6) | 0x20,
            (s16)(((S_80170DA8_2 *)entity_state)->unk_88 - 0x20));
        if (ground_height < 0x200) {
            (*(s16 *)((u8 *)entity + (0x92))) =
                (((S_80170DA8_2 *)entity_state)->unk_88 - ground_height) +
                (*(u16 *)((u8 *)entity + (0x92)));
            ((S_80170DA8_2 *)entity_state)->unk_88 = ground_height;
        }
    }

    ((S_80170DA8_0 *)motion)->unk_0A = ((S_80170DA8_2 *)entity_state)->unk_88 +
        (*(u16 *)((u8 *)entity + (0x92))) - (*(u16 *)((u8 *)entity + (0xA2)));
    ((S_80170DA8_1 *)sprite)->unk_14 |= 0x40;
}
