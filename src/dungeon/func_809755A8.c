...
extern void func_80170F3C(void) __attribute__((noreturn));
...
void func_80170DA8(void *arg0_, void *arg1_, void *arg2_)
{
    ...
    if (!(part_flags & 0x8000)) {
        ...
        if (D_8006CCF8[direction_copy] != 0) {
            u32 scratch;
            scratch = ((S_80170DA8_1 *)arg2)->unk_14 | 1;
        ...
        ((S_80170DA8_1 *)arg2)->unk_14 &= 0xFFFE;
        func_800A020C(((S_80170DA8_2 *)state)->unk_1C.s, (u8 *)arg2 + 0xC);
        if (!(((S_80170DA8_2 *)state)->unk_1C.u & 0x20)) {
            ...
            ((S_80170DA8_1 *)arg2)->unk_14 |= 0x7000;
            ((S_80170DA8_2 *)state)->unk_1C.u &= 0xFFFBFFFF;
        }

        {
            u32 masked_flags;
            masked_flags = ((S_80170DA8_2 *)state)->unk_1C.u & 0xF7FFFFFF;
            ((S_80170DA8_2 *)state)->unk_1C.u = masked_flags;
        ...
        if (!(((S_80170DA8_1 *)arg2)->unk_14 & 0x40)) {
            if (((S_80170DA8_1 *)arg2)->unk_2C == D_801740E0) {
                ...
                if (((S_80170DA8_1 *)arg2)->unk_04.u16 == 0x103) {
                    ...
                    tail_arg = arg2;
                    tail_index = ((tail_index + tail_state + 0x100) >> 9) & 7;
                    tail_value = &D_801740E0[tail_index];
play_tail_value_1:
    ...
    ((S_80170DA8_1 *)arg2)->unk_14 = (part_flags & 0x800)
        ? (part_flags & 0x8FFF)
        : (part_flags | 0x7000);
...
final_adjustment:
    flags = ((S_80170DA8_2 *)state)->unk_1C.u;
    if (flags & 0x40000000) {
        ((S_80170DA8_2 *)state)->unk_1C.u = flags & 0xBFFFFFFF;
        ground = func_800BCB04(
            (((S_80170DA8_1 *)arg2)->unk_24 << 6) | 0x20,
