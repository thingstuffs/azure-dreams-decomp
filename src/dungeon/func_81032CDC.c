...
typedef struct S_801744DC_0 {
    ...
    u8 pad_5C[0x8];
    s32 unk_64;
} S_801744DC_0;   /* work in func_801744DC */

typedef struct S_801744DC_1 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    void * unk_10;
} S_801744DC_1;   /* node in func_801744DC */

typedef struct S_801744DC_2 {
    u8 pad_00[0x6];
    s16 unk_06;
    u8 pad_08[0x4];
    u8 unk_0C;
    ...
    s16 unk_1C;
    s16 unk_1E;
} S_801744DC_2;   /* part in func_801744DC */

typedef struct S_801744DC_3 {
    u8 pad_00[0x2];
    u16 unk_02;
    u8 pad_04[0x2];
    u16 unk_06;
...
/* Spawn a particle with randomized position, rotation, and direction-based velocity. */
void func_801744DC(Rec_func_801744DC_arg0 *source, Rec_func_801744DC_arg1 *origin)
{
    void *effect;
    S_801744DC_0 *motion;
    S_801744DC_2 *sprite;
    S_801744DC_3 *position;
    s32 velocity_bias;
    ...
    if (effect != 0) {
        ...
        motion->unk_1E = 0xF;
        ((S_801744DC_1 *)effect)->unk_10 = &D_80174300;
        func_8004491C(effect, &D_80045340);

        sprite = ((S_801744DC_1 *)effect)->unk_0C;
        sprite->unk_10 = 0x20;
        sprite->unk_14 |= 0xC;
        sprite->unk_1A = (rand() & 7) << 9;
        sprite->unk_06 = 0;

        position = ((S_801744DC_1 *)effect)->unk_08;
