...
typedef struct S_80167238_0 {
    ...
    u8 pad_2C[0x3E];
    u16 unk_6A;
} S_80167238_0;   /* arg3 in func_80167238 */
...
typedef struct S_80167238_3 {
    u8 pad_00[0x14];
    u16 unk_14;
    u8 pad_16[0xE];
    u8 unk_24;
    u8 unk_25;
} S_80167238_3;   /* arg2 in func_80167238 */
...
void func_80167238(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    direction = (((S_80167238_0 *)arg3)->unk_6A >> 9) & 7;
...
state_zero:
    ...
    if (((S_80167238_0 *)arg3)->unk_28 == 0) {
        goto stop_motion;
    }
    if (((S_80167238_3 *)arg2)->unk_14 & 0x8000) {
        ((S_80167238_1 *)arg0)->unk_96.s = 0;
        ((S_80167238_1 *)arg0)->unk_9B = 3;
        goto done;
    }

    if (((S_80167238_0 *)arg3)->unk_1C & 0x228) {
        timer = 8;
    } else {
        timer = -1;
    }
...
state_one:
    ...
    } else if (((S_80167238_3 *)arg2)->unk_14 & 0x6000) {
        ((S_80167238_1 *)arg0)->unk_96.s = 0;
    }
...
continue_state_one:
    ...
    func_80047784(
        arg2,
        D_80168150[((D_80083228 + ((S_80167238_0 *)arg3)->unk_2A + 0x100) >> 9) & 7],
        0);
    ((S_80167238_1 *)arg0)->unk_9B++;
    goto done;
...
state_two:
    ((S_80167238_2 *)arg1)->unk_0C -= ((s16 *)&D_8006CCD8)[direction] << 14;
    ((S_80167238_2 *)arg1)->unk_10 -= ((s16 *)&D_8006CCE8)[direction] << 14;
    if (!(((S_80167238_3 *)arg2)->unk_14 & 0x6000)) {
        goto done;
    }
...
state_three:
    ...
    ((S_80167238_2 *)arg1)->unk_10 = 0;
    ((S_80167238_2 *)arg1)->unk_0C = 0;
    ((S_80167238_2 *)arg1)->unk_00.at00.v = ((((S_80167238_3 *)arg2)->unk_24 << 6) + 0x20) << 16;
    ((S_80167238_2 *)arg1)->unk_04.at00.v = ((((S_80167238_3 *)arg2)->unk_25 << 6) + 0x20) << 16;
    func_800A2B04(arg1, ((S_80167238_3 *)arg2)->unk_24, ((S_80167238_3 *)arg2)->unk_25);
