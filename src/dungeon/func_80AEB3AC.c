...
state_zero:
    ...
    func_80047784(
        arg2,
        D_80150E0C[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
...
state_two:
    if (((Rec_D_800E3D7C *)arg3)->unk_1C.as_s32 & 0x08000000) {
        ...
        func_80047784(
            arg2,
            D_80150E14[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        ((S_8014EBAC_0 *)arg0)->unk_9B++;
    }
    goto decrement_timer;
...
state_three:
    if (((Rec_D_80082E80 *)arg2)->unk_2C.as_pu8 == D_80150DEC) {
        goto decrement_timer;
    }
    (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_80150DEC;
    func_80047784(
        arg2,
        D_80150DEC[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
