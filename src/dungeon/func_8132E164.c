...
typedef struct S_80165164_0 {
    ...
    s32 unk_08;
} S_80165164_0;   /* arg1 in func_80165164 */

typedef struct S_80165164_1_pre {
    u16 unk_00;
} S_80165164_1_pre;   /* the 0x2 bytes before arg0 in func_80165164, addressed as arg0[-1] */

typedef struct S_80165164_1 {
    u8 unk_00;
    u8 unk_01;
    u8 unk_02;
    u8 pad_03[0x1];
