...
u8 *func_800A1618(s32 arg0, s32 arg1) {
    ...
    if ((s16)var_a1 == 3) {
        ...
        r_v1 = r_v0 + 0x3DD0;
        ASM_KEEP4(r_v0, r_v1, in_a0, arg1);   /* UNRESOLVED C shape (pin): removing it changes the basic-block layout; the source shape that makes it unnecessary has not been found */
        return func_800A1714(in_a0, arg1, 4);
    }
    if ((s16)var_a1 == 2) {
        u8 *r_v0;
        r_v0 = D_800E3DE0;
        ASM_TAILSLOT_PIN(r_v0);   /* UNRESOLVED C shape (pin): removing it changes a delay-slot's contents; the source shape that makes it unnecessary has not been found */
        return func_800A17D4();
    }
    ...
    if (var_v1[0x11] == 0x38) {
        ...
        var_v1 += 0x18;
        ASM_TAILSLOT_PIN(var_v1);   /* UNRESOLVED C shape (pin): removing it changes the whole function shape; the source shape that makes it unnecessary has not been found */
