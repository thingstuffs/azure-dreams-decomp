...
typedef struct S_8016A870_0 {
    u8 pad_00[0x8];
    void * unk_08;
    void * unk_0C;
    void * unk_10;
} S_8016A870_0;   /* obj in func_8016A870 */

typedef struct S_8016A870_1 {
    u8 pad_00[0x13];
    s8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    s32 unk_1C;
} S_8016A870_1;   /* work in func_8016A870 */

typedef struct S_8016A870_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_8016A870_2;   /* part_a in func_8016A870 */

typedef struct S_8016A870_3 {
    u8 pad_00[0x14];
    u16 unk_14;
    u8 pad_16[0xE];
    s8 unk_24;
    ...
    u8 pad_26[0x6];
    void * unk_2C;
} S_8016A870_3;   /* part_b in func_8016A870 */

typedef struct S_8016A870_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0xA];
    u8 unk_9A;
    u8 pad_9B[0x1];
    s8 unk_9C;
} S_8016A870_4;   /* actor in func_8016A870 */
...
void *func_8016A870(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    s32 kind;
    void *obj;
    S_8016A870_2 *part_a;
    ...
    if (obj != 0) {
        ...
        part_b = ((S_8016A870_0 *)obj)->unk_0C;
        kind = arg0 & 3;
        part_b->unk_25 = saved_arg2;
        actor = work;
        part_b->unk_2C = D_8016E194;
