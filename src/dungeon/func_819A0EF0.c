...
void func_800246F0(void *effect, S_800246F0_2 *motion, Rec_D_80082E80 *primitive)
{
    s32 brightness;
    s32 x;
    s32 y;
    ...
    primitive->unk_0C.at02_s8.v = brightness;
    primitive->unk_0C.at01_s8.v = brightness;
    primitive->unk_0C.at00_s8.v = brightness;
    x = motion->unk_00;
    dx = motion->unk_0C;
    y = motion->unk_04;
    dy = motion->unk_10;
