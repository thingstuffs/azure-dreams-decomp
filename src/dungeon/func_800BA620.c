...
s32 func_800BFD80(void *entity, s32 update_value, s16 update_mode)
{
    ...
    if (((Rec_D_800E3D7C *)entity)->unk_27 == ((Rec_D_800E3D7C *)entity)->unk_69) {
        completion_count = ((Rec_D_800E3D7C *)entity)->unk_00.at01_u8.v;
        if (completion_count < 0xFF) {
            ((Rec_D_800E3D7C *)entity)->unk_00.at01_u8.v = completion_count + 1;
            func_80041E70(entity);
        }
    }

    progress = ((Rec_D_800E3D7C *)entity)->unk_27;
    progress_value = progress & 0xFF;
    if (progress_value < 0xFF && progress_value < ((Rec_D_800E3D7C *)entity)->unk_69) {
        ((Rec_D_800E3D7C *)entity)->unk_27 = progress + 1;
    }
