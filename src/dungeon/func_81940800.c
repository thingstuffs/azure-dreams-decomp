...
void BODY_NAME(void *effect, void *unused, void *primitive) {
    ...
    frames_left = ((Rec_D_800E3D7C *)effect)->unk_2A.as_u16 - 1;
    shade = (s32)((s32)(frames_left << 0x10) >> 9) / (s16)((Rec_D_800E3D7C *)effect)->unk_2C;
    D_8002571C = 1;
    ((Rec_D_800E3D7C *)effect)->unk_2A.as_u16 = frames_left;
    ...
    if ((s16)((Rec_D_800E3D7C *)effect)->unk_2A.as_u16 <= 0) {
        ((S_81940800_2 *)(((((Rec_D_800E3D7C *)effect)->unk_32 * 2) + ((Rec_D_800E3D7C *)effect)->unk_60.as_s32)))->unk_46 = 0;
