...
{
    register void *arg0 ASM_REG("$17") = input0;   /* UNRESOLVED C shape (pin): removing it changes the register colouring; the source shape that makes it unnecessary has not been found */
    S_80170AA4_2 *arg1 = input1;
    void *arg2 = input2;
    register void *entity ASM_REG("$18") = arg0;   /* UNRESOLVED C shape (pin): removing it changes the whole function shape; the source shape that makes it unnecessary has not been found */
    s16 work;
    ...
    D_80174018[(*(u8 *)((u8 *)arg0 + 0x9A))](arg0, arg1, arg2, arg0);
    ...
    if ((*(u16 *)((u8 *)arg0 + 0x98)) & 0x8000) {
        wobble = (*(u16 *)((u8 *)arg0 + 0xAC)) + 1;
        (*(s16 *)((u8 *)arg0 + 0xAC)) = wobble;
        if (((s16)wobble >> 2) >= 2) {
            (*(s16 *)((u8 *)arg0 + 0xAC)) = -8;
            func_800A56E0(0x60B);
        }
        wobble = (*(u16 *)((u8 *)arg0 + 0xAC));
        wobble_base = (*(u16 *)((u8 *)arg0 + 0xA6));
        wobble = (s16)wobble >> 2;
        if (wobble < 0) {
            wobble = -wobble;
        }
        wobble_base += wobble;
        ((S_80170AA4_0 *)arg2)->unk_12 = wobble_base;
    } else if (((*(s32 *)((u8 *)arg0 + 0x14)) & 7) != (*(s16 *)((u8 *)arg0 + 0xAA))) {
        func_80042984(arg0);
        (*(s16 *)((u8 *)arg0 + 0xAA)) = (*(u16 *)((u8 *)arg0 + 0x14)) & 7;
    }

    part_flags = ((S_80170AA4_0 *)arg2)->unk_14.n;
    if (!(part_flags & 0x8000)) {
        arithmetic = D_80083228 + ((S_80170AA4_1 *)entity)->unk_2A + 0x100;
        work = (arithmetic >> 9) & 7;
        previous_direction = (*(s16 *)((u8 *)arg0 + 0x94));
        direction_copy = (u16)work;
        if (previous_direction != work) {
            if (((S_80170AA4_0 *)arg2)->unk_2C != 0) {
                func_80047738(arg2,
                              ((S_80170AA4_0 *)arg2)->unk_2C[work],
                              ((S_80170AA4_0 *)arg2)->unk_04);
            }
        ...
        if (table_value != 0) {
            ((S_80170AA4_0 *)arg2)->unk_14.n |= 1;
        } else {
            ((S_80170AA4_0 *)arg2)->unk_14.n &= 0xFFFE;
        }
        if (!(((S_80170AA4_1 *)entity)->unk_1C & 0x20)) {
            if (!(((S_80170AA4_0 *)arg2)->unk_14.v & 0x40)) {
                func_800478B8(arg2);
                goto after_part_flags;
            }
        } else {
            ((S_80170AA4_0 *)arg2)->unk_14.v |= 0x7000;
        }
after_part_flags:
        func_800A020C(((S_80170AA4_1 *)entity)->unk_1C, (u8 *)arg2 + 0xC);
        goto motion;
    }
    ...
    ((S_80170AA4_0 *)arg2)->unk_14.n = new_part_flags;
...
accumulate:
    ...
    if (!((*(u16 *)((u8 *)arg0 + 0x98)) & 4)) {
        ...
        if (height < 0x200) {
            ...
            ((S_80170AA4_1 *)entity)->unk_1C |= 0x08000000;
            (*(s8 *)((u8 *)arg0 + 0x9D)) = 0;
            (*(s16 *)((u8 *)arg0 + 0x92)) = height - ((S_80170AA4_1 *)entity)->unk_88;

flags_test:
            flags = ((S_80170AA4_1 *)entity)->unk_1C;
            if (flags & 0x40000000) {
                ((S_80170AA4_1 *)entity)->unk_1C = flags & 0xBFFFFFFF;
                floor_height = func_800BCB04(
                    (((S_80170AA4_0 *)arg2)->unk_24 << 6) | 0x20,
                    (((S_80170AA4_0 *)arg2)->unk_25 << 6) | 0x20,
                    (s16)(((S_80170AA4_1 *)entity)->unk_88 - 0x20));
                (*(s16 *)((u8 *)arg0 + 0x92)) +=
...
finish:
    arg1->unk_0A =
        ((S_80170AA4_1 *)entity)->unk_88 + (*(u16 *)((u8 *)arg0 + 0x92));
    ((S_80170AA4_0 *)arg2)->unk_14.n |= 0x40;
