...
{
    register void *arg0 ASM_REG("$17") = input0;   /* MATCH pin: retail register colouring depends on it */
    S_80170AA4_2 *arg1 = input1;
    void *arg2 = input2;
    register void *entity ASM_REG("$18") = arg0;   /* MATCH pin: load-bearing for the whole function shape */
    s16 work;
