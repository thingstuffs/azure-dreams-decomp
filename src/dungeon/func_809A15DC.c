...
L1:
    if (((S_80172DDC_1 *)arg2)->unk_14 & 0x8000) {
        ((S_80172DDC_0 *)arg0)->unk_96.s = 0x100;
...
L3:
    {
        ...
        ((S_80172DDC_0 *)arg0)->unk_A0.at00.v -= (s32)((S_80172DDC_0 *)arg0)->unk_96.u << 17;
        timer = ((S_80172DDC_0 *)arg0)->unk_96.s + 1;
        ((S_80172DDC_0 *)arg0)->unk_96.s = timer;
        if ((s16)timer < 9) {
            return;
        }
...
L4:
    ...
    ((S_80172DDC_0 *)arg0)->unk_A0.at00.v =
        func_800644B8(((S_80172DDC_0 *)arg0)->unk_96.u * 146) * 160 + 0x100000;

L5:
    {
        u16 timer = ((S_80172DDC_0 *)arg0)->unk_96.s + 1;
