...
void func_818B6AFC(void *in0, M2C_UNK arg1, void *arg2) {
    ...
    s16 temp_v1_2;
    s16 temp_v1_4;
    register s32 var_a1 ASM_REG("$5");   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    s32 var_v0;
    s32 var_v1;
    register s32 temp_a0_6 ASM_REG("$4");   /* MATCH pin: load-bearing for the whole function shape */
    s32 temp_t1;
    ...
    s32 packed_rem1;
    s32 remainder3;
    register s32 quotient3 ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    s32 packed3;
    s32 limit48;
    s32 delta48;
    s32 magic7;
    ...
    if (temp_v1_2 < 8) {
        ...
        ASM_KEEP_NV(quotient3);   /* MATCH pin: load-bearing for the whole function shape */
    ...
    if (temp_v1_2 < 0x30) {
        ...
        ASM_KEEP_NV(var_v0);   /* MATCH pin: keeps a statement from moving across a call/branch */
        limit48 = 0x30;
        ASM_KEEP_NV(limit48);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
