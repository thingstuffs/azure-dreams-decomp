...
void func_80173738(void *arg0, FuncArg1 *arg1, S_80173738_1 *arg2) {
    s16 temp_a0;
    s16 temp_v0;
    s32 temp_lo;
    s32 temp_base;
    ...
    if (arg2->unk_14 & 0x4000) {
        func_8003DB94(arg2, &D_800DEC70, 0);
    }
    temp_a0 = ((S_80173738_0 *)arg0)->unk_1A;
    if (temp_a0 < 0xA) {
        arg2->unk_0C = (s8) ((((S_80173738_0 *)arg0)->unk_00 * temp_a0) / 9);
        arg2->unk_0D = (s8) ((((S_80173738_0 *)arg0)->unk_01 * ((S_80173738_0 *)arg0)->unk_1A) / 9);
        arg2->unk_0E = (s8) ((((S_80173738_0 *)arg0)->unk_02 * ((S_80173738_0 *)arg0)->unk_1A) / 9);
    }
