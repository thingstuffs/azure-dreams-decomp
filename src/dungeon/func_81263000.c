...
extern void func_8015EA38() __attribute__((noreturn));
extern void func_8015EAA8() __attribute__((noreturn));
...
void BODY_NAME(void *arg0, void *arg1, void *arg2)
{
    ...
    if (!(((S_81263000_2 *)part)->unk_14 & 0x80)) {
        dst->unk_14 &= 0xFF7F;
    }

    ((S_81263000_4 *)out)->unk_02 = copy->unk_02;
    ((S_81263000_4 *)out)->unk_06 = copy->unk_06;
    ((S_81263000_4 *)out)->unk_0A = copy->unk_0A;

    callee_part = owner->unk_0C;
    if (func_8003DE58(callee_part->unk_08, callee_part, pos,
                      ((S_81263000_0 *)root)->unk_B6) != 0) {
        ((S_81263000_4 *)out)->unk_02 +=
            (pos[0] + ((S_81263000_0 *)root)->unk_B0) / 2;
        ((S_81263000_4 *)out)->unk_06 +=
            (pos[1] + ((S_81263000_0 *)root)->unk_B2) / 2;
        ((S_81263000_4 *)out)->unk_0A +=
            (pos[2] + ((S_81263000_0 *)root)->unk_B4) / 2;
        ((S_81263000_0 *)root)->unk_B0 = pos[0];
        ((S_81263000_0 *)root)->unk_B2 = pos[1];
        ((S_81263000_0 *)root)->unk_B4 = pos[2];
    }

    copy = dst->unk_08;
    dst->unk_1C = ((S_81263000_2 *)part)->unk_1C;
    dst->unk_1E = ((S_81263000_2 *)part)->unk_1E;
    dst->unk_14 = ((S_81263000_2 *)part)->unk_14;
    copy->unk_01 &= 0xFE;

    if (((S_81263000_0 *)root)->unk_B6 == 1) {
        value = ((S_81263000_2 *)part)->unk_04.s8;
        if (value < 8) {
        ...
        if (!(((S_81263000_2 *)part)->unk_14 & 0x8000) &&
            ((S_81263000_2 *)part)->unk_04.u16 == 0x10C) {
            func_800A56E0(0x709);
        }
    }
    ...
    if (((S_81263000_0 *)root)->unk_B6 == 2) {
        ...
        if (!(((S_81263000_2 *)part)->unk_14 & 0x8000) &&
            ((S_81263000_2 *)part)->unk_04.u16 == 0x104) {
            func_800A56E0(0x709);
        }
    }
