...
void func_80172650(void *action, void *motion, void *animation, void *actor_data) {
...
state_1:
    ...
    FIELD(animation, void **, 0x2C) = D_801748B8;
    func_80047784(animation,
        D_801748B8[((D_80083228 + FIELD(actor, s16 *, 0x2A) + 0x100) >> 9) & 7],
        0);
...
state_3:
    ...
    FIELD(action, void **, 0x8C) = D_80171058;
    D_8008346C = 0;
    func_800A4ACC(actor);
