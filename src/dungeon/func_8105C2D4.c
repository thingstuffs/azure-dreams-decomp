...
void func_80173AD4(void *arg0, void *arg1, void *arg2, void *arg3) {
    ...
    temp_byte = ((S_80173AD4_0 *)arg3)->unk_71;
    var_s0 = arg0;
    ((S_80173AD4_0 *)arg3)->unk_71 = temp_byte & 0x7F;
    var_s3 = (u8 *)&D_80083460;
    var_s2 = arg2;
    if (!(((S_80173AD4_1 *)var_s3)->unk_02 & 0x2000) && ((func_800A2BDC(arg3) << 0x10) == 0)) {
        ...
        if (!(((S_80173AD4_2 *)var_s0)->unk_98 & 0x8000)) {
            ...
            ((S_80173AD4_2 *)var_s0)->unk_AA = (s16) (((S_80173AD4_0 *)arg3)->unk_14 & 7);
        }
        ((S_80173AD4_1 *)var_s3)->unk_0A = (u16) (((S_80173AD4_1 *)var_s3)->unk_0A + 1);
        ((S_80173AD4_0 *)arg3)->unk_6D = (u8) (((S_80173AD4_0 *)arg3)->unk_6D - 1);
        call_flags = ((S_80173AD4_0 *)arg3)->unk_1C & 0x2000;
        ...
        ((S_80173AD4_0 *)arg3)->unk_1C = (s32) (((S_80173AD4_0 *)arg3)->unk_1C & ~0x2000);
        func_8009A21C(((S_80173AD4_3 *)var_s2)->unk_24, ((S_80173AD4_3 *)var_s2)->unk_25, 0x3000);
        (*(u8 **)((u8 *)var_s2 + 0x2C)) = D_80173FD0;
        func_80047784(var_s2, D_80173FD0[((D_80083228 + ((S_80173AD4_0 *)arg3)->unk_2A + 0x100) >> 9) & 7], 0);
