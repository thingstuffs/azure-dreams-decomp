...
state_zero:
    ...
    func_80047784(
        sprite,
        D_801519A8[((D_80083228 + ((Rec_D_800E3D7C *)entity)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
...
state_two:
    if (((Rec_D_800E3D7C *)entity)->unk_1C.as_s32 & 0x08000000) {
        ...
        func_80047784(
            sprite,
            D_801519B8[((D_80083228 + ((Rec_D_800E3D7C *)entity)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        ((S_8014EC54_0 *)action)->unk_9B++;
    }
    goto decrement_timer;
...
state_three:
    ...
    func_80047784(
        sprite,
        D_80151988[((D_80083228 + ((Rec_D_800E3D7C *)entity)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
