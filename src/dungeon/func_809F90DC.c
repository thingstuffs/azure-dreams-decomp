...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            work_value = 1;
            ((S_8016A8DC_6 *)(void *)saved_kind)->unk_02 = (s16)work_value;
            item_index = 0;
            do {
                outer_base = outer;
            } while (0);
            ...
            do {
                ...
                item_index++;
                {
                    ...
                    work_value = (uptr)call_zero;
                    ((S_8016A8DC_6 *)(void *)saved_kind)->unk_06 = (s16)work_value;
                ...
                ((S_8016A8DC_6 *)(void *)saved_kind)->unk_98 = table_page;
            } while (more_items);
        }
        outer = (u8 *)outer + 4;
        {
