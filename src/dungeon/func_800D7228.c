...
void func_800DC988(void *arg0) {
    ...
    S_800DC988_2 *data = D_800814A8;
    S_800DC988_1 *state;

    ((S_800DC988_0 *)arg0)->unk_20 = ~value;
    state = (s8 *)arg0 + 0x20;
    state->unk_04 = ~data->unk_FC;
    state->unk_10 = ~data->unk_28;
    state->unk_14 = ~data->unk_29;
    state->unk_30 = ~data->unk_11;
    func_800DC82C(state);
    do {
        func_800DC724(state);
