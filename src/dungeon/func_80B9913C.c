...
typedef struct S_8017293C_3 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_8017293C_3;   /* arg2 in func_8017293C */

typedef struct S_8017293C_4 {
    u8 pad_00[0xC];
    s32 unk_0C;
    s32 unk_10;
    s32 unk_14;
} S_8017293C_4;   /* arg1 in func_8017293C */
...
copy_active_coords:
            ...
            active = func_800A05A4(
                arg3, ((S_8017293C_3 *)arg2)->unk_24, ((S_8017293C_3 *)arg2)->unk_25,
...
empty_selection:
    ((S_8017293C_4 *)arg1)->unk_14 = 0;
    ((S_8017293C_4 *)arg1)->unk_10 = 0;
    ((S_8017293C_4 *)arg1)->unk_0C = 0;
    func_800A2B04(arg1, ((S_8017293C_3 *)arg2)->unk_24, ((S_8017293C_3 *)arg2)->unk_25);
    D_8008346C = 0;
...
state_1:
    if (func_8003F270()) {
        ((S_8017293C_3 *)arg2)->unk_14 |= 0x800;
        goto end;
    }
    ((S_8017293C_3 *)arg2)->unk_14 &= 0xF7FF;
    ((S_8017293C_0 *)arg0)->unk_9B++;

state_2:
    if ((((S_8017293C_3 *)arg2)->unk_04 == 3 &&
         (((S_8017293C_3 *)arg2)->unk_14 & 0x1000)) ||
        (((S_8017293C_3 *)arg2)->unk_14 & 0xE000)) {
        ((S_8017293C_3 *)arg2)->unk_14 |= 0x800;
    ...
    if (!(((S_8017293C_3 *)arg2)->unk_14 & 0xE000)) {
        goto end;
    }
    ((S_8017293C_4 *)arg1)->unk_14 = 0;
    ((S_8017293C_4 *)arg1)->unk_10 = 0;
    ((S_8017293C_4 *)arg1)->unk_0C = 0;
    func_800A2B04(arg1, ((S_8017293C_3 *)arg2)->unk_24, ((S_8017293C_3 *)arg2)->unk_25);
    if (((S_8017293C_3 *)arg2)->unk_2C != D_80174EE0) {
        u8 *table;
        s32 index;
