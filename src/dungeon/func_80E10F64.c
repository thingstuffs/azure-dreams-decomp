...
typedef struct S_80174764_1 {
    ...
    u8 unk_24;
    u8 unk_25;
} S_80174764_1;   /* arg2 in func_80174764 */

typedef struct S_80174764_2 {
    u8 pad_00[0x14];
    s32 unk_14;
    u8 pad_18[0x12];
    s16 unk_2A;
    u8 pad_2C[0x34];
    void * unk_60;
} S_80174764_2;   /* arg3 in func_80174764 */
...
typedef struct S_80174764_4 {
    u8 pad_00[0x14];
    s32 unk_14;
} S_80174764_4;   /* ((S_80174764_2 *)arg3)->unk_60 in func_80174764 */
...
void func_80174764(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    case 0:
        flags = ((S_80174764_1 *)arg2)->unk_14;
        if (flags & 0x8000) {
            ((S_80174764_1 *)arg2)->unk_14 = flags | 0x6000;
            if (((S_80174764_2 *)arg3)->unk_14 & 0x4000) {
                target = ((S_80174764_2 *)arg3)->unk_60;
                if (!func_80176258(target))
                    goto state0_cc_false;
                func_801763CC(1, ((S_80174764_2 *)arg3)->unk_60);
                goto state0_done;
state0_cc_false:
                func_801763CC(0, ((S_80174764_2 *)arg3)->unk_60);
                goto state0_done;
            }
            ...
            if (((S_80174764_3 *)target)->unk_14 & 0x4000) {
                ...
                func_80176330(1, ((S_80174764_2 *)arg3)->unk_60);
                goto state0_done;
state0_330_false:
                func_80176330(0, ((S_80174764_2 *)arg3)->unk_60);
                goto state0_done;
            }
...
state0_done:
        ...
        } else if (((S_80174764_4 *)(((S_80174764_2 *)arg3)->unk_60))->unk_14 & 0x4000) {
    ...
    case 1:
        ...
        ((S_80174764_0 *)arg0)->unk_96 = timer;
        if ((timer << 16) == 0 || (((S_80174764_1 *)arg2)->unk_14 & 0x8000)) {
            if (((S_80174764_2 *)arg3)->unk_14 & 0x4000) {
                target = ((S_80174764_2 *)arg3)->unk_60;
                if (!func_80176258(target))
...
state1_done:
    ...
    case 2:
        timer = ((S_80174764_0 *)arg0)->unk_96 - 1;
        ((S_80174764_0 *)arg0)->unk_96 = timer;
        if ((timer << 16) == 0 || (((S_80174764_1 *)arg2)->unk_14 & 0xE000)) {
            func_800AD594(arg3, 0x400);
            func_800A2B04(arg1, ((S_80174764_1 *)arg2)->unk_24, ((S_80174764_1 *)arg2)->unk_25);
    ...
    if (((S_80174764_1 *)arg2)->unk_14 & 0xE000) {
        s32 index;

        (*(void * *)((u8 *)arg2 + 0x2C)) = D_80176460;
        index = (D_80083228 + ((S_80174764_2 *)arg3)->unk_2A + 0x100) >> 9;
