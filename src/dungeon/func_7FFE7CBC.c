...
void func_7FFE7CBC(S_7FFE7CBC_3 *arg0, s32 arg1) {
    s32 temp_arg1;
    S_7FFE7CBC_1 *temp_a0;
    S_7FFE7CBC_4 *temp_a0_2;
    S_7FFE7CBC_0 *temp_v0;
    S_7FFE7CBC_2 *temp_v1;

    temp_v0 = func_7003CF18(0x12);
    if (temp_v0 != NULL) {
        temp_a0 = temp_v0->unk_0C;
        temp_v0->unk_10 = &D_8010AC34;
        temp_v0->unk_44 = arg0;
        temp_v0->unk_3E = 0x3C;
        temp_a0->unk_10 = 0x20;
        temp_a0->unk_14 =
        ...
        temp_v1->unk_02 =
            (u16)((S_7FFE7CBC_5 *)(arg0->unk_08))->unk_02;
        temp_v1->unk_06 =
            (u16)((S_7FFE7CBC_5 *)(arg0->unk_08))->unk_06;
        temp_v1->unk_0A =
            (u16)((S_7FFE7CBC_5 *)(arg0->unk_08))->unk_0A;
