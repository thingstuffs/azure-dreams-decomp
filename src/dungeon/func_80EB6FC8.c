...
typedef struct S_801727C8_1 {
    ...
    s8 unk_72;
    s8 unk_73;
} S_801727C8_1;   /* arg3 in func_801727C8 */
...
typedef struct S_801727C8_4 {
    ...
    u8 pad_26[0x6];
    M2C_UNK * unk_2C;
} S_801727C8_4;   /* arg2 in func_801727C8 */
...
typedef struct S_801727C8_6 {
    u8 pad_00[0xC];
    s32 unk_0C;
    s32 unk_10;
    s32 unk_14;
} S_801727C8_6;   /* arg1 in func_801727C8 */

typedef struct S_801727C8_7 {
    u8 pad_00[0xA6];
    u16 unk_A6;
} S_801727C8_7;   /* D_800814A8 in func_801727C8 */
...
block_4:
    ...
    return;
block_7:
    if (!(((S_801727C8_1 *)arg3)->unk_1C & 0x2000)) {
        goto block_13;
    }
    temp_v0_2 = ((S_801727C8_1 *)arg3)->unk_46 & 0x3FFF;
...
jt_c5:
    ...
    goto block_20;
block_13:
    temp_v1_2 = ((S_801727C8_1 *)arg3)->unk_46 & 0x3FFF;
    if (temp_v1_2 == 2) {
        goto block_19;
    }
    if (temp_v1_2 >= 3) {
...
block_22:
    ...
    *(volatile u16 *)((s8 *)arg0 + 0x98) = (u16) (((S_801727C8_0 *)arg0)->unk_98 & 0xFF7F);
    ...
    var_v0 = D_800814A8;
    ((S_801727C8_1 *)arg3)->unk_60 = var_v0;
    goto block_27;
block_25:
    if (D_8006DE24[*var_s1].type != 2) {
        goto block_28;
    }
    var_v0 = ((S_801727C8_1 *)arg3)->unk_60;
...
block_27:
    {
        ...
        ((S_801727C8_1 *)arg3)->unk_72 = (s8) ((S_801727C8_3 *)temp_v1_3)->unk_24;
        ((S_801727C8_1 *)arg3)->unk_73 = (s8) ((S_801727C8_3 *)temp_v1_3)->unk_25;
    }
    goto block_33;
block_28:
    {
        ...
        spawned = func_800A05A4(arg3, ((S_801727C8_4 *)arg2)->unk_24, ((S_801727C8_4 *)arg2)->unk_25, ((S_801727C8_1 *)arg3)->unk_2A, 0x10);
        ((S_801727C8_1 *)arg3)->unk_60 = spawned;
        ASM_SCHED_BARRIER();   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    }
    var_v0_2 = ((S_801727C8_1 *)arg3)->unk_72;
    var_v1 = ((S_801727C8_1 *)arg3)->unk_73;
    if (var_v0_2 >= 0) {
        goto block_30;
    }
    var_v0_2 = 0 - var_v0_2;
block_30:
    ...
    var_v1 = 0 - var_v1;
block_32:
    ((S_801727C8_1 *)arg3)->unk_72 = var_v0_2;
    ((S_801727C8_1 *)arg3)->unk_73 = var_v1;
block_33:
    var_a1 = (u8 *)0x80170000;
block_34:
    var_a1 += 0x41B4;
    ...
    func_80047784(temp_s7, *((u8 *) ((((s32) (D_80083228 + ((S_801727C8_1 *)arg3)->unk_2A + 0x100) >> 9) & 7) + (s32) var_a1)), 0);
    if (func_800A94A0(arg3, var_s1, var_s5, arg0 + 0x98) == 0) {
        goto block_54;
    }
    ((S_801727C8_4 *)arg2)->unk_14 = (u16) (((S_801727C8_4 *)arg2)->unk_14 & 0xF7FF);
...
block_36:
    ((S_801727C8_6 *)arg1)->unk_14 = 0;
    ((S_801727C8_6 *)arg1)->unk_10 = 0;
    ((S_801727C8_6 *)arg1)->unk_0C = 0;
    func_800A2B04(arg1, ((S_801727C8_4 *)arg2)->unk_24, ((S_801727C8_4 *)arg2)->unk_25);
    D_8008346C = 0;
    ((S_801727C8_7 *)D_800814A8)->unk_A6 = (u16) ((*(u16 *)((u8 *)D_800814A8 + 0xA6)) - 1);
    func_800A4ACC(arg3);
    ((S_801727C8_1 *)arg3)->unk_6D = (u8) (((S_801727C8_1 *)arg3)->unk_6D - 1);
    ((S_801727C8_0 *)arg0)->unk_8C = &D_801711A4;
    ((S_801727C8_1 *)arg3)->unk_73 = 0;
    ((S_801727C8_1 *)arg3)->unk_72 = 0;
    ((S_801727C8_1 *)arg3)->unk_46 = (u16) (((S_801727C8_1 *)arg3)->unk_46 & 0x7FFF);
    return;
block_37:
    if (func_8003F270() == 0) {
        goto block_39;
    }
    ((S_801727C8_4 *)arg2)->unk_14 = (u16) (((S_801727C8_4 *)arg2)->unk_14 | 0x800);
    return;
block_39:
    ((S_801727C8_4 *)arg2)->unk_14 = (u16) (((S_801727C8_4 *)arg2)->unk_14 & 0xF7FF);
...
block_40:
    ...
    if (!(((S_801727C8_4 *)arg2)->unk_14 & 0xE000)) {
        goto block_54;
    }
block_42:
    ...
    func_80047784(arg2, *((((s32) (D_80083228 + ((S_801727C8_1 *)arg3)->unk_2A + 0x100) >> 9) & 7) + &D_801741BC), 0);
block_44:
    temp_v1 = ((S_801727C8_0 *)arg0)->unk_9B;
block_44_increment:
...
block_45:
    ...
    ((S_801727C8_6 *)arg1)->unk_0C = 0;
    func_800A2B04(arg1, ((S_801727C8_4 *)arg2)->unk_24, ((S_801727C8_4 *)arg2)->unk_25);
    if (((S_801727C8_4 *)arg2)->unk_2C == &D_8017418C) {
        var_v0_3 = &D_80083460;
        goto block_50;
    }
    if (!(((S_801727C8_4 *)arg2)->unk_14 & 0x6000)) {
        goto block_49;
    }
    ...
    func_80047784(arg2, *((((s32) (D_80083228 + ((S_801727C8_1 *)arg3)->unk_2A + 0x100) >> 9) & 7) + &D_8017418C), 0);
block_49:
    var_v0_3 = &D_80083460;
block_50:
    ...
    ((S_801727C8_0 *)arg0)->unk_8C = &D_801711A4;
    func_800A4ACC(arg3);
    if ((s8) ((S_801727C8_1 *)arg3)->unk_6D <= 0) {
        goto block_53;
    }
    ((S_801727C8_1 *)arg3)->unk_6D = (u8) (((S_801727C8_1 *)arg3)->unk_6D - 1);
block_53:
