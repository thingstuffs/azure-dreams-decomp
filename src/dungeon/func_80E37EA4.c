...
typedef struct S_801716A4_4 {
    u8 pad_00[0x2A];
    u16 unk_2A;
    u8 pad_2C[0x2C];
    void * unk_58;
} S_801716A4_4;   /* D_800814A8 in func_801716A4 */
    ...
    if (flags & 0x2000) {
        ...
        if (flags & 0x20000) {
            ...
            u8 *buffer;
            {
                ...
                s32 direction = ((S_801716A4_4 *)D_800814A8)->unk_2A;
                s32 table_index =
    ...
    if (i == 0 &&
        *(u16 *)&D_80082EA4 != ((S_801716A4_2 *)arg2)->unk_24.at00u.v) {
        ...
        if (func_8009A180(arg3,
                (u8 *)((S_801716A4_4 *)D_800814A8)->unk_58 + 0x20) != 0) {
            return;
        }
    }
