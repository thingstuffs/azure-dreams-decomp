...
typedef struct S_80171570_1 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_80171570_1;   /* arg2 in func_80171570 */
...
void func_80171570(void *arg0, s32 arg1, void *arg2, void *arg3) {
    ...
    if (((S_80171570_1 *)arg2)->unk_2C != D_80174138) {
    ...
    x = ((S_80171570_1 *)arg2)->unk_24;
    y = ((S_80171570_1 *)arg2)->unk_25;
    mode = 0x3000;
    ...
    ((S_80171570_1 *)arg2)->unk_24 =
        ((S_80171570_3 *)((u8 *)state + ((S_80171570_0 *)state)->unk_8A))->unk_74;
    mode = 0x3000;
    ((S_80171570_1 *)arg2)->unk_25 =
        ((S_80171570_3 *)((u8 *)state + ((S_80171570_0 *)state)->unk_8A))->unk_7C;
    ((S_80171570_0 *)state)->unk_8A = (u16)((S_80171570_0 *)state)->unk_8A + 1;

    a24 = ((S_80171570_1 *)arg2)->unk_24;
    a25 = ((S_80171570_1 *)arg2)->unk_25;
    if (((S_80171570_0 *)state)->unk_1C & 0x2000) {
        mode = 0x300;
    }
    ...
    if (result == 3) {
        if (!(D_80083462 & 0x80) && !(((S_80171570_1 *)arg2)->unk_14 & 0x8000)) {
