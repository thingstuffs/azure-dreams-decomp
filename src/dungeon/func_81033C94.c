...
void func_80175494(Arg0Object *arg0, Arg1Object *arg1, Arg2Object *arg2) {
    ...
    if (allocated != 0) {
        ...
        child->field10 = 0x20;
        child->flags14 |= 0xc;
        block->field4c = (s8)(arg2->x24 + D_8017610C[(arg0->angle >> 7) & 0x1c]);
        {
            u8 y2 = arg2->y25;
            u16 angle2 = arg0->angle;
            u8 *table2 = D_8017610C + ((angle2 >> 7) & 0x1c);
            block->field4d = (s8)(y2 + table2[2]);
        }
        child->field6 = 6;
        payload = allocated->payload;
        payload->value0 = (((block->field4c << 6) + 0x20) << 0x10);
        payload->value4 = (((block->field4d << 6) + 0x20) << 0x10);
        payload->value8 = func_800BCB04(*(u16 *)((u8 *)payload + 2), *(u16 *)((u8 *)payload + 6), (s16)(arg1->height - 0x20)) << 0x10;
        block->angle_copy = arg0->angle;
        block->angle_index = (arg0->angle >> 9) & 7;
        child = allocated->child;
        ...
        *(Copy12 *)((u8 *)allocated + 0x54) = *(Copy12 *)D_8017612C;
        ...
        secondary = func_801748FC(arg0, (u16)(s8)block->field4c, (u16)(s8)block->field4d, *(s16 *)((u8 *)payload + 0xa));
        ...
        if (secondary != 0) {
            ...
            sx = secondary_child->x24;
            sy = secondary_child->y25;
            if (secondary_block->flags1c & 0x2000) {
                mode = 0x300;
            } else {
                mode = 0x3000;
            }
            func_8009A3D0(sx, sy, mode, mode);
        }
