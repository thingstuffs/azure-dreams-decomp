...
void func_800D3738(void *arg0, void *arg1_in, void *arg2_in, s16 arg3) {
    s32 temp_a0_2;
    s32 temp_a1_3;
    register s32 temp_a1_4 ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    s32 temp_a1_5;
    s32 temp_v0_10;
    s16 temp_v0_7;
    s32 temp_v0_8;
    ...
    s32 var_v1_2;
    s32 temp_a2;
    register u16 temp_y_width ASM_REG("$4");   /* MATCH pin: load-bearing for the whole function shape */
    u16 temp_v0_3;
    u16 temp_v0_4;
    register u32 temp_a0 ASM_REG("$4");   /* MATCH pin: load-bearing for the whole function shape */
    u32 temp_a0_3;
    u32 temp_a1;
    u32 temp_a1_6;
    register u32 temp_x_total ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    register u32 temp_y_total ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
    u32 temp_bound;
    register u32 temp_flags ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    u32 temp_any;
    u32 temp_v0;
    u32 temp_v0_2;
    u8 temp_v0_5;
    ...
    void *temp_s0;
    u8 *temp_s1;
    register u8 *base ASM_REG("$9");   /* MATCH pin: load-bearing for the whole function shape */
    register void *arg1 ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    u8 *page_scratch;
    void *temp_s2;
    void *temp_s4;
    register void *temp_s6 ASM_REG("$22");   /* MATCH pin: retail register colouring depends on it */
    void *var_s5;
    void *arg2;
    register s16 arg3_s0 ASM_REG("$16");   /* MATCH pin: retail schedule: same instructions, different order without it */

    arg1 = arg1_in;
    arg2 = arg2_in;
    ASM_KEEP_NV(arg2);   /* MATCH pin: keeps a statement from moving across a call/branch */
    arg3_s0 = arg3;
    ASM_KEEP_NV(arg3_s0);   /* MATCH pin: retail schedule: same instructions, different order without it */
    {
    u8 *call_a0;
    void *call_a1;
    void *call_a2;
    register void *call_a3 ASM_REG("$7");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    register void *root ASM_REG("$8");   /* MATCH pin: retail register colouring depends on it */
    ...
    ASM_KEEP_MEMDEP_NV(call_a0, page_scratch, *(void **)D_80083160);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    temp_s1 = call_a0;
    ASM_KEEP_NV(temp_s1);   /* MATCH pin: retail register colouring depends on it */
    ...
    ASM_KEEP_MEMDEP_NV(temp_s1, page_scratch, *(void **)D_80083160);   /* MATCH pin: retail register colouring depends on it */
#ifdef NON_MATCHING
    base = D_80083160 - 0x3160;
#else
    ASM_SET(base);   /* MATCH pin: retail keeps a computation the compiler would drop */
#endif
    ...
    ASM_KEEP_NV(temp_s6);   /* MATCH pin: retail callee-saved set / frame layout depends on it */
    M2C_FIELD(arg2, u16 *, 0x14) = (u16) (M2C_FIELD(arg2, u16 *, 0x14) | 0x8000);
    temp_v0 = M2C_FIELD(temp_s1, u32 *, 0xC0);
    temp_s2 = &D_8006CD30;
    ASM_KEEP_NV(temp_s2);   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    ...
    if (temp_v0_2 < 0x1D6U) {
        ...
        func_800649A0();
        {
            void *call_a0;
            void *call_a1;
            register u16 temp_adjust ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
            call_a0 = temp_s1;
        ...
        ASM_SET(call_a1);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
        call_a1 = temp_s1;
        ASM_KEEP_NV(call_a1);   /* MATCH pin: retail immediate-load split depends on it */
        ...
        }
        {
            ...
            ASM_KEEP_NV(call_a1);   /* MATCH pin: retail immediate-load split depends on it */
            call_a1 = (void *) ((u32) call_a1 | 0xD0);
            ASM_SET(call_a2);   /* MATCH pin: retail schedule: same instructions, different order without it */
            call_a2 = temp_s1;
            ASM_KEEP_NV(call_a2);   /* MATCH pin: keeps a statement from moving across a call/branch */
...
y_join:
            ...
            if (temp_any != 0) {
                ...
                temp_y_total = temp_a1_6;
                ASM_KEEP_NV(temp_y_total);   /* MATCH pin: retail basic-block layout depends on it */
