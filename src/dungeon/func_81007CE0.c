...
typedef struct S_801734E0_1 {
    u8 pad_00[0x14];
    u16 unk_14;
} S_801734E0_1;   /* arg2 in func_801734E0 */
...
typedef struct S_801734E0_3 {
    ...
    u8 pad_66[0x7];
    s8 unk_6D;
} S_801734E0_3;   /* arg3 in func_801734E0 */
...
typedef struct S_801734E0_5 {
    u8 pad_00[0x58];
    void * unk_58;
} S_801734E0_5;   /* D_800814A8 in func_801734E0 */
...
state_zero:
    {
        ...
        if (!(((S_801734E0_1 *)arg2)->unk_14 & 0xE000)) {
            goto done;
        }
        ...
        func_80047784(arg2,
            table[((D_80083228 + ((S_801734E0_3 *)arg3)->unk_2A + 0x100) >> 9) & 7],
            0);
...
state_one:
    {
        ...
        if (((S_801734E0_3 *)arg3)->unk_25 != 0) {
            s32 *base;

            (*(void * *)((u8 *)arg2 + 0x2C)) = D_801748E8;
            func_80047784(arg2,
                D_801748E8[((D_80083228 + ((S_801734E0_3 *)arg3)->unk_2A + 0x100) >> 9) & 7],
                0);
            ((S_801734E0_3 *)arg3)->unk_1C |= 0x40000;
            base = &D_80083460;
            ((S_801734E0_2 *)base)->unk_0A++;
            goto increment_state;
        }
        ...
        flags = ((S_801734E0_3 *)arg3)->unk_1C;
        if (flags & 0x100) {
        ...
        if (((S_801734E0_3 *)arg3)->unk_6D == 0) {
            goto done;
        }
        if ((func_800A2C34(arg3) << 16) != 0) {
            if ((func_8009A180(arg3,
                    (u8 *)((S_801734E0_5 *)D_800814A8)->unk_58 + 0x20) << 16) != 0) {
                goto done;
            }
        }
...
state_two:
    if (((S_801734E0_1 *)arg2)->unk_14 & 0xE000) {
        ...
        base = &D_80083460;
        ((S_801734E0_2 *)base)->unk_0A--;
        ((S_801734E0_3 *)arg3)->unk_1C &= ~0x208;
