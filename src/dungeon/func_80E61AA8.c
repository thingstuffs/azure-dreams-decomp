...
void func_801712A8(void *a0, void *a1, void *a2)
{
    ...
    register u32 old_direction_raw ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
    Callback callback;
    u16 flags;
    s16 floor;
    s16 actor_height;
    ...
    flags = ((S_801712A8_1 *)monster)->unk_14;
    if (!(flags & 0x8000)) {
        s32 direction_value;

        direction_value =
            (D_80083228 + ((S_801712A8_0 *)actor)->unk_2A + 0x100) >> 9;
        ASM_USE(direction);   /* MATCH pin: load-bearing for the whole function shape */
    ...
    if (!((*(u16 *)((u8 *)entity + 0x98)) & 4)) {
        ...
        if (floor < 0x200) {
            ...
            if (floor >= actor_height) {
                ...
                (*(s16 *)((u8 *)entity + 0x92)) = floor - ((S_801712A8_0 *)actor)->unk_88.u;
            }
...
check_adjustment:
            if (((S_801712A8_0 *)actor)->unk_1C.u & 0x40000000) {
                ...
                floor = func_800BCB04(
                    ...
                    (s16)(((S_801712A8_0 *)actor)->unk_88.u - 0x20));
                (*(s16 *)((u8 *)entity + 0x92)) +=
                    ((S_801712A8_0 *)actor)->unk_88.u - floor;
                ((S_801712A8_0 *)actor)->unk_88.u = floor;
            }
            goto finish;
        }
