...
typedef struct S_8016A854_0 {
    ...
    void ** unk_0C;
    void * unk_10;
} S_8016A854_0;   /* temp_v0 in func_8016A854 */
...
typedef struct S_8016A854_1 {
    ...
    u8 pad_18[0x4];
    s32 unk_1C;
} S_8016A854_1;   /* var_s1 in func_8016A854 */

typedef struct S_8016A854_2 {
    u8 pad_00[0xA];
    s16 unk_0A;
} S_8016A854_2;   /* temp_s6 in func_8016A854 */
...
typedef struct S_8016A854_3 {
    ...
    u8 pad_26[0x6];
    void * unk_2C;
} S_8016A854_3;   /* temp_s2 in func_8016A854 */
...
typedef struct S_8016A854_4 {
    ...
    s16 unk_A4;
    s16 unk_A6;
} S_8016A854_4;   /* temp_s3 in func_8016A854 */
...
BODY_STORAGE void *func_8016A854(s16 arg0, s16 arg1, s16 arg2, s16 arg3) BODY_ATTR;

BODY_STORAGE void *func_8016A854(s16 arg0, s16 arg1, s16 arg2, s16 arg3)
{
    s32 temp_v0_2;
    s32 var_s5;
    void *temp_s0;
    S_8016A854_3 *temp_s2;
    S_8016A854_2 *temp_s6;
    void *temp_s3;
    void *temp_v0;
    S_8016A854_1 *var_s1;
    ...
    ((S_8016A854_0 *)temp_v0)->unk_10 = D_8016AA8C;
    var_s1->unk_13 = 0x23;
    func_8004491C(temp_v0, D_80045340);
    temp_s6 = ((S_8016A854_0 *)temp_v0)->unk_08;
    temp_s6->unk_0A = arg3;
    temp_s2 = ((S_8016A854_0 *)temp_v0)->unk_0C;
    temp_s2->unk_25 = arg2;
    temp_s3 = var_s1;
    temp_s2->unk_2C = D_8016DD30;
    temp_v0_2 = arg0 & 3;
    temp_s2->unk_24 = arg1;
    if (temp_v0_2 == 1) {
        ...
        temp_s2->unk_2C = D_8016DD78;
    status_done:
        var_s5 = func_800A6D30() & 3;
    }
    func_800A9C18(temp_v0, temp_s6, temp_s2, arg0);
    ((S_8016A854_4 *)temp_s3)->unk_9A = 0xFF;
    ((S_8016A854_4 *)temp_s3)->unk_9C = -1;
    ((S_8016A854_4 *)temp_s3)->unk_8C = D_8016AF74;
    ((S_8016A854_4 *)temp_s3)->unk_A4 = -1;
    if (var_s5 != 0) {
        ((S_8016A854_4 *)temp_s3)->unk_A6 = 0;
    } else {
        temp_s0 = (u8 *)temp_s3 - 0x20;
        ((S_8016A854_4 *)temp_s3)->unk_A6 = 1;
        temp_s2->unk_10 = 0x60;
        temp_s2->unk_14 |= 0xC;
        temp_s2->unk_12 -= 0x80;
