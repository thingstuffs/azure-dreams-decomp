...
/* Renders two-byte character codes, advancing the horizontal position by two per character. */
void func_80123928(u8 *text, s16 x, s16 y) {
    M2C_UNK glyph;
    s16 draw_x;
    u8 *cursor;
    u8 code_hi;
