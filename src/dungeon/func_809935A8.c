...
void func_80152DA8(void *entity, void *motion, void *sprite_in)
{
        ...
        if (!(((S_80152DA8_1 *)sprite)->unk_14 & 0x40)) {
            if (((S_80152DA8_1 *)sprite)->unk_2C == D_801560E0) {
                ...
                if (((S_80152DA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    ...
                    func_80047784(sprite, D_801560E8[((D_80083228 + ((S_80152DA8_2 *)entity_state)->unk_2A + 0x100) >> 9) & 7], 0);
                }
                ...
                if (((S_80152DA8_1 *)sprite)->unk_04.u16 == 0x103) {
                    ...
                    func_80047784(sprite, D_801560E0[((D_80083228 + ((S_80152DA8_2 *)entity_state)->unk_2A + 0x100) >> 9) & 7], 0);
                }
            }
        }
