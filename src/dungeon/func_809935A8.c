...
extern void func_80152F3C(void) __attribute__((noreturn));
extern void func_80152FE4(void) __attribute__((noreturn));
extern void func_80153050(void) __attribute__((noreturn));
extern void func_80153408(void) __attribute__((noreturn));
...
void func_80152DA8(void *arg0_, void *arg1_, void *arg2_)
{
    ...
    if (D_80083462 & 0x2000) {
        ...
        if (callback == (Callback)D_801534D4) {
    ...
    D_80156168[(*(u8 *)((u8 *)arg0 + 0x9A))](arg0, arg1, arg2, arg0);
    if ((s16)old_state != (*(s8 *)((u8 *)arg0 + 0x6D))) {
        func_800AA36C(arg0, arg1, arg2, arg0);
    }

    ((S_80152DA8_0 *)arg1)->unk_00.at00.v += ((S_80152DA8_0 *)arg1)->unk_0C;
    ((S_80152DA8_0 *)arg1)->unk_04.at00.v += ((S_80152DA8_0 *)arg1)->unk_10;

    if (!((*(u32 *)((u8 *)arg0 + 0x1C)) & 0x40000) &&
        !((*(u16 *)((u8 *)arg0 + 0x98)) & 8)) {
        ((S_80152DA8_0 *)arg1)->unk_14 += (*(s8 *)((u8 *)arg0 + 0x9D)) * 0x14000;
        (*(u8 *)((u8 *)arg0 + 0x9D))++;
        func_80152F3C();
    }
    ...
    (*(s32 *)((u8 *)arg0 + 0x90)) += ((S_80152DA8_0 *)arg1)->unk_14;
    part_flags = ((S_80152DA8_1 *)arg2)->unk_14;

    if (!(part_flags & 0x8000)) {
        direction = ((D_80083228 + ((S_80152DA8_2 *)state)->unk_2A + 0x100) >> 9) & 7;
        direction_copy = direction;
        if ((*(s16 *)((u8 *)arg0 + 0x94)) != direction_copy) {
            func_80047738(arg2,
                (*(u8 *)((u8 *)(((S_80152DA8_1 *)arg2)->unk_2C) + direction_copy)),
                ((S_80152DA8_1 *)arg2)->unk_04.s8);
            (*(s16 *)((u8 *)arg0 + 0x94)) = direction;
        }
        if (D_8006CCF8[direction_copy] != 0) {
            u32 scratch;
            scratch = ((S_80152DA8_1 *)arg2)->unk_14 | 1;
        ...
        ((S_80152DA8_1 *)arg2)->unk_14 &= 0xFFFE;
        func_800A020C(((S_80152DA8_2 *)state)->unk_1C.s, (u8 *)arg2 + 0xC);
        if (!(((S_80152DA8_2 *)state)->unk_1C.u & 0x20)) {
            if (!(((S_80152DA8_1 *)arg2)->unk_14 & 0x40)) {
                func_800478B8(arg2);
            ...
            ((S_80152DA8_1 *)arg2)->unk_14 |= 0x7000;
            ((S_80152DA8_2 *)state)->unk_1C.u &= 0xFFFBFFFF;
        }

        {
            u32 masked_flags;
            masked_flags = ((S_80152DA8_2 *)state)->unk_1C.u & 0xF7FFFFFF;
            ((S_80152DA8_2 *)state)->unk_1C.u = masked_flags;
        ...
        if (!(((S_80152DA8_1 *)arg2)->unk_14 & 0x40)) {
            if (((S_80152DA8_1 *)arg2)->unk_2C == D_801560E0) {
                if (((S_80152DA8_1 *)arg2)->unk_04.u16 == 0x100) {
                    (*(u16 *)((u8 *)arg0 + 0x9E)) = 0;
                }
                ...
                (*(s32 *)((u8 *)arg0 + 0xA0)) = func_800644B8(call_arg) << 7;
                if (((S_80152DA8_1 *)arg2)->unk_04.u16 == 0x103) {
                    (*(u8 * *)((u8 *)arg2 + 0x2C)) = D_801560E0;
                    tail_index = D_80083228;
                    tail_state = ((S_80152DA8_2 *)state)->unk_2A;
                    tail_arg = arg2;
                    tail_index = ((tail_index + tail_state + 0x100) >> 9) & 7;
                    tail_value = &D_801560E0[tail_index];
play_tail_value_1:
    ...
    ((S_80152DA8_1 *)arg2)->unk_14 = (part_flags & 0x800)
        ? (part_flags & 0x8FFF)
        : (part_flags | 0x7000);
    ((S_80152DA8_2 *)state)->unk_1C.u &= 0xF7FFFFFF;
    if (!(((S_80152DA8_2 *)state)->unk_1C.u & 0x40000)) {
reset_offset:
        ...
        if (!((*(u16 *)((u8 *)arg0 + 0x98)) & 8)) {
            ground = func_800BCB04(((S_80152DA8_0 *)arg1)->unk_00.at02.v,
                ((S_80152DA8_0 *)arg1)->unk_04.at02.v,
                (s16)(((S_80152DA8_2 *)state)->unk_88 - 0x20));
            delta = ground - ((S_80152DA8_2 *)state)->unk_88;
            if (delta < (*(s16 *)((u8 *)arg0 + 0x92))) {
                (*(s16 *)((u8 *)arg0 + 0x92)) = delta;
                (*(u8 *)((u8 *)arg0 + 0x9D)) = 0;
                ((S_80152DA8_0 *)arg1)->unk_14 = 0;
                ((S_80152DA8_2 *)state)->unk_1C.u |= 0x08000000;
                func_80153408();
            }
        }
        goto final_adjustment;
...
final_adjustment:
    flags = ((S_80152DA8_2 *)state)->unk_1C.u;
    if (flags & 0x40000000) {
        ((S_80152DA8_2 *)state)->unk_1C.u = flags & 0xBFFFFFFF;
        ground = func_800BCB04(
            (((S_80152DA8_1 *)arg2)->unk_24 << 6) | 0x20,
            (((S_80152DA8_1 *)arg2)->unk_25 << 6) | 0x20,
            (s16)(((S_80152DA8_2 *)state)->unk_88 - 0x20));
        if (ground < 0x200) {
            (*(s16 *)((u8 *)arg0 + 0x92)) =
                (((S_80152DA8_2 *)state)->unk_88 - ground) +
                (*(u16 *)((u8 *)arg0 + 0x92));
            ((S_80152DA8_2 *)state)->unk_88 = ground;
        }
    }

    ((S_80152DA8_0 *)arg1)->unk_0A = ((S_80152DA8_2 *)state)->unk_88 +
        (*(u16 *)((u8 *)arg0 + 0x92)) - (*(u16 *)((u8 *)arg0 + 0xA2));
    ((S_80152DA8_1 *)arg2)->unk_14 |= 0x40;
}
