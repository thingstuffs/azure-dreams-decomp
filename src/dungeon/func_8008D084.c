...
state_zero:
        if (((S_800927E4_0 *)arg0)->unk_9A == 0x2C) {
            ...
            ASM_TAILSLOT_PIN_TIED(tailValue);   /* UNRESOLVED C shape (pin): removing it changes a delay-slot fill; the source shape that makes it unnecessary has not been found */
            func_80092AFC();
            return;
        }
