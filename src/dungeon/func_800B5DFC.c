...
void func_800BB55C(void *arg0, void *arg1, s32 arg2) {
    ...
    var_s3 = 0;
    do {
        temp_s0_2 = (s16)var_s5;
        sp28[0] = (func_80064584(temp_s0_2) >> 7) + 0x362;
        sp28[1] = (func_800644B8(temp_s0_2) >> 7) + 0x122;
        temp_s0_2 += 0x999;
        sp30[0] = (func_80064584(temp_s0_2) >> 7) + 0x362;
        temp_v0 = (func_800644B8(temp_s0_2) >> 7) + 0x122;
        sp30[1] = temp_v0;
        temp_v0_2 = func_800A07D0(sp28[0], sp28[1], sp30[0], temp_v0);
        sp30[0] = (u16) sp28[0] + ((s32) (func_80064584(temp_v0_2) * ((DungeonWork *)arg0)->field_30[var_s3]) >> 0xB);
        sp30[1] = (u16) sp28[1] + ((s32) (func_800644B8(temp_v0_2) * ((DungeonWork *)arg0)->field_30[var_s3]) >> 0xB);
        ((DungeonWork *)arg0)->field_3C[var_s3] = var_s5;
        var_s3 += 1;
        var_s5 += 0x999;
    ...
    var_s3_2 = arg0;
    do {
        temp_s0_3 = (s16)var_s5;
        sp28[0] = (func_80064584((s16) temp_s0_3) >> 7) + 0x362;
        sp28[1] = (func_800644B8((s16) temp_s0_3) >> 7) + 0x122;
        var_s2_angle = var_s5;
        var_s0_2 = var_s2_angle + 0x19;
        var_s1 = 0;
        if (var_s3_2->field_30[0] > 0) {
            do {
                var_s2_angle = var_s0_2;
                sp30[0] = (func_80064584((s16)var_s0_2) >> 7) + 0x362;
                sp30[1] = (func_800644B8((s16)var_s0_2) >> 7) + 0x122;
                func_800BB2E4(sp28, sp30, sp20, 0, NULL);
                sp28[0] = (u16) sp30[0];
                sp28[1] = (u16) sp30[1];
                var_s1 += 1;
                var_s0_2 = var_s2_angle + 0x19;
            } while (var_s1 < var_s3_2->field_30[0]);
        }
    ...
    if (M2C_FIELD(arg0, s16 *, 0x4A) != 0) {
        ...
        if (M2C_FIELD(arg0, s16 *, 0x4A) == 1) {
            ...
            temp_v1_4 = M2C_FIELD(arg0, u16 *, 0x64) - 1;
            M2C_FIELD(arg0, u16 *, 0x64) = temp_v1_4;
