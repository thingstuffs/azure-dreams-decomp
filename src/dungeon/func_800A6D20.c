...
s32 func_800AC480(S_800AC480_0 *arg0, Rec_D_800E3D7C *arg1, S_800AC480_1 *arg2, S_800AC480_3 *arg3) {
    s32 calc;
    s32 field;
    s32 *global_base;
    s32 step;
    ...
    if (temp_a1 != 0) {
        calc = arg2->unk_24 << 6;
        field = arg1->unk_00.at02_s16.v;
        field -= 0x20;
        calc -= field;
        step = (calc << 0x10) / temp_a1;
        field = arg1->unk_04.at02_s16.v;
        arg1->unk_0C.as_s32 = step;
        calc = arg2->unk_25 << 6;
        field -= 0x20;
        calc -= field;
        arg1->unk_10.at00_s32.v = (calc << 0x10) / (s16) arg0->unk_96;
    }
