...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            pinned_value = 1;
            ((S_8016A89C_6 *)entry)->unk_02 = (s16)pinned_value;
            item_index = 0;
            outer_base = outer;
            ...
            do {
                ...
                item_index++;
                {
                    ...
                    ((S_8016A89C_6 *)entry)->unk_06 = (s16)pinned_value;
                    func_800478E8(call_part, call_data, call_one);
                }
                pinned_value = (uptr)stack.root;
                new_link = (u8 *)pinned_value + 0x1E;
                more_items = item_index < ((S_8016A89C_6 *)entry)->unk_02;
        ...
        outer = (u8 *)outer + 4;
        {
            ...
            more_children = (s32)pinned_value < child_count;
            if (!more_children) {
                break;
            }
        }
