...
typedef struct S_8016A89C_0 {
    u8 pad_00[0x10];
    void * unk_10;
} S_8016A89C_0;   /* init_root in func_8016A89C */

typedef struct S_8016A89C_1 {
    u8 pad_00[0x13];
    u8 unk_13;
    s32 unk_14;
    u8 pad_18[0x4];
    ...
    u8 pad_20[0xA];
    s16 unk_2A;
} S_8016A89C_1;   /* object in func_8016A89C */

typedef struct S_8016A89C_2 {
    u8 pad_00[0x8];
    union { struct { void * v; } at00; struct { u8 pad[0x2]; s16 v; } at02; } unk_08;   /* overlapping accesses */
    void * unk_0C;
} S_8016A89C_2;   /* (void *)temp_t0 in func_8016A89C */

typedef struct S_8016A89C_3 {
    u8 pad_00[0x24];
    s8 unk_24;
    s8 unk_25;
    u8 pad_26[0x2];
    s32 unk_28;
    void * unk_2C;
} S_8016A89C_3;   /* part in func_8016A89C */

typedef struct S_8016A89C_4 {
    u8 pad_00[0x8C];
    void * unk_8C;
    u8 pad_90[0x2];
    s16 unk_92;
    ...
    u8 pad_A0[0x8];
    s16 unk_A8;
} S_8016A89C_4;   /* stable_object in func_8016A89C */

typedef struct S_8016A89C_5 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8016A89C_5;   /* outer in func_8016A89C */

typedef struct S_8016A89C_6 {
    u8 pad_00[0x2];
    s16 unk_02;
    u16 unk_04;
    s16 unk_06;
    u8 pad_08[0x90];
    void * unk_98;
} S_8016A89C_6;   /* entry in func_8016A89C */

typedef struct S_8016A89C_7 {
    u8 pad_00[0xC];
    s32 unk_0C;
    s16 unk_10;
    u8 pad_12[0x16];
    s32 unk_28;
} S_8016A89C_7;   /* item in func_8016A89C */

typedef struct S_8016A89C_8 {
    u8 pad_00[0xA4];
    void * unk_A4;
} S_8016A89C_8;   /* outer_base in func_8016A89C */

typedef struct S_8016A89C_9 {
    u8 pad_00[0x10];
    void * unk_10;
} S_8016A89C_9;   /* outer_child in func_8016A89C */
...
extern u8 D_8016ABB8[];
extern u8 D_8016B3A8[];
extern u8 D_8016E494[];
extern u8 D_8016E4FC[];

void *func_8016A89C(s32 arg0, s32 arg1, s32 arg2, s32 arg3)
{
    struct {
        void *root;
        void *copy;
    ...
    register s32 saved_arg3 ASM_REG("$17");   /* UNRESOLVED C shape (pin): removing it reorders the instructions (same instructions, different order); the source shape that makes it unnecessary has not been found */
    register s32 saved_arg2 ASM_REG("$18");   /* UNRESOLVED C shape (pin): removing it changes the address form (%hi/%lo vs base+offset); the source shape that makes it unnecessary has not been found */
    ...
    void *allocated;
    register uptr temp_t0 ASM_REG("$8");   /* UNRESOLVED C shape (pin): removing it rematerialises a constant retail keeps in a register; the source shape that makes it unnecessary has not been found */
...

    {
        ...
        init_root = allocated;
        setup = &D_80045340;
        ((S_8016A89C_0 *)init_root)->unk_10 = D_8016ABB8;
        ((S_8016A89C_1 *)object)->unk_13 = 17;
...

    {
        ...
        part_callback = D_8016E494;
        temp_t0 = (uptr)((S_8016A89C_2 *)((void *)temp_t0))->unk_08.at00.v;
        stack.copy = (void *)temp_t0;
        ((S_8016A89C_2 *)((void *)temp_t0))->unk_08.at02.v = saved_arg3;
        temp_t0 = (uptr)stack.root;
        stable_object = object;
        part = ((S_8016A89C_2 *)((void *)temp_t0))->unk_0C;
        ((S_8016A89C_3 *)part)->unk_2C = part_callback;
    }
    ((S_8016A89C_3 *)part)->unk_24 = (s8)(s32)outer;
    ((S_8016A89C_3 *)part)->unk_25 = saved_arg2;

    {
        register s32 flags0 ASM_REG("$2");   /* UNRESOLVED C shape (pin): removing it changes the whole function shape; the source shape that makes it unnecessary has not been found */
        s32 flags1;

        if ((saved_kind & 3) == 1) {
            flags0 = ((S_8016A89C_1 *)object)->unk_14 | 0x6000;
            flags1 = ((S_8016A89C_1 *)object)->unk_1C | 0x6000;
            goto store_flags;
        }
        if ((saved_kind & 3) >= 2) {
            flags0 = ((S_8016A89C_1 *)object)->unk_14 | 0x2000;
            flags1 = ((S_8016A89C_1 *)object)->unk_1C | 0x2000;
            goto store_flags;
        }
        goto update_kind;

store_flags:
        ((S_8016A89C_1 *)object)->unk_14 = flags0;
        ((S_8016A89C_1 *)object)->unk_1C = flags1;
        goto flags_done;

update_kind:
        flags0 = (saved_kind & -4) << 16;
        if (flags0 == 0) {
            if ((((S_8016A89C_1 *)object)->unk_14 & 0x200) == 0) {
                if (func_800A6D30() & 1) {
                    ((S_8016A89C_1 *)object)->unk_1C |= 0x200;
                    func_800A48F0(object, 1,
                        (func_800A6D30() & 0x3F) | 0x20);
                    ((S_8016A89C_3 *)part)->unk_2C = D_8016E4FC;
                }
            }
        }
...
flags_done:
    ...
    outer = stable_object;
    stack.outer_index = 0;
    ((S_8016A89C_4 *)stable_object)->unk_9A = 0xFF;
    ((S_8016A89C_4 *)stable_object)->unk_9C = -1;
    ((S_8016A89C_4 *)stable_object)->unk_8C = D_8016B3A8;
    ((S_8016A89C_1 *)object)->unk_1C |= 0x40000;
    ((S_8016A89C_4 *)stable_object)->unk_92 = -48;
    ((S_8016A89C_4 *)stable_object)->unk_A8 = 0;
    ((S_8016A89C_4 *)stable_object)->unk_9E = 1;
    ((S_8016A89C_4 *)stable_object)->unk_98 |= 0x4000;
    ...
    do {
        ...
        allocated = child;
        ((S_8016A89C_5 *)outer)->unk_A4 = allocated;
        if (allocated != 0) {
            ...
            temp_t0 = 1;
            ((S_8016A89C_6 *)entry)->unk_02 = (s16)temp_t0;
            inner_index = 0;
            outer_base = outer;
            ...
            do {
                ...
                ((S_8016A89C_6 *)entry)->unk_04 |= 0x8000;
                part_value = ((S_8016A89C_3 *)part)->unk_28;
                ((S_8016A89C_7 *)item)->unk_10 = 0x20;
                ((S_8016A89C_7 *)item)->unk_0C = color;
                ((S_8016A89C_7 *)item)->unk_28 = part_value;
                outer_child = ((S_8016A89C_8 *)outer_base)->unk_A4;
                ...
                ((S_8016A89C_9 *)outer_child)->unk_10 = (void *)temp_t0;
                (*(void * *)((u8 *)item + 0x2C)) = table;
                table_index = ((D_80083228 +
                    ((S_8016A89C_1 *)object)->unk_2A + 0x100) >> 9) & 7;
                entry_offset += 0x30;
                func_80047784(item,
                ...
                inner_index++;
                {
                    ...
                    ((S_8016A89C_6 *)entry)->unk_06 = (s16)temp_t0;
                    func_800478E8(call_part, call_data, call_one);
                }
                temp_t0 = (uptr)stack.root;
                new_link = (u8 *)temp_t0 + 0x1E;
                inner_more = inner_index < ((S_8016A89C_6 *)entry)->unk_02;
                ((S_8016A89C_6 *)entry)->unk_98 = new_link;
            } while (inner_more);
        }
        outer = (u8 *)outer + 4;
        {
            s32 outer_limit;
            register s32 outer_more ASM_REG("$2");   /* UNRESOLVED C shape (pin): removing it changes the whole function shape; the source shape that makes it unnecessary has not been found */

            temp_t0 = (uptr)stack.outer_index;
            outer_limit = ((S_8016A89C_4 *)stable_object)->unk_9E;
            temp_t0++;
