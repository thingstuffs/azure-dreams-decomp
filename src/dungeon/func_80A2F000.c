...
void *BODY_NAME(s16 arg0, s8 arg1, s8 arg2, s16 arg3)
{
    ...
    if (obj != 0) {
        work = (u8 *)obj + 0x20;
        ((S_80A2F000_0 *)obj)->unk_10 = D_8015EA58;
        work->unk_13 = 5;
        func_8004491C(obj, &D_80045340);

        part_a = ((S_80A2F000_0 *)obj)->unk_08;
        part_a->unk_0A = saved_arg3;
        part_b = ((S_80A2F000_0 *)obj)->unk_0C;
        kind = arg0 & 3;
        part_b->unk_25 = saved_arg2;
        actor = work;
        part_b->unk_2C = D_80162820;
