...
typedef struct S_8017139C_1 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_8017139C_1;   /* arg2 in func_8017139C */
...
void func_8017139C(void *arg0, void *arg1, void *arg2, void *arg3)
{
    ...
    x = ((S_8017139C_1 *)arg2)->unk_24;
    y = ((S_8017139C_1 *)arg2)->unk_25;
    move_flags = 0x3000;
    ...
    ((S_8017139C_1 *)arg2)->unk_24 =
        ((S_8017139C_3 *)((u8 *)state + ((S_8017139C_0 *)state)->unk_8A.s))->unk_74;
    move_flags = 0x3000;
    ((S_8017139C_1 *)arg2)->unk_25 =
        ((S_8017139C_3 *)((u8 *)state + ((S_8017139C_0 *)state)->unk_8A.s))->unk_7C;
    ((S_8017139C_0 *)state)->unk_8A.u++;

    {
        s32 next_x = ((S_8017139C_1 *)arg2)->unk_24;
        s32 next_y = ((S_8017139C_1 *)arg2)->unk_25;
    ...
    if (result == 3) {
        if (!(D_80083462 & 0x80) && !(((S_8017139C_1 *)arg2)->unk_14 & 0x8000)) {
