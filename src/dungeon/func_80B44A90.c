...
state_0:
    if (((Rec_D_80082E80 *)arg2)->unk_14.at00_u16.v & 0x6000) {
        ...
        func_80047784(
            arg2,
            D_80175A6C[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
...
state_1:
    ...
    if (temp_a0 != 0) {
        ...
        ((S_80172290_0 *)arg0)->unk_A0 += ((Rec_D_800E3D7C *)arg1)->unk_14.as_s32;
...
state_2:
    if (((Rec_D_800E3D7C *)arg3)->unk_1C.as_u32 & 0x08000000) {
        ...
        func_80047784(
            arg2,
            D_80175A74[((D_80083228 + ((Rec_D_800E3D7C *)arg3)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        ((S_80172290_0 *)arg0)->unk_9B++;
    }
