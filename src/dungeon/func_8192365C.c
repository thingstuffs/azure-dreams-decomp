...
void func_80024E5C(void *arg0, void *arg1, void *arg2) {
    ...
    initial_state = ((S_80024E5C_0 *)arg0)->unk_58.s;
    D_80025B60 = 1;
    if (initial_state < 3U) {
    ...
    if (((S_80024E5C_0 *)arg0)->unk_58.u == 0) {
        temp_v0_2 = ((S_80024E5C_0 *)arg0)->unk_5A.s;
        ((S_80024E5C_0 *)arg0)->unk_5A.s = (u16) (temp_v0_2 + 1);
        if ((s16) temp_v0_2 >= 6) {
            effect_id = D_80025B38[0];
            ((S_80024E5C_1 *)arg2)->unk_2C = D_80025B38;
            func_80047784(arg2, effect_id, 0);
            ((S_80024E5C_0 *)arg0)->unk_5A.s = 0U;
            ((S_80024E5C_0 *)arg0)->unk_58.s = (u16) (((S_80024E5C_0 *)arg0)->unk_58.s + 1);
            ((S_80024E5C_2 *)arg1)->unk_08.at02.v = (u16) (((S_80024E5C_2 *)arg1)->unk_08.at02.v - 0x5A);
        }
    }
    var_s0 = ((S_80024E5C_0 *)arg0)->unk_58.u;
    if (var_s0 == 1) {
        if ((func_800A4778(((S_80024E5C_2 *)arg1)->unk_00.at02.v, ((S_80024E5C_2 *)arg1)->unk_04.at02.v, (s16) ((S_80024E5C_2 *)arg1)->unk_08.at02.v, ((S_80024E5C_0 *)arg0)->unk_88) << 0x10) == 0) {
            if (((S_80024E5C_0 *)arg0)->unk_60 != 0) {
                ...
                if (((S_80024E5C_0 *)arg0)->unk_5A.u == 0) {
                    ...
                    ((S_80024E5C_0 *)arg0)->unk_5A.s = (u16) (((s32) (var_v0_2 << 0x10) >> 0xF) + 0xB);
                }
                var_v0 = D_800DDC40;
                temp_a0 = (s16) ((S_80024E5C_0 *)arg0)->unk_5A.s;
                ...
                if (var_v0_3 == 0) {
                    ...
                    ((S_80024E5C_2 *)arg1)->unk_10 = (s32) ((s32) (temp_a1_2 - ((S_80024E5C_2 *)arg1)->unk_04.at00.v) / (s32) ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s - 0xB));
                    ASM_SCHED_BARRIER();   /* MATCH pin: load-bearing for the whole function shape */
                    temp_v1_2 = ((S_80024E5C_2 *)arg1)->unk_08.at00.v;
                    temp_v0_3 = ((S_80024E5C_0 *)arg0)->unk_5A.u;
                ...
                if (temp_a0 >= 0xB) {
                    ...
                    ((S_80024E5C_2 *)arg1)->unk_10 = (s32) ((s32) (temp_a1_2 - ((S_80024E5C_2 *)arg1)->unk_04.at00.v) / (s32) ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s - 9));
                    ASM_SCHED_BARRIER();   /* MATCH pin: load-bearing for the whole function shape */
                    temp_v1_2 = ((S_80024E5C_2 *)arg1)->unk_08.at00.v;
                    temp_v0_3 = ((S_80024E5C_0 *)arg0)->unk_5A.u;
                    temp_v1_2 = temp_a2 - temp_v1_2;
                ...
                if (temp_a0 >= 5) {
                    ...
                    ((S_80024E5C_2 *)arg1)->unk_10 = (s32) ((s32) (temp_a1_2 - ((S_80024E5C_2 *)arg1)->unk_04.at00.v) / (s32) ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s - 4));
                    ((S_80024E5C_2 *)arg1)->unk_14 = (s32) ((s32) (temp_a2 - ((S_80024E5C_2 *)arg1)->unk_08.at00.v) / (s32) ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s - 4));
                ...
                ((S_80024E5C_2 *)arg1)->unk_10 = (s32) ((s32) (temp_a1_2 - ((S_80024E5C_2 *)arg1)->unk_04.at00.v) / (s16) ((S_80024E5C_0 *)arg0)->unk_5A.s);
                ((S_80024E5C_2 *)arg1)->unk_14 = (s32) ((s32) (temp_a2 - ((S_80024E5C_2 *)arg1)->unk_08.at00.v) / (s16) ((S_80024E5C_0 *)arg0)->unk_5A.s);
                ...
                temp_v0_4 = ((S_80024E5C_0 *)arg0)->unk_5A.s - 1;
                ((S_80024E5C_0 *)arg0)->unk_5A.s = temp_v0_4;
                if ((temp_v0_4 << 0x10) == 0) {
                    ((S_80024E5C_0 *)arg0)->unk_58.s = 2U;
            ...
            ((S_80024E5C_0 *)arg0)->unk_5A.s = 0xAU;
...
block_38:
                if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s >= 5) {
                    var_s0_2 = 0;
                    do {
...
block_41:
    temp_v1_3 = (s16) ((S_80024E5C_0 *)arg0)->unk_58.s;
    if (temp_v1_3 == 2) {
        temp_v0_6 = ((S_80024E5C_0 *)arg0)->unk_5A.s + 1;
        ((S_80024E5C_0 *)arg0)->unk_5A.s = temp_v0_6;
        if ((s16) temp_v0_6 == temp_v1_3) {
            func_80024AEC(arg0, arg1, arg2);
            func_800A56E0(0x300);
        }
        if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s >= 0xA) {
        ...
        if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s >= 0x1E) {
            ((S_80024E5C_0 *)arg0)->unk_56 = (u16) (((S_80024E5C_0 *)arg0)->unk_56 + 3);
            func_800247B8(arg0, arg1, arg2);
            if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s >= 0x28) {
                func_800247B8(arg0, arg1, arg2);
            }
            if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s >= 0x2D) {
                func_800247B8(arg0, arg1, arg2);
            }
        }
        if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s >= 0x32) {
            ((S_80024E5C_0 *)arg0)->unk_58.s = 3U;
            ((S_80024E5C_0 *)arg0)->unk_5A.s = 0U;
            ((S_80024E5C_1 *)arg2)->unk_14 = (u16) (((S_80024E5C_1 *)arg2)->unk_14 | 0x80);
        }
    }
    if ((s16) ((S_80024E5C_0 *)arg0)->unk_58.s == 3) {
        temp_v0_9 = ((S_80024E5C_0 *)arg0)->unk_5A.s + 1;
        ((S_80024E5C_0 *)arg0)->unk_5A.s = temp_v0_9;
        ...
        if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s == 0x10) {
            var_s0_4 = 0;
            do {
                func_800247B8(arg0, arg1, arg2);
        ...
        var_s0_5 = 0;
        if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s == 0x11) {
            do {
                func_800247B8(arg0, arg1, arg2);
        ...
        var_s0_6 = 0;
        if ((s16) ((S_80024E5C_0 *)arg0)->unk_5A.s == 0x12) {
            do {
                func_800247B8(arg0, arg1, arg2);
        ...
        temp_v0_14 = (s16) ((S_80024E5C_0 *)arg0)->unk_5A.s;
        var_s0 = 1;
        if (temp_v0_14 == 1) {
            func_800D4AB0(arg0, arg1, arg2);
            temp_v0_14 = ((S_80024E5C_0 *)arg0)->unk_5A.u;
        }
        if (temp_v0_14 >= 0x1B) {
            goto destroy;
        }
