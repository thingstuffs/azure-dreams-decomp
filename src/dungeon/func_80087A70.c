...
s32 func_8008D1D0(void *arg0, s32 arg1, void *arg2, void *arg3) {
    ...
    if (D_80083460.field_C == arg3 && D_80083460.field_A == 0 && !(D_80083460.field_2 & 8)) {
        ...
        *(s32 *)((char *)arg0 + 0x8C) = 0;
        func_800C77D0((char *)arg0 - 0x20, arg1, 8, 0x300);
        if (!(*(s32 *)((char *)arg3 + 0x1C) & 0x100000)) {
            *(u8 **)((char *)arg2 + 0x2C) = D_800DD0F8;
            func_80048A44(arg2, D_800DD0F8[((D_80083228 + *(s16 *)((char *)arg3 + 0x2A) + 0x100) >> 9) & 7], 1, 1);
        }
        func_800A56E0(0x201);
        if (!(D_80013714 & 2)) {
            D_80080AA0 = 1;
