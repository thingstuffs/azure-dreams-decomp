...
typedef struct S_80173B08_3 {
    ...
    u8 pad_26[0x6];
    u8 * unk_2C;
} S_80173B08_3;   /* arg2 in func_80173B08 */

typedef struct S_80173B08_4 {
    u8 pad_00[0x2];
    u16 unk_02;
    u8 pad_04[0x2];
    u16 unk_06;
    ...
    s32 unk_10;
    s32 unk_14;
} S_80173B08_4;   /* arg1 in func_80173B08 */
...
copy_active_coords:
            ...
            active = func_800A05A4(
                arg3, ((S_80173B08_3 *)arg2)->unk_24, ((S_80173B08_3 *)arg2)->unk_25,
...
empty_selection:
    ((S_80173B08_4 *)arg1)->unk_14 = 0;
    ((S_80173B08_4 *)arg1)->unk_10 = 0;
    ((S_80173B08_4 *)arg1)->unk_0C = 0;
    func_800A2B04(arg1, ((S_80173B08_3 *)arg2)->unk_24, ((S_80173B08_3 *)arg2)->unk_25);
    D_8008346C = 0;
...
state_1:
    if (func_8003F270()) {
        ((S_80173B08_3 *)arg2)->unk_14 |= 0x800;
        goto end;
    }
    ((S_80173B08_3 *)arg2)->unk_14 &= 0xF7FF;
    ((S_80173B08_0 *)arg0)->unk_9B++;
    func_800A56E0(0x703);
...
state_2:
    ...
    ((S_80173B08_4 *)arg1)->unk_10 = 0;
    ((S_80173B08_4 *)arg1)->unk_0C = 0;
    ((S_80173B08_3 *)arg2)->unk_10 = 0x20;
    ((S_80173B08_3 *)arg2)->unk_14 |= 0xC;

state_3:
    if (((S_80173B08_3 *)arg2)->unk_14 & 0x8000) {
        ((S_80173B08_0 *)arg0)->unk_9B = 7;
        ((S_80173B08_3 *)arg2)->unk_14 |= 0x6000;
    ...
    }
    {
        ...
        floor = func_800BCB04(((S_80173B08_4 *)arg1)->unk_02,
                              ((S_80173B08_4 *)arg1)->unk_06,
...
state_4:
    {
        ...
        if (timer < 12 && !(((S_80173B08_3 *)arg2)->unk_14 & 0xE000)) {
            goto end;
        }
    }
    ((S_80173B08_0 *)arg0)->unk_98 |= 0x80;
...
state_5:
    ...
    }
    {
        ...
        if (timer > 0 && !(((S_80173B08_3 *)arg2)->unk_14 & 0xE000)) {
            goto end;
        }
    }
    table = D_800E2388;
...
update_table:
    {
        ((S_80173B08_3 *)arg2)->unk_2C = table;
...
state_7:
    if (!(((S_80173B08_3 *)arg2)->unk_14 & 0xE000)) {
        goto end;
    }
    ((S_80173B08_4 *)arg1)->unk_14 = 0;
    ((S_80173B08_4 *)arg1)->unk_10 = 0;
    ((S_80173B08_4 *)arg1)->unk_0C = 0;
    func_800A2B04(arg1, ((S_80173B08_3 *)arg2)->unk_24, ((S_80173B08_3 *)arg2)->unk_25);
    if (((S_80173B08_3 *)arg2)->unk_2C != D_800E2348) {
        ...
        ((S_80173B08_3 *)arg2)->unk_14 &= 0xFFF3;
    }
    {
        u8 *global;
