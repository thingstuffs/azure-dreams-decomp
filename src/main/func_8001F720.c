...
void func_8001F720(void *object) {
    ...
    register s32 *component_cursor ASM_REG("$16");   /* UNRESOLVED C shape (pin): removing it moves a statement across a call/branch; the source shape that makes it unnecessary has not been found */
    s32 component_count;
    s32 component;
    u16 object_flags;
    s32 global_flags;
