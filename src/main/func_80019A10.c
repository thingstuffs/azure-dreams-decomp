...
void func_80019A10(void) {
    s32 t;
    func_8007CA38();
    t = func_8007C998(0xF4000001, 4, 0x2000, 0);
    *(s32 *)0x80409270 = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xB4); func_8007BEF0(1); }
    t = func_8007C998(0xF4000001, 0x8000, 0x2000, 0);
    *(s32 *)0x80409274 = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xB6); func_8007BEF0(1); }
    t = func_8007C998(0xF4000001, 0x100, 0x2000, 0);
    *(s32 *)0x80409278 = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xB8); func_8007BEF0(1); }
    t = func_8007C998(0xF4000001, 0x2000, 0x2000, 0);
    *(s32 *)0x8040927C = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xBA); func_8007BEF0(1); }
    t = func_8007C998(0xF0000011, 4, 0x1000, D_804009C0);
    *(s32 *)0x80409280 = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xBD); func_8007BEF0(1); }
    t = func_8007C998(0xF0000011, 0x8000, 0x1000, D_804009D4);
    *(s32 *)0x80409284 = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xBF); func_8007BEF0(1); }
    t = func_8007C998(0xF0000011, 0x100, 0x1000, D_804009E8);
    *(s32 *)0x80409288 = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xC1); func_8007BEF0(1); }
    t = func_8007C998(0xF0000011, 0x2000, 0x1000, D_804009FC);
    *(s32 *)0x8040928C = t;
    if (t == -1) { func_8007C040(D_80400004, D_8040002C, 0xC3); func_8007BEF0(1); }
    func_8007CA48();
