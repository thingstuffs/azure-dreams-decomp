...
void func_80020458(S_80020458_2 *owner) {
    register S_80020458_0 *firstChild ASM_REG("$6");   /* MATCH pin: retail register colouring depends on it */
    register S_80020458_1 *secondChild ASM_REG("$6");   /* MATCH pin: retail register colouring depends on it */
