...
void func_80123604(void) {
    {
        ...
        TIE_LOCAL(default_first);
        TIE_LOCAL(default_second);
#ifdef NON_MATCHING
    ...
    {
        register u8 *source_table ASM_REG("$5");   /* MATCH pin: retail register colouring depends on it */
        register u8 *object_table ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
