...
void func_800AF674(S_800AF674_0 *state) {
    ...
    entry_index = ((S_800AF674_2 *)(((S_800AF674_1 *)state)->unk_00))->unk_10 * 0xA;
next_entry:
    if (entry_index < ((S_800AF674_2 *)(((S_800AF674_1 *)state)->unk_00))->unk_1C) {
        entry_value = ((S_800AF674_2 *)(((S_800AF674_1 *)state)->unk_00))->unk_20[entry_index];
