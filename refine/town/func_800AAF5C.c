...
void func_800A86BC(void *effect, S_800A86BC_0 *motion, S_800A86BC_2 *primitive) {
    u8 shade;
    u16 ticks_left;
    ...
    shade = primitive->unk_0C;
    if (shade != 0) {
        shade -= 0x10;
        primitive->unk_0C = shade;
        primitive->unk_0E = shade;
        primitive->unk_0D = shade;
    }
