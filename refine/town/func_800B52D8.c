...
void func_800B2A38(S_800B52D8 *source, void *unused) {
    register S_800B52D8 *table ASM_REG("$9");   /* MATCH pin: load-bearing for the whole function shape */
    u32 values[64];
    UA32 *item;
    UA32 *value_write;
    UA32 *value_read;
    ...
    s32 *zero_write;
    s32 read_index;
    register s32 write_index ASM_REG("$7");   /* MATCH pin: retail register colouring depends on it */
