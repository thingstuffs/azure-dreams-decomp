...
void func_8009F4C0(S_8009F4C0_0 *entity, M2C_UNK unused_arg1, M2C_UNK unused_arg2, M2C_UNK context) {
    void *stored_entry;
    s32 unused_value;
    s32 record_offset;
    s32 record_value;
    ...
    register void *data_base ASM_REG("$6");   /* MATCH pin: load-bearing for the whole function shape */
