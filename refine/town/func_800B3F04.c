...
typedef struct S_800B1664_0 {
    u8 pad_00[0xC0];
    void * unk_C0;
} S_800B1664_0;   /* arg0 in func_800B1664 */
...
typedef struct S_800B1664_3 {
    u8 pad_00[0xC0];
    void * unk_C0;
} S_800B1664_3;   /* arg0 in func_800B1664 */

typedef struct S_800B1664_4 {
    u8 pad_00[0x6];
    u16 unk_06;
} S_800B1664_4;   /* ((S_800B1664_3 *)arg0)->unk_C0 in func_800B1664 */
...
void func_800B1664(void *object) {
    ...
    decay_state = ((S_800B1664_0 *)object)->unk_C0;
    ...
    counter_state = ((S_800B1664_0 *)object)->unk_C0;
    counter_state->unk_04 = (u16) (counter_state->unk_04 - 0x100);
    if ((s16) ((S_800B1664_4 *)(((S_800B1664_3 *)object)->unk_C0))->unk_06 < 0x11) {
