...
void func_80125FB8(S_80125FB8_0 *state)
{
    ...
    state_index = (s16)(state->unk_04 - 8);
...
case_0:
    ...
    do {
        ...
        ASM_KEEP(initial_data);   /* MATCH pin: retail delay-slot fill depends on it */
        object_index += 1;
...
case_123:
    ...
    do {
        ...
        ASM_KEEP(data_value);   /* MATCH pin: retail schedule: same instructions, different order without it */
        object_index += 1;
