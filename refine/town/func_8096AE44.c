...
void func_801232DC(void)
{
    ...
    s32 column;
    s32 object_offset;
    register s32 initial_index ASM_REG("$7");   /* MATCH pin: retail callee-saved set / frame layout depends on it */
    s32 group_index;
    register s32 entry_index ASM_REG("$7");   /* MATCH pin: retail callee-saved set / frame layout depends on it */
    s32 display_index;
    s32 final_width;
