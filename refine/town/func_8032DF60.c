...
s32 func_80018760(void) {
    register void *context ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
    register void *costProvider ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
