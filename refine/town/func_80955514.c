...
void func_80022514(void *effect) {
    ...
    s32 color_step;
    s32 frames_left;
    register s32 phase_value ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
...
mode_one:
{
    ...
    {
        register s32 next_phase ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
