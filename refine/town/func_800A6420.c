...
s32 func_800A3B80(S_800A3B80_3 *object, s32 unused, void *context)
{
    ...
    s32 coord_x;
    s32 coord_value;
    register s32 angle_or_coord ASM_REG("$16");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    ...
    ASM_KEEP(angle_or_coord);   /* MATCH pin: retail register colouring depends on it */
