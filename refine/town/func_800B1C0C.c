...
void func_800AF36C(S_800AF36C_0 *object) {
    s32 digit;
    s32 row;
    S_800AF36C_2 *x_parts;
    S_800AF36C_3 *y_parts;

    digit = ((S_800AF36C_4 *)(((S_800AF36C_1 *)object)->unk_00))->unk_18 % 10;
    row = digit / 5;
    ((S_800AF36C_15 *)(((S_800AF36C_10 *)(((S_800AF36C_5 *)(((S_800AF36C_1 *)object)->unk_A8))->unk_10))->unk_04))->unk_08 = (s16) ((row << 7) - 0x38);
    ((S_800AF36C_15 *)(((S_800AF36C_10 *)(((S_800AF36C_5 *)(((S_800AF36C_1 *)object)->unk_A8))->unk_10))->unk_04))->unk_0A = (s16) (((digit - (row * 5)) << 4) + 8);
    x_parts = object->unk_A8;
    ((S_800AF36C_11 *)(((S_800AF36C_6 *)(x_parts->unk_14))->unk_04))->unk_08 = (s16) (((S_800AF36C_12 *)(((S_800AF36C_7 *)(x_parts->unk_10))->unk_04))->unk_08 + 0x38);
    y_parts = object->unk_A8;
