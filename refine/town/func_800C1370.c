...
/* Creates an object and initializes its motion, callback, and display properties. */
s32 func_800BEAD0(void)
{
    ...
    if (object != NULL) {
        ...
        ASM_KEEP(object_part);   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
