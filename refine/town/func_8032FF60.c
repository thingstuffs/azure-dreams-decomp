...
void func_8001A760(s32 unused, s32 x_offset, s32 y_offset) {
    ...
    S_8001A760_2 *x_dest;
    S_8001A760_3 *y_dest;
    register s32 scaled_offset ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    register s32 tile_coord ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
