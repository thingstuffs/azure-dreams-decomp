...
s32 func_8002263C(Actor *actor, s16 *zone_id, s32 *offset_x, s32 *offset_y) {
    register Box *box ASM_REG("$8");
    register s32 neighbor ASM_REG("$3");
    s32 candidate;
    s32 box_id;
    register s32 old_zone ASM_REG("$8");
    s32 abs_dx;
    s32 abs_dy;
    s32 velocity;
    s32 zone_kind;
...
check_zone:
    ...
    {
        register s32 box_offset ASM_REG("$3");
        u8 *box_data;
        Box *linked_box;
...
diagonal_2:
    {
        register s32 band ASM_REG("$8");
        register s32 zone_y ASM_REG("$11");
        register s32 zone_height ASM_REG("$4");
        register s32 edge_delta ASM_REG("$2");
        s32 zone_x;
        s32 actor_y;
        s32 actor_x;
        s32 edge_y;
...
diagonal_3:
    {
        register s32 edge_delta ASM_REG("$2");
        register s32 band ASM_REG("$8");
        register s32 current_zone ASM_REG("$4");
        register s32 zone_x ASM_REG("$3");
        s32 zone_y;
        s32 actor_y;
        s32 actor_x;
        u8 *zone_data;
...
diagonal_4:
    {
        ...
        register s32 current_zone ASM_REG("$4");
        register s32 zone_y ASM_REG("$11");
        register s32 zone_x ASM_REG("$10");
        register s32 edge_coord ASM_REG("$3");
        s32 actor_y;
        s32 actor_x;
        u8 *zone_data;
        zone_data = (u8 *)D_80024020;
...
diagonal_5:
    {
        register s32 edge_delta ASM_REG("$2");
        register s32 band ASM_REG("$8");
        register s32 zone_width ASM_REG("$4");
        s32 zone_y;
        s32 zone_x;
        s32 neg_x;
        s32 actor_y;
