...
void func_80094DA8(TownObject *object) {
    ...
    s32 component_x;
    s32 limit_x;
    register s32 limit_abs_x ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
    s32 current_abs_x;
    s32 current_x;
    s32 step_x;
    register s32 clamp_work_x ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
    register s32 clamp_abs_x ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
    s32 component_y;
    s32 limit_y;
    register s32 limit_abs_y ASM_REG("$2");   /* MATCH pin: retail register colouring depends on it */
    s32 current_abs_y;
    s32 current_y;
    s32 step_y;
    s32 clamp_work_y;
    register s32 clamp_abs_y ASM_REG("$3");   /* MATCH pin: retail register colouring depends on it */
