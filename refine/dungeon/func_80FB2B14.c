...
{
    register s32 transitioned ASM_REG("$19");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    s32 target_heading;
    u16 *global_flags;

    ((S_80172314_0 *)actor)->unk_71 &= 0x7F;
    global_flags = (u16 *)&D_80083460;
    transitioned = 0;
    if (global_flags[1] & 0x2000) {
        goto abort_transition;
    }
    ASM_KEEP(transitioned);   /* MATCH pin: retail register colouring depends on it */
    target_heading = func_800A04F0(actor, ((S_80172314_1 *)sprite)->unk_24,
                           ((S_80172314_1 *)sprite)->unk_25, ((S_80172314_0 *)actor)->unk_2A);
    ...
    if (!(((S_80172314_0 *)actor)->unk_46 & 0x8000) && (global_flags[1] & 8)) {
        return -1;
    }
...
transition_ok:
    {
        ...
        if (state_flags & 0x8000) {
            ...
            ((S_80172314_0 *)actor)->unk_84 = 0x28;
            ((S_80172314_0 *)actor)->unk_85 = 0x10;
        } else {
            ((S_80172314_2 *)state)->unk_9A = 0x11;
            ((S_80172314_0 *)actor)->unk_84 = 0x7C;
            ((S_80172314_0 *)actor)->unk_85 = 0;
        }
    }

    (*(u8 * *)((u8 *)sprite + 0x2C)) = D_80175258;
    func_80047784(sprite,
                  D_80175258[((D_80083228 + ((S_80172314_0 *)actor)->unk_2A + 0x100) >> 9) & 7],
                  0);
    ((S_80172314_0 *)actor)->unk_6D--;
    func_8009C93C(actor, sprite, ((S_80172314_0 *)actor)->unk_2A, 1, 0);
    return transitioned;
}
