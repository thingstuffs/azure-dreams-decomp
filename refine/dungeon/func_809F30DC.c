...
void *func_801708DC(s32 kind, s32 part_x, s32 part_y, s32 copy_value)
{
    ...
    void *allocated;
    register uptr work_value ASM_REG("$8");   /* MATCH pin: keeps a constant in a register as retail does */
    s32 allocation_size;
...

    {
        ...
        work_value = (uptr)((S_801708DC_2 *)((void *)work_value))->unk_08.at00.v;
        stack.copy = (void *)work_value;
        ((S_801708DC_2 *)((void *)work_value))->unk_08.at02.v = saved_copy_value;
        work_value = (uptr)stack.root;
        stable_object = object;
        part = ((S_801708DC_2 *)((void *)work_value))->unk_0C;
    ...
    {
        register s32 primary_flags ASM_REG("$2");   /* MATCH pin: load-bearing for the whole function shape */
        s32 secondary_flags;
...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            work_value = 1;
            ((S_801708DC_6 *)entry)->unk_02 = (s16)work_value;
            item_index = 0;
            outer_base = outer;
            ...
            do {
                ...
                ((S_801708DC_9 *)outer_child)->unk_10 = (void *)work_value;
                ...
                item_index++;
                {
                    ...
                    register s32 one ASM_REG("$6");   /* MATCH pin: retail register colouring depends on it */

                    call_part = part;
                    call_data = D_800D71A8;
                    one = 1;
                    ASM_KEEP(one);   /* MATCH pin: keeps a constant in a register as retail does */
                    work_value = (uptr)one;
                    ((S_801708DC_6 *)entry)->unk_06 = (s16)work_value;
                    func_800478E8(call_part, call_data, one);
                }
                work_value = (uptr)stack.root;
                new_link = (u8 *)work_value + 0x1E;
                more_items = item_index < ((S_801708DC_6 *)entry)->unk_02;
