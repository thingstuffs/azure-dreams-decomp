...
void *func_8016F160(s16 mode, s8 config_24, s8 config_25, s16 config_0a)
{
    ...
    void *work;
    s16 saved_mode;
    register s8 saved_config_24 ASM_REG("$22");   /* MATCH pin: retail schedule: same instructions, different order without it */
    s16 saved_config_0a;
    register s8 saved_config_25 ASM_REG("$21");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    void *actor;
    void *actor_state;
