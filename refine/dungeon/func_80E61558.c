...
typedef struct S_80170D58_2 {
    u8 pad_00[0x14];
    u16 unk_14;
    u8 pad_16[0x6];
    u16 unk_1C;
    u16 unk_1E;
} S_80170D58_2;   /* arg2 in func_80170D58 */
...
void func_80170D58(void *motion, void *position, void *sprite)
{
    ...
    scale_x = ((S_80170D58_2 *)sprite)->unk_1C + 0x64;
    ((S_80170D58_2 *)sprite)->unk_1C = scale_x;
    if (scale_x > 0x1000) {
        ((S_80170D58_2 *)sprite)->unk_1C = 0x1000;
    }

    scale_y = ((S_80170D58_2 *)sprite)->unk_1E + 0x64;
    ((S_80170D58_2 *)sprite)->unk_1E = scale_y;
    if (scale_y > 0x1000) {
        ((S_80170D58_2 *)sprite)->unk_1E = 0x1000;
    }
    ...
    if (((S_80170D58_2 *)sprite)->unk_14 & 0x8000) {
        (*(u16 *)((u8 *)motion + -2)) |= 0x8000;
        D_800814A0 |= 0x8000;
    }
}
