...
void func_818D4B94(S_818D4B94_3 *source, s16 setting_14, s32 setting_08, s32 duration, s32 offset_x, s32 offset_y, s32 offset_z) {
    s16 saved_setting_14 = setting_14;
    s32 saved_setting_08 = setting_08;
    s32 saved_duration = duration;
    register s32 saved_offset_x ASM_REG("$18") = offset_x;   /* MATCH pin: keeps a statement from moving across a call/branch */
    register s32 saved_offset_y ASM_REG("$19") = offset_y;   /* MATCH pin: keeps a statement from moving across a call/branch */
    register s32 saved_offset_z ASM_REG("$20") = offset_z;   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    s32 signed_duration;
    s32 biased_duration;
    s32 step_count;
    s32 return_delta_x;
    ...
    if (effect != NULL) {
        ...
        ((S_818D4B94_4 *)(((S_818D4B94_2 *)effect)->unk_08))->unk_02 = (s16) (((S_818D4B94_5 *)(source->unk_08))->unk_02 + saved_offset_x);
        ((S_818D4B94_4 *)(((S_818D4B94_2 *)effect)->unk_08))->unk_06 = (s16) (((S_818D4B94_5 *)(source->unk_08))->unk_06 + saved_offset_y);
        ((S_818D4B94_4 *)(((S_818D4B94_2 *)effect)->unk_08))->unk_0A = (s16) (((S_818D4B94_5 *)(source->unk_08))->unk_0A + saved_offset_z);
        state = effect + 0x20;
        ...
        ASM_KEEP(saved_offset_y);   /* MATCH pin: retail keeps a computation the compiler would drop */
        ASM_KEEP(saved_setting_14);   /* MATCH pin: keeps a statement from moving across a call/branch */
        ASM_KEEP(saved_duration);   /* MATCH pin: keeps a statement from moving across a call/branch */
        ASM_KEEP(saved_setting_08);   /* MATCH pin: retail schedule: same instructions, different order without it */
        ...
        ASM_KEEP(saved_offset_z);   /* MATCH pin: load-bearing for the whole function shape */
