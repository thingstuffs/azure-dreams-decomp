...
void func_80166BAC(void *action, void *motion, void *map_entity, void *actor)
{
    s32 state;
    s32 hop_frames;
    s32 target_x;
...
state_zero:
    ...
    func_80047784(
        map_entity,
        D_80168E0C[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
...
state_one:
    ...
    if (hop_frames != 0) {
        ...
        ((Rec_D_800E3D7C *)motion)->unk_0C.as_s32 = ((target_x - pos_x) << 16) / hop_frames;
...
state_two:
    if (((Rec_D_800E3D7C *)actor)->unk_1C.as_s32 & 0x08000000) {
        ...
        func_80047784(
            map_entity,
            D_80168E14[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
            0);
        ((S_80166BAC_0 *)action)->unk_9B++;
    }
    goto decrement_timer;
...
state_three:
    ...
    func_80047784(
        map_entity,
        D_80168DEC[((D_80083228 + ((Rec_D_800E3D7C *)actor)->unk_2A.as_s16 + 0x100) >> 9) & 7],
        0);
