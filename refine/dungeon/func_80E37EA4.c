...
{
    register void *move_data ASM_REG("$21") = move_data_in;   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    register void *tile ASM_REG("$19") = tile_in;   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    register void *actor ASM_REG("$18") = actor_in;   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
...
process_state:
    ASM_KEEP(move_data);   /* MATCH pin: retail basic-block layout depends on it */
    ASM_KEEP(tile);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    ASM_KEEP(actor);   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    if (((S_801716A4_1 *)actor)->unk_12 >= 2) {
        goto reject_state;
    }
    if ((s16)func_80171E38(move_data, context, tile, actor) != 0) {
        goto accept_state;
    }
...
active:
    func_800A19E4(tile, actor, 2, 4, (u8 *)move_data + 0x9C);
    ...
    if (((S_801716A4_1 *)actor)->unk_1C & 0x20000) {
        ...
        ((S_801716A4_1 *)actor)->unk_2A.s = func_800A0818(
            ((S_801716A4_2 *)tile)->unk_24.at00.v, ((S_801716A4_2 *)tile)->unk_24.at01.v,
            origin[0x24], origin[0x25], (u8 *)move_data + 0x98);
        if (func_8009FD7C(
                ((S_801716A4_2 *)tile)->unk_24.at00.v, ((S_801716A4_2 *)tile)->unk_24.at01.v,
...
direct_move:
    func_800A0E6C(tile, ((S_801716A4_5 *)move_data)->unk_9C.s, actor,
                  (u8 *)move_data + 0x98);
...
loop_body:
    turn_flags = ((S_801716A4_5 *)move_data)->unk_98;
    ...
    if (func_8009A66C(trial_angle, tile, actor, 0x20) > 0) {
        if (turn_or_height >= 3) {
            ...
            ASM_KEEP_NV(stop_turn);   /* MATCH pin: load-bearing for the whole function shape */
            if (stop_turn != 0) {
                goto success;
            }
        }
...
loop_test:
...

    {
        ...
        ((S_801716A4_1 *)actor)->unk_46 &= 0x7FFF;
        ((S_801716A4_5 *)move_data)->unk_9C.u = ((S_801716A4_2 *)tile)->unk_26.u;
