...
typedef struct S_801739F8_1 {
    u8 pad_00[0x14];
    u16 unk_14;
} S_801739F8_1;   /* arg2 in func_801739F8 */
...
typedef struct S_801739F8_3 {
    ...
    u8 pad_66[0x7];
    s8 unk_6D;
} S_801739F8_3;   /* arg3 in func_801739F8 */
...
#define sprite saved_sprite
    ASM_KEEP_NV(saved_controller);   /* MATCH pin: retail callee-saved set / frame layout depends on it */
...
#define entity saved_entity
    ...
    case 0:
    {
        ...
        if ((((S_801739F8_1 *)sprite)->unk_14 & 0xE000) == 0) {
            return;
        }
        ...
        direction = (D_80083228 + ((S_801739F8_3 *)entity)->unk_2A + 0x100) >> 9;
        func_80047784(sprite, anim_table[direction & 7], 0);
        goto increment_state;
    }

    case 1:
        if (((S_801739F8_3 *)entity)->unk_25 != 0) {
        ...
        if ((((S_801739F8_3 *)entity)->unk_64 != 0) &&
        ...
        if (((S_801739F8_3 *)entity)->unk_1C & 0x100) {
            func_800AA258(controller, context, sprite, entity);
            return;
        }

        if (((S_801739F8_3 *)entity)->unk_1C & 0x80000) {
        ...
        if (((S_801739F8_3 *)entity)->unk_6D == 0) {
            return;
        }
        ...
        direction = (D_80083228 + ((S_801739F8_3 *)entity)->unk_2A + 0x100) >> 9;
        func_80047784(sprite, anim_table[direction & 7], 0);
        ((S_801739F8_3 *)entity)->unk_1C |= 0x40000;
...
#endif
        ((S_801739F8_2 *)activity_counts)->unk_0A--;
        ((S_801739F8_3 *)entity)->unk_1C &= ~0x208;
