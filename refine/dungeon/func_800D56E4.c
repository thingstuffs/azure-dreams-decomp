...
void func_800DAE44(S_800DAE44_1 *source_pos, s16 initial_value) {
    ...
    if (object != NULL) {
        ...
        ((S_800DAE44_4 *)(((S_800DAE44_3 *)object)->unk_08))->unk_02 = (u16) source_pos->unk_02;
        ((S_800DAE44_4 *)(((S_800DAE44_3 *)object)->unk_08))->unk_06 = (u16) source_pos->unk_06;
        object_data = object + 0x20;
        ((S_800DAE44_4 *)(((S_800DAE44_3 *)object)->unk_08))->unk_0A = (u16) source_pos->unk_0A;
        object_data->unk_10 = func_800BCB04(source_pos->unk_02, source_pos->unk_06, (s16) (source_pos->unk_0A - 0x80));
