...
s32 func_818BC9CC(void *effect_data, void *position_data)
{
    ...
    u8 *scratch;
    u8 *packet;
    register u8 *draw_mode ASM_REG("$16");
    u8 *render_ctx;
    u8 *render_state;
    u32 tag_mask;
    u32 window_tag_mask;
    s32 page_depth;
    register s32 page_blend ASM_REG("$5");
    s32 page_x;
    u32 x_extent;
    register u32 y_extent ASM_REG("$23");
    u32 depth;
    register u32 addr_mask ASM_REG("$20");
    s32 quad_index;
    u32 far_z;
    u32 far_y;
    s32 angle;
    ...
    do {
        ...
        if (quad_index < 2) {
            ...
            {
                void *vertex_arg0;
                register void *vertex_arg1 ASM_REG("$5");
                void *vertex0;
                void *vertex1;
