...
void *func_800CB82C(void *spawn_pos, void *source_state, void *owner) {
    ...
    if (object != NULL) {
        ...
        ((S_800CB82C_4 *)object_state)->unk_88 = (u16) ((S_800CB82C_8 *)source_state)->unk_88;
        ((S_800CB82C_4 *)object_state)->unk_13 = 0xFF;
        ((S_800CB82C_4 *)object_state)->unk_14 = (s32) ((S_800CB82C_8 *)source_state)->unk_14;
        ((S_800CB82C_4 *)object_state)->unk_1C = (s32) ((S_800CB82C_8 *)source_state)->unk_1C;
        ((S_800CB82C_4 *)object_state)->unk_2A = (s16) (((S_800CB82C_6 *)owner)->unk_2A - 0x800);
