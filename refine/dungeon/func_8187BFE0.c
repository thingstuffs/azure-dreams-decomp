...
void func_8187BFE0(void *state_data, void *source_data) {
    ...
    register s32 vertex_index ASM_REG("$18");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    s32 angle_offset;
    s16 blended_coord;
    s32 mode;
    u16 end_coord;
    ...
    ASM_KEEP(source_position);   /* MATCH pin: retail schedule: same instructions, different order without it */
    ...
    *(s16 *)(globals_page + 0x694C) = 1;
    ...
    case 1:
                ...
                ((S_8187BFE0_0 *)state)->unk_2A;
        {
            ...
            edge_height = 0x18;
            ASM_KEEP(next_coord);   /* MATCH pin: retail basic-block layout depends on it */
            ASM_TAILSLOT_PIN(edge_height);   /* MATCH pin: load-bearing for the whole function shape */
            func_80025AB0();
        }
        case 1:
            ((S_8187BFE0_2 *)edge_data)->unk_58.s = ((S_8187BFE0_2 *)edge_data)->unk_5C =
