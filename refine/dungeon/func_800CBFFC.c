...
s16 func_800D175C(s32 grid_x, s32 grid_y)
{
    ...
    s32 height;
    s32 biased_height;
    register s32 fallback_height ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    ...
    grid_y = (s16)grid_y;
    grid_x = (s16)grid_x;
    ASM_KEEP(grid_info);   /* MATCH pin: load-bearing for the whole function shape */
