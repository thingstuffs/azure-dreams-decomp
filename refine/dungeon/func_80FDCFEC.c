...
void func_801727EC(void *action_state, s32 actor_id, void *animation, void *actor) {
    ...
    switch (phase) {
    case 0:
        if (((S_801727EC_1 *)animation)->unk_14 & 0x8000) {
            ((S_801727EC_0 *)action_state)->unk_9B = 1;
            ((S_801727EC_1 *)animation)->unk_14 |= 0x6000;
        ...
        func_80047784(animation,
                     D_80174060[((D_80083228 + ((S_801727EC_2 *)actor)->unk_2A + 0x100) >> 9) & 7],
                     0);
    ...
    case 1:
        ...
        if (((ticks_left << 16) == 0) || (((S_801727EC_1 *)animation)->unk_14 & 0x8000)) {
            func_8009C12C(actor, animation, ((S_801727EC_2 *)actor)->unk_2A, 1);
            func_800A56E0(0x804);
        }
        if (((S_801727EC_1 *)animation)->unk_14 & 0xE000) {
            func_800A2B04(actor_id, ((S_801727EC_1 *)animation)->unk_24, ((S_801727EC_1 *)animation)->unk_25);
            func_800AD594(actor, 0x100);
            ((S_801727EC_0 *)action_state)->unk_8C = &D_80170EA8;
            D_8008346C = 0;
            func_800A4ACC(actor);
            if (((S_801727EC_2 *)actor)->unk_6D == 0) {
                ((S_801727EC_2 *)actor)->unk_46 &= 0x7FFF;
            } else {
