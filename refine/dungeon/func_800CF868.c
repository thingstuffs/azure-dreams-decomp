...
void func_800D4FC8(void *source, s32 color, unsigned short sound_id)
{
  ...
  if (effect != 0)
  {
    ...
    *((M2C_UNK **) (((u8 *) effect) + 0x10)) = &D_800D4DE8;
    *((s16 *) (((u8 *) effect_data) + 0x1E)) = 0x1E;
    render_flags = *((void **) (((u8 *) effect) + 0xC));
    *((s16 *) (((u8 *) render_flags) + 0x10)) = 0x20;
    *((u16 *) (((u8 *) render_flags) + 0x14)) = (u16) ((*((u16 *) (((u8 *) render_flags) + 0x14))) | 0xC);
    ...
    *((u8 *) (((u8 *) render_data) + 0xC)) = 0x80;
    packed_color = *color_ptr;
    *((s16 *) (((u8 *) render_data) + 0x1E)) = 0x1000;
    *((s16 *) (((u8 *) render_data) + 0x1C)) = 0x1000;
    *((s32 *) (((u8 *) render_data) + 0xC)) = packed_color;
    *((s32 *) (((u8 *) effect_data) + 0xC)) = packed_color;
    *((s16 *) (((u8 *) render_data) + 0x12)) = 0x7DCE;
    sprite_data = D_800DECF8;
    *((u16 *) (((u8 *) render_data) + 0x14)) = (u16) ((*((u16 *) (((u8 *) render_data) + 0x14))) | 0x100);
    func_8003DB94(render_data, sprite_data, 0);
    sound = sound_id & 0xFFFF;
    if (sound != 0)
    {
      func_800A56E0(sound);
    }
