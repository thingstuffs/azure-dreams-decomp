...
void *func_8017089C(s32 kind, s32 tile_x, s32 tile_y, s32 copy_value)
{
    ...
    register s32 saved_tile_y ASM_REG("$18");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    ...
    void *allocated;
    register uptr scratch_word ASM_REG("$8");   /* MATCH pin: keeps a constant in a register as retail does */
    s32 allocation_size;
...
flags_done:
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            scratch_word = 1;
            ((S_8017089C_6 *)entry)->unk_02 = (s16)scratch_word;
            item_index = 0;
            outer_base = outer;
            ...
            do {
                ...
                item_index++;
                {
                    ...
                    scratch_word = (uptr)call_one;
                    ((S_8017089C_6 *)entry)->unk_06 = (s16)scratch_word;
                    func_800478E8(call_part, call_data, call_one);
                }
                scratch_word = (uptr)stack.root;
                new_link = (u8 *)scratch_word + 0x1E;
                more_items = item_index < ((S_8017089C_6 *)entry)->unk_02;
        ...
        outer = (u8 *)outer + 4;
        {
            ...
            more_children = (s32)scratch_word < child_count;
            if (!more_children) {
                break;
            }
        }
