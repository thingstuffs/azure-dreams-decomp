...
state_0:
    ...
    if (((S_8197D468_3 *)motion)->unk_14 > 0) {
        ...
        ASM_KEEP(sprite_frames);   /* MATCH pin: retail schedule: same instructions, different order without it */
        sprite_flags = ((S_8197D468_2 *)sprite)->unk_14;
        ASM_KEEP(sprite_flags);   /* MATCH pin: keeps a statement from moving across a call/branch */
        ((S_8197D468_2 *)sprite)->unk_04 = 0;
        ((S_8197D468_2 *)sprite)->unk_05 = 0;
    ...
    if (((S_8197D468_3 *)motion)->unk_08.at02.v >= (ground_height - 0x20)) {
        ...
        do {
            ...
            if (particle != NULL) {
                ...
                ASM_KEEP(effect_data);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
