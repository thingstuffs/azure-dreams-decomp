...
/* Spawns two particles near the source with randomized positions and velocities. */
void func_800CAFDC(S_800CAFDC_4 *source, s16 effect_param, s32 render_param) {
    s16 angle;
    s32 remaining;
    ...
    do {
        ...
        if (particle != NULL) {
            ...
            motion->unk_02 = (s16) ((((S_800CAFDC_5 *)(source->unk_08))->unk_02 + (rand() & 0x3F)) - 0x20);
            motion->unk_06 = (s16) ((((S_800CAFDC_5 *)(source->unk_08))->unk_06 + (rand() & 0x3F)) - 0x20);
            motion->unk_0A = (s16) ((((S_800CAFDC_5 *)(source->unk_08))->unk_0A + (rand() & 0x3F)) - 0x20);
            angle = rand();
