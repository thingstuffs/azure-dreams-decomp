...
void *func_8015E89C(s32 kind, s32 part_x, s32 part_y, s32 initial_value)
{
    struct {
        void *root;
        void *copy;
    ...
    register s32 saved_value ASM_REG("$17");   /* MATCH pin: retail schedule: same instructions, different order without it */
    register s32 saved_y ASM_REG("$18");   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
...

    {
        ...
        address_or_count = (uptr)((S_8015E89C_2 *)((void *)address_or_count))->unk_08.at00.v;
        stack.copy = (void *)address_or_count;
        ((S_8015E89C_2 *)((void *)address_or_count))->unk_08.at02.v = saved_value;
        address_or_count = (uptr)stack.root;
        stable_object = object;
        part = ((S_8015E89C_2 *)((void *)address_or_count))->unk_0C;
    ...
    do {
        ...
        if (allocated != 0) {
            ...
            ASM_KEEP(outer_base);   /* MATCH pin: retail schedule: same instructions, different order without it */
            {
                ...
                direction_table = table_page + 0x24E4;
            }
            item_offset = 8;
            do {
                void *item;
                ...
                ((S_8015E89C_9 *)outer_child)->unk_10 = (void *)address_or_count;
