...
s32 func_80172438(void *action_state, void *action_context, void *sprite, void *actor) {
    ...
    s16 *y_step;
    s16 floor_height;
    register s32 target ASM_REG("$5");   /* MATCH pin: retail delay-slot fill depends on it */
    ...
    do {
        ...
        s32 floor_x;
        s32 floor_y;
        register s16 *y_steps ASM_REG("$2");   /* MATCH pin: retail delay-slot fill depends on it */
