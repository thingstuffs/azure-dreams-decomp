...
state_zero:
    if (!(((S_80174788_1 *)sprite)->unk_14 & 0xE000)) {
        goto done;
    }
    {
    ...
    func_80047784(sprite,
                  D_800E2428[((D_80083228 + ((S_80174788_3 *)actor)->unk_2A + 0x100) >> 9) & 7],
                  0);
...
state_one:
    ...
    if (((S_80174788_3 *)actor)->unk_64 != 0) {
    ...
    actor_flags = ((S_80174788_3 *)actor)->unk_1C;
    ...
    if (((S_80174788_3 *)actor)->unk_6D == 0) {
        goto done;
    }
    if ((func_800A2C34(actor) << 16) != 0) {
        if ((func_8009A180(actor, ((S_80174788_5 *)D_800814A8)->unk_58 + 0x20) << 16) != 0) {
            goto done;
        }
    }
    func_800A9A0C(actor);
    func_800A9A04(actor);
    if (((S_80174788_3 *)actor)->unk_25 == 0) {
        goto done;
    }
    (*(void * *)((u8 *)sprite + 0x2C)) = D_800E2430;
    func_80047784(sprite,
                  D_800E2430[((D_80083228 + ((S_80174788_3 *)actor)->unk_2A + 0x100) >> 9) & 7],
                  0);
    ((S_80174788_3 *)actor)->unk_1C |= 0x40000;
