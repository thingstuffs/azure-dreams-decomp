...
void *func_80158870(s16 kind_flags, s8 part_value_24, s8 part_value_25, s16 part_value_0a)
{
    ...
    ASM_KEEP_NV(saved_value_25);   /* MATCH pin: retail schedule: same instructions, different order without it */
    ASM_KEEP_NV(saved_value_24);   /* MATCH pin: retail schedule: same instructions, different order without it */
