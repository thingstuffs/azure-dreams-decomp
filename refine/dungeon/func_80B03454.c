...
/* Updates a timed hop, its animations, and the actor's return to its tile. */
void func_80160C54(void *action, void *motion, void *sprite, void *actor)
{
    s32 state;
    s32 hop_ticks;
    s32 target_x;
    ...
    state = ((S_80160C54_0 *)action)->unk_9B;
    if (state == 1) {
        goto state_one;
    }
    if (state < 2) {
...
state_zero:
    ...
    ((S_80160C54_0 *)action)->unk_9E.s = 5;
    ((S_80160C54_0 *)action)->unk_A4 = 0;
    ((S_80160C54_0 *)action)->unk_9B++;

state_one:
    hop_ticks = ((S_80160C54_0 *)action)->unk_9E.s;
    ((S_80160C54_0 *)action)->unk_90 -= ((S_80160C54_0 *)action)->unk_A4;
    if (hop_ticks != 0) {
        ...
        ((Rec_D_800E3D7C *)motion)->unk_10.at00_s32.v =
            ...
            ((S_80160C54_0 *)action)->unk_9E.s;

        ((S_80160C54_0 *)action)->unk_A4 =
            (-func_800644B8(((S_80160C54_0 *)action)->unk_9E.s * 0x199)) << 10;
    }

    height_offset = ((S_80160C54_0 *)action)->unk_90;
    height_step = ((S_80160C54_0 *)action)->unk_A4;
    next_hop_ticks = ((S_80160C54_0 *)action)->unk_9E.u;
    height_offset += height_step;
    next_hop_ticks -= 1;
    ((S_80160C54_0 *)action)->unk_9E.u = next_hop_ticks;
    ((S_80160C54_0 *)action)->unk_90 = height_offset;
    if ((next_hop_ticks << 16) >= 0) {
        goto state_two;
    }

    ((S_80160C54_0 *)action)->unk_90 = 0;
    ((S_80160C54_0 *)action)->unk_98 &= 0xFFF7;
...
state_three:
    if (((Rec_D_80082E80 *)sprite)->unk_2C.as_pu8 == D_80163988) {
        goto decrement_timer;
    }
...
decrement_timer:
    action_ticks = ((S_80160C54_0 *)action)->unk_96 - 1;
    ((S_80160C54_0 *)action)->unk_96 = action_ticks;
...
collision_check:
    if ((func_800AD9B4(sprite, actor) << 16) > 0) {
        ((S_80160C54_0 *)action)->unk_8C = &D_8015F7F4;
        func_800A9A04(actor);
    }
}
