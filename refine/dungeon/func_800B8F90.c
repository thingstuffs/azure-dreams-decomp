...
s32 func_800BE6F0(void *entity, s32 source, s16 reason)
{
    ...
    if (entity == D_800E3D7C) {
        ((S_800BE6F0_0 *)entity)->unk_110 = source;
    ...
    if (((S_800BE6F0_0 *)entity)->unk_14 & 0x4000) {
        text_buffer = func_800990FC();
        if ((u32)(((S_800BE6F0_0 *)entity)->unk_13 - 3) < 0x2B) {
    ...
    entity_type = ((S_800BE6F0_0 *)entity)->unk_13;
    if ((u32)(entity_type - 3) < 0x2B) {
        spawn_data[0] = entity_type;
        spawn_type = ((S_800BE6F0_0 *)entity)->unk_13;
        ...
        ASM_KEEP(selection_state);   /* MATCH pin: keeps a constant in a register as retail does */
        selected_entity = ((S_800BE6F0_2 *)selection_state)->unk_10;
        ASM_KEEP(selected_entity);   /* MATCH pin: retail register colouring depends on it */
        ...
        if ((func_80042900(entity, 0x1B) << 16) == 0) {
            ...
            tile_mask = 0x3000;
            if (((S_800BE6F0_0 *)entity)->unk_1C & 0x2000) {
                tile_mask = 0x300;
            }
...
success_cleanup:
    ...
    ASM_KEEP(dungeon_state);   /* MATCH pin: keeps a constant in a register as retail does */
