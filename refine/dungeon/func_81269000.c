...
void BODY_NAME(void *root_data, void *position_data, void *render_data)
{
    s16 offset[3];
    void *root = root_data;
    register void *output_pos ASM_REG("$17") = position_data;   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    ...
    render_part->unk_1C = ((S_81269000_2 *)part)->unk_1C;
    render_part->unk_1E = ((S_81269000_2 *)part)->unk_1E;
    render_part->unk_14 = ((S_81269000_2 *)part)->unk_14;
    transform->unk_01 &= 0xFE;

    if (((S_81269000_0 *)root)->unk_B6 == 1) {
        phase = ((S_81269000_2 *)part)->unk_04.s8;
        if (phase < 8) {
