...
void func_8017103C(void *entity_arg, void *motion_arg, void *monster_arg)
{
    ...
    void *call_entity;   /* MATCH pin: retail schedule: same instructions, different order without it */
    void *call_motion;   /* MATCH pin: retail schedule: same instructions, different order without it */
    void *call_monster;
    void *call_context;
    s32 direction_index;
    u16 monster_flags;
