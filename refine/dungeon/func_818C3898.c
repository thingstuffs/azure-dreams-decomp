...
void func_818C3898(void *effect, void *motion_data, S_818C3898_2 *sprite) {
    s16 size;
    s32 color_step;
    s32 color_index;
    s32 quarter_bias;
    ...
    sprite->unk_1A = (u16) (sprite->unk_1A + 0x300);
    quarter_bias = color_index;
    if (color_index < 0) {
        quarter_bias = color_index + 3;
    }
    half_color = (s32) (color_index + ((u32) (color_step << 0x10) >> 0x1F)) >> 1;
    sprite->unk_0C = (s8) ((quarter_bias >> 2) << 7);
    sprite->unk_0D = (s8) ((s32) (((s16) half_color - (((s32) ((s16) half_color + ((u32) (half_color << 0x10) >> 0x1F)) >> 1) * 2)) << 0x10) >> 9);
    sprite->unk_0E = (s8) ((s32) ((color_index - (half_color * 2)) << 0x10) >> 9);
