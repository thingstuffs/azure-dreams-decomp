...
typedef struct S_8017294C_0 {
    ...
    u8 pad_6E[0x3];
    u8 unk_71;
} S_8017294C_0;   /* arg3 in func_8017294C */
...
typedef struct S_8017294C_2 {
    u8 pad_00[0x2C];
    u8 * unk_2C;
} S_8017294C_2;   /* arg2 in func_8017294C */

/* Attempt an actor action and initialize its state and directional animation on success. */
void func_8017294C(S_8017294C_1 *action_state, M2C_UNK action_ctx, S_8017294C_2 *sprite, void *actor) {
    ((S_8017294C_0 *)actor)->unk_71 = (u8) (((S_8017294C_0 *)actor)->unk_71 & 0x7F);
    if (!(*D_80083462 & 0x2000) && ((func_800A2B5C(actor) << 0x10) == 0)) {
        ...
        if ((func_800A2B5C(actor) << 0x10) == 0) {
            ...
            sprite->unk_2C = D_801764A0;
            func_80047784(sprite, D_801764A0[((s32) (*D_80083228 + ((S_8017294C_0 *)actor)->unk_2A + 0x100) >> 9) & 7], 0);
            func_800A4ACC(actor);
            ((S_8017294C_0 *)actor)->unk_6D = (u8) (((S_8017294C_0 *)actor)->unk_6D - 1);
