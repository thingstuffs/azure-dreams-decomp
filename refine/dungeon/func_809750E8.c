...
void func_809750E8(void *record_data, void *unused, S_809750E8_1 *color_target) {
    s16 remaining_ticks;
    s32 intensity;

    intensity = (s32) (((S_809750E8_0 *)((u8 *)record_data - 0x2))->unk_98 << 7) / (s16) ((S_809750E8_0 *)((u8 *)record_data - 0x2))->unk_AC;
    color_target->unk_0E = (s8) intensity;
    color_target->unk_0D = (s8) intensity;
    color_target->unk_0C = (s8) intensity;
