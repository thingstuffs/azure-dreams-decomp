...
void func_80123604(void) {
    ...
    default_6 = 0x10;
    default_8 = 0xE0;
    ASM_KEEP(default_6);   /* MATCH pin: retail schedule: same instructions, different order without it */
    ASM_KEEP(default_8);   /* MATCH pin: retail register colouring depends on it */
