...
void func_818EC800(void *screen_pos, void *effect, s32 *ordering_tag, u32 draw_mode)
{
  ...
  s32 texture_word;
  void *render_context;
  register u8 *context_dep ASM_REG("$2");
  void *final_context;
  s32 base_rotation;
  s32 packet_mask;
  u8 flipped_x;
  ...
  void *frame;
  void *row_effect;
  register u8 *frame_data ASM_REG("$21");
  void *sprite;
  void *setup_arg;
  u8 *context_addr;
  u8 *state_base;
  ...
  ASM_KEEP_MEMDEP_NV(setup_arg, context_dep, *((void **) (&D_80083160)));
  ...
  if (!((*((u8 *) (((s8 *) frame) + 0))) & 0x20))
  {
    ...
    *((s32 *) (((s8 *) scratch) + 0x14)) = (s32) (*((u8 *) (((s8 *) frame_data) + 3)));
    if (((*((u8 *) (((s8 *) frame) + 0))) ^ (*((u16 *) (((s8 *) scratch) + 0x24)))) & 1)
    {
      ...
      *((u16 *) (((s8 *) scratch) + 0x70)) = mirrored_x;
      ...
      ASM_TAILSLOT_PIN_TIED(mirrored_x);
      func_80024344();
    }
    ...
    *((u16 *) (((s8 *) scratch) + 0x78)) = quad_x;
    if (((*((u8 *) (((s8 *) frame) + 0))) ^ (*((u16 *) (((s8 *) scratch) + 0x24)))) & 2)
    {
      ...
      *((u16 *) (((s8 *) scratch) + 0x72)) = mirrored_y;
      ...
      ASM_TAILSLOT_PIN_TIED(mirrored_y);
      func_800243B8();
    }
    ...
    *((s32 *) (((s8 *) scratch) + 0x0C)) <<= 8;
    ...
    if (clut_offset != 0)
    {
      ...
      ASM_TAILSLOT_PIN_TIED(texture_word);
      func_80024544();
    }
    ...
    *((Blk40 *) quad_copies) = *((Blk40 *) packet);
    ...
    ASM_USE2(sprite, frame_data);
    ASM_USE_G_NV(callback_arg);
    ASM_USE_G_NV(saved_draw_mode);
    ASM_USE(frame);
    func_80024990();
    return;
  }
