...
{
    s32 effect_type;
    register s32 effect_index ASM_REG("$3");   /* MATCH pin: load-bearing for the whole function shape */
    ...
    ASM_KEEP(effect_type);   /* MATCH pin: retail delay-slot fill depends on it */
