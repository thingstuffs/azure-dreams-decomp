                   ...
                   s32 z)
{
    ...
    LocalPoint *point;
    s32 point_index;
    register s32 offset_x ASM_REG("$21") = x;   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    register s32 offset_y ASM_REG("$19") = y;   /* MATCH pin: retail address form (%hi/%lo vs base+offset) depends on it */
    register s32 offset_z ASM_REG("$20") = z;   /* MATCH pin: retail immediate-load split depends on it */
