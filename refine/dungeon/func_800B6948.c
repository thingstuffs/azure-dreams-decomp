...
void *func_800BC0A8(s16 x, s16 y, s16 z, s16 angle, s32 value_50, s32 value_58, s32 state_word, s32 value_48) {
    register s32 saved_value_50 ASM_REG("$21") = value_50;   /* MATCH pin: retail callee-saved set / frame layout depends on it */
    register s32 saved_value_58 ASM_REG("$23") = value_58;   /* MATCH pin: retail callee-saved set / frame layout depends on it */
    register s32 saved_value_48 ASM_REG("$22") = value_48;   /* MATCH pin: retail callee-saved set / frame layout depends on it */
