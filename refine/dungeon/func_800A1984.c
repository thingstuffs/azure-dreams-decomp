...
s32 func_800A70E4(s32 input_x, s32 input_y, s32 input_z) {
    ...
    s32 held_y;
    s32 result;
    register s32 entry_index ASM_REG("$4");   /* MATCH pin: retail register colouring depends on it */
    s32 y;
    u16 tile_flags;
...
next_entry:
    ...
    ASM_KEEP(entry_index);   /* MATCH pin: retail delay-slot fill depends on it */
    return result;
}
