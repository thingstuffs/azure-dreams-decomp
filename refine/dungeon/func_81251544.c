...
void func_80170D44(void *effect, S_80170D44_1 *position, S_80170D44_3 *primitive)
{
    s16 ticks_left;
    s32 shade;
    u16 extent;
    ...
    extent = primitive->unk_1E + 0x320;
    primitive->unk_1E = extent;
    primitive->unk_1C = extent;
    ...
    primitive->unk_0E = (s8)shade;
    primitive->unk_0D = (s8)shade;
    primitive->unk_0C = (s8)shade;
