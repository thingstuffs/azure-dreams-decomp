...
/* Update a dungeon actor's animation and dispatch its current behavior. */
void func_8015F0EC(void *actor, void *context, void *sprite, void *entity)
{
    s32 distance;
    s8 room_id;
    u16 action_flags;
    ...
    if (D_80083462 & 0x1000) {
        ((S_8015F0EC_0 *)actor)->unk_9A = 0xE;
        func_8015F69C(actor, context, sprite, entity);
        return;
    }
    ...
    if (((Rec_D_800E3D7C *)entity)->unk_24.at01_u8.v == 0) {
        ...
        if (((S_8015F0EC_2 *)sprite)->unk_2C == D_80163EA0) {
            return;
        }
        anim_table = D_80163EB0;
    ...
    if (((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 & 0x200) {
        if (((S_8015F0EC_2 *)sprite)->unk_2C == D_80163EA0) {
            ((S_8015F0EC_0 *)actor)->unk_9A = 0xD;
            ((S_8015F0EC_0 *)actor)->unk_9B = 1;
            ((S_8015F0EC_0 *)actor)->unk_8C = 0;
            ((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 &= ~0x40000;
            return;
        }
        if (func_800AA924(actor, context, sprite, D_80163EB0) != 0) {
            return;
        }
    }
    ...
    if (!(D_80083462 & 0x2000)) {
...

        {
            ...
            if (((S_8015F0EC_0 *)actor)->unk_9A != 0xE) {
                ((S_8015F0EC_0 *)actor)->unk_9A = 0xE;
                ((S_8015F0EC_0 *)actor)->unk_B2 = 0;
            }

            current_anims = ((S_8015F0EC_2 *)sprite)->unk_2C;
            if (current_anims == D_80163EB8) {
                if (((S_8015F0EC_2 *)sprite)->unk_14 & 0xE000) {
                    u8 *idle_anims = D_80163E40;

                    (*(void * *)((u8 *)sprite + 0x2C)) = idle_anims;
                    func_80047784(sprite,
                        idle_anims[((D_80083228 + ((Rec_D_800E3D7C *)entity)->unk_2A.as_s16 + 0x100) >> 9) & 7],
                        0);
                    ((S_8015F0EC_2 *)sprite)->unk_05 = 1;
                    ((S_8015F0EC_0 *)actor)->unk_A2.s = 0;
                    ((S_8015F0EC_0 *)actor)->unk_9E = 0;
                }
            } else {
                anim_table = D_80163E40;
        ...
        ((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 |= 0x40000;
        ((S_8015F0EC_0 *)actor)->unk_98 &= 0xFFF7;

        if (((Rec_D_800E3D7C *)entity)->unk_64.as_s16 != 0) {
            if (func_800AA6B4(actor, context, sprite, D_80163E48) != 0) {
                return;
            }
        }
        ...
        if (((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 & 0x80000) {
            ...
            adjusted_offset = ((S_8015F0EC_0 *)actor)->unk_92.u - ((S_8015F0EC_0 *)actor)->unk_A2.u;
            ((S_8015F0EC_0 *)actor)->unk_A2.s = 0;
            ((S_8015F0EC_0 *)actor)->unk_9E = 0;
            ((S_8015F0EC_0 *)actor)->unk_92.s = adjusted_offset;
            func_80162574(actor, context, sprite, entity);
            return;
        }
    ...
    room_id = func_8009FB34(((S_8015F0EC_2 *)sprite)->unk_24.at00.v, ((S_8015F0EC_2 *)sprite)->unk_24.at01.v);
    ((S_8015F0EC_2 *)sprite)->unk_26 = room_id;

    if (((Rec_D_800E3D7C *)entity)->unk_6D.as_s8 > 0) {
        if (((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 & 0x20) {
            goto case_12;
        }
        if (((S_8015F0EC_2 *)sprite)->unk_24.at00u.v == *(u16 *)&D_80082EA4) {
            goto generic;
        }
        if (!(((Rec_D_800E3D7C *)entity)->unk_44.at02_u16.v & 0x8000)) {
            ...
            if ((func_8016066C(actor, context, sprite, 0) << 16) == 0) {
                return;
            }
...

        {
            ...
            u32 action_index = (u32)((((Rec_D_800E3D7C *)entity)->unk_44.at02_u16.v & 0x3FFF) - 1);

            if (action_index >= 12) {
                goto generic;
            }
            (void)dispatch_labels;
            goto *D_8015E808[action_index];
        }
sw_case89:
...
generic:
    ...
    if (!(((Rec_D_800E3D7C *)entity)->unk_1C.as_u32 & 0x2000)) {
        ...
        if (((Rec_D_800814A8 *)D_800814A8)->unk_9A == 0x17) {
            func_80160358(actor, context, sprite, entity);
        }
    }
}
