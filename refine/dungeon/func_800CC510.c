...
void *func_800D1C70(s16 spawn_kind, u8 tile_x, u8 tile_y, s16 height) {
    M2C_UNK tile_flags;
    s16 saved_kind;
    S_800D1C70_3 *sprite;
    ...
    void *object;
    S_800D1C70_0 *state;
    register u8 saved_x ASM_REG("$22");   /* MATCH pin: retail schedule: same instructions, different order without it */
    s16 saved_height;
    register u8 saved_y ASM_REG("$21");   /* MATCH pin: retail schedule: same instructions, different order without it */
    s32 kind;
    u8 call_x;
    u8 call_y;
