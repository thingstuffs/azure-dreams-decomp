...
void func_80172A04(void *state, void *position, void *sprite, void *actor)
{
    u16 effect_pos[4];
    u8 *motion;
    register s32 special_motion ASM_REG("$21");
    void *target;
    register void *target_record ASM_REG("$3");
    s32 target_x;
    s32 target_y;
    s32 ticks_left;
    u8 *action_state;
    ...
    case 0:
        if (((S_80172A04_1 *)actor)->unk_1C & 0x2000) {
            static void *const dispatch_labels[] = {&&special_third, &&special_second, &&special_first, &&no_motion};
            extern void *const D_80170838[];
            u32 motion_index = (u32)((((S_80172A04_1 *)actor)->unk_46 & 0x3FFF) - 1);
        ...
        switch (((S_80172A04_1 *)actor)->unk_46 & 0x3FFF) {
        case 3:
        select_third:
            motion = (u8 *)actor + 0xE;
            break;
        ...
        if (*motion != 0) {
            ...
            ASM_KEEP(motion);
            {
                ...
                ASM_KEEP(use_special);
                if (use_special != 0) {
                    target = D_800814A8;
                    ((S_80172A04_1 *)actor)->unk_60 = target;
                    goto have_target;
                }
            }
            if (((MotionEntry *)D_8006DE24)[*motion].kind == 2) {
                target = ((S_80172A04_1 *)actor)->unk_60;
                if (target == 0) {
                    goto run_motion;
                }
            have_target:
                target_record = ((S_80172A04_2_pre *)target)[-1].unk_00;
                ((S_80172A04_1 *)actor)->unk_72.s = ((S_80172A04_3 *)target_record)->unk_24;
                ((S_80172A04_1 *)actor)->unk_73.s = ((S_80172A04_3 *)target_record)->unk_25;
                goto run_motion;
            }
            ((S_80172A04_1 *)actor)->unk_60 =
                func_800A05A4(actor, ((S_80172A04_4 *)sprite)->unk_24, ((S_80172A04_4 *)sprite)->unk_25,
                              ((S_80172A04_1 *)actor)->unk_2A, 0x10);
            ASM_KEEP(actor);
            target_x = ((S_80172A04_1 *)actor)->unk_72.u;
            target_y = ((S_80172A04_1 *)actor)->unk_73.u;
            if (target_x < 0) {
                target_x = -target_x;
            }
            if (target_y < 0) {
            ...
            ((S_80172A04_1 *)actor)->unk_72.s = target_x;
            ((S_80172A04_1 *)actor)->unk_73.s = target_y;
        run_motion:
            ...
            if (func_800A94A0(actor, motion, special_motion, (u8 *)state + 0x98) == 0) {
                return;
            }
        ...
        ((S_80172A04_1 *)actor)->unk_73.s = 0;
        ((S_80172A04_1 *)actor)->unk_72.s = 0;
        ((S_80172A04_1 *)actor)->unk_46 &= 0x7FFF;
        return;
    ...
    case 2:
        ...
        ((S_80172A04_0 *)state)->unk_8C = D_80170E5C;
        func_800A4ACC(actor);
        if (((S_80172A04_1 *)actor)->unk_6D.u > 0) {
            ((S_80172A04_1 *)actor)->unk_6D.s = ((S_80172A04_1 *)actor)->unk_6D.s - 1;
        }
        ((S_80172A04_1 *)actor)->unk_73.s = 0;
        ((S_80172A04_1 *)actor)->unk_72.s = 0;
