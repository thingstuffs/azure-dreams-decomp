...
void func_8004F684(S_8004F684 *state)
{
    ...
    s32 value_delta;
    s32 scaled_weight;
    register s32 offset ASM_REG("$3");   /* MATCH pin: slus-value_delta */
    s32 target_value;
    register void *entry_or_target ASM_REG("$4");   /* MATCH pin: slus-value_delta */
    S_8004F684_Obj *obj;
    ...
    ASM_KEEP(entry_index);   /* MATCH pin: slus-value_delta */
}
