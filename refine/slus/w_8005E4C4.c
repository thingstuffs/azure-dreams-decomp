...
u32 func_8005E4C4(s32 mode, u32 value, s32 low_index, s32 high_index)
{
    ...
    {
        register volatile u16 *words ASM_REG("$4");   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
        u32 high_bits;
        u32 low_word;
        ...
        ASM_USE2_NV(dirty_bit, high_bits);   /* MATCH pin: slus-diff */
        dirty_bit = 1;
