...
s32 func_80042900(S_80042900 *entry, s32 effect_id)
{
    ...
    register s32 saved_id ASM_REG("$7") = effect_id;   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    register u8 *effect_base ASM_REG("$3") = (u8 *)entry + 6;   /* MATCH pin: slus-diff */
    s32 effect_index;
