...
void func_800463EC(void *unused, u8 *position, RenderObject *object, s16 depth_bias)
{
    ...
    register u32 vertex_word ASM_REG("$2");   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    unsigned long vertex_data;
    register void *vertex_0 ASM_REG("$4");   /* MATCH pin: slus-diff */
    void *vertex_1;
    void *vertex_2;
    void *vertex_3;
    s32 clip_xy_0;
    ...
    vertex_0 = (u8 *)scratch;
    ASM_KEEP_NV(vertex_0);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    vertex_0 = (void *)((unsigned long)vertex_0 | 0x50);
    vertex_1 = (u8 *)scratch;
    ASM_KEEP_NV(vertex_1);   /* MATCH pin: retail keeps a copy the compiler would otherwise drop/add */
    ...
    for (;;) {
        ...
        ASM_JALDELAY_PIN(vertex_data);   /* MATCH pin: slus-diff */
