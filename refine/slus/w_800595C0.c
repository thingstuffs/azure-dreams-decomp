...
{
    register Entity *ent ASM_REG("$17") = entity;
    s32 command;
    s32 operand;
    s32 value;
    register s32 saved_command ASM_REG("$19");
    s32 command_index;
...
L_case_47:
    ...
    return 1;
L_case_48: {
    register s32 next_byte ASM_REG("$3") = func_800589B8(ent);
    u32 slot_count;
    operand = next_byte;
...
L_case_49: {
    register s32 next_byte ASM_REG("$2") = func_800589B8(ent);
    operand = next_byte;
    ASM_KEEP(next_byte);
